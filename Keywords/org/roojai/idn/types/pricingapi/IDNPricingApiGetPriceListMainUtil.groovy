...
public class IDNPricingApiGetPriceListMainUtil{
	...
	public Boolean inputCase(){
		...
		try{
			...
			lIsPricingApiMultiPlanPriceCallResultOK=this.inputPricingApiCallMultiPlanPrice(lStrPricingApiVersion01JsonRootQuotationInput,lStrPricingApiJsonRootMultiCover,lStrPricingApiJsonRootAdditionalCoverage,lIsPositiveCase,lMapPricingApiInputOutput)
	...
	public Map inputPricingApiGetPlanPriceResult(String strPricingApiJsonRootQuotationInput,String strPricingApiJsonRootVehicleData,String strPricingApiJsonRootPlanOption,String strPricingApiJsonRootMultiCover,String strPricingApiJsonRootAdditionalCoverage,String strPricingApiJsonRootInputPremium,String strPricingApiJsonRootTotalPremium,String strPricingApiJsonRootTransaction,String strPricingApiJsonRootPayment,Map mapPricingApiInputOutput,Map mapPricingApiSourceFileInformation){
		...
		try{
			...
			for(Integer lIndex=0;lIndex<=lListCover.size()-1;lIndex++){
				...
				Boolean lIsPricingApiLibraryAdditionalCoveragePremiumValidationOK=this.validatePricingApiLibraryAdditionalCoveragePremiumResult(lSheetPricingApi,lMapCollectedPricingApiDetailResult,mapPricingApiInputOutput,lMapPricingApiLibraryGetPlanPriceResult)
				Boolean lIsPricingApiAdditionalCoveragePremiumValidationOK=this.validatePricingApiAdditionalCoveragePremiumResult(lSheetPricingApi,lMapCollectedPricingApiDetailResult,mapPricingApiInputOutput,lMapInputPricingApiPaymentFrequencyResult)
				...
				Boolean lIsPricingApiLibraryPremiumValidationOK=this.validatePricingApiLibraryPremiumResult(lSheetPricingApi,lListSelectedPricingApiTotalPremium,lMapInputPricingApiInstallmentAndDownPaymentAmountResult,lMapCollectedPricingApiDetailResult,mapPricingApiInputOutput,lMapPricingApiLibraryGetPlanPriceResult)
	...
	public Map inputPricingApiMandatoryFieldForRequest(Sheet sheetPricingApi,Map mapPricingApiJsonQuotationInput,String strPricingApiJsonRootVehicleData,Map mapInputPricingApiPaymentFrequencyResult, Map mapPricingApiInputOutput){
		...
		try{
			...
			if(IGNUemaHelper.checkObjectEmptyOfString(lStrPricingApiMasterSetId)){
				lStrPricingApiMasterSetId=lMapInputPricingApiPaymentFrequencyResult.StrPricingApiMasterSetId
				Map lMapPricingApiMasterSetIdRowAndColumnNumber=lMapPricingApiQuoteTransactionDate.MasterSetId
	...
	public Boolean inputPricingApiCallMultiPlanPrice(String strPricingApiMultiPlanPriceInputRequestBodyContent,String strPricingApiJsonRootMultiCover,String strPricingApiJsonRootAdditionalCoverage,Boolean isPositiveCase,Map mapPricingApiInputOutput){
		Boolean lreturn=false
		Boolean lResult=false
	...
	public Map verifyResponsePricingApiMultiPlanPriceApi(String strProductType,String strResponseText,Integer statusCode,Boolean  isPositiveCase,Map mapPricingApiInputOutput,List strCoverList,List strCoverageList){
		Boolean lResult=false
		Map lreturn=[:]
			...
			if(lNumStatusCode==200){
				...
				if(lIsObjectReady){
					...
					if(!lIsPricingApiMultiPlanPriceApiQuoteDataListEmpty){
						...
						List<String> lListPricingApiMultiPlanPriceLoadingFactor=lMapJson.root.Quote.Loading_Factors
						String lStrPricingApiPricingApiMultiPlanPriceApiLoadingFactor=lListPricingApiMultiPlanPriceLoadingFactor.toString()
						mapPricingApiInputOutput.MultiplePlanPriceQuoteLoadingFactorRoot=lStrPricingApiPricingApiMultiPlanPriceApiLoadingFactor
						Boolean lIsPricingApiMultiPlanPriceLoadingFactorListNull=IGNUemaHelper.checkObjectNullOfObject(lListPricingApiMultiPlanPriceLoadingFactor)
						if(lIsPricingApiMultiPlanPriceLoadingFactorListNull){
							...
							Boolean lIsPricingApiMultiPlanPriceApiLoadingFactorListEmpty=IGNUemaHelper.checkObjectEmptyOfList(lListPricingApiMultiPlanPriceLoadingFactor)
							if(lIsPricingApiMultiPlanPriceApiLoadingFactorListEmpty){
								lStrVerifyPricingApiMultiPlanPriceApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lStrVerifyPricingApiMultiPlanPriceApiDetail,"LoadingFactor="+lStrEmptyValue)
							}
						}
