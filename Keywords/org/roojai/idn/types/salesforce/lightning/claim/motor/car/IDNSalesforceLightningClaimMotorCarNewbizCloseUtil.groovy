...
import org.roojai.idn.types.testmanager.IDNTestStageControllerGroupSfLightningShareClaimMotorNameNewBizStoryClose
...
public class IDNSalesforceLightningClaimMotorCarNewbizCloseUtil {
	public WebDriver webDriver
	private IDNTestStageControllerGroupSfLightningShareClaimMotorNameNewBizStoryClose parentStageController=null
	public IDNSalesforceLightningClaimMotorCarNewbizCloseUtil(WebDriver webDriver,IDNTestStageControllerGroupSfLightningShareClaimMotorNameNewBizStoryClose initStageController){
		super()
		try{
	...
	public IDNTestStageControllerGroupSfLightningShareClaimMotorNameNewBizStoryClose getParentStageController(){
		try{
			return this.parentStageController
		}catch(Exception e){
		}
	}
	public void setParentStageController(IDNTestStageControllerGroupSfLightningShareClaimMotorNameNewBizStoryClose newParentStageController){
		//Do Nothing
	...
	public WebElement getElementIgniteClaimPageRoot(String cssLocator,Boolean isIgnoreCssLocator=true){
		WebElement lreturn=null
		Boolean lResult=false
		Boolean lIsIgnoreCssLocator=isIgnoreCssLocator
		if(IGNUemaHelper.checkObjectNullOfObject(cssLocator)){
		...
		try{
			//document.querySelector('one-record-home-flexipage2').shadowRoot.querySelector('.adg-rollup-wrapped').shadowRoot.querySelector('.forcegenerated-flexipage-module')			String lLocatorSearch01InputLevel01IgniteClaimReportingFormParent='c-i-g-n-claim-flow'
			String lLocatorSearch01InputLevel01IgniteClaimReportingFormChild01='c-ign-claim-form-app'
			String lLocatorSearch01InputLevel01IgniteClaimReportingFormChild02=lStrCssLocator
			WebElement lElementSearch01InputLevel01IgniteClaimReportingFormChild01=null
			WebElement lElementSearch01InputLevel01IgniteClaimReportingFormChild02=null
