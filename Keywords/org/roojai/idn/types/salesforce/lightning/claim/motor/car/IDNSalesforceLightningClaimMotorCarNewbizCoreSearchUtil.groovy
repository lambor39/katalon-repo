		...
		try{
			...
			if(lIsSalesforceSearchByDetailContinueStepResult){
				...
				if(!lMapinputMapSalesforceSearchDetailByDefaultOption.Result){
					...
					lStrSalesforceSearchGenerateTargetSalesforceFullId=lMapinputMapSalesforceSearchDetailByDefaultOption.SalesforceTargetRecordId
					lStrSalesforceSearchGenerateUrlAccessSfObject=lMapinputMapSalesforceSearchDetailByDefaultOption.SalesforceTargetFullUrlRecordId
				}
