...
public class THAElectricMotorCarQuotationDetail1UtilOld{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAElectricMotorCarQuotationDetail1UtilOld(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Boolean waitUntilOpportunityNumberUpdated(){
		...
		try{
			...
			String lOpportunityNumberOld=THAElectricMotorCarCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER.trim()
			...
			if(lOpportunityNumber.length()>0){
				lreturn=true
				THAElectricMotorCarCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER=lOpportunityNumber
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THAElectricMotorCarQuotationDetail1Type.DEFAULT_POSITIVE_CASE
		}
		try{
			...
			if(!lValid1){
				...
				if(!lValid2){
					...
					if(lValid3){
						...
						String lLocatorPaymentDocument='#payment-v3'
						if(!isSkipOTP){
	...
	public Map inputActualResultB(Boolean isPositiveCase,String strHolderPhoneNo,Boolean isSkipOTP){
		...
		try{
			...
			Boolean lValid1=lPaymentButtonVisible&&lPaymentButtonEnable
			if(!lValid1){
				lLocatorPaymentButton='#go2payment4button'
				lPaymentButtonVisible=IGNUemaHelper.checkElementVisibleByLocatorKs(this.driver,lLocatorPaymentButton)
				lPaymentButtonEnable=IGNUemaHelper.checkElementEnableByLocatorKs(this.driver,lLocatorPaymentButton)
				lValid1=lPaymentButtonVisible&&lPaymentButtonEnable
			}
			if(!lValid1){
				if(isPositiveCase){
					lIsActualResult=false
				...
				IGNUemaHelper.selectButtonByLocator(this.driver,lLocatorPaymentButton)
				IGNUemaHelper.delayThreadSecond(2)
				String lTagPleaseWait=''
				String lLocatorPleaseWait='#myPleaseWait'
				Boolean lValid2=IGNUemaHelper.waitElementInvisibleByLocator(this.driver,lLocatorPleaseWait,20)
	...
	public Map inputLanguageA(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THAElectricMotorCarQuotationDetail1Type.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_LANGUAGE)
			}
	...
	public Map inputSubmitCallMeBackA(String strSubmitCallMeBack,String strCallMeBackEmail,String strCallMeBackMobile){
		...
		if(lSubmitCallMeBack.length()<=0){
			lSubmitCallMeBack=THAElectricMotorCarQuotationDetail1Type.DEFAULT_SUBMIT_CALL_ME_BACK
		}
		String lCallMeBackEmail=strCallMeBackEmail.trim()
		if(lCallMeBackEmail.length()<=0){
			lCallMeBackEmail=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_EMAIL
		}
		String lCallMeBackMobile=strCallMeBackMobile.trim()
		if(lCallMeBackMobile.length()<=0){
			lCallMeBackMobile=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_MOBILE
		}
		try{
			Boolean lResult=false
			lreturn.put('SubmitCallMeBack','')
			...
			if(lIsSubmitCallMeBack){
				...
				String lLocatorSubmitCallMeBackModalForm='#p1-call-me-back-modal'
			...
			if(lIsSubmitCallMeBack){
				String lTagSubmitCallMeBackMobileInputText='callmeback-mobile-no'
				...
				String lTagSubmitCallMeBackModalFormSubmitButton='btn-callmeback-submit'
				...
				if(lElementSubmitCallMeBackModalFormSubmitButton){
					...
					String lLocatorSubmitCallMeBackSuccessForm='#p1-call-me-back-modal'
					...
					if(lIsSubmitCallMeBackSuccessFormDisplayed){
						String lTagSubmitCallMeBackSuccessFormDismissButton='btn-callmeback-close'
	...
	public Map inputHolderEmailA(String strHolderEmail){
		...
		if(lHolderEmail.length()<=0){
			lHolderEmail=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_EMAIL
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderEmail','')
	...
	public Map inputHolderNewsletterA(String strHolderNewsletter){
		...
		if(lHolderNewsletter.length()<=0){
			lHolderNewsletter=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_NEWSLETTER
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderNewsletter','')
			...
			String lTagButton='selectedPDPAConsent-label'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
	...
	public Map inputHolderNewsletterB(String strHolderNewsletter){
		...
		try{
			...
			Boolean lIsHolderNewsletter=IGNUemaHelper.convertStringToBoolean(lHolderNewsletter)
			String lTagButton=''
			String lLocatorButton='#inculde4pro2button'
			WebElement lElementButton=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorButton)
			String lStageStr=''
			Boolean lStageBool=false
			if(!lElementButton){
				lHolderNewsletter='No Option'
				...
				lStageBool=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
	...
	public Map inputHolderPhoneNoA(String strHolderPhoneNo){
		...
		String lHolderPhoneNo=strHolderPhoneNo.trim()
		if(lHolderPhoneNo.length()<=0){
			lHolderPhoneNo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_PHONE_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderPhoneNo','')
	...
	public Map inputHolderCallMeNowToDoA(String strHolderCallMeNowToDo){
		...
		if(lHolderCallMeNowToDo.length()<=0){
			lHolderCallMeNowToDo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW_TO_DO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCallMeNowToDo','')
	...
	public Map inputCallMeNowA(String strCallMeNow){
		...
		if(lCallMeNow.length()<=0){
			lCallMeNow=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_NOW
		}
		...
		try{
			...
			lCallMeNow=''
			if(!lCallMeNowItem){
				lCallMeNowItem=lCallMeNowList.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_NOW)
			}
	...
	public Map inputCallMeBackAtDayA(String strCallMeBackAtDay){
		...
		if(lCallMeBackAtDay.length()<=0){
			lCallMeBackAtDay=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_DAY
		}
		...
		try{
			...
			if(!lCallMeBackAtDayItem){
				lCallMeBackAtDayItem=lCallMeBackAtDayList.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_DAY)
			}
	...
	public Map inputCallMeBackAtTimeA(String strCallMeBackAtTime){
		...
		if(lCallMeBackAtTime.length()<=0){
			lCallMeBackAtTime=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_TIME
		}
		...
		try{
			...
			if(!lCallMeBackAtTimeItem){
				lCallMeBackAtTimeItem=lCallMeBackAtTimeList.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_TIME)
			}
			...
			if(!lElementButton){
				...
				String lLocatorCallMeBackAtTimeCloseButton='#schedule2call button'
				WebElement lElementCallMeBackAtTimeCloseButton=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorCallMeBackAtTimeCloseButton)
				IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementCallMeBackAtTimeCloseButton)
				lTagButton='callmeback'
				lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueEqual(this.driver,lTagButton,'No')
				IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)
			}else{
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
	...
	public Map inputHolderIsPersonA(String strHolderIsPerson){
		...
		if(lHolderIsPerson.length()<=0){
			lHolderIsPerson=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_IS_PERSON
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsPerson','')
	...
	public Map inputHolderIsMainA(String strHolderIsMain){
		...
		if(lHolderIsMain.length()<=0){
			lHolderIsMain=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_IS_MAIN
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsMain','')
	...
	public Map inputCarForCommercialA(String strCarForCommercial){
		...
		if(lCarForCommercial.length()<=0){
			lCarForCommercial=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CAR_FOR_COMMERCIAL
		}
		try{
			Boolean lResult=false
			lreturn.put('CarForCommercial','')
	...
	public Map inputCarPlateNumberA(String strCarPlateNumber){
		...
		if(lCarPlateNumber.length()<=0){
			lCarPlateNumber=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CAR_PLATE_NUMBER
		}
		if(lCarPlateNumber.length()<=0){
	...
	public Map inputCarPlateProvinceA(String strCarPlateProvince){
		...
		if(lCarPlateProvince.length()<=0){
			lCarPlateProvince=THAElectricMotorCarQuotationDetail1Type.DEFAULT_CAR_PLATE_PROVINCE
		}
		try{
			Boolean lResult=false
			lreturn.put('CarPlateProvince','')
			...
			IGNUemaHelper.delayThreadSecond(1)
			IGNUemaHelper.selectButtonByLocator(this.driver,IGNUemaHelper.getTagDataSeleniumKey('carPlateNext'))
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public Map inputHolderStatusA(String strHolderStatus){
		...
		try{
			...
			if(!lHolderStatusItem){
				lHolderStatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('HolderStatus','')
			lreturn.put('Result',lResult)
	...
	public Map inputHolderDobA(String strHolderDob){
		...
		if(lHolderDob.length()<=0){
			lHolderDob=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderDob','')
	...
	public Map inputHolderIsThaiA(String strHolderIsThai){
		...
		if(lHolderIsThai.length()<=0){
			lHolderIsThai=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsThai','')
	...
	public Map inputHolderThaiIdA(String strHolderThaiId){
		...
		if(lHolderThaiId.length()<=0){
			lHolderThaiId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderThaiId','')
	...
	public Map inputHolderOccupationA(String strHolderOccupation){
		...
		if(lHolderOccupation.length()<=0){
			lHolderOccupation=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderOccupation','')
	...
	public Map inputHolderPassportA(String strHolderPassport){
		...
		if(lHolderPassport.length()<=0){
			lHolderPassport=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderPassport','')
	...
	public Map inputHolderCountryA(String strHolderCountry){
		...
		if(lHolderCountry.length()<=0){
			lHolderCountry=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCountry','')
	...
	public Map inputHolderNameA(String strHolderName){
		...
		if(lHolderName.length()<=0){
			lHolderName=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderName','')
	...
	public Map inputHolderSurnameA(String strHolderSurname){
		...
		if(lHolderSurname.length()<=0){
			lHolderSurname=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderSurname','')
	...
	public Map inputHolderCompIdA(String strHolderCompId){
		...
		if(lHolderCompId.length()<=0){
			lHolderCompId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_COMP_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCompId','')
	...
	public Map inputHolderCompNameA(String strHolderCompName){
		...
		if(lHolderCompName.length()<=0){
			lHolderCompName=THAElectricMotorCarQuotationDetail1Type.DEFAULT_HOLDER_COMP_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCompName','')
	...
	public Map inputMainStatusA(String strMainStatus){
		...
		try{
			...
			if(!lMainStatusItem){
				lMainStatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('MainStatus','')
			lreturn.put('Result',lResult)
	...
	public Map inputMainDobA(String strMainDob){
		...
		if(lMainDob.length()<=0){
			lMainDob=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('MainDob','')
	...
	public Map inputMainIsThaiA(String strMainIsThai){
		...
		if(lMainIsThai.length()<=0){
			lMainIsThai=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('MainIsThai','')
	...
	public Map inputMainThaiIdA(String strMainThaiId){
		...
		if(lMainThaiId.length()<=0){
			lMainThaiId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('MainThaiId','')
	...
	public Map inputMainOccupationA(String strMainOccupation){
		...
		if(lMainOccupation.length()<=0){
			lMainOccupation=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('MainOccupation','')
	...
	public Map inputMainPassportA(String strMainPassport){
		...
		if(lMainPassport.length()<=0){
			lMainPassport=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('MainPassport','')
	...
	public Map inputMainCountryA(String strMainCountry){
		...
		if(lMainCountry.length()<=0){
			lMainCountry=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('MainCountry','')
	...
	public Map inputMainNameA(String strMainName){
		...
		if(lMainName.length()<=0){
			lMainName=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('MainName','')
	...
	public Map inputMainSurnameA(String strMainSurname){
		...
		if(lMainSurname.length()<=0){
			lMainSurname=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('MainSurname','')
	...
	public Map inputMainEmailA(String strMainEmail){
		...
		if(lMainEmail.length()<=0){
			lMainEmail=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_EMAIL
		}
		try{
			Boolean lResult=false
			lreturn.put('MainEmail','')
	...
	public Map inputMainPhoneNoA(String strMainPhoneNo){
		...
		if(lMainPhoneNo.length()<=0){
			lMainPhoneNo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_MAIN_PHONE_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('MainPhoneNo','')
	...
	public Map inputAdditionDriversA(String strAdditionDrivers){
		...
		if(lAdditionDrivers.length()<=0){
			lAdditionDrivers=THAElectricMotorCarQuotationDetail1Type.DEFAULT_ADDITION_DRIVERS
		}
		try{
			Boolean lResult=false
			lreturn.put('AdditionDrivers','')
			lreturn.put('Result',lResult)
			Integer lNumAdditionDrivers=IGNUemaHelper.convertStringToInteger(lAdditionDrivers,0)
			if((lNumAdditionDrivers<0)||(lNumAdditionDrivers>4)){
				lNumAdditionDrivers=0
			}
			String lTagButtonYes='add-driver-modal'
			String lLocatorButtonYes=IGNUemaHelper.getTagDataSeleniumKey(lTagButtonYes)
			String lTagButtonNo='additional-driver-skip'
	...
	public Map inputDriversHaveLicenseA(String strDriversHaveLicense){
		...
		if(lDriversHaveLicense.length()<=0){
			lDriversHaveLicense=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVERS_HAVE_LICENSE
		}
		try{
			Boolean lResult=false
			lreturn.put('DriversHaveLicense','')
	...
	public Map inputDriver1StatusA(String strDriver1Status){
		...
		try{
			...
			if(!lDriver1StatusItem){
				lDriver1StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('Driver1Status','')
			lreturn.put('Result',lResult)
	...
	public Map inputDriver1StatusB(String strDriver1Status){
		...
		try{
			...
			lreturn.put('Driver1Status','')
			lreturn.put('Result',lResult)
			String lTagButton='driver-gender'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueContain(this.driver,lTagButton,lDriver1StatusItem)
			if(!lElementButton){
				return lreturn
			}else{
				String lDriver1StatusText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver1Status=lDriver1StatusText.trim()
				}else{
					lDriver1Status=''
				}
			}
	...
	public Map inputDriver1DobA(String strDriver1Dob){
		...
		if(lDriver1Dob.length()<=0){
			lDriver1Dob=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Dob','')
	...
	public Map inputDriver1DobB(String strDriver1Dob){
		...
		try{
			...
			String lDriver1DobYYYY=IGNUemaHelper.extractStringYearFromDateStringSlashDDMMYYYY(lDriver1Dob)
			lDriver1Dob=''
			String lTagInputTextDD='driver-date'
			String lLocatorInputTextDD=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextDD)
			WebElement lElementInputTextDD=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextDD)
			lDriver1DobDD=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextDD,lDriver1DobDD)
			String lTagInputTextMM='driver-month'
			String lLocatorInputTextMM=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextMM)
			WebElement lElementInputTextMM=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextMM)
			lDriver1DobMM=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextMM,lDriver1DobMM)
			String lTagInputTextYYYY='driver-year'
			String lLocatorInputTextYYYY=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextYYYY)
			WebElement lElementInputTextYYYY=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextYYYY)
			lDriver1DobYYYY=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextYYYY,lDriver1DobYYYY)
			lDriver1Dob=lDriver1DobDD+'/'+lDriver1DobMM+'/'+lDriver1DobYYYY
			String lTagButtonNext='driver-dob-next'
			String lLocatorButtonNext=IGNUemaHelper.getTagDataSeleniumKey(lTagButtonNext)
			WebElement lElementButtonNext=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagButtonNext)
			IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButtonNext)
			lResult=lDriver1Dob.length()>0
	...
	public Map inputDriver1IsThaiA(String strDriver1IsThai){
		...
		if(lDriver1IsThai.length()<=0){
			lDriver1IsThai=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1IsThai','')
	...
	public Map inputDriver1IsThaiB(String strDriver1IsThai){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Boolean lIsDriver1IsThai=IGNUemaHelper.convertStringToBoolean(lDriver1IsThai)
			String lTagButton='driver-thaiNationality'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=null
			if(lIsDriver1IsThai){
				lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueContain(this.driver,lTagButton,'Yes')
			...
			if(!lElementButton){
				...
				String lDriver1IsThaiText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver1IsThai=lDriver1IsThaiText.trim()
				}else{
					lDriver1IsThai=''
				}
			}
	...
	public Map inputDriver1ThaiIdA(String strDriver1ThaiId){
		...
		if(lDriver1ThaiId.length()<=0){
			lDriver1ThaiId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1ThaiId','')
	...
	public Map inputDriver1PassportA(String strDriver1Passport){
		...
		if(lDriver1Passport.length()<=0){
			lDriver1Passport=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Passport','')
	...
	public Map inputDriver1PassportB(String strDriver1Passport){
		...
		try{
			...
			lreturn.put('Driver1Passport','')
			lreturn.put('Result',lResult)
			String lTagInputText='driver-passport'
			String lLocatorInputText=IGNUemaHelper.getTagDataSeleniumKey(lTagInputText)
			lDriver1Passport=IGNUemaHelper.typeTextWithEnterByLocator(this.driver,lLocatorInputText,lDriver1Passport)
			lResult=lDriver1Passport.length()>0
			IGNUemaHelper.selectButtonByLocator(this.driver,IGNUemaHelper.getTagDataSeleniumKey('driver-passport-next'))
			if(lResult){
				lreturn.put('Driver1Passport',lDriver1Passport)
				lreturn.put('Result',lResult)
			}
	...
	public Map inputDriver1CountryA(String strDriver1Country){
		...
		if(lDriver1Country.length()<=0){
			lDriver1Country=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Country','')
	...
	public Map inputDriver1CountryB(String strDriver1Country){
		...
		try{
			...
			lreturn.put('Driver1Country','')
			lreturn.put('Result',lResult)
			String lTagButton='driver-passport-country'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			String lTagDropdownList='driver-passport-country-item'
			String lLocatorDropdownList=IGNUemaHelper.getTagDataSeleniumKey(lTagDropdownList)
			Boolean lValid=IGNUemaHelper.checkElementEnableByLocatorKs(this.driver,lLocatorButton)
			if(!lValid){
				lDriver1Country='No Option'
	...
	public Map inputDriver1NameA(String strDriver1Name){
		...
		if(lDriver1Name.length()<=0){
			lDriver1Name=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Name','')
	...
	public Map inputDriver1NameB(String strDriver1Name){
		...
		try{
			...
			lreturn.put('Driver1Name','')
			lreturn.put('Result',lResult)
			String lTagInputText='driver-firstname'
			String lLocatorInputText=IGNUemaHelper.getTagDataSeleniumKey(lTagInputText)
			lDriver1Name=IGNUemaHelper.typeTextWithEnterByLocator(this.driver,lLocatorInputText,lDriver1Name)
			lResult=lDriver1Name.length()>0
			IGNUemaHelper.selectButtonByLocator(this.driver,IGNUemaHelper.getTagDataSeleniumKey('driver-name-next'))
			if(lResult){
				lreturn.put('Driver1Name',lDriver1Name)
				lreturn.put('Result',lResult)
			}
	...
	public Map inputDriver1SurnameA(String strDriver1Surname){
		...
		if(lDriver1Surname.length()<=0){
			lDriver1Surname=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Surname','')
	...
	public Map inputDriver1SurnameB(String strDriver1Surname){
		...
		try{
			...
			lreturn.put('Driver1Surname','')
			lreturn.put('Result',lResult)
			String lTagInputText='driver-lasstname'
			String lLocatorInputText=IGNUemaHelper.getTagDataSeleniumKey(lTagInputText)
			lDriver1Surname=IGNUemaHelper.typeTextWithEnterByLocator(this.driver,lLocatorInputText,lDriver1Surname)
			lResult=lDriver1Surname.length()>0
			IGNUemaHelper.selectButtonByLocator(this.driver,IGNUemaHelper.getTagDataSeleniumKey('driver-name-next'))
	...
	public Map inputDriver1YearDrivingA(String strDriver1YearDriving){
		...
		if(lDriver1YearDriving.length()<=0){
			lDriver1YearDriving=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_YEAR_DRIVING
		}
	...
	public Map inputDriver1YearDrivingB(String strDriver1YearDriving){
		...
		try{
			...
			lreturn.put('Driver1YearDriving','')
			lreturn.put('Result',lResult)
			String lTagButton='driver-drivingExperience'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueContain(this.driver,lTagButton,lDriver1YearDrivingNum.toString())
			if(!lElementButton){
				return lreturn
			}else{
				String lDriver1YearDrivingText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver1YearDriving=lDriver1YearDrivingText.trim()
				}else{
					lDriver1YearDriving=''
				}
			}
	...
	public Map inputDriver1ClaimsNoA(String strDriver1ClaimsNo){
		...
		if(lDriver1ClaimsNo.length()<=0){
			lDriver1ClaimsNo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_CLAIMS_NO
		}
	...
	public Map inputDriver1ClaimsNoB(String strDriver1ClaimsNo){
		...
		try{
			...
			lreturn.put('Driver1ClaimsNo','')
			lreturn.put('Result',lResult)
			String lTagButton='driver-claim'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueContain(this.driver,lTagButton,lDriver1ClaimsNoNum.toString())
			if(!lElementButton){
				return lreturn
			}else{
				String lDriver1ClaimsNoText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver1ClaimsNo=lDriver1ClaimsNoText.trim()
				}else{
					lDriver1ClaimsNo=''
				}
			}
	...
	public Map inputDriver1OccupationA(String strDriver1Occupation){
		...
		if(lDriver1Occupation.length()<=0){
			lDriver1Occupation=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Occupation','')
	...
	public Map inputDriver1OccupationB(String strDriver1Occupation){
		...
		try{
			...
			lreturn.put('Driver1Occupation','')
			lreturn.put('Result',lResult)
			String lTagButton='driver-occupation'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			String lTagDropdownList='driver-occupation-item'
			String lLocatorDropdownList=IGNUemaHelper.getTagDataSeleniumKey(lTagDropdownList)
			Boolean lValid=IGNUemaHelper.checkElementEnableByLocatorKs(this.driver,lLocatorButton)
			if(!lValid){
				lDriver1Occupation='No Option'
				...
				lDriver1Occupation=IGNUemaHelper.selectDropdownByDataSeleniumLocatorV2(this.driver,lTagButton,lTagDropdownList,lDriver1Occupation,true)
				String lTagDriverSaveButton='driver-save'
				String lLocatorDriverSaveButton=IGNUemaHelper.getTagDataSeleniumKey(lTagDriverSaveButton)
				WebElement lElementDriverSaveButton=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagDriverSaveButton)
				if(!lElementDriverSaveButton){
					lLocatorDriverSaveButton='#dynamic4addtional button'
					lElementDriverSaveButton=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorDriverSaveButton)
				}
				IGNUemaHelper.delayThreadSecond(3)
				IGNUemaHelper.webJsScrollToElement(this.driver,lElementDriverSaveButton)
				IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementDriverSaveButton)
			}
			lResult=lDriver1Occupation.length()>0
			if(lResult){
				lreturn.put('Driver1Occupation',lDriver1Occupation)
	...
	public Map inputDriver2StatusA(String strDriver2Status){
		...
		try{
			...
			if(!lDriver2StatusItem){
				lDriver2StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('Driver2Status','')
			lreturn.put('Result',lResult)
	...
	public Map inputDriver2StatusB(String strDriver2Status){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver2StatusText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver2Status=lDriver2StatusText.trim()
				}else{
					lDriver2Status=''
				}
			}
	...
	public Map inputDriver2DobA(String strDriver2Dob){
		...
		if(lDriver2Dob.length()<=0){
			lDriver2Dob=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Dob','')
	...
	public Map inputDriver2IsThaiA(String strDriver2IsThai){
		...
		if(lDriver2IsThai.length()<=0){
			lDriver2IsThai=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2IsThai','')
	...
	public Map inputDriver2IsThaiB(String strDriver2IsThai){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver2IsThaiText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver2IsThai=lDriver2IsThaiText.trim()
				}else{
					lDriver2IsThai=''
				}
			}
	...
	public Map inputDriver2ThaiIdA(String strDriver2ThaiId){
		...
		if(lDriver2ThaiId.length()<=0){
			lDriver2ThaiId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2ThaiId','')
	...
	public Map inputDriver2PassportA(String strDriver2Passport){
		...
		if(lDriver2Passport.length()<=0){
			lDriver2Passport=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Passport','')
	...
	public Map inputDriver2CountryA(String strDriver2Country){
		...
		if(lDriver2Country.length()<=0){
			lDriver2Country=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Country','')
	...
	public Map inputDriver2NameA(String strDriver2Name){
		...
		if(lDriver2Name.length()<=0){
			lDriver2Name=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Name','')
	...
	public Map inputDriver2SurnameA(String strDriver2Surname){
		...
		if(lDriver2Surname.length()<=0){
			lDriver2Surname=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Surname','')
	...
	public Map inputDriver2YearDrivingA(String strDriver2YearDriving){
		...
		if(lDriver2YearDriving.length()<=0){
			lDriver2YearDriving=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_YEAR_DRIVING
		}
	...
	public Map inputDriver2YearDrivingB(String strDriver2YearDriving){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver2YearDrivingText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver2YearDriving=lDriver2YearDrivingText.trim()
				}else{
					lDriver2YearDriving=''
				}
			}
	...
	public Map inputDriver2ClaimsNoA(String strDriver2ClaimsNo){
		...
		if(lDriver2ClaimsNo.length()<=0){
			lDriver2ClaimsNo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_CLAIMS_NO
		}
	...
	public Map inputDriver2ClaimsNoB(String strDriver2ClaimsNo){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver2ClaimsNoText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver2ClaimsNo=lDriver2ClaimsNoText.trim()
				}else{
					lDriver2ClaimsNo=''
				}
			}
	...
	public Map inputDriver2OccupationA(String strDriver2Occupation){
		...
		if(lDriver2Occupation.length()<=0){
			lDriver2Occupation=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Occupation','')
	...
	public Map inputDriver3StatusA(String strDriver3Status){
		...
		try{
			...
			if(!lDriver3StatusItem){
				lDriver3StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('Driver3Status','')
			lreturn.put('Result',lResult)
	...
	public Map inputDriver3StatusB(String strDriver3Status){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver3StatusText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver3Status=lDriver3StatusText.trim()
				}else{
					lDriver3Status=''
				}
			}
	...
	public Map inputDriver3DobA(String strDriver3Dob){
		...
		if(lDriver3Dob.length()<=0){
			lDriver3Dob=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Dob','')
	...
	public Map inputDriver3IsThaiA(String strDriver3IsThai){
		...
		if(lDriver3IsThai.length()<=0){
			lDriver3IsThai=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3IsThai','')
	...
	public Map inputDriver3IsThaiB(String strDriver3IsThai){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver3IsThaiText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver3IsThai=lDriver3IsThaiText.trim()
				}else{
					lDriver3IsThai=''
				}
			}
	...
	public Map inputDriver3ThaiIdA(String strDriver3ThaiId){
		...
		if(lDriver3ThaiId.length()<=0){
			lDriver3ThaiId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3ThaiId','')
	...
	public Map inputDriver3PassportA(String strDriver3Passport){
		...
		if(lDriver3Passport.length()<=0){
			lDriver3Passport=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Passport','')
	...
	public Map inputDriver3CountryA(String strDriver3Country){
		...
		if(lDriver3Country.length()<=0){
			lDriver3Country=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Country','')
	...
	public Map inputDriver3NameA(String strDriver3Name){
		...
		if(lDriver3Name.length()<=0){
			lDriver3Name=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Name','')
	...
	public Map inputDriver3SurnameA(String strDriver3Surname){
		...
		if(lDriver3Surname.length()<=0){
			lDriver3Surname=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Surname','')
	...
	public Map inputDriver3YearDrivingA(String strDriver3YearDriving){
		...
		if(lDriver3YearDriving.length()<=0){
			lDriver3YearDriving=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_YEAR_DRIVING
		}
	...
	public Map inputDriver3YearDrivingB(String strDriver3YearDriving){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver3YearDrivingText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver3YearDriving=lDriver3YearDrivingText.trim()
				}else{
					lDriver3YearDriving=''
				}
			}
	...
	public Map inputDriver3ClaimsNoA(String strDriver3ClaimsNo){
		...
		if(lDriver3ClaimsNo.length()<=0){
			lDriver3ClaimsNo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_CLAIMS_NO
		}
	...
	public Map inputDriver3ClaimsNoB(String strDriver3ClaimsNo){
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver3ClaimsNoText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver3ClaimsNo=lDriver3ClaimsNoText.trim()
				}else{
					lDriver3ClaimsNo=''
				}
			}
	...
	public Map inputDriver3OccupationA(String strDriver3Occupation){
		...
		if(lDriver3Occupation.length()<=0){
			lDriver3Occupation=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Occupation','')
	...
	public Map inputDriver4Status(String strDriver4Status){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4StatusA(strDriver4Status)
						break
					case 'B':
						lreturn=this.inputDriver4StatusB(strDriver4Status)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4StatusA(String strDriver4Status){
		Map lreturn=[:]
		String lDriver4Status=strDriver4Status.toUpperCase().trim()
		try{
			String lDriver4StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(lDriver4Status)
			if(!lDriver4StatusItem){
				lDriver4StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('Driver4Status','')
			lreturn.put('Result',lResult)
			String lTagButton='add-driver-2-gender'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueContain(this.driver,lTagButton,lDriver4StatusItem)
			if(!lElementButton){
				return lreturn
			}else{
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4Status=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				}else{
					lDriver4Status=''
				}
			}
			lDriver4Status=IGNUemaHelper.convertStringAsTitleCase(lDriver4Status)
	...
	public Map inputDriver4StatusB(String strDriver4Status){
		Map lreturn=[:]
		String lDriver4Status=strDriver4Status.toUpperCase().trim()
		try{
			String lDriver4StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(lDriver4Status)
			...
			if(!lElementButton){
				...
				String lDriver4StatusText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4Status=lDriver4StatusText.trim()
				}else{
					lDriver4Status=''
				}
			}
	...
	public Map inputDriver4Dob(String strDriver4Dob){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4DobA(strDriver4Dob)
						break
					case 'B':
						lreturn=this.inputDriver4DobB(strDriver4Dob)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4DobA(String strDriver4Dob){
		Map lreturn=[:]
		String lDriver4Dob=strDriver4Dob.trim()
		if(lDriver4Dob.length()<=0){
			lDriver4Dob=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4Dob','')
			lreturn.put('Result',lResult)
			String lDriver4DobDD=IGNUemaHelper.extractStringDayFromDateStringSlashDDMMYYYY(lDriver4Dob)
			String lDriver4DobMM=IGNUemaHelper.extractStringMonthFromDateStringSlashDDMMYYYY(lDriver4Dob)
			String lDriver4DobYYYY=IGNUemaHelper.extractStringYearFromDateStringSlashDDMMYYYY(lDriver4Dob)
			lDriver4Dob=''
			String lTagInputTextDD='driver-dd-2'
			String lLocatorInputTextDD=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextDD)
			WebElement lElementInputTextDD=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextDD)
			lDriver4DobDD=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextDD,lDriver4DobDD)
			String lTagInputTextMM='driver-mm-2'
			String lLocatorInputTextMM=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextMM)
			WebElement lElementInputTextMM=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextMM)
			lDriver4DobMM=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextMM,lDriver4DobMM)
			String lTagInputTextYYYY='driver-yyyy-2'
			String lLocatorInputTextYYYY=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextYYYY)
			WebElement lElementInputTextYYYY=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextYYYY)
			lDriver4DobYYYY=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextYYYY,lDriver4DobYYYY)
			lDriver4Dob=lDriver4DobDD+'/'+lDriver4DobMM+'/'+lDriver4DobYYYY
			String lTagButtonNext='add-driver-2-dob-next'
			String lLocatorButtonNext=IGNUemaHelper.getTagDataSeleniumKey(lTagButtonNext)
			WebElement lElementButtonNext=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagButtonNext)
			IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButtonNext)
	...
	public Map inputDriver4DobB(String strDriver4Dob){
		Map lreturn=[:]
		String lDriver4Dob=strDriver4Dob.trim()
		if(lDriver4Dob.length()<=0){
			lDriver4Dob=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_DOB
	...
	public Map inputDriver4IsThai(String strDriver4IsThai){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4IsThaiA(strDriver4IsThai)
						break
					case 'B':
						lreturn=this.inputDriver4IsThaiB(strDriver4IsThai)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4IsThaiA(String strDriver4IsThai){
		Map lreturn=[:]
		String lDriver4IsThai=strDriver4IsThai.trim()
		if(lDriver4IsThai.length()<=0){
			lDriver4IsThai=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4IsThai','')
			...
			if(!lElementButton){
				...
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4IsThai=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				}else{
					lDriver4IsThai=''
				}
			}
	...
	public Map inputDriver4IsThaiB(String strDriver4IsThai){
		Map lreturn=[:]
		String lDriver4IsThai=strDriver4IsThai.trim()
		if(lDriver4IsThai.length()<=0){
			lDriver4IsThai=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_IS_THAI
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver4IsThaiText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4IsThai=lDriver4IsThaiText.trim()
				}else{
					lDriver4IsThai=''
				}
			}
	...
	public Map inputDriver4ThaiId(String strDriver4ThaiId){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4ThaiIdA(strDriver4ThaiId)
						break
					case 'B':
						lreturn=this.inputDriver4ThaiIdB(strDriver4ThaiId)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4ThaiIdA(String strDriver4ThaiId){
		Map lreturn=[:]
		String lDriver4ThaiId=strDriver4ThaiId.trim()
		if(lDriver4ThaiId.length()<=0){
			lDriver4ThaiId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4ThaiId','')
	...
	public Map inputDriver4ThaiIdB(String strDriver4ThaiId){
		Map lreturn=[:]
		String lDriver4ThaiId=strDriver4ThaiId.trim()
		if(lDriver4ThaiId.length()<=0){
			lDriver4ThaiId=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_THAI_ID
	...
	public Map inputDriver4Passport(String strDriver4Passport){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4PassportA(strDriver4Passport)
						break
					case 'B':
						lreturn=this.inputDriver4PassportB(strDriver4Passport)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4PassportA(String strDriver4Passport){
		Map lreturn=[:]
		String lDriver4Passport=strDriver4Passport.trim()
		if(lDriver4Passport.length()<=0){
			lDriver4Passport=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4Passport','')
			...
			String lTagInputText='add-driver-2-passport'
			String lLocatorInputText=IGNUemaHelper.getTagDataSeleniumKey(lTagInputText)
			lDriver4Passport=IGNUemaHelper.typeTextWithEnterByLocator(this.driver,lLocatorInputText,lDriver4Passport)
	...
	public Map inputDriver4PassportB(String strDriver4Passport){
		Map lreturn=[:]
		String lDriver4Passport=strDriver4Passport.trim()
		if(lDriver4Passport.length()<=0){
			lDriver4Passport=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_PASSPORT
	...
	public Map inputDriver4Country(String strDriver4Country){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4CountryA(strDriver4Country)
						break
					case 'B':
						lreturn=this.inputDriver4CountryB(strDriver4Country)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4CountryA(String strDriver4Country){
		Map lreturn=[:]
		String lDriver4Country=strDriver4Country.trim()
		if(lDriver4Country.length()<=0){
			lDriver4Country=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4Country','')
			...
			Boolean lValid=IGNUemaHelper.checkElementEnableByLocatorKs(this.driver,lLocatorButton)
			if(!lValid){
				lDriver4Country='No Option'
			}else{
				lDriver4Country=IGNUemaHelper.selectDropdownByDataSeleniumLocatorV2(this.driver,lTagButton,lTagDropdownList,lDriver4Country,true)
			}
	...
	public Map inputDriver4CountryB(String strDriver4Country){
		Map lreturn=[:]
		String lDriver4Country=strDriver4Country.trim()
		if(lDriver4Country.length()<=0){
			lDriver4Country=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_COUNTRY
	...
	public Map inputDriver4Name(String strDriver4Name){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4NameA(strDriver4Name)
						break
					case 'B':
						lreturn=this.inputDriver4NameB(strDriver4Name)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4NameA(String strDriver4Name){
		Map lreturn=[:]
		String lDriver4Name=strDriver4Name.trim()
		if(lDriver4Name.length()<=0){
			lDriver4Name=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4Name','')
			...
			String lTagInputText='add-driver-2-firstname'
			String lLocatorInputText=IGNUemaHelper.getTagDataSeleniumKey(lTagInputText)
			lDriver4Name=IGNUemaHelper.typeTextWithEnterByLocator(this.driver,lLocatorInputText,lDriver4Name)
	...
	public Map inputDriver4NameB(String strDriver4Name){
		Map lreturn=[:]
		String lDriver4Name=strDriver4Name.trim()
		if(lDriver4Name.length()<=0){
			lDriver4Name=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_NAME
	...
	public Map inputDriver4Surname(String strDriver4Surname){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4SurnameA(strDriver4Surname)
						break
					case 'B':
						lreturn=this.inputDriver4SurnameB(strDriver4Surname)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4SurnameA(String strDriver4Surname){
		Map lreturn=[:]
		String lDriver4Surname=strDriver4Surname.trim()
		if(lDriver4Surname.length()<=0){
			lDriver4Surname=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4Surname','')
			...
			String lTagInputText='add-driver-2-lastname'
			String lLocatorInputText=IGNUemaHelper.getTagDataSeleniumKey(lTagInputText)
			lDriver4Surname=IGNUemaHelper.typeTextWithEnterByLocator(this.driver,lLocatorInputText,lDriver4Surname)
	...
	public Map inputDriver4SurnameB(String strDriver4Surname){
		Map lreturn=[:]
		String lDriver4Surname=strDriver4Surname.trim()
		if(lDriver4Surname.length()<=0){
			lDriver4Surname=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_SURNAME
	...
	public Map inputDriver4YearDriving(String strDriver4YearDriving){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4YearDrivingA(strDriver4YearDriving)
						break
					case 'B':
						lreturn=this.inputDriver4YearDrivingB(strDriver4YearDriving)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4YearDrivingA(String strDriver4YearDriving){
		Map lreturn=[:]
		String lDriver4YearDriving=strDriver4YearDriving.trim()
		if(lDriver4YearDriving.length()<=0){
			lDriver4YearDriving=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_YEAR_DRIVING
		}
		Integer lDriver4YearDrivingMin=0
		Integer lDriver4YearDrivingMax=6
		Integer lDriver4YearDrivingDefault=6
		Integer lDriver4YearDrivingNum=IGNUemaHelper.convertStringToInteger(lDriver4YearDriving,lDriver4YearDrivingDefault)
		if((lDriver4YearDrivingNum<lDriver4YearDrivingMin)||(lDriver4YearDrivingNum>lDriver4YearDrivingMax)){
			lDriver4YearDrivingNum=lDriver4YearDrivingDefault
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4YearDriving','')
			...
			String lTagButton='add-driver-2-drivingExperience'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueContain(this.driver,lTagButton,lDriver4YearDrivingNum.toString())
			if(!lElementButton){
				return lreturn
			}else{
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4YearDriving=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				}else{
					lDriver4YearDriving=''
				}
			}
	...
	public Map inputDriver4YearDrivingB(String strDriver4YearDriving){
		Map lreturn=[:]
		String lDriver4YearDriving=strDriver4YearDriving.trim()
		if(lDriver4YearDriving.length()<=0){
			lDriver4YearDriving=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_YEAR_DRIVING
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver4YearDrivingText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4YearDriving=lDriver4YearDrivingText.trim()
				}else{
					lDriver4YearDriving=''
				}
			}
	...
	public Map inputDriver4ClaimsNo(String strDriver4ClaimsNo){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4ClaimsNoA(strDriver4ClaimsNo)
						break
					case 'B':
						lreturn=this.inputDriver4ClaimsNoB(strDriver4ClaimsNo)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4ClaimsNoA(String strDriver4ClaimsNo){
		Map lreturn=[:]
		String lDriver4ClaimsNo=strDriver4ClaimsNo.trim()
		if(lDriver4ClaimsNo.length()<=0){
			lDriver4ClaimsNo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_CLAIMS_NO
		}
		Integer lDriver4ClaimsNoMin=0
		Integer lDriver4ClaimsNoMax=3
		Integer lDriver4ClaimsNoDefault=0
		Integer lDriver4ClaimsNoNum=IGNUemaHelper.convertStringToInteger(lDriver4ClaimsNo,lDriver4ClaimsNoDefault)
		if((lDriver4ClaimsNoNum<lDriver4ClaimsNoMin)||(lDriver4ClaimsNoNum>lDriver4ClaimsNoMax)){
			lDriver4ClaimsNoNum=lDriver4ClaimsNoDefault
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4ClaimsNo','')
			...
			String lTagButton='add-driver-2-claim'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueContain(this.driver,lTagButton,lDriver4ClaimsNoNum.toString())
			if(!lElementButton){
				return lreturn
			}else{
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4ClaimsNo=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				}else{
					lDriver4ClaimsNo=''
				}
			}
	...
	public Map inputDriver4ClaimsNoB(String strDriver4ClaimsNo){
		Map lreturn=[:]
		String lDriver4ClaimsNo=strDriver4ClaimsNo.trim()
		if(lDriver4ClaimsNo.length()<=0){
			lDriver4ClaimsNo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_CLAIMS_NO
		...
		try{
			...
			if(!lElementButton){
				...
				String lDriver4ClaimsNoText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementButton)
				if(IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButton)){
					lDriver4ClaimsNo=lDriver4ClaimsNoText.trim()
				}else{
					lDriver4ClaimsNo=''
				}
			}
	...
	public Map inputDriver4Occupation(String strDriver4Occupation){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputDriver4OccupationA(strDriver4Occupation)
						break
					case 'B':
						lreturn=this.inputDriver4OccupationB(strDriver4Occupation)
						break
					default:
						return lreturn
						break
	...
	public Map inputDriver4OccupationA(String strDriver4Occupation){
		Map lreturn=[:]
		String lDriver4Occupation=strDriver4Occupation.trim()
		if(lDriver4Occupation.length()<=0){
			lDriver4Occupation=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver4Occupation','')
			...
			Boolean lValid=IGNUemaHelper.checkElementEnableByLocatorKs(this.driver,lLocatorButton)
			if(!lValid){
				lDriver4Occupation='No Option'
			}else{
				lDriver4Occupation=IGNUemaHelper.selectDropdownByDataSeleniumLocatorV2(this.driver,lTagButton,lTagDropdownList,lDriver4Occupation,true)
			}
	...
	public Map inputDriver4OccupationB(String strDriver4Occupation){
		Map lreturn=[:]
		String lDriver4Occupation=strDriver4Occupation.trim()
		if(lDriver4Occupation.length()<=0){
			lDriver4Occupation=THAElectricMotorCarQuotationDetail1Type.DEFAULT_DRIVER4_OCCUPATION
	...
	public Map inputPolicyStartDateA(String strPolicyStartDate,String strPolicyStartDayOffset){
		...
		if(lPolicyStartDate.length()<=0){
			lPolicyStartDate=THAElectricMotorCarQuotationDetail1Type.DEFAULT_POLICY_START_DATE
		}
		...
		if(lPolicyStartDayOffset.length()<=0){
			lPolicyStartDayOffset=THAElectricMotorCarQuotationDetail1Type.DEFAULT_POLICY_START_DAY_OFFSET
		}
	...
	public Map inputPolicyStartDateB(String strPolicyStartDate,String strPolicyStartDayOffset){
		...
		try{
			...
			if(!lElementInputTextDD){
				lLocatorInputTextDD='#policyStartdate-dd'
				lElementInputTextDD=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorInputTextDD)
			}
			lPolicyStartDateDD=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextDD,lPolicyStartDateDD)
			String lTagInputTextMM='policyStartdate-mm'
			String lLocatorInputTextMM=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextMM)
			WebElement lElementInputTextMM=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextMM)
			if(!lElementInputTextMM){
				lLocatorInputTextMM='#policyStartdate-mm'
				lElementInputTextMM=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorInputTextMM)
			}
			lPolicyStartDateMM=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextMM,lPolicyStartDateMM)
			String lTagInputTextYYYY='policyStartdate-yyyy'
			String lLocatorInputTextYYYY=IGNUemaHelper.getTagDataSeleniumKey(lTagInputTextYYYY)
			WebElement lElementInputTextYYYY=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagInputTextYYYY)
			if(!lElementInputTextYYYY){
				lLocatorInputTextYYYY='#policyStartdate-yyyy'
				lElementInputTextYYYY=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorInputTextYYYY)
			}
			lPolicyStartDateYYYY=IGNUemaHelper.typeTextByWebElement(this.driver,lElementInputTextYYYY,lPolicyStartDateYYYY)
			lPolicyStartDate=lPolicyStartDateDD+'/'+lPolicyStartDateMM+'/'+lPolicyStartDateYYYY
			String lTagButtonNext='hdPolicyStartDate-next'
	...
	public Map inputPolicyInsurerA(String strPolicyInsurer){
		...
		try{
			...
			this.waitUntilOpportunityNumberUpdated()
			String lOpportunityNumber=THAElectricMotorCarCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER.trim()
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THAElectricMotorCarQuotationDetail1Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
