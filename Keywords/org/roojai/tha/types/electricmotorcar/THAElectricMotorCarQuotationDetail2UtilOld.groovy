...
public class THAElectricMotorCarQuotationDetail2UtilOld{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAElectricMotorCarQuotationDetail2UtilOld(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Map inputLanguage(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THAElectricMotorCarQuotationDetail2Type.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THAElectricMotorCarQuotationDetail2Type.DEFAULT_LANGUAGE)
			}
	...
	public String inputUnderFinancing(String strUnderFinancing){
		...
		try{
			String lText=''
			if(lUnderFinancing.length()<=0){
				lUnderFinancing=THAElectricMotorCarQuotationDetail2Type.DEFAULT_UNDER_FINANCING
			}
			Boolean lIsUnderFinancing=IGNUemaHelper.convertStringToBoolean(lUnderFinancing)
	...
	public String inputFinancialOrganisation(String strFinancialOrganisation){
		...
		try{
			String lText=''
			if(lFinancialOrganisation.length()<=0){
				lFinancialOrganisation=THAElectricMotorCarQuotationDetail2Type.DEFAULT_FINANCIAL_ORGANISATION
			}
	...
	public String inputWithRedPlate(String strWithRedPlate){
		...
		try{
			String lText=''
			if(lWithRedPlate.length()<=0){
				lWithRedPlate=THAElectricMotorCarQuotationDetail2Type.DEFAULT_WITH_RED_PLATE
			}
	...
	public String inputPrevInsuranceCovered(String strPrevInsuranceCovered){
		...
		try{
			String lText=''
			if(lPrevInsuranceCovered.length()<=0){
				lPrevInsuranceCovered=THAElectricMotorCarQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COVERED
			}
			Boolean lIsPrevInsuranceCovered=IGNUemaHelper.convertStringToBoolean(lPrevInsuranceCovered)
	...
	public String inputPrevInsuranceCompany(String strPrevInsuranceCompany){
		...
		try{
			String lText=''
			if(lPrevInsuranceCompany.length()<=0){
				lPrevInsuranceCompany=THAElectricMotorCarQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COMPANY
			}
	...
	public String inputPrevInsuranceType(String strPrevInsuranceType){
		...
		try{
			String lText=''
			if(lPrevInsuranceType.length()<=0){
				lPrevInsuranceType=THAElectricMotorCarQuotationDetail2Type.DEFAULT_PREV_INSURANCE_TYPE
			}
	...
	public String inputPolicyExpirationDayOffset(String strPolicyExpirationDayOffset){
		...
		if(lPolicyExpirationDayOffset.length()<=0){
			lPolicyExpirationDayOffset=THAElectricMotorCarQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DAY_OFFSET
		}
		try{
			String lText=''
			Integer lPolicyExpirationDayOffsetNum=IGNUemaHelper.convertStringToInteger(lPolicyExpirationDayOffset,0)
	...
	public String inputPolicyExpirationDate(String strPolicyExpirationDate,Integer numPolicyExpirationDayOffset){
		...
		try{
			String lText=''
			if(lPolicyExpirationDate.length()<=0){
				lPolicyExpirationDate=THAElectricMotorCarQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DATE
			}
	...
	public String inputPolicyStartDayOffset(String strPolicyStartDayOffset){
		...
		if(lPolicyStartDayOffset.length()<=0){
			lPolicyStartDayOffset=THAElectricMotorCarQuotationDetail2Type.DEFAULT_POLICY_START_DAY_OFFSET
		}
		try{
			String lText=''
			Integer lPolicyStartDayOffsetNum=IGNUemaHelper.convertStringToInteger(lPolicyStartDayOffset,0)
	...
	public String inputPolicyStartDate(String strPolicyStartDate,Integer numPolicyStartDayOffset){
		...
		try{
			String lText=''
			if(lPolicyStartDate.length()<=0){
				lPolicyStartDate=THAElectricMotorCarQuotationDetail2Type.DEFAULT_POLICY_START_DATE
			}
	...
	public String inputSendToPostalCode(String strSendToPostalCode){
		...
		try{
			String lText=''
			if(lSendToPostalCode.length()<=0){
				lSendToPostalCode=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SEND_TO_POSTAL_CODE
			}
	...
	public String inputSendToProvince(String strSendToProvince){
		...
		try{
			String lText=''
			if(lSendToProvince.length()<=0){
				lSendToProvince=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SEND_TO_PROVINCE
			}
	...
	public String inputSendToDistrict(String strSendToDistrict){
		...
		try{
			String lText=''
			if(lSendToDistrict.length()<=0){
				lSendToDistrict=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SEND_TO_DISTRICT
			}
	...
	public String inputSendToSubDistrict(String strSendToSubDistrict){
		...
		try{
			String lText=''
			if(lSendToSubDistrict.length()<=0){
				lSendToSubDistrict=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SEND_TO_SUB_DISTRICT
			}
	...
	public String inputSendToRoad(String strSendToRoad){
		...
		try{
			String lText=''
			if(lSendToRoad.length()<=0){
				lSendToRoad=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SEND_TO_ROAD
			}
	...
	public String inputSendToBuildingName(String strSendToBuildingName){
		...
		try{
			String lText=''
			if(lSendToBuildingName.length()<=0){
				lSendToBuildingName=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NAME
			}
	...
	public String inputSendToBuildingNumber(String strSendToBuildingNumber){
		...
		try{
			String lText=''
			if(lSendToBuildingNumber.length()<=0){
				lSendToBuildingNumber=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NUMBER
			}
	...
	public String inputPositiveCase(String strPositiveCase){
		...
		try{
			String lText=''
			if(lPositiveCase.length()<=0){
				lPositiveCase=THAElectricMotorCarQuotationDetail2Type.DEFAULT_POSITIVE_CASE
			}
			Boolean lIsPositiveCase=IGNUemaHelper.convertStringToBoolean(lPositiveCase)
		...
		try{
			...
			if(lElementInfo){
				...
				if(lInfoText.length()>0){
					THAElectricMotorCarCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER=lInfoText
					lreturn=lInfoText
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
	...
	public Map inputSalesforceProceedVerifyBefore(Map caseOutput){
		...
		try{
			...
			switch(THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_METHOD){
				case '2':
					lAutomationYearly=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
					...
					break
				case '3':
					lAutomationPaymentFrequency=THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_QR_CODE_IS_YEARLY
					...
					if(lIsPaymentFrequency){
						...
						lAutomationPremiumNoDepositAmount=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_AMOUNT_VALUE
						...
						lAutomationPremiumNoDepositTotal=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_TOTAL_VALUE
					...
					break
				case '4':
					lAutomationPaymentFrequency=THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_TRUE_MONEY_IS_YEARLY
					lSalesforcePaymentFrequency=caseOutput.SalesforceVerifyDataOpportunityObjPaymentFrequencyC
					lIsPaymentFrequency=IGNUemaHelper.convertStringToBoolean(lAutomationPaymentFrequency)
					if(lIsPaymentFrequency){
						lAutomationYearly=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
					...
					break
				case '5':
					lAutomationPaymentFrequency=THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_RABBIT_LINE_PAY_IS_YEARLY
					lSalesforcePaymentFrequency=caseOutput.SalesforceVerifyDataOpportunityObjPaymentFrequencyC
					lIsPaymentFrequency=IGNUemaHelper.convertStringToBoolean(lAutomationPaymentFrequency)
					if(lIsPaymentFrequency){
						lAutomationYearly=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
					...
					break
				default:
					lAutomationPaymentFrequency=THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_CC_IS_YEARLY
					lSalesforcePaymentFrequency=caseOutput.SalesforceVerifyDataOpportunityObjPaymentFrequencyC
					lIsPaymentFrequency=IGNUemaHelper.convertStringToBoolean(lAutomationPaymentFrequency)
					if(lIsPaymentFrequency){
						lAutomationYearly=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
	...
	public Map inputSalesforceProceedRetrieveTodo(String strSalesforceProceedRetrieveTodo,String strAccountNameAnonymous){
		...
		if(lSalesforceProceedRetrieveTodo.length()<=0){
			lSalesforceProceedRetrieveTodo=THAElectricMotorCarQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
