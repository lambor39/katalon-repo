...
public class THAElectricMotorCarQuotationInputType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteElectricMotorCar/ElectricMotorCar_Quotation_01_Input.Input'
	public static final String INPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_ElectricMotorCar_Quotation_Website.xlsx'
	public static final String INPUT_EXCEL_SHEET_NAME='ElectricMotorCar_Input.Input'
	public static final Integer INPUT_EXCEL_COL_BEGIN=2
	public static final Integer INPUT_EXCEL_ROW_BEGIN=1
	public static final Integer INPUT_EXCEL_ROW_END=60
	public static final Integer INPUT_DATA_COL_BEGIN=3
	public static final Integer INPUT_DATA_ROW_BEGIN=1
	public static final Integer INPUT_DATA_ROW_END=61
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteElectricMotorCar/ElectricMotorCar_Quotation_01_Input.Output'
	public static final String OUTPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_ElectricMotorCar_Quotation_Website.xlsx'
	public static final String OUTPUT_EXCEL_SHEET_NAME='ElectricMotorCar_Input.Output'
	public static final Integer OUTPUT_EXCEL_COL_BEGIN=1
	public static final Integer OUTPUT_EXCEL_ROW_BEGIN=1
	public static final Integer OUTPUT_EXCEL_ROW_END=69
	public static final Integer OUTPUT_DATA_COL_BEGIN=2
	public static final Integer OUTPUT_DATA_ROW_BEGIN=1
	public static final Integer OUTPUT_DATA_ROW_END=70
	//Constant
	...
	public static final String DEFAULT_START_FROM_DIRECT_ELECTRIC_MOTOR_CAR='Yes'
	public static final String DEFAULT_CMS_BASE_URL_FORM_MAIN='https://www.uat-roojai.com'
	public static final String DEFAULT_CMS_BASE_URL_FORM_MINI='https://www.uat-roojai.com/en/ev-car-insurance'
	...
	public static final String DEFAULT_BASE_URL_MOTOR_CAR='https://insure.uat-roojai.com/#/quotationInput'
	public static final String DEFAULT_BASE_URL_ELECTRIC_MOTOR_CAR='https://insure.uat-roojai.com/#/ev'
	...
	public static final String DEFAULT_VERSION='AA-A-A'
	...
	public static final String DEFAULT_EXPECTED_KUMKA_COMPARE_BUTTON='1'
	public static final String DEFAULT_KUMKA_COMPARE_TO_DO='1'
	public static final String DEFAULT_POSITIVE_CASE='Yes'
	public Map Input=[:]
	public Map Output=[:]
	public THAElectricMotorCarQuotationInputType(){
		super()
		this.initInput()
		this.initOutput()
	}
	...
	public void initInput(){
		...
		this.Input.put('StartFromDirectElectricMotorCar',this.DEFAULT_START_FROM_DIRECT_ELECTRIC_MOTOR_CAR)
		...
		this.Input.put('BaseUrlMotorCar',this.DEFAULT_BASE_URL_MOTOR_CAR)
		this.Input.put('BaseUrlElectricMotorCar',this.DEFAULT_BASE_URL_ELECTRIC_MOTOR_CAR)
		...
		this.Input.put('ExpectedKumkaCompareButton',this.DEFAULT_EXPECTED_KUMKA_COMPARE_BUTTON)
		this.Input.put('KumkaCompareToDo',this.DEFAULT_KUMKA_COMPARE_TO_DO)
	...
	public void initOutput(){
		...
		this.Output.put('StartFromDirectElectricMotorCar','')
		...
		this.Output.put('BaseUrlMotorCar','')
		this.Output.put('BaseUrlElectricMotorCar','')
		...
		this.Output.put('ExpectedKumkaCompareButton','')
		this.Output.put('KumkaCompareToDo','')
		...
		this.Output.put('KumkaDefaultSaveQuoteId','')
		this.Output.put('KumkaOutboundCardNumber','')
	}
	public static Boolean readInputFromDataFile(Integer caseNumber,Map caseInput){
		...
		try{
			...
			dataRowIndex+=1
			caseInput.put('StartFromDirectElectricMotorCar',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			...
			dataRowIndex+=1
			caseInput.put('BaseUrlMotorCar',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseInput.put('BaseUrlElectricMotorCar',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			...
			dataRowIndex+=1
			caseInput.put('ExpectedKumkaCompareButton',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseInput.put('KumkaCompareToDo',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
	...
	public static Boolean readOutputFromDataFile(Integer caseNumber,Map caseOutput){
		...
		try{
			...
			dataRowIndex+=1
			caseOutput.put('StartFromDirectElectricMotorCar',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			...
			dataRowIndex+=1
			caseOutput.put('BaseUrlMotorCar',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseOutput.put('BaseUrlMotorCarEv',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			...
			dataRowIndex+=1
			caseOutput.put('ExpectedKumkaCompareButton',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseOutput.put('KumkaCompareToDo',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			...
			dataRowIndex+=1
			caseOutput.put('KumkaDefaultSaveQuoteId',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseOutput.put('KumkaOutboundCardNumber',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			lreturn=true
		}catch(Exception e){
			//e.printStackTrace()
			return lreturn
