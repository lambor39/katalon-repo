...
public class THAElectricMotorCarQuotationInputUtil{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAElectricMotorCarQuotationInputUtil(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Map inputVersionReferrer(String strBaseUrl,String strVersion,String strReferrer){
		...
		if(lBaseUrl.length()<=0){
			lBaseUrl=THAElectricMotorCarQuotationInputType.DEFAULT_BASE_URL_ELECTRIC_MOTOR_CAR
		}
