...
public class THAElectricMotorCarQuotationInputUtilOld{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAElectricMotorCarQuotationInputUtilOld(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Map inputVersionReferrer(String strBaseUrl,String strVersion,String strReferrer){
		...
		if(lBaseUrl.length()<=0){
			lBaseUrl=THAElectricMotorCarQuotationInputType.DEFAULT_BASE_URL_MOTOR_CAR
		}
		String lDefaultVersion=THAElectricMotorCarQuotationInputType.DEFAULT_VERSION
	...
	public Boolean inputInputFromProduct(Map caseInput,Map caseOutput){
		Boolean lreturn=false
		String lStartFromDirectElectricMotorCar=caseInput.StartFromDirectElectricMotorCar.toString().trim()
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THAElectricMotorCarQuotationInputType.DEFAULT_POSITIVE_CASE
		}
		try{
			Boolean lResult=false
	...
	public Map inputActualResultA(Boolean isPositiveCase){
		...
		try{
			...
			if(!lRedirected){
				...
				if(lElementButtonNext){
					IGNUemaHelper.webJsScrollToElement(this.driver,lElementButtonNext)
					IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementButtonNext)
				}
			}
			lRedirected=IGNUemaHelper.checkElementPresentByLocator(this.driver,lLocatorResultPage,20)
	...
	public Map inputCmsLanguage(String strCmsLanguage){
		...
		if(lCmsLanguage.length()<=0){
			lCmsLanguage=THAElectricMotorCarQuotationInputType.DEFAULT_CMS_LANGUAGE
		}
		...
		try{
			...
			if(!lCmsLanguageItem){
				lCmsLanguageItem=lCmsLanguageList.get(THAElectricMotorCarQuotationInputType.DEFAULT_CMS_LANGUAGE)
			}
			lCmsLanguage=''
	...
	public Map inputCmsAffiliateLanguage(String strCmsAffiliateLanguage){
		...
		if(lCmsAffiliateLanguage.length()<=0){
			lCmsAffiliateLanguage=THAElectricMotorCarQuotationInputType.DEFAULT_CMS_AFFILIATE_LANGUAGE
		}
		...
		try{
			...
			if(!lCmsAffiliateLanguageItem){
				lCmsAffiliateLanguageItem=lCmsAffiliateLanguageList.get(THAElectricMotorCarQuotationInputType.DEFAULT_CMS_AFFILIATE_LANGUAGE)
			}
			lCmsAffiliateLanguage=''
	...
	public Map inputLanguageA(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THAElectricMotorCarQuotationInputType.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THAElectricMotorCarQuotationInputType.DEFAULT_LANGUAGE)
			}
	...
	public Map inputCmsCarMake(String strCmsCarMake){
		...
		if(lCmsCarMake.length()<=0){
			lCmsCarMake=THAElectricMotorCarQuotationInputType.DEFAULT_CMS_CAR_MAKE
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarMakeA(String strCarMake){
		...
		if(lCarMake.length()<=0){
			lCarMake=THAElectricMotorCarQuotationInputType.DEFAULT_CAR_MAKE
		}
		try{
			Boolean lResult=false
			lreturn.put('CarMake','')
	...
	public Map inputCmsCarModel(String strCmsCarModel){
		...
		if(lCmsCarModel.length()<=0){
			lCmsCarModel=THAElectricMotorCarQuotationInputType.DEFAULT_CMS_CAR_MODEL
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarModelA(String strCarModel){
		...
		if(lCarModel.length()<=0){
			lCarModel=THAElectricMotorCarQuotationInputType.DEFAULT_CAR_MODEL
		}
		try{
			Boolean lResult=false
			lreturn.put('CarModel','')
	...
	public Map inputCarModelB(String strCarModel){
		...
		try{
			...
			String lTagButton='carModel'
			//String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			String lLocatorButton='#btn-select-model'
			String lTagDropdownListHit='carModel-item-hit'
			String lLocatorDropdownListHit=IGNUemaHelper.getTagDataSeleniumKey(lTagDropdownListHit)
			String lTagDropdownListAll='carModel-item'
			String lLocatorDropdownListAll=IGNUemaHelper.getTagDataSeleniumKey(lTagDropdownListAll)
	...
	public Map inputCmsCarYear(String strCmsCarYear){
		...
		if(lCmsCarYear.length()<=0){
			lCmsCarYear=THAElectricMotorCarQuotationInputType.DEFAULT_CMS_CAR_YEAR
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarYearA(String strCarYear){
		...
		if(lCarYear.length()<=0){
			lCarYear=THAElectricMotorCarQuotationInputType.DEFAULT_CAR_YEAR
		}
		try{
			Boolean lResult=false
			lreturn.put('CarYear','')
	...
	public Map inputCarYearB(String strCarYear){
		...
		try{
			...
			String lTagButton='carYear'
			//String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			String lLocatorButton='#btn-select-year'
			String lTagDropdownListHit='carYear-item-hit'
			String lLocatorDropdownListHit=IGNUemaHelper.getTagDataSeleniumKey(lTagDropdownListHit)
			String lTagDropdownListAll='carYear-item'
			String lLocatorDropdownListAll=IGNUemaHelper.getTagDataSeleniumKey(lTagDropdownListAll)
	...
	public Map inputCmsCarSubmodel(String strCmsCarSubmodel){
		...
		if(lCmsCarSubmodel.length()<=0){
			lCmsCarSubmodel=THAElectricMotorCarQuotationInputType.DEFAULT_CMS_CAR_SUBMODEL
		}
		try{
			Boolean lResult=false
	...
	public Map inputSubmodelA(String strSubmodel){
		...
		if(lSubmodel.length()<=0){
			lSubmodel=THAElectricMotorCarQuotationInputType.DEFAULT_SUBMODEL
		}
		try{
			Boolean lResult=false
			lreturn.put('Submodel','')
	...
	public Map inputCmsKeepDetailA(String strCmsKeepDetail,String strCmsLanguage,String strCmsCarMake,String strCmsCarModel,String strCmsCarYear,String strCmsCarSubmodel){
		...
		if(lCmsKeepDetail.length()<=0){
			lCmsKeepDetail=THAElectricMotorCarQuotationInputType.DEFAULT_CMS_KEEP_DETAIL
		}
	...
	public Map inputGenderMainMaritalStatusA(String strGenderMain,String strMaritalStatus){
		...
		if(lGenderMain.length()<=0){
			lGenderMain=THAElectricMotorCarQuotationInputType.DEFAULT_GENDER_MAIN
		}
		String lMaritalStatus=strMaritalStatus.trim()
		if(lMaritalStatus.length()<=0){
			lMaritalStatus=THAElectricMotorCarQuotationInputType.DEFAULT_MARITAL_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('GenderMain','')
	...
	public Map inputBirthDateMainA(String strBirthDateMain){
		...
		if(lBirthDateMain.length()<=0){
			lBirthDateMain=THAElectricMotorCarQuotationInputType.DEFAULT_BIRTH_DATE_MAIN
		}
		try{
			Boolean lResult=false
			lreturn.put('BirthDateMain','')
	...
	public Map inputYearDrivingA(String strYearDriving){
		...
		if(lYearDriving.length()<=0){
			lYearDriving=THAElectricMotorCarQuotationInputType.DEFAULT_YEAR_DRIVING
		}
	...
	public Map inputClaimsNoA(String strClaimsNo){
		...
		if(lClaimsNo.length()<=0){
			lClaimsNo=THAElectricMotorCarQuotationInputType.DEFAULT_CLAIMS_NO
		}
	...
	public Map inputVehicleUsageA(String strVehicleUsage){
		...
		try{
			...
			if(!lVehicleUsageItem){
				lVehicleUsageItem=lVehicleUsageList.get(THAElectricMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE.toUpperCase())
			}
	...
	public Map inputVehicleUsageForCommercialA(String strVehicleUsageForCommercial){
		...
		try{
			...
			if(!lVehicleUsageForCommercialItem){
				lVehicleUsageForCommercialItem=lVehicleUsageForCommercialList.get(THAElectricMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE_FOR_COMMERCIAL)
			}
			String lTagButtonKey='carUsage'
	...
	public Map inputVehicleUsageDriveToWorkA(String strVehicleUsageDriveToWork){
		...
		try{
			...
			if(!lVehicleUsageDriveToWorkItem){
				lVehicleUsageDriveToWorkItem=lVehicleUsageDriveToWorkList.get(THAElectricMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE_DRIVE_TO_WORK)
			}
	...
	public Map inputVehicleUsageDriveToWorkOftenA(String strVehicleUsageDriveToWorkOften){
		...
		try{
			...
			if(!lVehicleUsageDriveToWorkOftenItem){
				lVehicleUsageDriveToWorkOftenItem=lVehicleUsageDriveToWorkOftenList.get(THAElectricMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE_DRIVE_TO_WORK_OFTEN)
			}
			lVehicleUsageDriveToWorkOften=''
	...
	public Map inputTaxiOrVehicleForHireA(String strTaxiOrVehicleForHire){
		...
		if(lTaxiOrVehicleForHire.length()<=0){
			lTaxiOrVehicleForHire=THAElectricMotorCarQuotationInputType.DEFAULT_TAXI_OR_VEHICLE_FOR_HIRE
		}
		try{
			Boolean lResult=false
			lreturn.put('TaxiOrVehicleForHire','')
	...
	public Map inputRentalVehicleA(String strRentalVehicle){
		...
		if(lRentalVehicle.length()<=0){
			lRentalVehicle=THAElectricMotorCarQuotationInputType.DEFAULT_RENTAL_VEHICLE
		}
		try{
			Boolean lResult=false
			lreturn.put('RentalVehicle','')
	...
	public Map inputGoodsTransportVehicleA(String strGoodsTransportVehicle){
		...
		if(lGoodsTransportVehicle.length()<=0){
			lGoodsTransportVehicle=THAElectricMotorCarQuotationInputType.DEFAULT_GOODS_TRANSPORT_VEHICLE
		}
		try{
			Boolean lResult=false
			lreturn.put('GoodsTransportVehicle','')
	...
	public Map inputLogisticsOrCourierCompanyA(String strLogisticsOrCourierCompany){
		...
		if(lLogisticsOrCourierCompany.length()<=0){
			lLogisticsOrCourierCompany=THAElectricMotorCarQuotationInputType.DEFAULT_LOGISTICS_OR_COURIER_COMPANY
		}
		try{
			Boolean lResult=false
			lreturn.put('LogisticsOrCourierCompany','')
	...
	public Map inputGoodsTransportRouteA(String strGoodsTransportRoute){
		...
		try{
			...
			if(!lGoodsTransportRouteItem){
				lGoodsTransportRouteItem=lGoodsTransportRouteList.get(THAElectricMotorCarQuotationInputType.DEFAULT_GOODS_TRANSPORT_ROUTE.toUpperCase())
			}
	...
	public Map inputPostalCodeA(String strPostalCode){
		...
		if(lPostalCode.length()<=0){
			lPostalCode=THAElectricMotorCarQuotationInputType.DEFAULT_POSTAL_CODE
		}
		try{
			Boolean lResult=false
			lreturn.put('PostalCode','')
	...
	public Map inputOdometerReadingA(String strOdometerReading){
		...
		if(lOdometerReading.length()<=0){
			lOdometerReading=THAElectricMotorCarQuotationInputType.DEFAULT_ODOMETER_READING
		}
		...
		try{
			...
			if(!lElementOdometerNext){
				lLocatorOdometerNext='#next2level4odometer'
				lElementOdometerNext=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorOdometerNext)
			}
			if(lElementOdometerNext){
	...
	public Map inputDeclaredNcbA(String strDeclaredNcb){
		...
		if(lDeclaredNcb.length()<=0){
			lDeclaredNcb=THAElectricMotorCarQuotationInputType.DEFAULT_DECLARED_NCB
		}
	...
	public Map inputUnderFinancingA(String strUnderFinancing){
		...
		if(lUnderFinancing.length()<=0){
			lUnderFinancing=THAElectricMotorCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase()
		}
		...
		try{
			...
			if(!lUnderFinancingItem){
				lUnderFinancingItem=lUnderFinancingList.get(THAElectricMotorCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase())
			}
			lUnderFinancing=''
	...
	public Map inputCarCameraA(String strCarCamera){
		...
		if(lCarCamera.length()<=0){
			lCarCamera=THAElectricMotorCarQuotationInputType.DEFAULT_CAR_CAMERA
		}
		try{
			Boolean lResult=false
			lreturn.put('CarCamera','')
	...
	public Map inputTentativeA(String strTentative){
		...
		if(lTentative.length()<=0){
			lTentative=THAElectricMotorCarQuotationInputType.DEFAULT_TENTATIVE
		}
		try{
			Boolean lResult=false
			lreturn.put('Tentative','')
	...
	public Map inputAlcoholFreeA(String strAlcoholFree){
		...
		if(lAlcoholFree.length()<=0){
			lAlcoholFree=THAElectricMotorCarQuotationInputType.DEFAULT_ALCOHOL_FREE.toUpperCase()
		}
		...
		try{
			...
			if(!lAlcoholFreeItem){
				lAlcoholFreeItem=lAlcoholFreeList.get(THAElectricMotorCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase())
			}
			lAlcoholFree=''
