...
public class THAElectricMotorCarQuotationPaymentUtilOld{
	private WebDriver driver=null
	private WebDriver selenium=null
	private lIsIBSuccessCase=false
	private Boolean lIsSalesforceProceedRetrieveWebFromUrlSuccess=false
	public THAElectricMotorCarQuotationPaymentUtilOld(WebDriver newDriver,WebDriver newSelenium){
		super()
					...
					case 'A':
						...
						if(lIsSalesforceProceedTodo){
							...
							if(lIsActualResult){
								...
								if(lIsSalesforceProceedRetrieveTodo){
									Map lMapSalesforceProceedRetrieveWebFromUrl=this.inputSalesforceProceedRetrieveWebFromUrl(THAElectricMotorCarCoreType.CURRENT_QUOTATION_RETRIEVAL_URL_PAGE_PAYMENT)
						...
						switch(lPaymentMethod){
							...
							case '3':
								...
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_QR_CODE_SUCCESS_CASE=lQrSuccessCase
								if(!lMapPaymentByQR.Result){
									return lreturn
								}
								break
							case '4':
								...
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_TRUE_MONEY_MOBILE_NO=lTrueMoneyMobileNo
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_TRUE_MONEY_EMAIL=lTrueMoneyEmail
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_TRUE_MONEY_SUCCESS_CASE=lTrueMoneySuccessCase
								if(!lMapPaymentByTrueMoney.Result){
									return lreturn
								}
								break
							case '5':
								...
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_RABBIT_LINE_PAY_MOBILE_NO=lRabbitLinePayMobileNo
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_RABBIT_LINE_PAY_EMAIL=lRabbitLinePayEmail
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_RABBIT_LINE_PAY_SUCCESS_CASE=lRabbitLinePaySuccessCase
								if(!lMapPaymentByRabbitLinePay.Result){
									return lreturn
								}
								break
							case '6':
								...
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_MOBILE_BANKING_CARD=lMobileBankingCard
								THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_MOBILE_BANKING_SUCCESS_CASE=lMobileBankingSuccessCase
								if(!lMapPaymentByMobileBanking.Result){
									return lreturn
								}
								break
	...
	public Map inputLanguageA(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THAElectricMotorCarQuotationPaymentType.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THAElectricMotorCarQuotationPaymentType.DEFAULT_LANGUAGE)
			}
	...
	public Map inputActualResult(Boolean isPositiveCase){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THAElectricMotorCarCoreType.CURRENT_SKIP_PAGE_DETAIL2){
	...
	public Map inputPaymentMethodA(String strPaymentMethod){
		...
		try{
			...
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_METHOD=lPaymentMethod
	...
	public Map inputPaymentByQRA(String strQrIsYearly,String strQrInstalment,String strEPolicy,String strQrSuccessCase){
		...
		if(lQrIsYearly.length()<=0){
			lQrIsYearly=THAElectricMotorCarQuotationPaymentType.DEFAULT_QR_IS_YEARLY
		}
		String lQrInstalment=strQrInstalment.trim()
		if(lQrInstalment.length()<=0){
			lQrInstalment=THAElectricMotorCarQuotationPaymentType.DEFAULT_QR_INSTALMENT
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAElectricMotorCarQuotationPaymentType.DEFAULT_E_POLICY
		}
		String lQrSuccessCase=strQrSuccessCase.trim()
		if(lQrSuccessCase.length()<=0){
			lQrSuccessCase=THAElectricMotorCarQuotationPaymentType.DEFAULT_QR_SUCCESS_CASE
		}
		String lQrAmtYearly=''
		String lQrAmtDeposit=''
		String lQrAmtMonthly=''
		...
		try{
			...
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_QR_CODE_IS_YEARLY=lQrIsYearly
			if(lResult){
	...
	public Map inputPaymentByIBA(String strIbBank,String strEPolicy,String strAutoRenew,String strIbSuccessCase){
		...
		if(lAutoRenew.length()<=0){
			lAutoRenew=THAElectricMotorCarQuotationPaymentType.DEFAULT_AUTO_RENEW
		}
		String lIbSuccessCase=strIbSuccessCase.trim()
		if(lIbSuccessCase.length()<=0){
			lIbSuccessCase=THAElectricMotorCarQuotationPaymentType.DEFAULT_IB_SUCCESS_CASE
		}
		String lIbAmtYearly=''
		try{
			Boolean lResult=false
			...
			if(!lIbBankItem){
				lIbBankItem=lIbBankList.get(THAElectricMotorCarQuotationPaymentType.DEFAULT_IB_BANK)
			}
			lIbBank=''
	...
	public Map inputPaymentByCC(String strCcIsYearly,String strCcInstalment,String strCcNumber,String strCcName,String strCcExpiryMonth,String strCcExpiryYear,String strCcCvv,String strCcBank,String strEPolicy,String strAutoRenew,String strCcSuccessCase){
		...
		try{
			...
			if(this.lIsSalesforceProceedRetrieveWebFromUrlSuccess){
				THAElectricMotorCarCoreType.CURRENT_SKIP_PAGE_DETAIL2=true
			}
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
	...
	public Map inputPaymentByCCA(String strCcIsYearly,String strCcInstalment,String strCcNumber,String strCcName,String strCcExpiryMonth,String strCcExpiryYear,String strCcCvv,String strCcBank,String strEPolicy,String strAutoRenew,String strCcSuccessCase){
		...
		if(lCcIsYearly.length()<=0){
			lCcIsYearly=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_IS_YEARLY
		}
		String lCcInstalment=strCcInstalment.trim()
		if(lCcInstalment.length()<=0){
			lCcInstalment=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_INSTALMENT
		}
		String lCcNumber=strCcNumber.trim()
		if(lCcNumber.length()<=0){
			lCcNumber=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_NUMBER
		}
		String lCcName=strCcName.trim()
		if(lCcName.length()<=0){
			lCcName=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_NAME
		}
		String lCcExpiryMonth=strCcExpiryMonth.trim()
		if(lCcExpiryMonth.length()<=0){
			lCcExpiryMonth=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_EXPIRY_MONTH
		}
		String lCcExpiryYear=strCcExpiryYear.trim()
		if(lCcExpiryYear.length()<=0){
			lCcExpiryYear=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_EXPIRY_YEAR
		}
		String lCcCvv=strCcCvv.trim()
		if(lCcCvv.length()<=0){
			lCcCvv=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_CVV
		}
		String lCcBank=strCcBank.trim()
		if(lCcBank.length()<=0){
			lCcBank=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_BANK
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAElectricMotorCarQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lCcSuccessCase.length()<=0){
			lCcSuccessCase=THAElectricMotorCarQuotationPaymentType.DEFAULT_CC_SUCCESS_CASE
		}
		String lCcAmtYearly=''
		String lCcAmtDeposit=''
		String lCcAmtMonthly=''
		...
		try{
			...
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_CC_IS_YEARLY=lCcIsYearly
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputPaymentByTrueMoneyA(String strTrueMoneyIsYearly,String strTrueMoneyInstalment,String strTrueMoneyMobileNo,String strTrueMoneyEmail,String strEPolicy,String strAutoRenew,String strTrueMoneySuccessCase){
		...
		if(lTrueMoneyIsYearly.length()<=0){
			lTrueMoneyIsYearly=THAElectricMotorCarQuotationPaymentType.DEFAULT_TRUE_MONEY_IS_YEARLY
		}
		String lTrueMoneyInstalment=strTrueMoneyInstalment.trim()
		if(lTrueMoneyInstalment.length()<=0){
			lTrueMoneyInstalment=THAElectricMotorCarQuotationPaymentType.DEFAULT_TRUE_MONEY_INSTALMENT
		}
		String lTrueMoneyMobileNo=strTrueMoneyMobileNo.trim()
		if(lTrueMoneyMobileNo.length()<=0){
			lTrueMoneyMobileNo=THAElectricMotorCarQuotationPaymentType.DEFAULT_TRUE_MONEY_MOBILE_NO
		}
		String lTrueMoneyEmail=strTrueMoneyEmail.trim()
		if(lTrueMoneyEmail.length()<=0){
			lTrueMoneyEmail=THAElectricMotorCarQuotationPaymentType.DEFAULT_TRUE_MONEY_EMAIL
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAElectricMotorCarQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lTrueMoneySuccessCase.length()<=0){
			lTrueMoneySuccessCase=THAElectricMotorCarQuotationPaymentType.DEFAULT_TRUE_MONEY_SUCCESS_CASE
		}
		String lTrueMoneyAmtYearly=''
		String lTrueMoneyAmtDeposit=''
		String lTrueMoneyAmtMonthly=''
		...
		try{
			...
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_TRUE_MONEY_IS_YEARLY=lTrueMoneyIsYearly
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputPaymentByRabbitLinePayA(String strRabbitLinePayIsYearly,String strRabbitLinePayInstalment,String strRabbitLinePayMobileNo,String strRabbitLinePayEmail,String strEPolicy,String strAutoRenew,String strRabbitLinePaySuccessCase){
		...
		if(lRabbitLinePayIsYearly.length()<=0){
			lRabbitLinePayIsYearly=THAElectricMotorCarQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_IS_YEARLY
		}
		String lRabbitLinePayInstalment=strRabbitLinePayInstalment.trim()
		if(lRabbitLinePayInstalment.length()<=0){
			lRabbitLinePayInstalment=THAElectricMotorCarQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_INSTALMENT
		}
		String lRabbitLinePayMobileNo=strRabbitLinePayMobileNo.trim()
		if(lRabbitLinePayMobileNo.length()<=0){
			lRabbitLinePayMobileNo=THAElectricMotorCarQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_MOBILE_NO
		}
		String lRabbitLinePayEmail=strRabbitLinePayEmail.trim()
		if(lRabbitLinePayEmail.length()<=0){
			lRabbitLinePayEmail=THAElectricMotorCarQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_EMAIL
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAElectricMotorCarQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lRabbitLinePaySuccessCase.length()<=0){
			lRabbitLinePaySuccessCase=THAElectricMotorCarQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_SUCCESS_CASE
		}
		String lRabbitLinePayAmtYearly=''
		String lRabbitLinePayAmtDeposit=''
		String lRabbitLinePayAmtMonthly=''
		...
		try{
			...
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_RABBIT_LINE_PAY_IS_YEARLY=lRabbitLinePayIsYearly
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputPaymentByMobileBankingA(String strMobileBankingIsYearly,String strMobileBankingInstalment,String strMobileBankingCard,String strEPolicy,String strAutoRenew,String strMobileBankingSuccessCase){
		...
		if(lMobileBankingIsYearly.length()<=0){
			lMobileBankingIsYearly=THAElectricMotorCarQuotationPaymentType.DEFAULT_MOBILE_BANKING_IS_YEARLY
		}
		String lMobileBankingInstalment=strMobileBankingInstalment.trim()
		if(lMobileBankingInstalment.length()<=0){
			lMobileBankingInstalment=THAElectricMotorCarQuotationPaymentType.DEFAULT_MOBILE_BANKING_INSTALMENT
		}
		String lMobileBankingCard=strMobileBankingCard.trim()
		if(lMobileBankingCard.length()<=0){
			lMobileBankingCard=THAElectricMotorCarQuotationPaymentType.DEFAULT_MOBILE_BANKING_CARD
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAElectricMotorCarQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lMobileBankingSuccessCase.length()<=0){
			lMobileBankingSuccessCase=THAElectricMotorCarQuotationPaymentType.DEFAULT_MOBILE_BANKING_SUCCESS_CASE
		}
		String lMobileBankingAmtYearly=''
		String lMobileBankingAmtDeposit=''
		String lMobileBankingAmtMonthly=''
		...
		try{
			...
			if(!lMobileBankingCardItem){
				lMobileBankingCardItem=lMobileBankingCardList.get(THAElectricMotorCarQuotationPaymentType.DEFAULT_MOBILE_BANKING_CARD)
			}
			String lTagPaymentMethodModalForm=''
			String lLocatorPaymentMethodModalForm='#method-detail-modal'
			WebElement lElementPaymentMethodModalForm=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorPaymentMethodModalForm)
			...
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_PREMIUM_MOBILE_BANKING_IS_YEARLY=lMobileBankingIsYearly
			Boolean lSetBrowserWindowModeSize=IGNUemaHelper.setBrowserWindowModeSize(this.driver,false,576,1024)
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputAutomationDataBefore(){
		...
		try{
			...
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_OPPORTUNITY_NUMBER_VALUE=lOpportunityNumber
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE=lStrPremiumAmtYearly
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_DEPOSIT_VALUE=lStrPremiumAmtDeposit
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_MONTHLY_VALUE=lStrPremiumAmtMonthly
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_INSTALMENT_VALUE=lStrPremiumAmtInstalment
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_AMOUNT_VALUE=lStrPremiumAmtNoDepositAmount
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_TOTAL_VALUE=lStrPremiumAmtNoDepositTotal
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_AMOUNT_VALUE=lStrPremiumAmtQuarterlyAmount
			THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_TOTAL_VALUE=lStrPremiumAmtQuarterlyTotal
			lResult=lOpportunityNumber.length()>0
			if(lResult){
				lreturn.put('Result',lResult)
			}
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THAElectricMotorCarQuotationPaymentType.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
	...
	public Map inputSalesforceProceedVerifyBefore(Map caseOutput){
		...
		try{
			...
			switch(THAElectricMotorCarCoreType.CURRENT_QUOTATION_PAYMENT_METHOD){
				case '2':
	...
	public Map inputSalesforceProceedVerifyAfter(Map caseOutput){
		...
		try{
			...
			lreturn.put('Result','')
			String lText=''
			String lAutomationOpportunityNumber=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_OPPORTUNITY_NUMBER_VALUE
			...
			String lAutomationYearly=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
			...
			String lAutomationPremiumNoDepositAmount=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_AMOUNT_VALUE
			...
			String lAutomationPremiumNoDepositTotal=THAElectricMotorCarCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_TOTAL_VALUE
	...
	public Map inputSalesforceProceedRetrieveTodo(String strSalesforceProceedRetrieveTodo,String strAccountNameAnonymous){
		...
		if(lSalesforceProceedRetrieveTodo.length()<=0){
			lSalesforceProceedRetrieveTodo=THAElectricMotorCarQuotationPaymentType.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
