...
public class THAElectricMotorCarQuotationVerifyType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteElectricMotorCar/ElectricMotorCar_Quotation_00_Verify.Input'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteElectricMotorCar/ElectricMotorCar_Quotation_00_Verify.Output'
	...
	public Map Input=[:]
	public Map Output=[:]
	public THAElectricMotorCarQuotationVerifyType(){
		super()
		this.initInput()
		this.initOutput()
	}
