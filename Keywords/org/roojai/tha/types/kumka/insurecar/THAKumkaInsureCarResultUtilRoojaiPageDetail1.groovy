...
import org.roojai.tha.types.motorcar.THAMotorCarQuotationDetail1Type
...
public class THAKumkaInsureCarResultUtilRoojaiPageDetail1{
	private WebDriver driver=null
	private WebDriver selenium=null
	private def lMotorCarQuotationDetail1Util=null
	public THAKumkaInsureCarResultUtilRoojaiPageDetail1(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	private THAMotorCarQuotationDetail1Util getlMotorCarQuotationDetail1Util(){
		return this.lMotorCarQuotationDetail1Util
	}
	private void setlMotorCarQuotationDetail1Util(THAMotorCarQuotationDetail1Util newlMotorCarQuotationDetail1Util){
		//Do Nothing
		//this.lMotorCarQuotationDetail1Util=newlMotorCarQuotationDetail1Util
	}
	public Boolean inputDetail1(Map caseInput,Map caseOutput){
		...
		try{
			...
			if(THAKumkaInsureCarCoreType.CURRENT_URL_UNDER_QUOTE_APPLICATION){
				this.lMotorCarQuotationDetail1Util=new THAMotorCarQuotationDetail1Util(this.driver,this.selenium)
			}else{
				this.lMotorCarQuotationDetail1Util=new THAMotorCarQuotationDetail1UtilOld(this.driver,this.selenium)
			}
	...
	public Boolean inputDetail1MotorCar(Map caseInput,Map caseOutput){
		...
		try{
			...
			Map lMapDetail1Input=this.lMotorCarQuotationDetail1Util.initDetail1Input()
			...
			if(lIsActualResult){
				...
				if(lIsSalesforceProceedTodo){
					...
					String lSalesforceVerifyDataTransactionSyncedObjMainDriverC=caseOutput.SalesforceVerifyDataTransactionSyncedObjMainDriverC.toString().trim()
					String lSalesforceVerifyDataTransactionSyncedObjGenderMainC=caseOutput.SalesforceVerifyDataTransactionSyncedObjGenderMainC.toString().trim()
					if(lSalesforceVerifyDataTransactionSyncedObjMainDriverC.length()>0){
						String lSalesforceObjectName='Account'
						Map lMapAccount=[:]
						LocalDate lLocalDateConvertAccountPersonBirthdate=IGNUemaHelper.convertDateStringtoLocalDate('dd/MM/yyyy',THAKumkaInsureCarCoreType.CURRENT_QUOTATION_ACCOUNT_PERSONAL_BIRTHDATE)
						String lAccountPersonBirthdate=IGNUemaHelper.convertLocalDateToString('yyyy-MM-dd',lLocalDateConvertAccountPersonBirthdate)
						lMapAccount.put('PersonBirthdate',lAccountPersonBirthdate)
						lMapAccount.put('Contact_Individual_Gender__c',lSalesforceVerifyDataTransactionSyncedObjGenderMainC)
						Map lMapUpdateAccountObjectInSF=IGNSalesforceRestAPIHelper.mapUpdateSalesforceObjectByQueryParamList(lSalesforceObjectName,lSalesforceVerifyDataTransactionSyncedObjMainDriverC,lMapAccount)
						if(!lMapUpdateAccountObjectInSF.Result){
							lIsActualResult=lMapUpdateAccountObjectInSF.Result
							lActualResult=IGNUemaHelper.convertBooleanToString(lIsActualResult)
							caseOutput.ResultMessage='Cannot update account data in SF || All data are same'
						}
					}
					caseOutput.ActualResult=lActualResult
				}
	...
	public Map inputDetail1MotorCarA(Map mapInput,Boolean isPositiveCase){
		Map lreturn=lMotorCarQuotationDetail1Util.initDetail1Output()
	...
	public Map inputActualResult(Boolean isPositiveCase,String strHolderPhoneNo,Boolean isSkipOTP){
		...
		try{
			...
			Map lMapActualResult=this.lMotorCarQuotationDetail1Util.inputActualResult(isPositiveCase,lHolderPhoneNo,isSkipOTP)
			if(!lMapActualResult.Result){
				lActualResult=''
			}else{
				lActualResult=lMapActualResult.ActualResult
	...
	public Map inputLanguage(String strLanguage){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapLanguage=this.lMotorCarQuotationDetail1Util.inputLanguage(lLanguage)
			if(!lMapLanguage.Result){
				lLanguage=''
			}else{
				lLanguage=lMapLanguage.Language
	...
	public Map inputSubmitCallMeBack(String strSubmitCallMeBack,String strCallMeBackEmail,String strCallMeBackMobile){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapSubmitCallMeBack=this.lMotorCarQuotationDetail1Util.inputSubmitCallMeBack(lSubmitCallMeBack,lCallMeBackEmail,lCallMeBackMobile)
			if(!lMapSubmitCallMeBack.Result){
				lSubmitCallMeBack=''
				lCallMeBackEmail=''
				lCallMeBackMobile=''
	...
	public Map inputHolderEmail(String strHolderEmail){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderEmail=this.lMotorCarQuotationDetail1Util.inputHolderEmail(lHolderEmail)
			if(!lMapHolderEmail.Result){
				lHolderEmail=''
			}else{
				lHolderEmail=lMapHolderEmail.HolderEmail
	...
	public Map inputHolderNewsletter(String strHolderNewsletter){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderNewsletter=this.lMotorCarQuotationDetail1Util.inputHolderNewsletter(lHolderNewsletter)
			if(!lMapHolderNewsletter.Result){
				lHolderNewsletter=''
			}else{
				lHolderNewsletter=lMapHolderNewsletter.HolderNewsletter
	...
	public Map inputHolderPhoneNo(String strHolderPhoneNo){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderPhoneNo=this.lMotorCarQuotationDetail1Util.inputHolderPhoneNo(lHolderPhoneNo)
			if(!lMapHolderPhoneNo.Result){
				lHolderPhoneNo=''
			}else{
				lHolderPhoneNo=lMapHolderPhoneNo.HolderPhoneNo
	...
	public Map inputHolderCallMeNowToDo(String strHolderCallMeNowToDo){
		...
		if(lHolderCallMeNowToDo.length()<=0){
			lHolderCallMeNowToDo=THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_NOW
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCallMeNowToDo','')
			lreturn.put('Result',lResult)
			if(!THAKumkaInsureCarCoreType.CURRENT_POLICY_DETAIL_1_SKIP_CALL_ME_NOW){
				Map lMapHolderCallMeNowToDo=this.lMotorCarQuotationDetail1Util.inputHolderCallMeNowToDo(lHolderCallMeNowToDo)
				if(!lMapHolderCallMeNowToDo.Result){
					lHolderCallMeNowToDo=''
				}else{
					lHolderCallMeNowToDo=lMapHolderCallMeNowToDo.HolderCallMeNowToDo
	...
	public Map inputCallMeNow(String strCallMeNow){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(!THAKumkaInsureCarCoreType.CURRENT_POLICY_DETAIL_1_SKIP_CALL_ME_NOW){
				Map lMapCallMeNow=this.lMotorCarQuotationDetail1Util.inputCallMeNow(lCallMeNow)
				if(!lMapCallMeNow.Result){
					lCallMeNow=''
				}else{
					lCallMeNow=lMapCallMeNow.CallMeNow
	...
	public Map inputCallMeBackAtDay(String strCallMeBackAtDay){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(!THAKumkaInsureCarCoreType.CURRENT_POLICY_DETAIL_1_SKIP_CALL_ME_NOW){
				Map lMapCallMeBackAtDay=this.lMotorCarQuotationDetail1Util.inputCallMeBackAtDay(lCallMeBackAtDay)
				if(!lMapCallMeBackAtDay.Result){
					lCallMeBackAtDay=''
				}else{
					lCallMeBackAtDay=lMapCallMeBackAtDay.CallMeBackAtDay
	...
	public Map inputCallMeBackAtTime(String strCallMeBackAtTime){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(!THAKumkaInsureCarCoreType.CURRENT_POLICY_DETAIL_1_SKIP_CALL_ME_NOW){
				Map lMapCallMeBackAtTime=this.lMotorCarQuotationDetail1Util.inputCallMeBackAtTime(lCallMeBackAtTime)
				if(!lMapCallMeBackAtTime.Result){
					lCallMeBackAtTime=''
				}else{
					lCallMeBackAtTime=lMapCallMeBackAtTime.CallMeBackAtTime
	...
	public Map inputHolderIsPerson(String strHolderIsPerson){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderIsPerson=this.lMotorCarQuotationDetail1Util.inputHolderIsPerson(lHolderIsPerson)
			if(!lMapHolderIsPerson.Result){
				lHolderIsPerson=''
			}else{
				lHolderIsPerson=lMapHolderIsPerson.HolderIsPerson
	...
	public Map inputHolderIsMain(String strHolderIsMain){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderIsMain=this.lMotorCarQuotationDetail1Util.inputHolderIsMain(lHolderIsMain)
			if(!lMapHolderIsMain.Result){
				lHolderIsMain=''
			}else{
				lHolderIsMain=lMapHolderIsMain.HolderIsMain
	...
	public Map inputCarForCommercial(String strCarForCommercial){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapCarForCommercial=this.lMotorCarQuotationDetail1Util.inputCarForCommercial(lCarForCommercial)
			if(!lMapCarForCommercial.Result){
				lCarForCommercial=''
			}else{
				lCarForCommercial=lMapCarForCommercial.CarForCommercial
	...
	public Map inputCarPlateNumber(String strCarPlateNumber){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapCarPlateNumber=this.lMotorCarQuotationDetail1Util.inputCarPlateNumber(lCarPlateNumber)
			if(!lMapCarPlateNumber.Result){
				lCarPlateNumber=''
			}else{
				lCarPlateNumber=lMapCarPlateNumber.CarPlateNumber
	...
	public Map inputCarPlateProvince(String strCarPlateProvince){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapCarPlateProvince=this.lMotorCarQuotationDetail1Util.inputCarPlateProvince(lCarPlateProvince)
			if(!lMapCarPlateProvince.Result){
				lCarPlateProvince=''
			}else{
				lCarPlateProvince=lMapCarPlateProvince.CarPlateProvince
	...
	public Map inputHolderStatus(String strHolderStatus){
		...
		if(lHolderStatus.length()<=0){
			lHolderStatus=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderStatus','')
			lreturn.put('Result',lResult)
			Map lMapHolderStatus=this.lMotorCarQuotationDetail1Util.inputHolderStatus(lHolderStatus)
			if(!lMapHolderStatus.Result){
				lHolderStatus=''
			}else{
				lHolderStatus=lMapHolderStatus.HolderStatus
	...
	public Map inputHolderDob(String strHolderDob){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderDob=this.lMotorCarQuotationDetail1Util.inputHolderDob(lHolderDob)
			if(!lMapHolderDob.Result){
				lHolderDob=''
			}else{
				lHolderDob=lMapHolderDob.HolderDob
	...
	public Map inputHolderIsThai(String strHolderIsThai){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderIsThai=this.lMotorCarQuotationDetail1Util.inputHolderIsThai(lHolderIsThai)
			if(!lMapHolderIsThai.Result){
				lHolderIsThai=''
			}else{
				lHolderIsThai=lMapHolderIsThai.HolderIsThai
	...
	public Map inputHolderThaiId(String strHolderThaiId){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderThaiId=this.lMotorCarQuotationDetail1Util.inputHolderThaiId(lHolderThaiId)
			if(!lMapHolderThaiId.Result){
				lHolderThaiId=''
			}else{
				lHolderThaiId=lMapHolderThaiId.HolderThaiId
	...
	public Map inputHolderOccupation(String strHolderOccupation){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderOccupation=this.lMotorCarQuotationDetail1Util.inputHolderOccupation(lHolderOccupation)
			if(!lMapHolderOccupation.Result){
				lHolderOccupation=''
			}else{
				lHolderOccupation=lMapHolderOccupation.HolderOccupation
	...
	public Map inputHolderPassport(String strHolderPassport){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderPassport=this.lMotorCarQuotationDetail1Util.inputHolderPassport(lHolderPassport)
			if(!lMapHolderPassport.Result){
				lHolderPassport=''
			}else{
				lHolderPassport=lMapHolderPassport.HolderPassport
	...
	public Map inputHolderCountry(String strHolderCountry){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderCountry=this.lMotorCarQuotationDetail1Util.inputHolderCountry(lHolderCountry)
			if(!lMapHolderCountry.Result){
				lHolderCountry=''
			}else{
				lHolderCountry=lMapHolderCountry.HolderCountry
	...
	public Map inputHolderName(String strHolderName){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderName=this.lMotorCarQuotationDetail1Util.inputHolderName(lHolderName)
			if(!lMapHolderName.Result){
				lHolderName=''
			}else{
				lHolderName=lMapHolderName.HolderName
	...
	public Map inputHolderSurname(String strHolderSurname){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderSurname=this.lMotorCarQuotationDetail1Util.inputHolderSurname(lHolderSurname)
			if(!lMapHolderSurname.Result){
				lHolderSurname=''
			}else{
				lHolderSurname=lMapHolderSurname.HolderSurname
	...
	public Map inputHolderCompId(String strHolderCompId){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderCompId=this.lMotorCarQuotationDetail1Util.inputHolderCompId(lHolderCompId)
			if(!lMapHolderCompId.Result){
				lHolderCompId=''
			}else{
				lHolderCompId=lMapHolderCompId.HolderCompId
	...
	public Map inputHolderCompName(String strHolderCompName){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapHolderCompName=this.lMotorCarQuotationDetail1Util.inputHolderCompName(lHolderCompName)
			if(!lMapHolderCompName.Result){
				lHolderCompName=''
			}else{
				lHolderCompName=lMapHolderCompName.HolderCompName
	...
	public Map inputMainStatus(String strMainStatus){
		...
		if(lMainStatus.length()<=0){
			lMainStatus=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('MainStatus','')
			lreturn.put('Result',lResult)
			Map lMapMainStatus=this.lMotorCarQuotationDetail1Util.inputMainStatus(lMainStatus)
			if(!lMapMainStatus.Result){
				lMainStatus=''
			}else{
				lMainStatus=lMapMainStatus.MainStatus
	...
	public Map inputMainDob(String strMainDob){
		...
		try{
			...
			lreturn.put('MainDob','')
			lreturn.put('Result',lResult)
			Map lMapMainDob=this.lMotorCarQuotationDetail1Util.inputMainDob(lMainDob)
			if(!lMapMainDob.Result){
				lMainDob=''
			}else{
				lMainDob=lMapMainDob.MainDob
	...
	public Map inputMainIsThai(String strMainIsThai){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainIsThai=this.lMotorCarQuotationDetail1Util.inputMainIsThai(lMainIsThai)
			if(!lMapMainIsThai.Result){
				lMainIsThai=''
			}else{
				lMainIsThai=lMapMainIsThai.MainIsThai
	...
	public Map inputMainThaiId(String strMainThaiId){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainThaiId=this.lMotorCarQuotationDetail1Util.inputMainThaiId(lMainThaiId)
			if(!lMapMainThaiId.Result){
				lMainThaiId=''
			}else{
				lMainThaiId=lMapMainThaiId.MainThaiId
	...
	public Map inputMainOccupation(String strMainOccupation){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainOccupation=this.lMotorCarQuotationDetail1Util.inputMainOccupation(lMainOccupation)
			if(!lMapMainOccupation.Result){
				lMainOccupation=''
			}else{
				lMainOccupation=lMapMainOccupation.MainOccupation
	...
	public Map inputMainPassport(String strMainPassport){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainPassport=this.lMotorCarQuotationDetail1Util.inputMainPassport(lMainPassport)
			if(!lMapMainPassport.Result){
				lMainPassport=''
			}else{
				lMainPassport=lMapMainPassport.MainPassport
	...
	public Map inputMainCountry(String strMainCountry){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainCountry=this.lMotorCarQuotationDetail1Util.inputMainCountry(lMainCountry)
			if(!lMapMainCountry.Result){
				lMainCountry=''
			}else{
				lMainCountry=lMapMainCountry.MainCountry
	...
	public Map inputMainName(String strMainName){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainName=this.lMotorCarQuotationDetail1Util.inputMainName(lMainName)
			if(!lMapMainName.Result){
				lMainName=''
			}else{
				lMainName=lMapMainName.MainName
	...
	public Map inputMainSurname(String strMainSurname){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainSurname=this.lMotorCarQuotationDetail1Util.inputMainSurname(lMainSurname)
			if(!lMapMainSurname.Result){
				lMainSurname=''
			}else{
				lMainSurname=lMapMainSurname.MainSurname
	...
	public Map inputMainEmail(String strMainEmail){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainEmail=this.lMotorCarQuotationDetail1Util.inputMainEmail(lMainEmail)
			if(!lMapMainEmail.Result){
				lMainEmail=''
			}else{
				lMainEmail=lMapMainEmail.MainEmail
	...
	public Map inputMainPhoneNo(String strMainPhoneNo){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapMainPhoneNo=this.lMotorCarQuotationDetail1Util.inputMainPhoneNo(lMainPhoneNo)
			if(!lMapMainPhoneNo.Result){
				lMainPhoneNo=''
			}else{
				lMainPhoneNo=lMapMainPhoneNo.MainPhoneNo
	...
	public Map inputAdditionDrivers(String strAdditionDrivers){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapAdditionDrivers=this.lMotorCarQuotationDetail1Util.inputAdditionDrivers(lAdditionDrivers)
			if(!lMapAdditionDrivers.Result){
				lAdditionDrivers=''
			}else{
				lAdditionDrivers=lMapAdditionDrivers.AdditionDrivers
	...
	public Map inputDriversHaveLicense(String strDriversHaveLicense){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriversHaveLicense=this.lMotorCarQuotationDetail1Util.inputDriversHaveLicense(lDriversHaveLicense)
			if(!lMapDriversHaveLicense.Result){
				lDriversHaveLicense=''
			}else{
				lDriversHaveLicense=lMapDriversHaveLicense.DriversHaveLicense
	...
	public Map inputDriver1Status(String strDriver1Status){
		...
		if(lDriver1Status.length()<=0){
			lDriver1Status=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Status','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Status=this.lMotorCarQuotationDetail1Util.inputDriver1Status(lDriver1Status)
			if(!lMapDriver1Status.Result){
				lDriver1Status=''
			}else{
				lDriver1Status=lMapDriver1Status.Driver1Status
	...
	public Map inputDriver1Dob(String strDriver1Dob){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1Dob=this.lMotorCarQuotationDetail1Util.inputDriver1Dob(lDriver1Dob)
			if(!lMapDriver1Dob.Result){
				lDriver1Dob=''
			}else{
				lDriver1Dob=lMapDriver1Dob.Driver1Dob
	...
	public Map inputDriver1IsThai(String strDriver1IsThai){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1IsThai=this.lMotorCarQuotationDetail1Util.inputDriver1IsThai(lDriver1IsThai)
			if(!lMapDriver1IsThai.Result){
				lDriver1IsThai=''
			}else{
				lDriver1IsThai=lMapDriver1IsThai.Driver1IsThai
	...
	public Map inputDriver1ThaiId(String strDriver1ThaiId){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1ThaiId=this.lMotorCarQuotationDetail1Util.inputDriver1ThaiId(lDriver1ThaiId)
			if(!lMapDriver1ThaiId.Result){
				lDriver1ThaiId=''
			}else{
				lDriver1ThaiId=lMapDriver1ThaiId.Driver1ThaiId
	...
	public Map inputDriver1Passport(String strDriver1Passport){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1Passport=this.lMotorCarQuotationDetail1Util.inputDriver1Passport(lDriver1Passport)
			if(!lMapDriver1Passport.Result){
				lDriver1Passport=''
			}else{
				lDriver1Passport=lMapDriver1Passport.Driver1Passport
	...
	public Map inputDriver1Country(String strDriver1Country){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1Country=this.lMotorCarQuotationDetail1Util.inputDriver1Country(lDriver1Country)
			if(!lMapDriver1Country.Result){
				lDriver1Country=''
			}else{
				lDriver1Country=lMapDriver1Country.Driver1Country
	...
	public Map inputDriver1Name(String strDriver1Name){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1Name=this.lMotorCarQuotationDetail1Util.inputDriver1Name(lDriver1Name)
			if(!lMapDriver1Name.Result){
				lDriver1Name=''
			}else{
				lDriver1Name=lMapDriver1Name.Driver1Name
	...
	public Map inputDriver1Surname(String strDriver1Surname){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1Surname=this.lMotorCarQuotationDetail1Util.inputDriver1Surname(lDriver1Surname)
			if(!lMapDriver1Surname.Result){
				lDriver1Surname=''
			}else{
				lDriver1Surname=lMapDriver1Surname.Driver1Surname
	...
	public Map inputDriver1YearDriving(String strDriver1YearDriving){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1YearDriving=this.lMotorCarQuotationDetail1Util.inputDriver1YearDriving(lDriver1YearDriving)
			if(!lMapDriver1YearDriving.Result){
				lDriver1YearDriving=''
			}else{
				lDriver1YearDriving=lMapDriver1YearDriving.Driver1YearDriving
	...
	public Map inputDriver1ClaimsNo(String strDriver1ClaimsNo){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1ClaimsNo=this.lMotorCarQuotationDetail1Util.inputDriver1ClaimsNo(lDriver1ClaimsNo)
			if(!lMapDriver1ClaimsNo.Result){
				lDriver1ClaimsNo=''
			}else{
				lDriver1ClaimsNo=lMapDriver1ClaimsNo.Driver1ClaimsNo
	...
	public Map inputDriver1Occupation(String strDriver1Occupation){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver1Occupation=this.lMotorCarQuotationDetail1Util.inputDriver1Occupation(lDriver1Occupation)
			if(!lMapDriver1Occupation.Result){
				lDriver1Occupation=''
			}else{
				lDriver1Occupation=lMapDriver1Occupation.Driver1Occupation
	...
	public Map inputDriver2Status(String strDriver2Status){
		...
		if(lDriver2Status.length()<=0){
			lDriver2Status=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Status','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Status=this.lMotorCarQuotationDetail1Util.inputDriver2Status(lDriver2Status)
			if(!lMapDriver2Status.Result){
				lDriver2Status=''
			}else{
				lDriver2Status=lMapDriver2Status.Driver2Status
	...
	public Map inputDriver2Dob(String strDriver2Dob){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2Dob=this.lMotorCarQuotationDetail1Util.inputDriver2Dob(lDriver2Dob)
			if(!lMapDriver2Dob.Result){
				lDriver2Dob=''
			}else{
				lDriver2Dob=lMapDriver2Dob.Driver2Dob
	...
	public Map inputDriver2IsThai(String strDriver2IsThai){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2IsThai=this.lMotorCarQuotationDetail1Util.inputDriver2IsThai(lDriver2IsThai)
			if(!lMapDriver2IsThai.Result){
				lDriver2IsThai=''
			}else{
				lDriver2IsThai=lMapDriver2IsThai.Driver2IsThai
	...
	public Map inputDriver2ThaiId(String strDriver2ThaiId){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2ThaiId=this.lMotorCarQuotationDetail1Util.inputDriver2ThaiId(lDriver2ThaiId)
			if(!lMapDriver2ThaiId.Result){
				lDriver2ThaiId=''
			}else{
				lDriver2ThaiId=lMapDriver2ThaiId.Driver2ThaiId
	...
	public Map inputDriver2Passport(String strDriver2Passport){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2Passport=this.lMotorCarQuotationDetail1Util.inputDriver2Passport(lDriver2Passport)
			if(!lMapDriver2Passport.Result){
				lDriver2Passport=''
			}else{
				lDriver2Passport=lMapDriver2Passport.Driver2Passport
	...
	public Map inputDriver2Country(String strDriver2Country){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2Country=this.lMotorCarQuotationDetail1Util.inputDriver2Country(lDriver2Country)
			if(!lMapDriver2Country.Result){
				lDriver2Country=''
			}else{
				lDriver2Country=lMapDriver2Country.Driver2Country
	...
	public Map inputDriver2Name(String strDriver2Name){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2Name=this.lMotorCarQuotationDetail1Util.inputDriver2Name(lDriver2Name)
			if(!lMapDriver2Name.Result){
				lDriver2Name=''
			}else{
				lDriver2Name=lMapDriver2Name.Driver2Name
	...
	public Map inputDriver2Surname(String strDriver2Surname){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2Surname=this.lMotorCarQuotationDetail1Util.inputDriver2Surname(lDriver2Surname)
			if(!lMapDriver2Surname.Result){
				lDriver2Surname=''
			}else{
				lDriver2Surname=lMapDriver2Surname.Driver2Surname
	...
	public Map inputDriver2YearDriving(String strDriver2YearDriving){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2YearDriving=this.lMotorCarQuotationDetail1Util.inputDriver2YearDriving(lDriver2YearDriving)
			if(!lMapDriver2YearDriving.Result){
				lDriver2YearDriving=''
			}else{
				lDriver2YearDriving=lMapDriver2YearDriving.Driver2YearDriving
	...
	public Map inputDriver2ClaimsNo(String strDriver2ClaimsNo){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2ClaimsNo=this.lMotorCarQuotationDetail1Util.inputDriver2ClaimsNo(lDriver2ClaimsNo)
			if(!lMapDriver2ClaimsNo.Result){
				lDriver2ClaimsNo=''
			}else{
				lDriver2ClaimsNo=lMapDriver2ClaimsNo.Driver2ClaimsNo
	...
	public Map inputDriver2Occupation(String strDriver2Occupation){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver2Occupation=this.lMotorCarQuotationDetail1Util.inputDriver2Occupation(lDriver2Occupation)
			if(!lMapDriver2Occupation.Result){
				lDriver2Occupation=''
			}else{
				lDriver2Occupation=lMapDriver2Occupation.Driver2Occupation
	...
	public Map inputDriver3Status(String strDriver3Status){
		...
		if(lDriver3Status.length()<=0){
			lDriver3Status=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Status','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Status=this.lMotorCarQuotationDetail1Util.inputDriver3Status(lDriver3Status)
			if(!lMapDriver3Status.Result){
				lDriver3Status=''
			}else{
				lDriver3Status=lMapDriver3Status.Driver3Status
	...
	public Map inputDriver3Dob(String strDriver3Dob){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3Dob=this.lMotorCarQuotationDetail1Util.inputDriver3Dob(lDriver3Dob)
			if(!lMapDriver3Dob.Result){
				lDriver3Dob=''
			}else{
				lDriver3Dob=lMapDriver3Dob.Driver3Dob
	...
	public Map inputDriver3IsThai(String strDriver3IsThai){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3IsThai=this.lMotorCarQuotationDetail1Util.inputDriver3IsThai(lDriver3IsThai)
			if(!lMapDriver3IsThai.Result){
				lDriver3IsThai=''
			}else{
				lDriver3IsThai=lMapDriver3IsThai.Driver3IsThai
	...
	public Map inputDriver3ThaiId(String strDriver3ThaiId){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3ThaiId=this.lMotorCarQuotationDetail1Util.inputDriver3ThaiId(lDriver3ThaiId)
			if(!lMapDriver3ThaiId.Result){
				lDriver3ThaiId=''
			}else{
				lDriver3ThaiId=lMapDriver3ThaiId.Driver3ThaiId
	...
	public Map inputDriver3Passport(String strDriver3Passport){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3Passport=this.lMotorCarQuotationDetail1Util.inputDriver3Passport(lDriver3Passport)
			if(!lMapDriver3Passport.Result){
				lDriver3Passport=''
			}else{
				lDriver3Passport=lMapDriver3Passport.Driver3Passport
	...
	public Map inputDriver3Country(String strDriver3Country){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3Country=this.lMotorCarQuotationDetail1Util.inputDriver3Country(lDriver3Country)
			if(!lMapDriver3Country.Result){
				lDriver3Country=''
			}else{
				lDriver3Country=lMapDriver3Country.Driver3Country
	...
	public Map inputDriver3Name(String strDriver3Name){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3Name=this.lMotorCarQuotationDetail1Util.inputDriver3Name(lDriver3Name)
			if(!lMapDriver3Name.Result){
				lDriver3Name=''
			}else{
				lDriver3Name=lMapDriver3Name.Driver3Name
	...
	public Map inputDriver3Surname(String strDriver3Surname){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3Surname=this.lMotorCarQuotationDetail1Util.inputDriver3Surname(lDriver3Surname)
			if(!lMapDriver3Surname.Result){
				lDriver3Surname=''
			}else{
				lDriver3Surname=lMapDriver3Surname.Driver3Surname
	...
	public Map inputDriver3YearDriving(String strDriver3YearDriving){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3YearDriving=this.lMotorCarQuotationDetail1Util.inputDriver3YearDriving(lDriver3YearDriving)
			if(!lMapDriver3YearDriving.Result){
				lDriver3YearDriving=''
			}else{
				lDriver3YearDriving=lMapDriver3YearDriving.Driver3YearDriving
	...
	public Map inputDriver3ClaimsNo(String strDriver3ClaimsNo){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3ClaimsNo=this.lMotorCarQuotationDetail1Util.inputDriver3ClaimsNo(lDriver3ClaimsNo)
			if(!lMapDriver3ClaimsNo.Result){
				lDriver3ClaimsNo=''
			}else{
				lDriver3ClaimsNo=lMapDriver3ClaimsNo.Driver3ClaimsNo
	...
	public Map inputDriver3Occupation(String strDriver3Occupation){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapDriver3Occupation=this.lMotorCarQuotationDetail1Util.inputDriver3Occupation(lDriver3Occupation)
			if(!lMapDriver3Occupation.Result){
				lDriver3Occupation=''
			}else{
				lDriver3Occupation=lMapDriver3Occupation.Driver3Occupation
	...
	public Map inputPolicyStartDate(String strPolicyStartDate,String strPolicyStartDayOffset){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapPolicyStartDate=this.lMotorCarQuotationDetail1Util.inputPolicyStartDate(lPolicyStartDate,lPolicyStartDayOffset)
			if(!lMapPolicyStartDate.Result){
				lPolicyStartDate=''
				lPolicyStartDayOffset=''
			}else{
	...
	public Map inputPolicyInsurer(String strPolicyInsurer){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapPolicyInsurer=this.lMotorCarQuotationDetail1Util.inputPolicyInsurer(lPolicyInsurer)
			if(!lMapPolicyInsurer.Result){
				lPolicyInsurer=''
			}else{
				lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapSalesforceProceedTodo=this.lMotorCarQuotationDetail1Util.inputSalesforceProceedTodo(lSalesforceProceedTodo)
			if(!lMapSalesforceProceedTodo.Result){
				lSalesforceProceedTodo=''
			}else{
				lSalesforceProceedTodo=lMapSalesforceProceedTodo.SalesforceProceedTodo
