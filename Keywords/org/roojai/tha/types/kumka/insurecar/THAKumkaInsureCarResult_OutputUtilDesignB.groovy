...
public class THAKumkaInsureCarResult_OutputUtilDesignB{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAKumkaInsureCarResult_OutputUtilDesignB(WebDriver newDriver,WebDriver newSelenium){
		super()
		...
		try{
			...
			if(lOutputNumberOfCardsNum<=0){
				...
				for(lIndexOutput=0;lIndexOutput<lOutputNumberOfCardsNum;lIndexOutput++){
					...
					lOutputItem.Output.put('DesignBCardDisplayPlanId',this.outputCardDisplayPlanId(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardDisplayPlanType',this.outputCardDisplayPlanType(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardOpenScore',this.outputCardOpenScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					...
					if(lElementCardOpenScore){
						...
						lOutputItem.Output.put('DesignBModalScorePartnernameScore',this.outputModalScorePartnernameScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScorePartnerName',this.outputModalScorePartnerName(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreSuminsured',this.outputModalScoreSuminsured(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreSuminsuredScore',this.outputModalScoreSuminsuredScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreExcess',this.outputModalScoreExcess(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreExcessScore',this.outputModalScoreExcessScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreGarage',this.outputModalScoreGarage(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreGarageScore',this.outputModalScoreGarageScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreDriver',this.outputModalScoreDriver(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreDriverScore',this.outputModalScoreDriverScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScoreProperty',this.outputModalScoreProperty(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalScorePropertyScore',this.outputModalScorePropertyScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					...
					lOutputItem.Output.put('DesignBCardPromotionText',this.outputCardPromotionText(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardInsurerName',this.outputCardInsurerName(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardPartnerName',this.outputCardPartnerName(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardPlanName',this.outputCardPlanName(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardPrice',this.outputCardPrice(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardBasicPremium',this.outputCardBasicPremium(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardDiscountAmount',this.outputCardDiscountAmount(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardExcess',this.outputCardExcess(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardSumInsure',this.outputCardSumInsure(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardProperty',this.outputCardProperty(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardIsRoadside',this.outputCardIsRoadside(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardIsOnlinePayment',this.outputCardIsOnlinePayment(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardIsCompulsoryAvailable',this.outputCardIsCompulsoryAvailable(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardIsFlood',this.outputCardIsFlood(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardGarage',this.outputCardGarage(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardDriver',this.outputCardDriver(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBCardInstalmentPrice',this.outputCardInstalmentPrice(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					lOutputItem.Output.put('DesignBOutboundButtonName',this.outputOutboundButtonName(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
					...
					if(lElementSeeMoreLink){
						...
						IGNUemaHelper.delayThreadSecond(1)
						lOutputItem.Output.put('DesignBModalDetailInsurerName',this.outputModalDetailInsurerName(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailPartnerName',this.outputModalDetailPartnerName(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailPrice',this.outputModalDetailPrice(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailBasicPremium',this.outputModalDetailBasicPremium(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailDiscountAmount',this.outputModalDetailDiscountAmount(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailSuminsure',this.outputModalDetailSuminsure(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailScore',this.outputModalDetailScore(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailPromotion',this.outputModalDetailPromotion(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailExcess',this.outputModalDetailExcess(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailGarage',this.outputModalDetailGarage(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailDriver',this.outputModalDetailDriver(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailFire',this.outputModalDetailFire(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailFlood',this.outputModalDetailFlood(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailPersonal',this.outputModalDetailPersonal(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailMedical',this.outputModalDetailMedical(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailBail',this.outputModalDetailBail(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailProperty',this.outputModalDetailProperty(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailDeath',this.outputModalDetailDeath(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
						lOutputItem.Output.put('DesignBModalDetailMaxDeath',this.outputModalDetailMaxDeath(lElementListOfCardResultList[lIndexOutput],lIndexOutput))
