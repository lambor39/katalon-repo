...
public class THAKumkaInsureCarVerifyType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/KumkaInsureCar/KumkaInsureCar_00_Verify.Input'
	public static final String INPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_InsureCar_Kumka.xlsx'
	public static final String INPUT_EXCEL_SHEET_NAME='InsureCar_Verify'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/KumkaInsureCar/KumkaInsureCar_00_Verify.Output'
	public static final String OUTPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_InsureCar_Kumka.xlsx'
	public static final String OUTPUT_EXCEL_SHEET_NAME='InsureCar_Verify'
	...
	//Constant
	public static final String DEFAULT_KUMKA_INSURE_CAR_01_INPUT=''
	public static final String DEFAULT_KUMKA_INSURE_CAR_02_RESULT=''
	public static final String DEFAULT_ACTUAL_RESULT=''
	public Map Input=[:]
	public Map Output=[:]
	public THAKumkaInsureCarVerifyType(){
		super()
		this.initInput()
		this.initOutput()
	}
	...
	public void initInput(){
		this.Input.clear()
		this.Input.put('KumkaInsureCar01Input',this.DEFAULT_KUMKA_INSURE_CAR_01_INPUT)
		this.Input.put('KumkaInsureCar02Result',this.DEFAULT_KUMKA_INSURE_CAR_02_RESULT)
		this.Input.put('ActualResult',this.DEFAULT_ACTUAL_RESULT)
	}
	public void initOutput(){
		this.Output.clear()
		this.Output.put('KumkaInsureCar01Input','')
		this.Output.put('KumkaInsureCar02Result','')
	...
	public static Boolean readInputFromDataFile(Integer caseNumber,Map caseInput){
		...
		try{
			...
			caseInput.put('KumkaInsureCar01Input',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseInput.put('KumkaInsureCar02Result',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
	...
	public static Boolean readOutputFromDataFile(Integer caseNumber,Map caseOutput){
		...
		try{
			...
			caseOutput.put('KumkaInsureCar01Input',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseOutput.put('KumkaInsureCar02Result',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
