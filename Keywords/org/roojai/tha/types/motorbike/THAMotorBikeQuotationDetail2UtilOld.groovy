...
public class THAMotorBikeQuotationDetail2UtilOld{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAMotorBikeQuotationDetail2UtilOld(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public String inputUnderFinancing(String strUnderFinancing){
		...
		try{
			String lText=''
			if(lUnderFinancing.length()<=0){
				lUnderFinancing=THAMotorBikeQuotationDetail2Type.DEFAULT_UNDER_FINANCING
			}
			Boolean lIsUnderFinancing=IGNUemaHelper.convertStringToBoolean(lUnderFinancing)
	...
	public String inputFinancialOrganisation(String strFinancialOrganisation){
		...
		try{
			String lText=''
			if(lFinancialOrganisation.length()<=0){
				lFinancialOrganisation=THAMotorBikeQuotationDetail2Type.DEFAULT_FINANCIAL_ORGANISATION
			}
	...
	public String inputWithRedPlate(String strWithRedPlate){
		...
		try{
			String lText=''
			if(lWithRedPlate.length()<=0){
				lWithRedPlate=THAMotorBikeQuotationDetail2Type.DEFAULT_WITH_RED_PLATE
			}
	...
	public String inputPrevInsuranceCovered(String strPrevInsuranceCovered){
		...
		try{
			String lText=''
			if(lPrevInsuranceCovered.length()<=0){
				lPrevInsuranceCovered=THAMotorBikeQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COVERED
			}
			Boolean lIsPrevInsuranceCovered=IGNUemaHelper.convertStringToBoolean(lPrevInsuranceCovered)
	...
	public String inputPrevInsuranceCompany(String strPrevInsuranceCompany){
		...
		try{
			String lText=''
			if(lPrevInsuranceCompany.length()<=0){
				lPrevInsuranceCompany=THAMotorBikeQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COMPANY
			}
	...
	public String inputPrevInsuranceType(String strPrevInsuranceType){
		...
		try{
			String lText=''
			if(lPrevInsuranceType.length()<=0){
				lPrevInsuranceType=THAMotorBikeQuotationDetail2Type.DEFAULT_PREV_INSURANCE_TYPE
			}
	...
	public String inputPolicyExpirationDayOffset(String strPolicyExpirationDayOffset){
		...
		if(lPolicyExpirationDayOffset.length()<=0){
			lPolicyExpirationDayOffset=THAMotorBikeQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DAY_OFFSET
		}
		try{
			String lText=''
			Integer lPolicyExpirationDayOffsetNum=IGNUemaHelper.convertStringToInteger(lPolicyExpirationDayOffset,0)
	...
	public String inputPolicyExpirationDate(String strPolicyExpirationDate,Integer numPolicyExpirationDayOffset){
		...
		try{
			String lText=''
			if(lPolicyExpirationDate.length()<=0){
				lPolicyExpirationDate=THAMotorBikeQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DATE
			}
	...
	public String inputPolicyStartDayOffset(String strPolicyStartDayOffset){
		...
		if(lPolicyStartDayOffset.length()<=0){
			lPolicyStartDayOffset=THAMotorBikeQuotationDetail2Type.DEFAULT_POLICY_START_DAY_OFFSET
		}
		try{
			String lText=''
			Integer lPolicyStartDayOffsetNum=IGNUemaHelper.convertStringToInteger(lPolicyStartDayOffset,0)
	...
	public String inputPolicyStartDate(String strPolicyStartDate,Integer numPolicyStartDayOffset){
		...
		try{
			String lText=''
			if(lPolicyStartDate.length()<=0){
				lPolicyStartDate=THAMotorBikeQuotationDetail2Type.DEFAULT_POLICY_START_DATE
			}
	...
	public String inputSendToPostalCode(String strSendToPostalCode){
		...
		try{
			String lText=''
			if(lSendToPostalCode.length()<=0){
				lSendToPostalCode=THAMotorBikeQuotationDetail2Type.DEFAULT_SEND_TO_POSTAL_CODE
			}
	...
	public String inputSendToProvince(String strSendToProvince){
		...
		try{
			String lText=''
			if(lSendToProvince.length()<=0){
				lSendToProvince=THAMotorBikeQuotationDetail2Type.DEFAULT_SEND_TO_PROVINCE
			}
	...
	public String inputSendToDistrict(String strSendToDistrict){
		...
		try{
			String lText=''
			if(lSendToDistrict.length()<=0){
				lSendToDistrict=THAMotorBikeQuotationDetail2Type.DEFAULT_SEND_TO_DISTRICT
			}
	...
	public String inputSendToSubDistrict(String strSendToSubDistrict){
		...
		try{
			String lText=''
			if(lSendToSubDistrict.length()<=0){
				lSendToSubDistrict=THAMotorBikeQuotationDetail2Type.DEFAULT_SEND_TO_SUB_DISTRICT
			}
	...
	public String inputSendToRoad(String strSendToRoad){
		...
		try{
			String lText=''
			if(lSendToRoad.length()<=0){
				lSendToRoad=THAMotorBikeQuotationDetail2Type.DEFAULT_SEND_TO_ROAD
			}
	...
	public String inputSendToBuildingName(String strSendToBuildingName){
		...
		try{
			String lText=''
			if(lSendToBuildingName.length()<=0){
				lSendToBuildingName=THAMotorBikeQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NAME
			}
	...
	public String inputSendToBuildingNumber(String strSendToBuildingNumber){
		...
		try{
			String lText=''
			if(lSendToBuildingNumber.length()<=0){
				lSendToBuildingNumber=THAMotorBikeQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NUMBER
			}
	...
	public String inputPositiveCase(String strPositiveCase){
		...
		try{
			String lText=''
			if(lPositiveCase.length()<=0){
				lPositiveCase=THAMotorBikeQuotationDetail2Type.DEFAULT_POSITIVE_CASE
			}
			Boolean lIsPositiveCase=IGNUemaHelper.convertStringToBoolean(lPositiveCase)
	...
	public String inputActualResult(Boolean isPositiveCase){
		...
		try{
			...
			if(IGNUemaHelper.selectButtonByLocator(this.driver,IGNUemaHelper.getTagDataSeleniumKey('enter-payment'))){
				lRedirected=IGNUemaHelper.checkElementPresentByLocator(this.driver,'#illness-review',5)
				if(isPositiveCase){
					lIsDone=lRedirected
				}else{
					lIsDone=!lRedirected
				...
				if(!lRedirected){
					if(IGNUemaHelper.selectButtonByLocator(this.driver,IGNUemaHelper.getTagDataSeleniumKey('nextProcess'))){
						lRedirected=IGNUemaHelper.checkElementPresentByLocator(this.driver,'#illness-review',15)
						if(isPositiveCase){
							lIsDone=lRedirected
						}else{
							lIsDone=!lRedirected
				...
				if(!lRedirected){
					lRedirected=IGNUemaHelper.checkElementPresentByLocator(this.driver,'#new-promptpay',10)
					if(isPositiveCase){
						lIsDone=lRedirected
					}else{
						lIsDone=!lRedirected
		...
		try{
			...
			if(lElementInfo){
				...
				if(lInfoText.length()>0){
					THAMotorBikeCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER=lInfoText
					lreturn=lInfoText
	...
	public Map inputAutomationDataBefore(){
		...
		try{
			...
			String lLocatorPaymentInstalmentOptionModalForm='#installment-detail-modal-readonly'
			...
			String lStrPremiumAmtYearly=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'fullPayment-totalPrice')).trim()
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THAMotorBikeQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
	...
	public Map inputSalesforceProceedVerifyBefore(Map caseOutput){
		...
		try{
			...
			switch(THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_METHOD){
				case '2':
					lAutomationYearly=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
					...
					break
				case '3':
					lAutomationPaymentFrequency=THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_QR_CODE_IS_YEARLY
					...
					if(lIsPaymentFrequency){
						...
						lAutomationPremiumNoDepositAmount=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_AMOUNT_VALUE
						...
						lAutomationPremiumNoDepositTotal=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_TOTAL_VALUE
					...
					break
				case '4':
					lAutomationPaymentFrequency=THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_TRUE_MONEY_IS_YEARLY
					lSalesforcePaymentFrequency=caseOutput.SalesforceVerifyDataOpportunityObjPaymentFrequencyC
					lIsPaymentFrequency=IGNUemaHelper.convertStringToBoolean(lAutomationPaymentFrequency)
					if(lIsPaymentFrequency){
						lAutomationYearly=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
					...
					break
				case '5':
					lAutomationPaymentFrequency=THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_RABBIT_LINE_PAY_IS_YEARLY
					lSalesforcePaymentFrequency=caseOutput.SalesforceVerifyDataOpportunityObjPaymentFrequencyC
					lIsPaymentFrequency=IGNUemaHelper.convertStringToBoolean(lAutomationPaymentFrequency)
					if(lIsPaymentFrequency){
						lAutomationYearly=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
					...
					break
				default:
					lAutomationPaymentFrequency=THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_CC_IS_YEARLY
					lSalesforcePaymentFrequency=caseOutput.SalesforceVerifyDataOpportunityObjPaymentFrequencyC
					lIsPaymentFrequency=IGNUemaHelper.convertStringToBoolean(lAutomationPaymentFrequency)
					if(lIsPaymentFrequency){
						lAutomationYearly=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
	...
	public Map inputSalesforceProceedRetrieveTodo(String strSalesforceProceedRetrieveTodo,String strAccountNameAnonymous){
		...
		if(lSalesforceProceedRetrieveTodo.length()<=0){
			lSalesforceProceedRetrieveTodo=THAMotorBikeQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
	...
	public Map inputSalesforceProceedRetrieveWebFromUrl(String strRetrievePageURL){
		...
		try{
			...
			try{
				...
				String lLocatorResultPage='#policy2'
