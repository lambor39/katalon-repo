...
public class THAMotorBikeQuotationPaymentUtilOld{
	private WebDriver driver=null
	private WebDriver selenium=null
	private lIsIBSuccessCase=false
	public THAMotorBikeQuotationPaymentUtilOld(WebDriver newDriver,WebDriver newSelenium){
		super()
					...
					case 'A':
						...
						if(lIsSalesforceProceedTodo){
							...
							if(lIsActualResult){
								...
								if(lIsSalesforceProceedRetrieveTodo){
									Map lMapSalesforceProceedRetrieveWebFromUrl=this.inputSalesforceProceedRetrieveWebFromUrl(THAMotorBikeCoreType.CURRENT_QUOTATION_RETRIEVAL_URL_PAGE_PAYMENT)
						...
						switch(lPaymentMethod){
							...
							case '3':
								...
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_QR_CODE_SUCCESS_CASE=lQrSuccessCase
								if(!lMapPaymentByQR.Result){
									return lreturn
								}
								break
							case '4':
								...
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_TRUE_MONEY_MOBILE_NO=lTrueMoneyMobileNo
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_TRUE_MONEY_EMAIL=lTrueMoneyEmail
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_TRUE_MONEY_SUCCESS_CASE=lTrueMoneySuccessCase
								if(!lMapPaymentByTrueMoney.Result){
									return lreturn
								}
								break
							case '5':
								...
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_RABBIT_LINE_PAY_MOBILE_NO=lRabbitLinePayMobileNo
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_RABBIT_LINE_PAY_EMAIL=lRabbitLinePayEmail
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_RABBIT_LINE_PAY_SUCCESS_CASE=lRabbitLinePaySuccessCase
								if(!lMapPaymentByRabbitLinePay.Result){
									return lreturn
								}
								break
							case '6':
								...
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_MOBILE_BANKING_CARD=lMobileBankingCard
								THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_MOBILE_BANKING_SUCCESS_CASE=lMobileBankingSuccessCase
								if(!lMapPaymentByMobileBanking.Result){
									return lreturn
								}
								break
	...
	public Map inputLanguageA(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THAMotorBikeQuotationPaymentType.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THAMotorBikeQuotationPaymentType.DEFAULT_LANGUAGE)
			}
	...
	public Map inputActualResultA(Boolean isPositiveCase){
		...
		try{
			...
			String lLocatorProgressDialogOld='#myPleaseWait'
			IGNUemaHelper.waitElementVisibleByLocator(this.driver,lLocatorProgressDialogOld,10)
			WebElement lElementProgressDialogOld=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorProgressDialogOld)
			String lTagProgressDialog='loading'
			String lLocatorProgressDialog=IGNUemaHelper.getTagDataSeleniumKey(lTagProgressDialog)
			if(lElementProgressDialogOld){
				lLocatorProgressDialog=lLocatorProgressDialogOld
			}
	...
	public Map inputOpportunityNumberA(){
		...
		try{
			...
			if(!lElementInfo){
				...
				lInfoText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementInfo)
				lOpportunityNumber=this.checkOpportunityNumber(lInfoText)
			...
			String lLocatorRoojaiRewardText='.rewards2words'
			...
			if(lElementRoojaiRewardText){
				...
				if(lRoojaiRewardText.length()>0){
					lOpportunityNumber=lOpportunityNumber+'\nRoojaiReward:'+lRoojaiRewardText
				}else{
					lOpportunityNumber=lOpportunityNumber+'\nRoojaiReward:No Option'
				}
			}else{
				lOpportunityNumber=lOpportunityNumber+'\nRoojaiReward:No Option'
			}
	...
	public Map inputPaymentMethodA(String strPaymentMethod){
		...
		try{
			...
			THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_METHOD=lPaymentMethod
	...
	public Map inputPaymentByQRA(String strQrIsYearly,String strQrInstalment,String strEPolicy,String strQrSuccessCase){
		...
		if(lQrIsYearly.length()<=0){
			lQrIsYearly=THAMotorBikeQuotationPaymentType.DEFAULT_QR_IS_YEARLY
		}
		String lQrInstalment=strQrInstalment.trim()
		if(lQrInstalment.length()<=0){
			lQrInstalment=THAMotorBikeQuotationPaymentType.DEFAULT_QR_INSTALMENT
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAMotorBikeQuotationPaymentType.DEFAULT_E_POLICY
		}
		String lQrSuccessCase=strQrSuccessCase.trim()
		if(lQrSuccessCase.length()<=0){
			lQrSuccessCase=THAMotorBikeQuotationPaymentType.DEFAULT_QR_SUCCESS_CASE
		}
		String lQrAmtYearly=''
		String lQrAmtDeposit=''
		String lQrAmtMonthly=''
		...
		try{
			...
			if(lIsQrIsYearly){
				...
				switch(lQrInstalmentNum){
					case 2:
						...
						lQrAmtNoDepositAmount=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-instalment')).trim()
						lQrAmtNoDepositTotal=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-totalPrice'))
						break
					case 3:
			...
			THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_QR_CODE_IS_YEARLY=lQrIsYearly
			if(lResult){
	...
	public Map inputPaymentByIBA(String strIbBank,String strEPolicy,String strAutoRenew,String strIbSuccessCase){
		...
		if(lAutoRenew.length()<=0){
			lAutoRenew=THAMotorBikeQuotationPaymentType.DEFAULT_AUTO_RENEW
		}
		String lIbSuccessCase=strIbSuccessCase.trim()
		if(lIbSuccessCase.length()<=0){
			lIbSuccessCase=THAMotorBikeQuotationPaymentType.DEFAULT_IB_SUCCESS_CASE
		}
		String lIbAmtYearly=''
		try{
			Boolean lResult=false
			...
			if(!lIbBankItem){
				lIbBankItem=lIbBankList.get(THAMotorBikeQuotationPaymentType.DEFAULT_IB_BANK)
			}
			lIbBank=''
			...
			this.inputAutomationDataBefore()
	...
	public Map inputPaymentByCCA(String strCcIsYearly,String strCcInstalment,String strCcNumber,String strCcName,String strCcExpiryMonth,String strCcExpiryYear,String strCcCvv,String strCcBank,String strEPolicy,String strAutoRenew,String strCcSuccessCase){
		...
		if(lCcIsYearly.length()<=0){
			lCcIsYearly=THAMotorBikeQuotationPaymentType.DEFAULT_CC_IS_YEARLY
		}
		String lCcInstalment=strCcInstalment.trim()
		if(lCcInstalment.length()<=0){
			lCcInstalment=THAMotorBikeQuotationPaymentType.DEFAULT_CC_INSTALMENT
		}
		String lCcNumber=strCcNumber.trim()
		if(lCcNumber.length()<=0){
			lCcNumber=THAMotorBikeQuotationPaymentType.DEFAULT_CC_NUMBER
		}
		String lCcName=strCcName.trim()
		if(lCcName.length()<=0){
			lCcName=THAMotorBikeQuotationPaymentType.DEFAULT_CC_NAME
		}
		String lCcExpiryMonth=strCcExpiryMonth.trim()
		if(lCcExpiryMonth.length()<=0){
			lCcExpiryMonth=THAMotorBikeQuotationPaymentType.DEFAULT_CC_EXPIRY_MONTH
		}
		String lCcExpiryYear=strCcExpiryYear.trim()
		if(lCcExpiryYear.length()<=0){
			lCcExpiryYear=THAMotorBikeQuotationPaymentType.DEFAULT_CC_EXPIRY_YEAR
		}
		String lCcCvv=strCcCvv.trim()
		if(lCcCvv.length()<=0){
			lCcCvv=THAMotorBikeQuotationPaymentType.DEFAULT_CC_CVV
		}
		String lCcBank=strCcBank.trim()
		if(lCcBank.length()<=0){
			lCcBank=THAMotorBikeQuotationPaymentType.DEFAULT_CC_BANK
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAMotorBikeQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lCcSuccessCase.length()<=0){
			lCcSuccessCase=THAMotorBikeQuotationPaymentType.DEFAULT_CC_SUCCESS_CASE
		}
		String lCcAmtYearly=''
		String lCcAmtDeposit=''
		String lCcAmtMonthly=''
		...
		try{
			...
			if(lIsCcIsYearly){
				...
				switch(lCcInstalmentNum){
					case 2:
						...
						lCcAmtNoDepositAmount=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-instalment')).trim()
						lCcAmtNoDepositTotal=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-totalPrice'))
						break
					case 3:
						...
						lCcAmtQuarterlyAmount=IGNUemaHelper.getChildTextByWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-instalment')).trim()
						lCcAmtQuarterlyTotal=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-totalPrice'))
						break
					default:
			...
			THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_CC_IS_YEARLY=lCcIsYearly
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputPaymentByTrueMoneyA(String strTrueMoneyIsYearly,String strTrueMoneyInstalment,String strTrueMoneyMobileNo,String strTrueMoneyEmail,String strEPolicy,String strAutoRenew,String strTrueMoneySuccessCase){
		...
		if(lTrueMoneyIsYearly.length()<=0){
			lTrueMoneyIsYearly=THAMotorBikeQuotationPaymentType.DEFAULT_TRUE_MONEY_IS_YEARLY
		}
		String lTrueMoneyInstalment=strTrueMoneyInstalment.trim()
		if(lTrueMoneyInstalment.length()<=0){
			lTrueMoneyInstalment=THAMotorBikeQuotationPaymentType.DEFAULT_TRUE_MONEY_INSTALMENT
		}
		String lTrueMoneyMobileNo=strTrueMoneyMobileNo.trim()
		if(lTrueMoneyMobileNo.length()<=0){
			lTrueMoneyMobileNo=THAMotorBikeQuotationPaymentType.DEFAULT_TRUE_MONEY_MOBILE_NO
		}
		String lTrueMoneyEmail=strTrueMoneyEmail.trim()
		if(lTrueMoneyEmail.length()<=0){
			lTrueMoneyEmail=THAMotorBikeQuotationPaymentType.DEFAULT_TRUE_MONEY_EMAIL
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAMotorBikeQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lTrueMoneySuccessCase.length()<=0){
			lTrueMoneySuccessCase=THAMotorBikeQuotationPaymentType.DEFAULT_TRUE_MONEY_SUCCESS_CASE
		}
		String lTrueMoneyAmtYearly=''
		String lTrueMoneyAmtDeposit=''
		String lTrueMoneyAmtMonthly=''
		...
		try{
			...
			if(lIsTrueMoneyIsYearly){
				...
				switch(lTrueMoneyInstalmentNum){
					case 2:
						...
						lTrueMoneyAmtNoDepositAmount=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-instalment')).trim()
						lTrueMoneyAmtNoDepositTotal=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-totalPrice'))
						break
					case 3:
			...
			THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_TRUE_MONEY_IS_YEARLY=lTrueMoneyIsYearly
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputPaymentByRabbitLinePayA(String strRabbitLinePayIsYearly,String strRabbitLinePayInstalment,String strRabbitLinePayMobileNo,String strRabbitLinePayEmail,String strEPolicy,String strAutoRenew,String strRabbitLinePaySuccessCase){
		...
		if(lRabbitLinePayIsYearly.length()<=0){
			lRabbitLinePayIsYearly=THAMotorBikeQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_IS_YEARLY
		}
		String lRabbitLinePayInstalment=strRabbitLinePayInstalment.trim()
		if(lRabbitLinePayInstalment.length()<=0){
			lRabbitLinePayInstalment=THAMotorBikeQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_INSTALMENT
		}
		String lRabbitLinePayMobileNo=strRabbitLinePayMobileNo.trim()
		if(lRabbitLinePayMobileNo.length()<=0){
			lRabbitLinePayMobileNo=THAMotorBikeQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_MOBILE_NO
		}
		String lRabbitLinePayEmail=strRabbitLinePayEmail.trim()
		if(lRabbitLinePayEmail.length()<=0){
			lRabbitLinePayEmail=THAMotorBikeQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_EMAIL
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAMotorBikeQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lRabbitLinePaySuccessCase.length()<=0){
			lRabbitLinePaySuccessCase=THAMotorBikeQuotationPaymentType.DEFAULT_RABBIT_LINE_PAY_SUCCESS_CASE
		}
		String lRabbitLinePayAmtYearly=''
		String lRabbitLinePayAmtDeposit=''
		String lRabbitLinePayAmtMonthly=''
		...
		try{
			...
			if(lIsRabbitLinePayIsYearly){
				...
				switch(lRabbitLinePayInstalmentNum){
					case 2:
						...
						lRabbitLinePayAmtNoDepositAmount=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-instalment')).trim()
						lRabbitLinePayAmtNoDepositTotal=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-totalPrice'))
						break
					case 3:
			...
			THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_RABBIT_LINE_PAY_IS_YEARLY=lRabbitLinePayIsYearly
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputPaymentByMobileBankingA(String strMobileBankingIsYearly,String strMobileBankingInstalment,String strMobileBankingCard,String strEPolicy,String strAutoRenew,String strMobileBankingSuccessCase){
		...
		if(lMobileBankingIsYearly.length()<=0){
			lMobileBankingIsYearly=THAMotorBikeQuotationPaymentType.DEFAULT_MOBILE_BANKING_IS_YEARLY
		}
		String lMobileBankingInstalment=strMobileBankingInstalment.trim()
		if(lMobileBankingInstalment.length()<=0){
			lMobileBankingInstalment=THAMotorBikeQuotationPaymentType.DEFAULT_MOBILE_BANKING_INSTALMENT
		}
		String lMobileBankingCard=strMobileBankingCard.trim()
		if(lMobileBankingCard.length()<=0){
			lMobileBankingCard=THAMotorBikeQuotationPaymentType.DEFAULT_MOBILE_BANKING_CARD
		}
		String lEPolicy=strEPolicy.trim()
		if(lEPolicy.length()<=0){
			lEPolicy=THAMotorBikeQuotationPaymentType.DEFAULT_E_POLICY
		...
		if(lMobileBankingSuccessCase.length()<=0){
			lMobileBankingSuccessCase=THAMotorBikeQuotationPaymentType.DEFAULT_MOBILE_BANKING_SUCCESS_CASE
		}
		String lMobileBankingAmtYearly=''
		String lMobileBankingAmtDeposit=''
		String lMobileBankingAmtMonthly=''
		...
		try{
			...
			if(!lMobileBankingCardItem){
				lMobileBankingCardItem=lMobileBankingCardList.get(THAMotorBikeQuotationPaymentType.DEFAULT_MOBILE_BANKING_CARD)
			}
			String lTagPaymentMethodModalForm=''
			String lLocatorPaymentMethodModalForm='#method-detail-modal'
			WebElement lElementPaymentMethodModalForm=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorPaymentMethodModalForm)
			...
			if(lIsMobileBankingIsYearly){
				...
				switch(lMobileBankingInstalmentNum){
					case 2:
						...
						lMobileBankingAmtNoDepositAmount=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-instalment')).trim()
						lMobileBankingAmtNoDepositTotal=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-totalPrice'))
						break
					case 3:
			...
			THAMotorBikeCoreType.CURRENT_QUOTATION_PREMIUM_MOBILE_BANKING_IS_YEARLY=lMobileBankingIsYearly
			Boolean lSetBrowserWindowModeSize=IGNUemaHelper.setBrowserWindowModeSize(this.driver,false,576,1024)
			/*************************************************************************************************************************************************/
			if(lResult){
	...
	public Map inputAutomationDataBefore(){
		...
		try{
			...
			String lStrPremiumAmtNoDepositAmount=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-instalment')).trim()
			String lStrPremiumAmtNoDepositTotal=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,'quarterly-totalPrice')).trim()
			...
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_OPPORTUNITY_NUMBER_VALUE=lOpportunityNumber
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE=lStrPremiumAmtYearly
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_DEPOSIT_VALUE=lStrPremiumAmtDeposit
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_MONTHLY_VALUE=lStrPremiumAmtMonthly
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_INSTALMENT_VALUE=lStrPremiumAmtInstalment
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_AMOUNT_VALUE=lStrPremiumAmtNoDepositAmount
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_TOTAL_VALUE=lStrPremiumAmtNoDepositTotal
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_AMOUNT_VALUE=lStrPremiumAmtQuarterlyAmount
			THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_TOTAL_VALUE=lStrPremiumAmtQuarterlyTotal
			lResult=lOpportunityNumber.length()>0
			if(lResult){
				lreturn.put('Result',lResult)
			}
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THAMotorBikeQuotationPaymentType.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
	...
	public Map inputSalesforceProceedVerifyBefore(Map caseOutput){
		...
		try{
			...
			lreturn.put('Result','')
			String lText=''
			String lAutomationOpportunityNumber=THAMotorBikeCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER
			...
			switch(THAMotorBikeCoreType.CURRENT_QUOTATION_PAYMENT_METHOD){
				case '2':
	...
	public Map inputSalesforceProceedVerifyAfter(Map caseOutput){
		...
		try{
			...
			lreturn.put('Result','')
			String lText=''
			String lAutomationOpportunityNumber=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_OPPORTUNITY_NUMBER_VALUE
			...
			String lAutomationYearly=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE
			...
			String lAutomationPremiumNoDepositAmount=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_AMOUNT_VALUE
			...
			String lAutomationPremiumNoDepositTotal=THAMotorBikeCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NO_DEPOSIT_TOTAL_VALUE
	...
	public Map inputSalesforceProceedRetrieveTodo(String strSalesforceProceedRetrieveTodo,String strAccountNameAnonymous){
		...
		if(lSalesforceProceedRetrieveTodo.length()<=0){
			lSalesforceProceedRetrieveTodo=THAMotorBikeQuotationPaymentType.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
