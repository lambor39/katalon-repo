...
public class THAMotorCarQuotationDetail1Util{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAMotorCarQuotationDetail1Util(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Boolean inputDetail1(Map caseInput,Map caseOutput){
		...
		try{
			...
			THAMotorCarCoreType.CURRENT_SKIP_PAGE_DETAIL2=lMapExpectedSkipDetail2.IsCurrentSkipPageDetail2
	...
	public Map initDetail1Input(){
		...
		try{
			...
			lreturn.put('Detail2UnderFinancing','')
			lreturn.put('Detail2FinancialOrganisation','')
			lreturn.put('Detail2WithRedPlate','')
			lreturn.put('Detail2ChassisNumber','')
			lreturn.put('Detail2PrevInsuranceCovered','')
			lreturn.put('Detail2PrevInsuranceCompany','')
			lreturn.put('Detail2PrevInsuranceType','')
			lreturn.put('Detail2PolicyExpirationDayOffset','')
			lreturn.put('Detail2PolicyExpirationDate','')
			lreturn.put('Detail2PolicyStartDayOffset','')
			lreturn.put('Detail2PolicyStartDate','')
			lreturn.put('Detail2SendToPostalCode','')
			lreturn.put('Detail2SendToProvince','')
			lreturn.put('Detail2SendToDistrict','')
			lreturn.put('Detail2SendToSubDistrict','')
			lreturn.put('Detail2SendToRoad','')
			lreturn.put('Detail2SendToBuildingName','')
			lreturn.put('Detail2SendToBuildingNumber','')
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THAMotorCarQuotationDetail1Type.DEFAULT_POSITIVE_CASE
		}
		try{
	...
	public Map inputLanguageA(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THAMotorCarQuotationDetail1Type.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THAMotorCarQuotationDetail1Type.DEFAULT_LANGUAGE)
			}
	...
	public Map inputSubmitCallMeBackA(String strSubmitCallMeBack,String strCallMeBackEmail,String strCallMeBackMobile){
		...
		if(lSubmitCallMeBack.length()<=0){
			lSubmitCallMeBack=THAMotorCarQuotationDetail1Type.DEFAULT_SUBMIT_CALL_ME_BACK
		}
		String lCallMeBackEmail=strCallMeBackEmail.trim()
		if(lCallMeBackEmail.length()<=0){
			lCallMeBackEmail=THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_EMAIL
		}
		String lCallMeBackMobile=strCallMeBackMobile.trim()
		if(lCallMeBackMobile.length()<=0){
			lCallMeBackMobile=THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_MOBILE
		}
		try{
			Boolean lResult=false
			lreturn.put('SubmitCallMeBack','')
	...
	public Map inputHolderEmailA(String strHolderEmail){
		...
		if(lHolderEmail.length()<=0){
			lHolderEmail=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_EMAIL
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderEmail','')
	...
	public Map inputHolderNewsletterA(String strHolderNewsletter){
		...
		if(lHolderNewsletter.length()<=0){
			lHolderNewsletter=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_NEWSLETTER
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderNewsletter','')
			...
			String lTagButton='inculde4pro2button-userAcceptConsent'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			WebElement lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagButton)
			String lStageStr=''
			Boolean lStageBool=false
			if(!lElementButton){
				lTagButton='selectedPDPAConsent-label'
				lElementButton=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagButton)
			}
			if(!lElementButton){
	...
	public Map inputHolderNewsletterB(String strHolderNewsletter){
		...
		try{
			...
			Boolean lStageBool=false
			if(!lElementButton){
				lLocatorButton='#inculde4pro2button'
				lElementButton=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorButton)
			}
			if(!lElementButton){
				lHolderNewsletter='No Option'
			}else{
	...
	public Map inputHolderPhoneNoA(String strHolderPhoneNo){
		...
		String lHolderPhoneNo=strHolderPhoneNo.trim()
		if(lHolderPhoneNo.length()<=0){
			lHolderPhoneNo=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_PHONE_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderPhoneNo','')
	...
	public Map inputHolderCallMeNowToDoA(String strHolderCallMeNowToDo){
		...
		if(lHolderCallMeNowToDo.length()<=0){
			lHolderCallMeNowToDo=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW_TO_DO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCallMeNowToDo','')
	...
	public Map inputCallMeNowA(String strCallMeNow){
		...
		if(lCallMeNow.length()<=0){
			lCallMeNow=THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_NOW
		}
		...
		try{
			...
			lCallMeNow=''
			if(!lCallMeNowItem){
				lCallMeNowItem=lCallMeNowList.get(THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_NOW)
			}
	...
	public Map inputCallMeBackAtDayA(String strCallMeBackAtDay){
		...
		if(lCallMeBackAtDay.length()<=0){
			lCallMeBackAtDay=THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_DAY
		}
		...
		try{
			...
			if(!lCallMeBackAtDayItem){
				lCallMeBackAtDayItem=lCallMeBackAtDayList.get(THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_DAY)
			}
	...
	public Map inputCallMeBackAtTimeA(String strCallMeBackAtTime){
		...
		if(lCallMeBackAtTime.length()<=0){
			lCallMeBackAtTime=THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_TIME
		}
		...
		try{
			...
			if(!lCallMeBackAtTimeItem){
				lCallMeBackAtTimeItem=lCallMeBackAtTimeList.get(THAMotorCarQuotationDetail1Type.DEFAULT_CALL_ME_BACK_AT_TIME)
			}
	...
	public Map inputHolderIsPersonA(String strHolderIsPerson){
		...
		if(lHolderIsPerson.length()<=0){
			lHolderIsPerson=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_IS_PERSON
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsPerson','')
	...
	public Map inputHolderIsMainA(String strHolderIsMain){
		...
		if(lHolderIsMain.length()<=0){
			lHolderIsMain=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_IS_MAIN
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsMain','')
	...
	public Map inputCarForCommercialA(String strCarForCommercial){
		...
		if(lCarForCommercial.length()<=0){
			lCarForCommercial=THAMotorCarQuotationDetail1Type.DEFAULT_CAR_FOR_COMMERCIAL
		}
		try{
			Boolean lResult=false
			lreturn.put('CarForCommercial','')
	...
	public Map inputCarPlateNumberA(String strCarPlateNumber){
		...
		if(lCarPlateNumber.length()<=0){
			lCarPlateNumber=THAMotorCarQuotationDetail1Type.DEFAULT_CAR_PLATE_NUMBER
		}
		if(lCarPlateNumber.length()<=0){
	...
	public Map inputCarPlateProvinceA(String strCarPlateProvince){
		...
		if(lCarPlateProvince.length()<=0){
			lCarPlateProvince=THAMotorCarQuotationDetail1Type.DEFAULT_CAR_PLATE_PROVINCE
		}
		try{
			Boolean lResult=false
			lreturn.put('CarPlateProvince','')
			...
			IGNUemaHelper.delayThreadSecond(1)
			Boolean lIsSelected=IGNUemaHelper.selectButtonByLocator(this.driver,IGNUemaHelper.getTagDataSeleniumKey('nextProcess'))
			if(!lIsSelected){
	...
	public Map inputHolderStatusA(String strHolderStatus){
		...
		try{
			...
			if(!lHolderStatusItem){
				lHolderStatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('HolderStatus','')
			lreturn.put('Result',lResult)
	...
	public Map inputHolderDobA(String strHolderDob){
		...
		if(lHolderDob.length()<=0){
			lHolderDob=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderDob','')
	...
	public Map inputHolderIsThaiA(String strHolderIsThai){
		...
		if(lHolderIsThai.length()<=0){
			lHolderIsThai=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsThai','')
	...
	public Map inputHolderThaiIdA(String strHolderThaiId){
		...
		if(lHolderThaiId.length()<=0){
			lHolderThaiId=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderThaiId','')
	...
	public Map inputHolderOccupationA(String strHolderOccupation){
		...
		if(lHolderOccupation.length()<=0){
			lHolderOccupation=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderOccupation','')
	...
	public Map inputHolderPassportA(String strHolderPassport){
		...
		if(lHolderPassport.length()<=0){
			lHolderPassport=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderPassport','')
	...
	public Map inputHolderCountryA(String strHolderCountry){
		...
		if(lHolderCountry.length()<=0){
			lHolderCountry=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCountry','')
	...
	public Map inputHolderNameA(String strHolderName){
		...
		if(lHolderName.length()<=0){
			lHolderName=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderName','')
	...
	public Map inputHolderSurnameA(String strHolderSurname){
		...
		if(lHolderSurname.length()<=0){
			lHolderSurname=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderSurname','')
	...
	public Map inputHolderCompIdA(String strHolderCompId){
		...
		if(lHolderCompId.length()<=0){
			lHolderCompId=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_COMP_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCompId','')
	...
	public Map inputHolderCompNameA(String strHolderCompName){
		...
		if(lHolderCompName.length()<=0){
			lHolderCompName=THAMotorCarQuotationDetail1Type.DEFAULT_HOLDER_COMP_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCompName','')
	...
	public Map inputMainStatusA(String strMainStatus){
		...
		try{
			...
			if(!lMainStatusItem){
				lMainStatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('MainStatus','')
			lreturn.put('Result',lResult)
	...
	public Map inputMainDobA(String strMainDob){
		...
		if(lMainDob.length()<=0){
			lMainDob=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('MainDob','')
	...
	public Map inputMainIsThaiA(String strMainIsThai){
		...
		if(lMainIsThai.length()<=0){
			lMainIsThai=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('MainIsThai','')
	...
	public Map inputMainThaiIdA(String strMainThaiId){
		...
		if(lMainThaiId.length()<=0){
			lMainThaiId=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('MainThaiId','')
	...
	public Map inputMainOccupationA(String strMainOccupation){
		...
		if(lMainOccupation.length()<=0){
			lMainOccupation=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('MainOccupation','')
	...
	public Map inputMainPassportA(String strMainPassport){
		...
		if(lMainPassport.length()<=0){
			lMainPassport=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('MainPassport','')
	...
	public Map inputMainCountryA(String strMainCountry){
		...
		if(lMainCountry.length()<=0){
			lMainCountry=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('MainCountry','')
	...
	public Map inputMainNameA(String strMainName){
		...
		if(lMainName.length()<=0){
			lMainName=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('MainName','')
	...
	public Map inputMainSurnameA(String strMainSurname){
		...
		if(lMainSurname.length()<=0){
			lMainSurname=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('MainSurname','')
	...
	public Map inputMainEmailA(String strMainEmail){
		...
		if(lMainEmail.length()<=0){
			lMainEmail=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_EMAIL
		}
		try{
			Boolean lResult=false
			lreturn.put('MainEmail','')
	...
	public Map inputMainPhoneNoA(String strMainPhoneNo){
		...
		if(lMainPhoneNo.length()<=0){
			lMainPhoneNo=THAMotorCarQuotationDetail1Type.DEFAULT_MAIN_PHONE_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('MainPhoneNo','')
	...
	public Map inputAdditionDriversA(String strAdditionDrivers){
		...
		if(lAdditionDrivers.length()<=0){
			lAdditionDrivers=THAMotorCarQuotationDetail1Type.DEFAULT_ADDITION_DRIVERS
		}
		try{
			Boolean lResult=false
			lreturn.put('AdditionDrivers','')
			...
			if(!lButtonYesValid){
				lTagButtonYes='add-driver-modal'
				lLocatorButtonYes=IGNUemaHelper.getTagDataSeleniumKey(lTagButtonYes)
				lButtonYesVisible=IGNUemaHelper.checkElementVisibleByLocatorKs(this.driver,lLocatorButtonYes)
				lButtonYesEnable=IGNUemaHelper.checkElementEnableByLocatorKs(this.driver,lLocatorButtonYes)
				lButtonYesValid=lButtonYesVisible&&lButtonYesEnable
			}
			if(lNumAdditionDrivers>0){
				if(!lButtonYesValid){
					lNumAdditionDrivers=0
			...
			if(lNumAdditionDrivers<=0){
				Boolean lIsSelected=IGNUemaHelper.selectButtonByLocator(this.driver,lLocatorButtonNo)
				if(!lIsSelected){
					lTagButtonNo='additional-driver-skip'
					lLocatorButtonNo=IGNUemaHelper.getTagDataSeleniumKey(lTagButtonNo)
					lIsSelected=IGNUemaHelper.selectButtonByLocator(this.driver,lLocatorButtonNo)
				}
			}
	...
	public Map inputDriversHaveLicenseA(String strDriversHaveLicense){
		...
		if(lDriversHaveLicense.length()<=0){
			lDriversHaveLicense=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVERS_HAVE_LICENSE
		}
		try{
			Boolean lResult=false
			lreturn.put('DriversHaveLicense','')
	...
	public Map inputDriver1StatusA(String strDriver1Status){
		...
		try{
			...
			if(!lDriver1StatusItem){
				lDriver1StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('Driver1Status','')
			lreturn.put('Result',lResult)
	...
	public Map inputDriver1DobA(String strDriver1Dob){
		...
		if(lDriver1Dob.length()<=0){
			lDriver1Dob=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Dob','')
	...
	public Map inputDriver1IsThaiA(String strDriver1IsThai){
		...
		if(lDriver1IsThai.length()<=0){
			lDriver1IsThai=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1IsThai','')
	...
	public Map inputDriver1ThaiIdA(String strDriver1ThaiId){
		...
		if(lDriver1ThaiId.length()<=0){
			lDriver1ThaiId=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1ThaiId','')
	...
	public Map inputDriver1PassportA(String strDriver1Passport){
		...
		if(lDriver1Passport.length()<=0){
			lDriver1Passport=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Passport','')
	...
	public Map inputDriver1CountryA(String strDriver1Country){
		...
		if(lDriver1Country.length()<=0){
			lDriver1Country=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Country','')
	...
	public Map inputDriver1NameA(String strDriver1Name){
		...
		if(lDriver1Name.length()<=0){
			lDriver1Name=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Name','')
	...
	public Map inputDriver1SurnameA(String strDriver1Surname){
		...
		if(lDriver1Surname.length()<=0){
			lDriver1Surname=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Surname','')
	...
	public Map inputDriver1YearDrivingA(String strDriver1YearDriving){
		...
		if(lDriver1YearDriving.length()<=0){
			lDriver1YearDriving=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_YEAR_DRIVING
		}
	...
	public Map inputDriver1ClaimsNoA(String strDriver1ClaimsNo){
		...
		if(lDriver1ClaimsNo.length()<=0){
			lDriver1ClaimsNo=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_CLAIMS_NO
		}
	...
	public Map inputDriver1OccupationA(String strDriver1Occupation){
		...
		if(lDriver1Occupation.length()<=0){
			lDriver1Occupation=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER1_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Occupation','')
	...
	public Map inputDriver2StatusA(String strDriver2Status){
		...
		try{
			...
			if(!lDriver2StatusItem){
				lDriver2StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('Driver2Status','')
			lreturn.put('Result',lResult)
	...
	public Map inputDriver2DobA(String strDriver2Dob){
		...
		if(lDriver2Dob.length()<=0){
			lDriver2Dob=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Dob','')
	...
	public Map inputDriver2IsThaiA(String strDriver2IsThai){
		...
		if(lDriver2IsThai.length()<=0){
			lDriver2IsThai=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2IsThai','')
	...
	public Map inputDriver2ThaiIdA(String strDriver2ThaiId){
		...
		if(lDriver2ThaiId.length()<=0){
			lDriver2ThaiId=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2ThaiId','')
	...
	public Map inputDriver2PassportA(String strDriver2Passport){
		...
		if(lDriver2Passport.length()<=0){
			lDriver2Passport=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Passport','')
	...
	public Map inputDriver2CountryA(String strDriver2Country){
		...
		if(lDriver2Country.length()<=0){
			lDriver2Country=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Country','')
	...
	public Map inputDriver2NameA(String strDriver2Name){
		...
		if(lDriver2Name.length()<=0){
			lDriver2Name=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Name','')
	...
	public Map inputDriver2SurnameA(String strDriver2Surname){
		...
		if(lDriver2Surname.length()<=0){
			lDriver2Surname=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Surname','')
	...
	public Map inputDriver2YearDrivingA(String strDriver2YearDriving){
		...
		if(lDriver2YearDriving.length()<=0){
			lDriver2YearDriving=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_YEAR_DRIVING
		}
	...
	public Map inputDriver2ClaimsNoA(String strDriver2ClaimsNo){
		...
		if(lDriver2ClaimsNo.length()<=0){
			lDriver2ClaimsNo=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_CLAIMS_NO
		}
	...
	public Map inputDriver2OccupationA(String strDriver2Occupation){
		...
		if(lDriver2Occupation.length()<=0){
			lDriver2Occupation=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER2_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Occupation','')
	...
	public Map inputDriver3StatusA(String strDriver3Status){
		...
		try{
			...
			if(!lDriver3StatusItem){
				lDriver3StatusItem=this.DEFAULT_LIST_SEX_MARITAL_STATUS.get(THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_STATUS.toUpperCase())
			}
			Boolean lResult=false
			lreturn.put('Driver3Status','')
			lreturn.put('Result',lResult)
	...
	public Map inputDriver3DobA(String strDriver3Dob){
		...
		if(lDriver3Dob.length()<=0){
			lDriver3Dob=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Dob','')
	...
	public Map inputDriver3IsThaiA(String strDriver3IsThai){
		...
		if(lDriver3IsThai.length()<=0){
			lDriver3IsThai=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3IsThai','')
	...
	public Map inputDriver3ThaiIdA(String strDriver3ThaiId){
		...
		if(lDriver3ThaiId.length()<=0){
			lDriver3ThaiId=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3ThaiId','')
	...
	public Map inputDriver3PassportA(String strDriver3Passport){
		...
		if(lDriver3Passport.length()<=0){
			lDriver3Passport=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Passport','')
	...
	public Map inputDriver3CountryA(String strDriver3Country){
		...
		if(lDriver3Country.length()<=0){
			lDriver3Country=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Country','')
	...
	public Map inputDriver3NameA(String strDriver3Name){
		...
		if(lDriver3Name.length()<=0){
			lDriver3Name=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Name','')
	...
	public Map inputDriver3SurnameA(String strDriver3Surname){
		...
		if(lDriver3Surname.length()<=0){
			lDriver3Surname=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Surname','')
	...
	public Map inputDriver3YearDrivingA(String strDriver3YearDriving){
		...
		if(lDriver3YearDriving.length()<=0){
			lDriver3YearDriving=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_YEAR_DRIVING
		}
	...
	public Map inputDriver3ClaimsNoA(String strDriver3ClaimsNo){
		...
		if(lDriver3ClaimsNo.length()<=0){
			lDriver3ClaimsNo=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_CLAIMS_NO
		}
	...
	public Map inputDriver3OccupationA(String strDriver3Occupation){
		...
		if(lDriver3Occupation.length()<=0){
			lDriver3Occupation=THAMotorCarQuotationDetail1Type.DEFAULT_DRIVER3_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Occupation','')
	...
	public Map inputPolicyStartDateA(String strPolicyStartDate,String strPolicyStartDayOffset){
		...
		if(lPolicyStartDate.length()<=0){
			lPolicyStartDate=THAMotorCarQuotationDetail1Type.DEFAULT_POLICY_START_DATE
		}
		...
		if(lPolicyStartDayOffset.length()<=0){
			lPolicyStartDayOffset=THAMotorCarQuotationDetail1Type.DEFAULT_POLICY_START_DAY_OFFSET
		}
	...
	public Map inputPolicyInsurerA(String strPolicyInsurer){
		...
		try{
			...
			this.waitUntilOpportunityNumberUpdated()
			String lOpportunityNumber=THAMotorCarCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER.trim()
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THAMotorCarQuotationDetail1Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
	...
	public Map inputExpectedSkipDetail2(String strExpectedSkipDetail2,String strDetail2ProceedTodo){
		...
		if(lExpectedSkipDetail2.length()<=0){
			lExpectedSkipDetail2=THAMotorCarQuotationDetail1Type.DEFAULT_EXPECTED_SKIP_DETAIL2
		}
		if(lDetail2ProceedTodo.length()<=0){
			lDetail2ProceedTodo=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_PROCEED_TODO
		}
		Map lExpectedSkipDetail2List=['1':'Any','2':'No','3':'Yes']
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			String lExpectedSkipDetail2Item=lExpectedSkipDetail2List.get(lExpectedSkipDetail2)
			lExpectedSkipDetail2=''
			if(!lExpectedSkipDetail2Item){
				lExpectedSkipDetail2Item=lExpectedSkipDetail2List.get(THAMotorCarQuotationDetail1Type.DEFAULT_EXPECTED_SKIP_DETAIL2)
			}
			lExpectedSkipDetail2=lExpectedSkipDetail2Item
			Boolean lIsDetail2ProceedTodo=IGNUemaHelper.convertStringToBoolean(lDetail2ProceedTodo)
			lDetail2ProceedTodo=IGNUemaHelper.convertBooleanToString(lIsDetail2ProceedTodo)
			String lTagSkippedPageDetail2='skipped_pd2'
			String lLocatorSkippedPageDetail2=IGNUemaHelper.getTagDataSeleniumKey(lTagSkippedPageDetail2)
			WebElement lElementSkippedPageDetail2=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagSkippedPageDetail2)
			String lSkippedPageDetail2Value='No'
			Boolean lIsSkippedPageDetail2=IGNUemaHelper.convertStringToBoolean(lSkippedPageDetail2Value)
			if(!lElementSkippedPageDetail2){
				lIsSkippedPageDetail2=IGNUemaHelper.convertStringToBoolean(lSkippedPageDetail2Value)
			}else{
				lSkippedPageDetail2Value=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementSkippedPageDetail2)
				lIsSkippedPageDetail2=IGNUemaHelper.convertStringToBoolean(lSkippedPageDetail2Value)
			}
			lIsCurrentSkipPageDetail2=lIsSkippedPageDetail2
			Boolean lIsPassed=true
			if(lIsSkippedPageDetail2){
				switch(lExpectedSkipDetail2){
					case 'Any':
						if(!lIsDetail2ProceedTodo){
							lIsPassed=false
						}
						break
					case 'No':
	...
	public String inputUnderFinancing(String strUnderFinancing){
		...
		try{
			String lText=''
			if(lUnderFinancing.length()<=0){
				lUnderFinancing=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_UNDER_FINANCING
			}
			Boolean lIsUnderFinancing=IGNUemaHelper.convertStringToBoolean(lUnderFinancing)
	...
	public String inputFinancialOrganisation(String strFinancialOrganisation){
		...
		try{
			String lText=''
			if(lFinancialOrganisation.length()<=0){
				lFinancialOrganisation=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_FINANCIAL_ORGANISATION
			}
	...
	public String inputSendToPostalCode(String strSendToPostalCode){
		...
		try{
			String lText=''
			if(lSendToPostalCode.length()<=0){
				lSendToPostalCode=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_SEND_TO_POSTAL_CODE
			}
	...
	public String inputSendToProvince(String strSendToProvince){
		...
		try{
			String lText=''
			if(lSendToProvince.length()<=0){
				lSendToProvince=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_SEND_TO_PROVINCE
			}
	...
	public String inputSendToDistrict(String strSendToDistrict){
		...
		try{
			String lText=''
			if(lSendToDistrict.length()<=0){
				lSendToDistrict=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_SEND_TO_DISTRICT
			}
	...
	public String inputSendToSubDistrict(String strSendToSubDistrict){
		...
		try{
			String lText=''
			if(lSendToSubDistrict.length()<=0){
				lSendToSubDistrict=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_SEND_TO_SUB_DISTRICT
			}
	...
	public String inputSendToRoad(String strSendToRoad){
		...
		try{
			String lText=''
			if(lSendToRoad.length()<=0){
				lSendToRoad=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_SEND_TO_ROAD
			}
	...
	public String inputSendToBuildingName(String strSendToBuildingName){
		...
		try{
			String lText=''
			if(lSendToBuildingName.length()<=0){
				lSendToBuildingName=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_SEND_TO_BUILDING_NAME
			}
	...
	public String inputSendToBuildingNumber(String strSendToBuildingNumber){
		...
		try{
			String lText=''
			if(lSendToBuildingNumber.length()<=0){
				lSendToBuildingNumber=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_SEND_TO_BUILDING_NUMBER
			}
	...
	public String inputPrevInsuranceCompany(String strPrevInsuranceCompany){
		...
		try{
			String lText=''
			if(lPrevInsuranceCompany.length()<=0){
				lPrevInsuranceCompany=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_PREV_INSURANCE_COMPANY
			}
	...
	public String inputPrevInsuranceType(String strPrevInsuranceType){
		...
		try{
			String lText=''
			if(lPrevInsuranceType.length()<=0){
				lPrevInsuranceType=THAMotorCarQuotationDetail1Type.DEFAULT_DETAIL2_PREV_INSURANCE_TYPE
			}
