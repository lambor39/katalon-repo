...
public class THAMotorCarQuotationInputUtilOld{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THAMotorCarQuotationInputUtilOld(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Map inputVersionReferrer(String strBaseUrl,String strVersion,String strReferrer){
		...
		if(lBaseUrl.length()<=0){
			lBaseUrl=THAMotorCarQuotationInputType.DEFAULT_BASE_URL
		}
		String lDefaultVersion=THAMotorCarQuotationInputType.DEFAULT_VERSION
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THAMotorCarQuotationInputType.DEFAULT_POSITIVE_CASE
		}
		try{
			Boolean lResult=false
	...
	public Map inputCmsLanguage(String strCmsLanguage){
		...
		if(lCmsLanguage.length()<=0){
			lCmsLanguage=THAMotorCarQuotationInputType.DEFAULT_CMS_LANGUAGE
		}
		...
		try{
			...
			if(!lCmsLanguageItem){
				lCmsLanguageItem=lCmsLanguageList.get(THAMotorCarQuotationInputType.DEFAULT_CMS_LANGUAGE)
			}
			lCmsLanguage=''
	...
	public Map inputCmsAffiliateLanguage(String strCmsAffiliateLanguage){
		...
		if(lCmsAffiliateLanguage.length()<=0){
			lCmsAffiliateLanguage=THAMotorCarQuotationInputType.DEFAULT_CMS_AFFILIATE_LANGUAGE
		}
		...
		try{
			...
			if(!lCmsAffiliateLanguageItem){
				lCmsAffiliateLanguageItem=lCmsAffiliateLanguageList.get(THAMotorCarQuotationInputType.DEFAULT_CMS_AFFILIATE_LANGUAGE)
			}
			lCmsAffiliateLanguage=''
	...
	public Map inputLanguageA(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THAMotorCarQuotationInputType.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THAMotorCarQuotationInputType.DEFAULT_LANGUAGE)
			}
	...
	public Map inputCmsCarMake(String strCmsCarMake){
		...
		if(lCmsCarMake.length()<=0){
			lCmsCarMake=THAMotorCarQuotationInputType.DEFAULT_CMS_CAR_MAKE
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarMakeA(String strCarMake){
		...
		if(lCarMake.length()<=0){
			lCarMake=THAMotorCarQuotationInputType.DEFAULT_CAR_MAKE
		}
		try{
			Boolean lResult=false
			lreturn.put('CarMake','')
	...
	public Map inputCmsCarModel(String strCmsCarModel){
		...
		if(lCmsCarModel.length()<=0){
			lCmsCarModel=THAMotorCarQuotationInputType.DEFAULT_CMS_CAR_MODEL
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarModelA(String strCarModel){
		...
		if(lCarModel.length()<=0){
			lCarModel=THAMotorCarQuotationInputType.DEFAULT_CAR_MODEL
		}
		try{
			Boolean lResult=false
			lreturn.put('CarModel','')
	...
	public Map inputCmsCarYear(String strCmsCarYear){
		...
		if(lCmsCarYear.length()<=0){
			lCmsCarYear=THAMotorCarQuotationInputType.DEFAULT_CMS_CAR_YEAR
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarYearA(String strCarYear){
		...
		if(lCarYear.length()<=0){
			lCarYear=THAMotorCarQuotationInputType.DEFAULT_CAR_YEAR
		}
		try{
			Boolean lResult=false
			lreturn.put('CarYear','')
	...
	public Map inputCmsCarSubmodel(String strCmsCarSubmodel){
		...
		if(lCmsCarSubmodel.length()<=0){
			lCmsCarSubmodel=THAMotorCarQuotationInputType.DEFAULT_CMS_CAR_SUBMODEL
		}
		try{
			Boolean lResult=false
	...
	public Map inputSubmodelA(String strSubmodel){
		...
		if(lSubmodel.length()<=0){
			lSubmodel=THAMotorCarQuotationInputType.DEFAULT_SUBMODEL
		}
		try{
			Boolean lResult=false
			lreturn.put('Submodel','')
			...
			if(lSubmodel.length()<=0){
				if(!lValid){
					...
					lSubmodel=IGNUemaHelper.selectDropdownByDataSeleniumLocatorV2(this.driver,lTagButton,lTagDropdownListHit,lSubmodel,true)
					if(lSubmodel.length()<=0){
						lSubmodel=IGNUemaHelper.selectDropdownByDataSeleniumLocatorV3(this.driver,lTagButton,lTagDropdownListAll,lSubmodel,true)
					}
				}
			}
	...
	public Map inputCmsKeepDetailA(String strCmsKeepDetail,String strCmsLanguage,String strCmsCarMake,String strCmsCarModel,String strCmsCarYear,String strCmsCarSubmodel){
		...
		if(lCmsKeepDetail.length()<=0){
			lCmsKeepDetail=THAMotorCarQuotationInputType.DEFAULT_CMS_KEEP_DETAIL
		}
	...
	public Map inputGenderMainMaritalStatusA(String strGenderMain,String strMaritalStatus){
		...
		if(lGenderMain.length()<=0){
			lGenderMain=THAMotorCarQuotationInputType.DEFAULT_GENDER_MAIN
		}
		String lMaritalStatus=strMaritalStatus.trim()
		if(lMaritalStatus.length()<=0){
			lMaritalStatus=THAMotorCarQuotationInputType.DEFAULT_MARITAL_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('GenderMain','')
	...
	public Map inputBirthDateMainA(String strBirthDateMain){
		...
		if(lBirthDateMain.length()<=0){
			lBirthDateMain=THAMotorCarQuotationInputType.DEFAULT_BIRTH_DATE_MAIN
		}
		try{
			Boolean lResult=false
			lreturn.put('BirthDateMain','')
	...
	public Map inputYearDrivingA(String strYearDriving){
		...
		if(lYearDriving.length()<=0){
			lYearDriving=THAMotorCarQuotationInputType.DEFAULT_YEAR_DRIVING
		}
	...
	public Map inputClaimsNoA(String strClaimsNo){
		...
		if(lClaimsNo.length()<=0){
			lClaimsNo=THAMotorCarQuotationInputType.DEFAULT_CLAIMS_NO
		}
	...
	public Map inputVehicleUsageA(String strVehicleUsage){
		...
		try{
			...
			if(!lVehicleUsageItem){
				lVehicleUsageItem=lVehicleUsageList.get(THAMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE.toUpperCase())
			}
	...
	public Map inputVehicleUsageForCommercialA(String strVehicleUsageForCommercial){
		...
		try{
			...
			if(!lVehicleUsageForCommercialItem){
				lVehicleUsageForCommercialItem=lVehicleUsageForCommercialList.get(THAMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE_FOR_COMMERCIAL)
			}
			String lTagButtonKey='carUsage'
	...
	public Map inputVehicleUsageDriveToWorkA(String strVehicleUsageDriveToWork){
		...
		Map lVehicleUsageDriveToWorkList=['No':'SPT','Yes':'SPTC']
		try{
			Boolean lResult=false
			lreturn.put('VehicleUsageDriveToWork','')
			lreturn.put('Result',lResult)
			...
			if(!lVehicleUsageDriveToWorkItem){
				lVehicleUsageDriveToWorkItem=lVehicleUsageDriveToWorkList.get(THAMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE_DRIVE_TO_WORK)
			}
	...
	public Map inputVehicleUsageDriveToWorkOftenA(String strVehicleUsageDriveToWorkOften){
		...
		try{
			...
			if(!lVehicleUsageDriveToWorkOftenItem){
				lVehicleUsageDriveToWorkOftenItem=lVehicleUsageDriveToWorkOftenList.get(THAMotorCarQuotationInputType.DEFAULT_VEHICLE_USAGE_DRIVE_TO_WORK_OFTEN)
			}
			lVehicleUsageDriveToWorkOften=''
			...
			String lLocatorVehicleUsageDriveToWorkOftenModalForm='#useToCommuteToWork'
			...
			if(!lIsVehicleUsageDriveToWorkOftenModalFormDisplayed){
				...
				switch(lVehicleUsageDriveToWorkOftenItemNum){
					case 2:
						lTagVehicleUsageDriveToWorkOftenButtonValue='SPTC < 3'
						break
					case 3:
						lTagVehicleUsageDriveToWorkOftenButtonValue='SPTC'
						break
					default:
	...
	public Map inputTaxiOrVehicleForHireA(String strTaxiOrVehicleForHire){
		...
		if(lTaxiOrVehicleForHire.length()<=0){
			lTaxiOrVehicleForHire=THAMotorCarQuotationInputType.DEFAULT_TAXI_OR_VEHICLE_FOR_HIRE
		}
		try{
			Boolean lResult=false
			lreturn.put('TaxiOrVehicleForHire','')
	...
	public Map inputRentalVehicleA(String strRentalVehicle){
		...
		if(lRentalVehicle.length()<=0){
			lRentalVehicle=THAMotorCarQuotationInputType.DEFAULT_RENTAL_VEHICLE
		}
		try{
			Boolean lResult=false
			lreturn.put('RentalVehicle','')
	...
	public Map inputGoodsTransportVehicleA(String strGoodsTransportVehicle){
		...
		if(lGoodsTransportVehicle.length()<=0){
			lGoodsTransportVehicle=THAMotorCarQuotationInputType.DEFAULT_GOODS_TRANSPORT_VEHICLE
		}
		try{
			Boolean lResult=false
			lreturn.put('GoodsTransportVehicle','')
	...
	public Map inputLogisticsOrCourierCompanyA(String strLogisticsOrCourierCompany){
		...
		if(lLogisticsOrCourierCompany.length()<=0){
			lLogisticsOrCourierCompany=THAMotorCarQuotationInputType.DEFAULT_LOGISTICS_OR_COURIER_COMPANY
		}
		try{
			Boolean lResult=false
			lreturn.put('LogisticsOrCourierCompany','')
	...
	public Map inputGoodsTransportRouteA(String strGoodsTransportRoute){
		...
		try{
			...
			if(!lGoodsTransportRouteItem){
				lGoodsTransportRouteItem=lGoodsTransportRouteList.get(THAMotorCarQuotationInputType.DEFAULT_GOODS_TRANSPORT_ROUTE.toUpperCase())
			}
	...
	public Map inputPostalCodeA(String strPostalCode){
		...
		if(lPostalCode.length()<=0){
			lPostalCode=THAMotorCarQuotationInputType.DEFAULT_POSTAL_CODE
		}
		try{
			Boolean lResult=false
			lreturn.put('PostalCode','')
	...
	public Map inputOdometerReading(String strOdometerReading){
		...
		try{
			...
			lreturn.put('Result',lResult)
			String lStrOdoMeterAbTestingVersion=''
			String lTagOdoMeterAbTestingVersion='ODOmeter-version'
			String lLocatorOdoMeterAbTestingVersion=IGNUemaHelper.getTagDataSeleniumKey(lTagOdoMeterAbTestingVersion)
			WebElement lElementOdoMeterAbTestingVersion=null
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				lElementOdoMeterAbTestingVersion=IGNUemaHelper.getWebElementFromDataSeleniumKey(this.driver,lTagOdoMeterAbTestingVersion)
				if(!lElementOdoMeterAbTestingVersion){
					return lreturn
				}
				lStrOdoMeterAbTestingVersion=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementOdoMeterAbTestingVersion).trim()
				switch(lStrOdoMeterAbTestingVersion){
					case 'A':
	...
	public Map inputOdometerReadingA(String strOdometerReading){
		...
		if(lOdometerReading.length()<=0){
			lOdometerReading=THAMotorCarQuotationInputType.DEFAULT_ODOMETER_READING
		}
		...
		try{
			...
			Integer lOdometerCurrentNum=IGNUemaHelper.convertStringToInteger(lOdometerText,0)
			if(lOdometerReadingNum>0){
				if(lOdometerCurrentNum<=0){
					Boolean lIsSelectSliderTrack=IGNUemaHelper.selectSliderTrackByLocatorV5(this.driver,lElementOdometerValueStep,lOdometerReadingNum)
					if(!lIsSelectSliderTrack){
						return lreturn
					}
					lOdometerText=IGNUemaHelper.getDataSeleniumValueWebElement(this.driver,lElementSliderInput).trim()
				}
			}
			IGNUemaHelper.printLog('lOdometerNum:'+lOdometerText)
			...
			String lLocatorOdometerDisplayText='.drt-container #odometer4input #guide2km'
			Boolean lIsOdometerDisplayText=IGNUemaHelper.checkElementVisibleByLocatorKs(this.driver,lLocatorOdometerDisplayText)
			if(!lIsOdometerDisplayText){
				lLocatorOdometerDisplayText='.car-mileage .selected-migeage'
			}
	...
	public Map inputOdometerReadingB(String strOdometerReading){
		...
		Map lOdometerReadingList=['0':'0','1':'0','2':'1','3':'2','4':'3','5':'4','6':'5','7':'6','8':'7','9':'8','10':'9','11':'10','12':'11','13':'12','14':'13','15':'14','16':'15','17':'16','18':'17','19':'18','20':'19']
		Integer lNumCarOdometerDefault=0
		try{
			Boolean lResult=false
			lreturn.put('OdometerReading','')
			lreturn.put('Result',lResult)
			String lOdometerReadingItem=lOdometerReadingList.get(lOdometerReading)
			if(!lOdometerReadingItem){
				lOdometerReadingItem=lOdometerReadingList.get(THAMotorCarQuotationInputType.DEFAULT_ODOMETER_READING)
			}
			String lTagButton='ODOmeter_dropdown'
			String lLocatorButton=IGNUemaHelper.getTagDataSeleniumKey(lTagButton)
			String lTagDropdownList='ODOmeter-item'
			String lLocatorDropdownList=IGNUemaHelper.getTagDataSeleniumKey(lTagDropdownList)
			Integer lNumCarOdometer=IGNUemaHelper.convertStringToInteger(lOdometerReadingItem,lNumCarOdometerDefault)
			lOdometerReading=''
			Boolean lValid=IGNUemaHelper.checkElementExistByLocator(this.driver,lLocatorDropdownList)&&IGNUemaHelper.checkElementEnableByLocatorKs(this.driver,lLocatorButton)
			if(!lValid){
				lOdometerReading='No Option'
			}else{
				lOdometerReadingItem=IGNUemaHelper.selectDropdownByDataSeleniumLocatorV4(this.driver,lTagButton,lTagDropdownList,lNumCarOdometer)
				if(lOdometerReadingItem.length()<=0){
					lOdometerReadingItem=lOdometerReadingList.get(THAMotorCarQuotationInputType.DEFAULT_ODOMETER_READING)
					lOdometerReadingItem=IGNUemaHelper.selectDropdownByDataSeleniumLocatorV4(this.driver,lTagButton,lTagDropdownList,lNumCarOdometer)
				}
				lOdometerReading=lOdometerReadingItem.toUpperCase()
				if(lOdometerReading.length()<=0){
					lOdometerReading='No Option'
				}
			}
	...
	public Map inputDeclaredNcbA(String strDeclaredNcb){
		...
		if(lDeclaredNcb.length()<=0){
			lDeclaredNcb=THAMotorCarQuotationInputType.DEFAULT_DECLARED_NCB
		}
	...
	public Map inputUnderFinancingA(String strUnderFinancing){
		...
		if(lUnderFinancing.length()<=0){
			lUnderFinancing=THAMotorCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase()
		}
		...
		try{
			...
			if(!lUnderFinancingItem){
				lUnderFinancingItem=lUnderFinancingList.get(THAMotorCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase())
			}
			lUnderFinancing=''
	...
	public Map inputCarCameraA(String strCarCamera){
		...
		if(lCarCamera.length()<=0){
			lCarCamera=THAMotorCarQuotationInputType.DEFAULT_CAR_CAMERA
		}
		try{
			Boolean lResult=false
			lreturn.put('CarCamera','')
	...
	public Map inputTentativeA(String strTentative){
		...
		if(lTentative.length()<=0){
			lTentative=THAMotorCarQuotationInputType.DEFAULT_TENTATIVE
		}
		try{
			Boolean lResult=false
			lreturn.put('Tentative','')
	...
	public Map inputAlcoholFreeA(String strAlcoholFree){
		...
		if(lAlcoholFree.length()<=0){
			lAlcoholFree=THAMotorCarQuotationInputType.DEFAULT_ALCOHOL_FREE.toUpperCase()
		}
		...
		try{
			...
			if(!lAlcoholFreeItem){
				lAlcoholFreeItem=lAlcoholFreeList.get(THAMotorCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase())
			}
			lAlcoholFree=''
