...
public class THAMotorCarQuotationVerifyType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteMotorCar/MotorCar_Quotation_00_Verify.Input'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteMotorCar/MotorCar_Quotation_00_Verify.Output'
	...
	public Map Input=[:]
	public Map Output=[:]
	public THAMotorCarQuotationVerifyType(){
		super()
		this.initInput()
		this.initOutput()
	}
