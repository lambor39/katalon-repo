...
public class THAMyAccountRenewalVerifyType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/MyAccountRenewal/MyAccountRenewal_00_Verify.Input'
	public static final String INPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_MyAccount_Renewal.xlsx'
	public static final String INPUT_EXCEL_SHEET_NAME='MyAccount_Renewal_Verify'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/MyAccountRenewal/MyAccountRenewal_00_Verify.Output'
	public static final String OUTPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_MyAccount_Renewal.xlsx'
	public static final String OUTPUT_EXCEL_SHEET_NAME='MyAccount_Renewal_Verify'
	...
	//Constant
	public static final String DEFAULT_MY_ACCOUNT_RENEWAL_01_INPUT=''
	public static final String DEFAULT_MY_ACCOUNT_RENEWAL_02_MAIN=''
	public static final String DEFAULT_ACTUAL_RESULT=''
	public Map Input=[:]
	public Map Output=[:]
	public THAMyAccountRenewalVerifyType(){
		super()
		this.initInput()
		this.initOutput()
	}
	...
	public void initInput(){
		this.Input.clear()
		this.Input.put('MyAccountRenewal01Input',this.DEFAULT_MY_ACCOUNT_RENEWAL_01_INPUT)
		this.Input.put('MyAccountRenewal02Main',this.DEFAULT_MY_ACCOUNT_RENEWAL_02_MAIN)
		this.Input.put('ActualResult',this.DEFAULT_ACTUAL_RESULT)
	}
	public void initOutput(){
		this.Output.clear()
		this.Output.put('MyAccountRenewal01Input','')
		this.Output.put('MyAccountRenewal02Main','')
	...
	public static Boolean readInputFromDataFile(Integer caseNumber,Map caseInput){
		...
		try{
			...
			caseInput.put('MyAccountRenewal01Input',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseInput.put('MyAccountRenewal02Main',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
	...
	public static Boolean readOutputFromDataFile(Integer caseNumber,Map caseOutput){
		...
		try{
			...
			caseOutput.put('MyAccountRenewal01Input',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseOutput.put('MyAccountRenewal02Main',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
