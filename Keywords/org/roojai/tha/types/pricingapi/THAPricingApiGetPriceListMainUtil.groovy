...
import org.roojai.tha.types.pricingapi.THAPricingApiGetPriceListCoreType as THAPricingApiGetPriceListCoreType
import org.roojai.tha.types.pricingapi.THAPricingApiHelper as THAPricingApiHelper
...
public class THAPricingApiGetPriceListMainUtil{
	private THATestStageControllerGroupPricingApiShareQuoteAllNameProductAllStoryGetPriceList parentStageController
	public THAPricingApiGetPriceListMainUtil(THATestStageControllerGroupPricingApiShareQuoteAllNameProductAllStoryGetPriceList initStageController){
		super()
		try{
	...
	public THATestStageControllerGroupPricingApiShareQuoteAllNameProductAllStoryGetPriceList getParentStageController(){
		try{
			return this.parentStageController
		}catch(Exception e){
		}
	}
	public void setParentStageController(THATestStageControllerGroupPricingApiShareQuoteAllNameProductAllStoryGetPriceList newParentStageController){
		//Do Nothing
	...
	public Boolean inputCase(){
		...
		String lPricingApiCurrentJsonRootQuotationInputPartOne=''
		String lPricingApiCurrentJsonRootQuotationInputPartTwo=''
		...
		try{
			...
			IGNUemaHelper.printLog(lPricingApiJsonRootQuotationInput)
			if(lPricingApiQuoteRequiredTransactionType=='Endorsemment'){
				List lPricingApiCurrentJsonRootQuotationInputList=[]
				lPricingApiCurrentJsonRootQuotationInputList.add(lPricingApiCurrentJsonRootQuotationInputPartOne)
				lPricingApiCurrentJsonRootQuotationInputList.add(lPricingApiCurrentJsonRootQuotationInputPartTwo)
				String lPricingApiCurrentJsonRootQuotationInput=IGNUemaHelper.getStringDecodedForExcelCell(lPricingApiCurrentJsonRootQuotationInputList)
				IGNUemaHelper.printLog('lPricingApiCurrentJsonRootQuotationInput')
				IGNUemaHelper.printLog(lPricingApiCurrentJsonRootQuotationInput)
			}
			...
			switch(lProductCode){
				case '2':
					lTestExcelFileGenericTestDataWorkBook=IGNUemaHelper.getExcelWorkbookInstanceFromFileName(THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_MOTOR_BIKE)
					lExcelGenericFilename=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_MOTOR_BIKE
					lMacroGenericFileName=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_MACRO_MOTOR_BIKE
					lPricingApiSheet=IGNUemaHelper.getExcelWorkSheetFromExcelWorkbook(lTestExcelFileGenericTestDataWorkBook,'PricingAPI')
					break
				case  '3':
					lTestExcelFileGenericTestDataWorkBook=IGNUemaHelper.getExcelWorkbookInstanceFromFileName(THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_NON_MOTOR_PERSONAL_ACCIDENT)
					lExcelGenericFilename=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_NON_MOTOR_PERSONAL_ACCIDENT
					lMacroGenericFileName=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_MACRO_NON_MOTOR_PERSONAL_ACCIDENT
					lPricingApiSheet=IGNUemaHelper.getExcelWorkSheetFromExcelWorkbook(lTestExcelFileGenericTestDataWorkBook,'PricingAPI')
					break
				case  '4':
					lTestExcelFileGenericTestDataWorkBook=IGNUemaHelper.getExcelWorkbookInstanceFromFileName(THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_NON_MOTOR_CANCER)
					lExcelGenericFilename=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_NON_MOTOR_CANCER
					lMacroGenericFileName=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_MACRO_NON_MOTOR_CANCER
					lPricingApiSheet=IGNUemaHelper.getExcelWorkSheetFromExcelWorkbook(lTestExcelFileGenericTestDataWorkBook,'PricingAPI')
					break
				case '5':
					lTestExcelFileGenericTestDataWorkBook=IGNUemaHelper.getExcelWorkbookInstanceFromFileName(THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_NON_MOTOR_CRITICAL_ILLNESS)
					lExcelGenericFilename=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_NON_MOTOR_CRITICAL_ILLNESS
					lMacroGenericFileName=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_MACRO_NON_MOTOR_CRITICAL_ILLNESS
					lPricingApiSheet=IGNUemaHelper.getExcelWorkSheetFromExcelWorkbook(lTestExcelFileGenericTestDataWorkBook,'PricingAPI')
					break
				default:
					lTestExcelFileGenericTestDataWorkBook=IGNUemaHelper.getExcelWorkbookInstanceFromFileName(THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_MOTOR_CAR)
					lExcelGenericFilename=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_GENERIC_MOTOR_CAR
					lMacroGenericFileName=THAPricingApiPrepareGenericDataInputUtil.CURRENT_TEST_TRANSFORM_DATA_FILE_INPUT_MACRO_MOTOR_CAR
					lPricingApiSheet=IGNUemaHelper.getExcelWorkSheetFromExcelWorkbook(lTestExcelFileGenericTestDataWorkBook,'PricingAPI')
					break
			}
			THAPricingApiGetPriceListCoreType.PRICINGAPI_GENERIC_DATA_FILE_NAME=lExcelGenericFilename
			...
			THAPricingApiGetPriceListCoreType.PRICINGAPI_PRODUCT_TYPE=lPricingApiQuoteRequiredProductType
			Boolean lIsRegClientOK=false,lIsMultiPlanOK=false,lIsGetPlanOK=false,lIsGetPlanWithInstallmentOK=false,lIsAdditionalCoveragePremiumValidationOK=false,lIsPremiumValidationOK=false
			...
			if(lIsRegClientOK){
				...
				Map lMapRootParameterWithMasterDataParmeterResult=THAPricingApiPrepareGenericDataInputUtil.inputMapTargetParameterWithMasterParameter(lMasterDataSheet,'Root')
				...
				if(lIsJsonQuotationInputStructureValidationOK){
					...
					if(IGNUemaHelper.checkStringContainString(lPricingApiQuoteRequiredProductType,'Motor')){
						...
						if(!IGNUemaHelper.checkObjectEmptyOfMap(lMapVehicleData)){
							...
							Map lMapVehicleDataResult=THAPricingApiHelper.getVehicleDataTable(lVehicleMake,lVehicleModel,lVehicleYearOfManufacture,lVehicleSubModel)
							List<GroovyRowResult> lVehicleDataResultSet=[]
							Map lMapRedBookVehicleDataParameterWithMasterParameter=[:]
							Map lMapRedBookVehicleDataParameterWithMasterParameterResult=THAPricingApiPrepareGenericDataInputUtil.inputMapTargetParameterWithMasterParameter(lMasterDataSheet,'RedBook')
				...
				if(lMapPricingApiMultiPlanApiCallResult.Result){
					...
					for(Integer lIndex=0;lIndex<=lCoverList.size()-1;lIndex++){
						...
						for(Integer lListIndex=0;lListIndex<=lSelectedCoverList.size()-1;lListIndex++){
							...
							lMapValidationTestResult.put('GetPlanValidationTestResult',lSelectedAdditionalCoverage.ValidationTestResultGetPlan)
							lMapValidationTestResult.put('GetPlanWithInstallmentValidationTestResult',lSelectedAdditionalCoverage.ValidationTestResultGetPlanWithInstallment)
							...
							Integer lRowNumber=lPricingApiInputPremiumRowAndColumnNumber.RowNumber
							Integer lColumnNumber=lPricingApiInputPremiumRowAndColumnNumber.ColumnNumber
							...
							Map lMapCoverDependencyResult=THAPricingApiHelper.getDependencyTable(lPolicyProductVersion,lPricingApiQuoteRequiredProductType,lCoverName)
							...
							String[] lDefaultSelectedOptionList=[]
							if(lMapCoverDependencyResult.Result){
								...
								for(Map.Entry entry : lPlanOptionListAll.entrySet()){
									...
									if(lPlanValue.getClass()==LazyMap.class){
										...
										lDefaultSelectedOptionList=lDefaultSelectedOption.split('_')
										break
									}
								}
								if(lIsPlanOptionListOK){
									...
									for(Integer lCodeIndex=0;lCodeIndex<=lDependencyCodeMappingResultSet.size()-1;lCodeIndex++){
										...
										Boolean lIsWriteDefaultPlanOptionToExcelSheetDone=this.inputPricingApiResultToExcelSheetForValidation(lPricingApiSheet,lPlanOptionRowNumber,lPlanOptionColumnNumber,lDefaultSelectedOptionList[lCodeIndex])
										if(!lIsWriteDefaultPlanOptionToExcelSheetDone){
											return lreturn
										}
										String lCoverPlan=lPlanOptionListAll.get(lOptionName)
										lPlanOptionListAll.put(lOptionName,lDefaultSelectedOptionList[lCodeIndex])
									}
								}
							}
							Map lMapCoverList=[:]
							...
							for(Integer lCoverIndex=0;lCoverIndex<=lCoverPremiumOptionList.size()-1;lCoverIndex++){
								if(lCoverPremiumOptionList.get(lCoverIndex).Name==lCoverPlanName){
									lPremium=lCoverPremiumOptionList.get(lCoverIndex).Premium_Before_Taxes
								}
							}
							Boolean lInputCoverPremiumToExcelSheetDone=this.inputPricingApiResultToExcelSheetForValidation(lPricingApiSheet,lRowNumber,lColumnNumber,lPremium)
							...
							String lLoadingFactor=this.inputPricingApiLoadingFactorForGivenPaymentFrequency(lPricingApiSheet,lLoadingFactorList,lPolicyPaymentFrequency,lMapPricingApiJsonPayment)
							...
							if(lPricingApiCoverageNameList.size()>0){
								for(Integer lCoverageIndex=0;lCoverageIndex<=lPricingApiCoverageNameList.size()-1;lCoverageIndex++){
									...
									Map lMapCoverageDependencyResult=THAPricingApiHelper.getDependencyTable(lPolicyProductVersion,lPricingApiQuoteRequiredProductType,lCoverageName)
									...
									for(Integer lOptionIndex=0;lOptionIndex<=lAdditionalCoveragePremiumOptionList.size()-1;lOptionIndex++){
										...
										if(lOptionName==lCoveragePlanName){
											...
											Integer lPremiumRowNumber=lMapAdditionalCoverageTableResult.RowNumber
											Integer lPremiumColumnNumber=lMapAdditionalCoverageTableResult.ColumnNumber
											Boolean lIsInputAdditionalCoveragePremiumToExcelSheetDone=this.inputPricingApiResultToExcelSheetForValidation(lPricingApiSheet,lPremiumRowNumber,lPremiumColumnNumber,lAdditionalCoveragePremium)
											...
											Float lAdditionalCoveragePremiumWithLoading=lAdditionalCoveragePremiumNum*lLoadingFactorValue
							...
							Map lMapPricingApiJsonPaymentAnnualNetPremiumRowAndColumnNumber=lMapPricingApiJsonPayment.AnnualNetPremWithoutLoading
							Integer lAnnualNetPremiumPremiumRowNumber=lMapPricingApiJsonPaymentAnnualNetPremiumRowAndColumnNumber.RowNumber
							Integer lAnnualNetPremiumPremiumColumnNumber=lMapPricingApiJsonPaymentAnnualNetPremiumRowAndColumnNumber.ColumnNumber
							Float lCoverPremium=IGNUemaHelper.convertStringToFloat(lPremium,0.0)
							lAnnualNetPremium=lTotalAdditionalCoverageSumValue+lCoverPremium
							String lStrAnnualNetPremium=lAnnualNetPremium.toString()
						...
						IGNUemaHelper.printLog(lTransactionDate)
						String lMasterSetId=lMapResponseJson.root[0].Quote[0].mastersetId
						Boolean lIsWriteMasterSetIdToExcelSheet=this.inputPricingApiResultToExcelSheetForValidation(lPricingApiSheet,lMasterSetIdRowNumber,lMasterSetIdColumnNumber,lMasterSetId)
						if(!lIsWriteMasterSetIdToExcelSheet){
							return lreturn
						}
						lMapJsonRootQuotationInput.root.Quote.put('MasterSetId',lMasterSetId)
	...
	public Boolean inputTestReport(){
		...
		try{
			...
			String lPricingApiTotalNumberOfCases=THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES
			...
			Integer lPricingApiNumberOfTestCaseSubset=IGNUemaHelper.convertStringToInteger(THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES_SUBSET,0)
			lSubSetDataIndex=this.CURRENT_NUMBER_OF_SUBSET+lPricingApiNumberOfTestCaseSubset
			THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES_SUBSET=lSubSetDataIndex.toString()
			THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES=lPricingApiTotalNumberOfCases
			...
			if(lIsActualResultOK){
				Integer lPricingApiNumberOfTestCasesPassedNum=IGNUemaHelper.convertStringToInteger(THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES_PASSED,0)
				...
				THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES_PASSED=lPricingApiNumberOfTestCasesPassed
			}else{
				Integer lPricingApiNumberOfTestCasesFailedNum=IGNUemaHelper.convertStringToInteger(THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES_FAILED,0)
				...
				THAPricingApiGetPriceListCoreType.NUMBER_OF_TESTCASES_FAILED=lPricingApiNumberOfTestCasesFailed
			}
			lreturn=true
		}
		catch(Exception e){
	...
	public Boolean initPricingApiRegisterClientApiRequest(String strPricingApiRegisterClientInputRequestBodyContent,Map mapPricingApiInputOutput){
		...
		try{
			...
			Map lMapPricingApiRegisterClientCallRequestResult=THAPricingApiHelper.mapPricingApiRegisterClientCallRequest(lPricingApiRegisterClientInputRequestBodyContent)
	...
	public Map initMultiPlanPricingApiRequest(String strProductType,String strPricingApiMultiPlanPriceInputRequestBodyContent,String strPricingApiMultiPlanPriceInputRequestUrl,Boolean isPositiveCase,Map mapPricingApiInputOutput,List strCoverList,List strCoverageList){
		...
		try{
			...
			IGNUemaHelper.printLog(lRegisterUuid)
			Map lMapPricingApiMultiPlanCallRequestResult=THAPricingApiHelper.inputPricingApiMultiPlanPriceCallRequest(lPricingApiMultiPlanPriceInputRequestBodyContent,lPricingApiMultiPlanPriceInputRequestUrl,lRegisterUuid)
	...
	public Map initGetPlanPricingApiRequest(String strProductType,String strPricingApiGetPlanPriceInputRequestBodyContent,String strPricingApiGetPlanPriceInputRegisterUuid,String strPricingApiGetPlanPriceInputRequestUrl,Map mapPricingApiInputOutput){
		...
		try{
			...
			IGNUemaHelper.printLog('lRegisterUuid')
			IGNUemaHelper.printLog(lRegisterUuid)
			Map lMapPricingApiGetPlanPriceCallRequestResult=THAPricingApiHelper.inputPricingApiGetPlanPriceCallRequest(lPricingApiGetPlanPriceInputRequestBodyContent,lPricingApiGetPlanPriceInputRequestUrl,lRegisterUuid)
	...
	public Map initGetPlanWithInstallmentPricingApiRequest(String strProductType,String strPricingApiGetPlanWithInstallmentPriceInputRequestBodyContent,String strPricingApiGetPlanWithInstallmentPriceRegisterUuid,String strPricingApiGetPlanWithInstallmentPriceInputRequestUrl,Map mapPricingApiInputOutput){
		...
		try{
			...
			Map lMapPricingApiGetPlanWithInstallmentCallRequestResult=THAPricingApiHelper.inputPricingApiGetPlanWithInstallmentPriceCallRequest(lPricingApiGetPlanWithInstallmentPriceInputRequestBodyContent,lPricingApiGetPlanWithInstallmentPriceInputRequestUrl,lPricingApiGetPlanWithInstallmentPriceRegisterUuid)
			...
			if(statusCode==200){
				...
				if(lIsObjectReady){
					...
					if(!lIsMultiPlanPricingApiQuoteDataListEmpty){
						...
						List<String>lMultiPlanPricingApiLoadingFactorList=lMapJson.root[0].Quote[0].Loading_Factors
						...
						if(IGNUemaHelper.checkStringContainString(lProductType,'Motor')){
							List<String>lMultiPlanPricingApiVehicleDataList=lMapJson.root[0].Quote[0].Vehicle_Data
						...
						String lMultiPlanPricingApiModelName=lMapJson.root[0].Quote[0].Model_Name
						...
						String lMultiPlanPricingApiPolicyAutoRenewalFlag=lMapJson.root[0].Quote[0].Policy_Auto_renewal_Flag
						mapPricingApiInputOutput.MultiplePlanPriceQuotePolicyAutoRenewalFlag=lMultiPlanPricingApiPolicyAutoRenewalFlag
						Boolean lIsMultiPlanPricingApiPolicyAutoRenewalFlagNull=IGNUemaHelper.checkObjectNullOfObject(lMultiPlanPricingApiPolicyAutoRenewalFlag)
						if(lIsMultiPlanPricingApiPolicyAutoRenewalFlagNull){
							lIsObjectOK=false
							lVerifyMultiPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyMultiPlanPricingApiDetail,"PolicyAutoRenewalFlag="+lEmptyValue)
						}else{
							Boolean lIsMultiPlanPricingApiPolicyAutoRenewalFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lMultiPlanPricingApiPolicyAutoRenewalFlag)
							if(lIsMultiPlanPricingApiPolicyAutoRenewalFlagEmpty){
								lIsObjectOK=false
								lVerifyMultiPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyMultiPlanPricingApiDetail,"PolicyAutoRenewalFlag="+lEmptyValue)
							}
						}
						String lMultiPlanPricingApiPolicyProductVersion=lMapJson.root[0].Quote[0].Policy_Product_Version
						...
						String lMultiPlanPricingApiDefaultShowPaymentFrequency=lMapJson.root[0].Quote[0].Default_Show_Payment_Frequency
			...
			if(statusCode==200){
				...
				if(lIsObjectReady){
					...
					if(!lIsMapGetPlanPricingApiQuoteDataNull){
						String lGetPlanPricingApiRewardPoint=lMapJson.root.Quote.Reward_Point
						...
						String lGetPlanPricingApiProductId=lMapJson.root.Quote.productId
						Boolean lIsGetPlanPricingApiProductIdNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiProductId)
						if(lIsGetPlanPricingApiProductIdNull){
							lIsObjectOK=false
							lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"ProductId="+lNullValue)
						}else{
							Boolean lIsGetPlanPricingApiProductIdEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiProductId)
							if(lIsGetPlanPricingApiProductIdEmpty){
								lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"ProductId="+lEmptyValue)
							}
						}
						String lGetPlanPricingApiPolicyPaymentFrequency=lMapJson.root.Quote.Policy_Payment_Frequency
						Boolean lIsGetPlanPricingApiPolicyPaymentFrequencyNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiPolicyPaymentFrequency)
						if(lIsGetPlanPricingApiPolicyPaymentFrequencyNull){
							lIsObjectOK=false
							lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"PolicyPaymentFrequency"+lNullValue)
						}else{
							//Write in O/p
						}
						...
						String lGetPlanPricingApiPolicyAutoRenewalFlag=lMapJson.root.Quote.Policy_Auto_renewal_Flag
						...
						String lGetPlanPricingApiPolicyProductVersion=lMapJson.root.Quote.Policy_Product_Version
						Boolean lIsGetPlanPricingApiPolicyProductVersionNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiPolicyProductVersion)
						if(lIsGetPlanPricingApiPolicyProductVersionNull){
							lIsObjectOK=false
							lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"PolicyProductVersion="+lNullValue)
						}else{
							Boolean lIsGetPlanPricingApiPolicyProductVersionEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiPolicyProductVersion)
							if(lIsGetPlanPricingApiPolicyProductVersionEmpty){
								lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"PolicyProductVersion"+lEmptyValue)
							}
						}
						String lGetPlanPricingApiPolicyNumber=lMapJson.root.Quote.Policy_Number
						Boolean lIsGetPlanPricingApiPolicyNumberNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiPolicyNumber)
						if(lIsGetPlanPricingApiPolicyNumberNull){
							lIsObjectOK=false
							lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"PolicyNumber="+lNullValue)
						}
						String lGetPlanPricingApiModelName=lMapJson.root.Quote.Model_Name
						Boolean lIsGetPlanPricingApiModelNameNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiModelName)
						if(lIsGetPlanPricingApiModelNameNull){
							lIsObjectOK=false
							lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"ModelName="+lNullValue)
						}else{
							Boolean lIsGetPlanPricingApiModelNameEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiModelName)
							if(lIsGetPlanPricingApiModelNameEmpty){
								lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,"ModelName"+lEmptyValue)
							}
						}
						String lGetPlanPricingApiDefaultShowPaymentFrequency=lMapJson.root.Quote.Default_Show_Payment_Frequency
						Boolean lIsGetPlanPricingApiDefaultShowPaymentFrequencyNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiDefaultShowPaymentFrequency)
						if(lIsGetPlanPricingApiDefaultShowPaymentFrequencyNull){
							lIsObjectOK=false
							lText=lText+IGNUemaHelper.concatMessageLeftRightByPipe("DefaultShowPaymentFrequency",lNullValue)
						}else{
							Boolean lIsGetPlanPricingApiDefaultShowPaymentFrequencyEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiDefaultShowPaymentFrequency)
							if(lIsGetPlanPricingApiDefaultShowPaymentFrequencyEmpty){
								lVerifyGetPlanPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanPricingApiDetail,'DefaultShowPaymentFrequency'+lEmptyValue)
							}
						}
						if(IGNUemaHelper.checkStringContainString(lProductType,'Motor')){
							Map lMapGetPlanPricingApiVehicleData=lMapJson.root.Quote.Vehicle_Data
							...
							if(lIsMapGetPlanPricingApiVehicleDataNull){
								...
								if(lIsMapGetPlanPricingApiVehicleDataEmpty){
									...
									lText=''
									String lGetPlanPricingApiPolicyEstimatedAnnualMileage=lMapGetPlanPricingApiVehicleData.Policy_Estimated_Annual_Mileage
									...
									String lGetPlanPricingApiPlanType=lMapGetPlanPricingApiVehicleData.Plan_Type
									...
									String lGetPlanPricingApiUwVehicleTypeUpdateFlag=lMapGetPlanPricingApiVehicleData.UW_Vehicle_Type_Update_Flag
									Boolean lIsGetPlanPricingApiUwVehicleTypeUpdateFlagNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiUwVehicleTypeUpdateFlag)
									if(lIsGetPlanPricingApiUwVehicleTypeUpdateFlagNull){
										lIsObjectOK=false
										lText=+IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleTypeUpdateFlag='+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiUwVehicleTypeUpdateFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiUwVehicleTypeUpdateFlag)
										if(lIsGetPlanPricingApiUwVehicleTypeUpdateFlagEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleTypeUpdateFlag='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiVehicleInspectionRequired=lMapGetPlanPricingApiVehicleData.Vehicle_Inspection_Required
									...
									String lGetPlanPricingApiCoverPlanOverWriteFlag=lMapGetPlanPricingApiVehicleData.Cover_Plan_Overwrite_Flag
									Boolean lIsGetPlanPricingApiCoverPlanOverWriteFlagNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiCoverPlanOverWriteFlag)
									if(lIsGetPlanPricingApiCoverPlanOverWriteFlagNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"CoverPlanOverWriteFlag="+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiCoverPlanOverWriteFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiCoverPlanOverWriteFlag)
										if(lIsGetPlanPricingApiCoverPlanOverWriteFlagEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'CoverPlanOverWriteFlag='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiDriverPlan=lMapGetPlanPricingApiVehicleData.Driver_Plan
									Boolean lIsGetPlanPricingApiDriverPlanNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiDriverPlan)
									if(lIsGetPlanPricingApiDriverPlanNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"DriverPlan="+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiDriverPlanEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiDriverPlan)
										if(lIsGetPlanPricingApiDriverPlanEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'DriverPlan='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiFaultIncurred=lMapGetPlanPricingApiVehicleData.Fault_Incurred
									Boolean lIsGetPlanPricingApiFaultIncurredNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiFaultIncurred)
									if(lIsGetPlanPricingApiFaultIncurredNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'FaultIncurred='+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiFaultIncurredEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiFaultIncurred)
										if(lIsGetPlanPricingApiFaultIncurredEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'FaultIncurred='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiUwVehicleType=lMapGetPlanPricingApiVehicleData.UW_Vehicle_Type
									Boolean lIsGetPlanPricingApiUwVehicleTypeNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiUwVehicleType)
									if(lIsGetPlanPricingApiUwVehicleTypeNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"UwVehicleType="+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiUwVehicleTypeEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiUwVehicleType)
										if(lIsGetPlanPricingApiUwVehicleTypeEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleType='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiExcess=lMapGetPlanPricingApiVehicleData.Excess
									Boolean lIsGetPlanPricingApiExcessNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiExcess)
									if(lIsGetPlanPricingApiExcessNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"Excess="+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiExcessEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiExcess)
										if(lIsGetPlanPricingApiExcessEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'Excess='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiVehicleInspectionLimit=lMapGetPlanPricingApiVehicleData.Vehicle_Inspection_Limit
									...
									String lGetPlanPricingApiUwVehicleTypeWarningFlag=lMapGetPlanPricingApiVehicleData.UW_Vehicle_Type_Warning_Flag
									Boolean lIsGetPlanPricingApiUwVehicleTypeWarningFlagNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiUwVehicleTypeWarningFlag)
									if(lIsGetPlanPricingApiUwVehicleTypeWarningFlagNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"UwVehicleTypeWarningFlag="+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiUwVehicleTypeWarningFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiUwVehicleTypeWarningFlag)
										if(lIsGetPlanPricingApiUwVehicleTypeWarningFlagEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleTypeWarningFlag='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiCarDefaultValueFinal=lMapGetPlanPricingApiVehicleData.Car_Default_Value_Final
									Boolean lIsGetPlanPricingApiCarDefaultValueFinalNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiCarDefaultValueFinal)
									if(lIsGetPlanPricingApiCarDefaultValueFinalNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"CarDefaultValueFinal="+lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiCarDefaultValueFinalEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiCarDefaultValueFinal)
										if(lIsGetPlanPricingApiCarDefaultValueFinalEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'CarDefaultValueFinal='+lEmptyValue)
										}
									}
									String lGetPlanPricingApiVehicleInspectionMethod=lMapGetPlanPricingApiVehicleData.Vehicle_Inspection_Method
									...
									String lGetPlanPricingApiWorkshop=lMapGetPlanPricingApiVehicleData.Workshop
									...
									String lGetPlanPricingApiFaultClaimForRating=lMapGetPlanPricingApiVehicleData.Fault_Claims_For_Rating
									Boolean lIsGetPlanPricingApiFaultClaimForRatingNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanPricingApiFaultClaimForRating)
									if(lIsGetPlanPricingApiFaultClaimForRatingNull){
										lIsObjectOK=false
										lText=lText+IGNUemaHelper.concatMessageLeftRightByPipe("FaultClaimForRating",lNullValue)
									}else{
										Boolean lIsGetPlanPricingApiFaultClaimForRatingEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanPricingApiFaultClaimForRating)
										if(lIsGetPlanPricingApiFaultClaimForRatingEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'FaultClaimForRating='+lEmptyValue)
										}
									}
									if(lText.length()>1){
										lText=IGNUemaHelper.concatMessageLeftRightByPipe('VehicleData',lText)
			...
			if(statusCode==200){
				...
				if(lIsObjectReady){
					...
					if(!lIsMapGetPlanWithInstallmentPricingApiQuoteDataNull){
						...
						String lGetPlanWithInstallmentPricingApiProductId=lMapJson.root.Quote.productId
						Boolean lIsGetPlanWithInstallmentPricingApiProductIdNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiProductId)
						if(lIsGetPlanWithInstallmentPricingApiProductIdNull){
							lIsObjectOK=false
							lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"ProductId="+lNullValue)
						}else{
							Boolean lIsGetPlanWithInstallmentPricingApiProductIdEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiProductId)
							if(lIsGetPlanWithInstallmentPricingApiProductIdEmpty){
								lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"ProductId="+lEmptyValue)
							}
						}
						String lGetPlanWithInstallmentPricingApiPolicyPaymentFrequency=lMapJson.root.Quote.Policy_Payment_Frequency
						Boolean lIsGetPlanWithInstallmentPricingApiPolicyPaymentFrequencyNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiPolicyPaymentFrequency)
						if(lIsGetPlanWithInstallmentPricingApiPolicyPaymentFrequencyNull){
							lIsObjectOK=false
							lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"PolicyPaymentFrequency"+lNullValue)
						}else{
							//Write in O/p
						}
						...
						String lGetPlanWithInstallmentPricingApiPolicyAutoRenewalFlag=lMapJson.root.Quote.Policy_Auto_renewal_Flag
						Boolean lIsGetPlanWithInstallmentPricingApiPolicyAutoRenewalFlagNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiPolicyAutoRenewalFlag)
						if(lIsGetPlanWithInstallmentPricingApiPolicyAutoRenewalFlagNull){
							lIsObjectOK=false
							lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"PolicyAutoRenewalFlag"+lNullValue)
						}else{
							Boolean lIsGetPlanWithInstallmentPricingApiPolicyAutoRenewalFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiPolicyAutoRenewalFlag)
							if(lIsGetPlanWithInstallmentPricingApiPolicyAutoRenewalFlagEmpty){
								lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"PolicyAutoRenewalFlag"+lEmptyValue)
							}
						}
						String lGetPlanWithInstallmentPricingApiPolicyProductVersion=lMapJson.root.Quote.Policy_Product_Version
						Boolean lIsGetPlanWithInstallmentPricingApiPolicyProductVersionNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiPolicyProductVersion)
						if(lIsGetPlanWithInstallmentPricingApiPolicyProductVersionNull){
							lIsObjectOK=false
							lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"PolicyProductVersion="+lNullValue)
						}else{
							Boolean lIsGetPlanWithInstallmentPricingApiPolicyProductVersionEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiPolicyProductVersion)
							if(lIsGetPlanWithInstallmentPricingApiPolicyProductVersionEmpty){
								lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"PolicyProductVersion"+lEmptyValue)
							}
						}
						String lGetPlanWithInstallmentPricingApiPolicyNumber=lMapJson.root.Quote.Policy_Number
						Boolean lIsGetPlanWithInstallmentPricingApiPolicyNumberNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiPolicyNumber)
						if(lIsGetPlanWithInstallmentPricingApiPolicyNumberNull){
							lIsObjectOK=false
							lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"PolicyNumber="+lNullValue)
						}
						String lGetPlanWithInstallmentPricingApiModelName=lMapJson.root.Quote.Model_Name
						Boolean lIsGetPlanWithInstallmentPricingApiModelNameNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiModelName)
						if(lIsGetPlanWithInstallmentPricingApiModelNameNull){
							lIsObjectOK=false
							lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"ModelName="+lNullValue)
						}else{
							Boolean lIsGetPlanWithInstallmentPricingApiModelNameEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiModelName)
							if(lIsGetPlanWithInstallmentPricingApiModelNameEmpty){
								lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,"ModelName"+lEmptyValue)
							}
						}
						String lGetPlanWithInstallmentPricingApiDefaultShowPaymentFrequency=lMapJson.root.Quote.Default_Show_Payment_Frequency
						Boolean lIsGetPlanWithInstallmentPricingApiDefaultShowPaymentFrequencyNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiDefaultShowPaymentFrequency)
						if(lIsGetPlanWithInstallmentPricingApiDefaultShowPaymentFrequencyNull){
							lIsObjectOK=false
							lText=lText+IGNUemaHelper.concatMessageLeftRightByPipe("DefaultShowPaymentFrequency",lNullValue)
						}else{
							Boolean lIsGetPlanWithInstallmentPricingApiDefaultShowPaymentFrequencyEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiDefaultShowPaymentFrequency)
							if(lIsGetPlanWithInstallmentPricingApiDefaultShowPaymentFrequencyEmpty){
								lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,'DefaultShowPaymentFrequency'+lEmptyValue)
							}
						}
						if(IGNUemaHelper.checkStringContainString(lProductType,'Motor')){
							...
							if(lIsMapGetPlanWithInstallmentPricingApiVehicleDataNull){
								...
								if(lIsMapGetPlanWithInstallmentPricingApiVehicleDataEmpty){
									...
									lText=''
									String lGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileage=lMapGetPlanWithInstallmentPricingApiVehicleData.Policy_Estimated_Annual_Mileage
									if(lGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileage=='[]'){
										lGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileage=''
									}
									Boolean lIsGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileageNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileage)
									if(lIsGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileageNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"PolicyEstimatedAnnualMileage="+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileageEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileage)
										if(lIsGetPlanWithInstallmentPricingApiPolicyEstimatedAnnualMileageEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'PolicyEstimatedAnnualMileage='+lEmptyValue)
										}
									}
									String lGetPlanWithInstallmentPricingApiPlanType=lMapGetPlanWithInstallmentPricingApiVehicleData.Plan_Type
									...
									String lGetPlanWithInstallmentPricingApiUwVehicleTypeUpdateFlag=lMapGetPlanWithInstallmentPricingApiVehicleData.UW_Vehicle_Type_Update_Flag
									Boolean lIsGetPlanWithInstallmentPricingApiUwVehicleTypeUpdateFlagNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiUwVehicleTypeUpdateFlag)
									if(lIsGetPlanWithInstallmentPricingApiUwVehicleTypeUpdateFlagNull){
										lIsObjectOK=false
										lText=+IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleTypeUpdateFlag='+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiUwVehicleTypeUpdateFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiUwVehicleTypeUpdateFlag)
										if(lIsGetPlanWithInstallmentPricingApiUwVehicleTypeUpdateFlagEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleTypeUpdateFlag='+lEmptyValue)
										}
									}
									String lGetPlanWithInstallmentPricingApiVehicleInspectionRequired=lMapGetPlanWithInstallmentPricingApiVehicleData.Vehicle_Inspection_Required
									...
									String lGetPlanWithInstallmentPricingApiCoverPlanOverWriteFlag=lMapGetPlanWithInstallmentPricingApiVehicleData.Cover_Plan_Overwrite_Flag
									Boolean lIsGetPlanWithInstallmentPricingApiCoverPlanOverWriteFlagNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiCoverPlanOverWriteFlag)
									if(lIsGetPlanWithInstallmentPricingApiCoverPlanOverWriteFlagNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"CoverPlanOverWriteFlag="+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiCoverPlanOverWriteFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiCoverPlanOverWriteFlag)
										if(lIsGetPlanWithInstallmentPricingApiCoverPlanOverWriteFlagEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'CoverPlanOverWriteFlag='+lEmptyValue)
										}
									}
									String lGetPlanWithInstallmentPricingApiDriverPlan=lMapGetPlanWithInstallmentPricingApiVehicleData.Driver_Plan
									Boolean lIsGetPlanWithInstallmentPricingApiDriverPlanNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiDriverPlan)
									if(lIsGetPlanWithInstallmentPricingApiDriverPlanNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"DriverPlan="+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiDriverPlanEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiDriverPlan)
										if(lIsGetPlanWithInstallmentPricingApiDriverPlanEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'DriverPlan='+lEmptyValue)
										}
									}
									String lGetPlanWithInstallmentPricingApiFaultIncurred=lMapGetPlanWithInstallmentPricingApiVehicleData.Fault_Incurred
									Boolean lIsGetPlanWithInstallmentPricingApiFaultIncurredNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiFaultIncurred)
									if(lIsGetPlanWithInstallmentPricingApiFaultIncurredNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'FaultIncurred='+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiFaultIncurredEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiFaultIncurred)
										if(lIsGetPlanWithInstallmentPricingApiFaultIncurredEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'FaultIncurred='+lEmptyValue)
										}
									}
									String lGetPlanWithInstallmentPricingApiUwVehicleType=lMapGetPlanWithInstallmentPricingApiVehicleData.UW_Vehicle_Type
									Boolean lIsGetPlanWithInstallmentPricingApiUwVehicleTypeNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiUwVehicleType)
									if(lIsGetPlanWithInstallmentPricingApiUwVehicleTypeNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"UwVehicleType="+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiUwVehicleTypeEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiUwVehicleType)
										if(lIsGetPlanWithInstallmentPricingApiUwVehicleTypeEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleType='+lEmptyValue)
										}
									}
									...
									String lGetPlanWithInstallmentPricingApiVehicleInspectionLimit=lMapGetPlanWithInstallmentPricingApiVehicleData.Vehicle_Inspection_Limit
									...
									String lGetPlanWithInstallmentPricingApiUwVehicleTypeWarningFlag=lMapGetPlanWithInstallmentPricingApiVehicleData.UW_Vehicle_Type_Warning_Flag
									Boolean lIsGetPlanWithInstallmentPricingApiUwVehicleTypeWarningFlagNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiUwVehicleTypeWarningFlag)
									if(lIsGetPlanWithInstallmentPricingApiUwVehicleTypeWarningFlagNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"UwVehicleTypeWarningFlag="+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiUwVehicleTypeWarningFlagEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiUwVehicleTypeWarningFlag)
										if(lIsGetPlanWithInstallmentPricingApiUwVehicleTypeWarningFlagEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'UwVehicleTypeWarningFlag='+lEmptyValue)
										}
									}
									String lGetPlanWithInstallmentPricingApiCarDefaultValueFinal=lMapGetPlanWithInstallmentPricingApiVehicleData.Car_Default_Value_Final
									Boolean lIsGetPlanWithInstallmentPricingApiCarDefaultValueFinalNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiCarDefaultValueFinal)
									if(lIsGetPlanWithInstallmentPricingApiCarDefaultValueFinalNull){
										lIsObjectOK=false
										lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,"CarDefaultValueFinal="+lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiCarDefaultValueFinalEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiCarDefaultValueFinal)
										if(lIsGetPlanWithInstallmentPricingApiCarDefaultValueFinalEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'CarDefaultValueFinal='+lEmptyValue)
										}
									}
									String lGetPlanWithInstallmentPricingApiVehicleInspectionMethod=lMapGetPlanWithInstallmentPricingApiVehicleData.Vehicle_Inspection_Method
									...
									String lGetPlanWithInstallmentPricingApiWorkshop=lMapGetPlanWithInstallmentPricingApiVehicleData.Workshop
									...
									String lGetPlanWithInstallmentPricingApiFaultClaimForRating=lMapGetPlanWithInstallmentPricingApiVehicleData.Fault_Claims_For_Rating
									Boolean lIsGetPlanWithInstallmentPricingApiFaultClaimForRatingNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiFaultClaimForRating)
									if(lIsGetPlanWithInstallmentPricingApiFaultClaimForRatingNull){
										lIsObjectOK=false
										lText=lText+IGNUemaHelper.concatMessageLeftRightByPipe("FaultClaimForRating",lNullValue)
									}else{
										Boolean lIsGetPlanWithInstallmentPricingApiFaultClaimForRatingEmpty=IGNUemaHelper.checkObjectEmptyOfString(lGetPlanWithInstallmentPricingApiFaultClaimForRating)
										if(lIsGetPlanWithInstallmentPricingApiFaultClaimForRatingEmpty){
											lText=IGNUemaHelper.concatMessageLeftRightByPipe(lText,'FaultClaimForRating='+lEmptyValue)
										}
									}
									if(lText.length()>1){
						...
						List<String> lGetPlanWithInstallmentPricingApiPaymentDetailList=lMapJson.root.Quote.paymentDetails
						Boolean lIsGetPlanWithInstallmentPricingApiPaymentDetailListNull=IGNUemaHelper.checkObjectNullOfObject(lGetPlanWithInstallmentPricingApiPaymentDetailList)
						if(lIsGetPlanWithInstallmentPricingApiPaymentDetailListNull){
							lIsObjectOK=false
							...
							Boolean lIsGetPlanWithInstallmentPricingApiPaymentDetailListEmpty=IGNUemaHelper.checkObjectEmptyOfList(lGetPlanWithInstallmentPricingApiPaymentDetailList)
							if(lIsGetPlanWithInstallmentPricingApiPaymentDetailListEmpty){
								lIsObjectOK=false
								lVerifyGetPlanWithInstallmentPricingApiDetail=IGNUemaHelper.concatMessageLeftRightByPipe(lVerifyGetPlanWithInstallmentPricingApiDetail,'PaymentDetail='+lEmptyValue)
							}
						}
					}else{
						lIsObjectOK=false
		...
		try{
			...
			for(Integer lIndex=0;lIndex<=lCoverList.size()-1;lIndex++){
				...
				for(Integer lCoverageIndex=0;lCoverageIndex<=lCurrentCoverageList.size()-1;lCoverageIndex++){
					...
					Map lMapGetPlanWithInstallmentCoverData=lMapJsonGetPlanWithInstallmentResponse.root.Quote.Covers.get(lCover)
					String lCoverageName=lCurrentCoverageList.get(lCoverageIndex)
					String lCoverageIndexValue=THAPricingApiHelper.getPricingCoverageIndexValue(strProductType,lCoverageName)
				...
				if(!IGNUemaHelper.checkObjectEmptyOfString(lAdditionalCoveragePremiumWithoutLoadingValidationResultMessage)){
					lIsAdditionalCoveragePremiumMatchedValidationResultOK=false
					Map lMapGetPlanPremiumResultValidationResultMessage=lMapAdditionalCoveragePremiumValidationResultMessage.GetPlanValidationTestResult
				...
				if(!IGNUemaHelper.checkObjectEmptyOfString(lAdditionalCoveragePremiumWithLoadingValidationResultMessage)){
					lIsAdditionalCoveragePremiumMatchedValidationResultOK=false
					Map lMapGetPlanWithInstallmentPremiumResultValidationResultMessage=lMapAdditionalCoveragePremiumValidationResultMessage.GetPlanWithInstallmentValidationTestResult
	...
	public Boolean validateGetPlanPricingApiResult(Sheet targetSheet,String strTransactionType,Float numAnnualNetPremiumWithoutLoading,List strPricingApiTransactionList,List strCoverList,List strPricingApiJsonTotalPremiumList,String strGetPlanResponse,String strGetPlanWithInstallmentResponse,String strPaymentFrequency,String strGetPlanApiRequest,String strGetPlanWithInstallmentRequest,Map mapTotalInstallmentAndDownPaymentAmount){
		...
		try{
			...
			for(Integer lGetCellIndex=0;lGetCellIndex<=lSelectedPricingApiTransactionList.size()-1;lGetCellIndex++){
				...
				Map lMapCoverData=lMapJsonGetPlanResponse.root.Quote.Covers.get(lCoverName)
				Map lMapGetPlanWithInstallmentCoverData=lMapJsonGetPlanWithInstallmentResponse.root.Quote.Covers.get(lCoverName)
			...
			for(Integer lIndex=0;lIndex<=lPricingApiJsonTotalPremiumList.size()-1;lIndex++){
				...
				Integer lInputGetPlanResponseColumnNumber=lInputValidationTestResultColumnNumber+1
				Integer lInputGetPlanWithInstallmentResponseColumnNumber=lInputValidationTestResultColumnNumber+2
				...
				Map lMapGetPlanWithInstallmentTotalDownPaymentAndInstallmentAmountValidationResult=this.validateGetPlanWithInstallmentTotalDownPaymentAndInstallmentAmount(lTransactionType,lMapTotalInstallmentAndDownPaymentAmount,lMapJsonGetPlanWithInstallmentResponse)
	...
	public Map validateGetPlanWithInstallmentTotalDownPaymentAndInstallmentAmount(String strTransactionType,Map mapTotalInstallmentAndDownPaymentAmount,Map mapJsonGetPlanWithInstallmentResponse){
		Map lreturn=[:]
		Boolean lResult=false
