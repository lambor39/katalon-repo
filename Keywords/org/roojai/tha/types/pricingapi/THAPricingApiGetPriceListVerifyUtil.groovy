...
public class THAPricingApiGetPriceListVerifyUtil{
	private THATestStageControllerGroupPricingApiShareQuoteAllNameProductAllStoryGetPriceList parentStageController
	public THAPricingApiGetPriceListVerifyUtil(THATestStageControllerGroupPricingApiShareQuoteAllNameProductAllStoryGetPriceList initStageController){
		super()
		try{
