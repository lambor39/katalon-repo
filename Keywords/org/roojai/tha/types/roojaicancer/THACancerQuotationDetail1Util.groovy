...
public class THACancerQuotationDetail1Util{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THACancerQuotationDetail1Util(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THACancerQuotationDetail1Type.DEFAULT_POSITIVE_CASE
		}
		try{
	...
	public Map inputLanguage(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THACancerQuotationDetail1Type.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THACancerQuotationDetail1Type.DEFAULT_LANGUAGE)
			}
	...
	public Map inputSubmitCallMeBack(String strSubmitCallMeBack,String strCallMeBackEmail,String strCallMeBackMobile){
		...
		if(lSubmitCallMeBack.length()<=0){
			lSubmitCallMeBack=THACancerQuotationDetail1Type.DEFAULT_SUBMIT_CALL_ME_BACK
		}
		String lCallMeBackEmail=strCallMeBackEmail.trim()
		if(lCallMeBackEmail.length()<=0){
			lCallMeBackEmail=THACancerQuotationDetail1Type.DEFAULT_CALL_ME_BACK_EMAIL
		}
		String lCallMeBackMobile=strCallMeBackMobile.trim()
		if(lCallMeBackMobile.length()<=0){
			lCallMeBackMobile=THACancerQuotationDetail1Type.DEFAULT_CALL_ME_BACK_MOBILE
		}
		try{
			Boolean lResult=false
	...
	public Map inputHolderEmail(String strHolderEmail,String strHolderNewsletter){
		...
		if(lHolderEmail.length()<=0){
			lHolderEmail=THACancerQuotationDetail1Type.DEFAULT_HOLDER_EMAIL
		}
		String lHolderNewsletter=strHolderNewsletter.trim()
		if(lHolderNewsletter.length()<=0){
			lHolderNewsletter=THACancerQuotationDetail1Type.DEFAULT_HOLDER_NEWSLETTER
		}
		try{
			Boolean lResult=false
	...
	public Map inputHolderPhoneNo(String strHolderPhoneNo){
		...
		if(lHolderPhoneNo.length()<=0){
			lHolderPhoneNo=THACancerQuotationDetail1Type.DEFAULT_HOLDER_PHONE_NO
		}
		try{
			Boolean lResult=false
	...
	public Map inputHolderCallMeNowToDo(String strHolderCallMeNowToDo){
		...
		if(lHolderCallMeNowToDo.length()<=0){
			lHolderCallMeNowToDo=THACancerQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW_TO_DO
		}
		try{
			Boolean lResult=false
	...
	public Map inputHolderCallMeNow(String strHolderCallMeNow){
		...
		if(lHolderCallMeNow.length()<=0){
			lHolderCallMeNow=THACancerQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW.toUpperCase()
		}
		...
		try{
			...
			if(!lHolderCallMeNowItem){
				lHolderCallMeNowItem=lHolderCallMeNowList.get(THACancerQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW.toUpperCase())
			}
			lHolderCallMeNow=''
			...
			if(!lElementCallMeNowButton){
				lHolderCallMeNowItem=lHolderCallMeNowList.get(THACancerQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW)
	...
	public Map inputQueryQuestion(String strQueryTravelledHighRiskCountry,String strQueryHealthCondition,String strQueryInsuredDeniedCoverage,String strQueryDiedFromCancer,String strQueryOtherQuestion01,String strQueryOtherQuestion02,String strQueryOtherQuestion03,String strQueryOtherQuestion04,String strQueryOtherQuestion05,String strQueryOtherQuestion06,String strQueryOtherQuestion07,String strQueryOtherQuestion08,String strQueryOtherQuestion09,String strQueryOtherQuestion10,String strQueryHospitalIncomeBenefitQuestion01,String strQueryHospitalIncomeBenefitQuestion02,String strQueryHospitalIncomeBenefitQuestion03,String strQueryHospitalIncomeBenefitQuestion04,String strQueryHospitalIncomeBenefitQuestion05,String strQueryHospitalIncomeBenefitQuestion06,String strQueryHospitalIncomeBenefitQuestion07,String strQueryHospitalIncomeBenefitQuestion08,String strQueryHospitalIncomeBenefitQuestion09,String strQueryHospitalIncomeBenefitQuestion10){
		...
		if(lQueryHospitalIncomeBenefitQuestion01.length()<=0){
			lQueryHospitalIncomeBenefitQuestion01=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_01
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion02.length()<=0){
			lQueryHospitalIncomeBenefitQuestion02=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_02
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion03.length()<=0){
			lQueryHospitalIncomeBenefitQuestion03=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_03
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion04.length()<=0){
			lQueryHospitalIncomeBenefitQuestion04=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_04
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion05.length()<=0){
			lQueryHospitalIncomeBenefitQuestion05=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_05
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion06.length()<=0){
			lQueryHospitalIncomeBenefitQuestion06=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_06
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion07.length()<=0){
			lQueryHospitalIncomeBenefitQuestion07=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_07
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion08.length()<=0){
			lQueryHospitalIncomeBenefitQuestion08=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_08
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion09.length()<=0){
			lQueryHospitalIncomeBenefitQuestion09=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_09
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion10.length()<=0){
			lQueryHospitalIncomeBenefitQuestion10=THACancerQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_10
		}
		...
		try{
			...
			lreturn.put('Result',lResult)
			String lQueryTravelledHighRiskCountryItem=lQueryQuestionListAnswerTypeAnswerType1.get(lQueryTravelledHighRiskCountry)
			if(!lQueryTravelledHighRiskCountryItem){
				lQueryTravelledHighRiskCountryItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_TRAVELLED_HIGH_RISK_COUNTRY.toUpperCase())
			}
			lQueryTravelledHighRiskCountry=''
			Boolean lIsQueryTravelledHighRiskCountry=IGNUemaHelper.checkStringContainString(lQueryTravelledHighRiskCountryItem,'YES')
			...
			if(!lQueryHealthConditionItem){
				lQueryHealthConditionItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_HEALTH_CONDITION.toUpperCase())
			}
			lQueryHealthCondition=''
			...
			if(!lQueryInsuredDeniedCoverageItem){
				lQueryInsuredDeniedCoverageItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_INSURED_DENIED_COVERAGE.toUpperCase())
			}
			lQueryInsuredDeniedCoverage=''
			Boolean lIsQueryInsuredDeniedCoverage=IGNUemaHelper.checkStringContainString(lQueryInsuredDeniedCoverageItem,'YES')
			String lQueryDiedFromCancerItem=lQueryQuestionListAnswerTypeAnswerType1.get(lQueryDiedFromCancer)
			if(!lQueryDiedFromCancerItem){
				lQueryDiedFromCancerItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_DIED_FROM_CANCER.toUpperCase())
			}
			lQueryDiedFromCancer=''
			Boolean lIsQueryDiedFromCancer=IGNUemaHelper.checkStringContainString(lQueryDiedFromCancerItem,'YES')
			...
			if(!lQueryOtherQuestion01Item){
				lQueryOtherQuestion01Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_01.toUpperCase())
			}
			lQueryOtherQuestion01=''
			...
			if(!lQueryOtherQuestion02Item){
				lQueryOtherQuestion02Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_02.toUpperCase())
			}
			lQueryOtherQuestion02=''
			...
			if(!lQueryOtherQuestion03Item){
				lQueryOtherQuestion03Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_03.toUpperCase())
			}
			lQueryOtherQuestion03=''
			...
			if(!lQueryOtherQuestion04Item){
				lQueryOtherQuestion04Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_04.toUpperCase())
			}
			lQueryOtherQuestion04=''
			...
			if(!lQueryOtherQuestion05Item){
				lQueryOtherQuestion05Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_05.toUpperCase())
			}
			lQueryOtherQuestion05=''
			...
			if(!lQueryOtherQuestion06Item){
				lQueryOtherQuestion06Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_06.toUpperCase())
			}
			lQueryOtherQuestion06=''
			...
			if(!lQueryOtherQuestion07Item){
				lQueryOtherQuestion07Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_07.toUpperCase())
			}
			lQueryOtherQuestion07=''
			...
			if(!lQueryOtherQuestion08Item){
				lQueryOtherQuestion08Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_08.toUpperCase())
			}
			lQueryOtherQuestion08=''
			...
			if(!lQueryOtherQuestion09Item){
				lQueryOtherQuestion09Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_09.toUpperCase())
			}
			lQueryOtherQuestion09=''
			...
			if(!lQueryOtherQuestion10Item){
				lQueryOtherQuestion10Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_10.toUpperCase())
			}
			lQueryOtherQuestion10=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion01Item){
				lQueryHospitalIncomeBenefitQuestion01Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_01.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion01=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion02Item){
				lQueryHospitalIncomeBenefitQuestion02Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_02.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion02=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion03Item){
				lQueryHospitalIncomeBenefitQuestion03Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_03.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion03=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion04Item){
				lQueryHospitalIncomeBenefitQuestion04Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_04.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion04=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion05Item){
				lQueryHospitalIncomeBenefitQuestion05Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_05.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion05=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion06Item){
				lQueryHospitalIncomeBenefitQuestion06Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_06.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion06=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion07Item){
				lQueryHospitalIncomeBenefitQuestion07Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_07.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion07=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion08Item){
				lQueryHospitalIncomeBenefitQuestion08Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_08.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion08=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion09Item){
				lQueryHospitalIncomeBenefitQuestion09Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_09.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion09=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion10Item){
				lQueryHospitalIncomeBenefitQuestion10Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationResultType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_10.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion10=''
			...
			Boolean lIsDoneQueryTravelledHighRiskCountry=false
			Boolean lIsDoneQueryHealthCondition=false
			Boolean lIsDoneQueryInsuredDeniedCoverage=false
			Boolean lIsDoneQueryDiedFromCancer=false
			...
			String lTagQueryTravelledHighRiskCountryButtonKey='productQuestion-PSQ0001'
			String lTagQueryTravelledHighRiskCountryButtonValue=lQueryTravelledHighRiskCountryItem
			String lLocatorQueryTravelledHighRiskCountryButton=IGNUemaHelper.getTagDataSeleniumKeyValueEqual(lTagQueryTravelledHighRiskCountryButtonKey,lTagQueryTravelledHighRiskCountryButtonValue)
			WebElement lElementQueryTravelledHighRiskCountryButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueEqual(this.driver,lTagQueryTravelledHighRiskCountryButtonKey,lTagQueryTravelledHighRiskCountryButtonValue)
			String lTagQueryHealthConditionButtonKey='productQuestion-TMQ002'
			...
			String lTagQueryDiedFromCancerButtonKey='productQuestion-TMQ050'
			String lTagQueryDiedFromCancerButtonValue=lQueryDiedFromCancerItem
			String lLocatorQueryDiedFromCancerButton=IGNUemaHelper.getTagDataSeleniumKeyValueEqual(lTagQueryDiedFromCancerButtonKey,lTagQueryDiedFromCancerButtonValue)
			WebElement lElementQueryDiedFromCancerButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueEqual(this.driver,lTagQueryDiedFromCancerButtonKey,lTagQueryDiedFromCancerButtonValue)
			String lTagQueryOtherQuestion01ButtonKey='productQuestion-RJTMQ020'
			...
			if(lElementCheckPointNextButton){
				lQueryTravelledHighRiskCountry='No Option'
				lQueryHealthCondition='No Option'
				lQueryInsuredDeniedCoverage='No Option'
				lQueryDiedFromCancer='No Option'
				...
				lElementQueryTravelledHighRiskCountryButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueEqual(this.driver,lTagQueryTravelledHighRiskCountryButtonKey,lTagQueryTravelledHighRiskCountryButtonValue)
				if(!lElementQueryTravelledHighRiskCountryButton){
					IGNUemaHelper.delayThreadSecond(2)
					lElementQueryTravelledHighRiskCountryButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueEqual(this.driver,lTagQueryTravelledHighRiskCountryButtonKey,lTagQueryTravelledHighRiskCountryButtonValue)
				}
				if(lElementQueryTravelledHighRiskCountryButton){
					if(!lIsDoneQueryTravelledHighRiskCountry){
						lIsDoneQueryTravelledHighRiskCountry=IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementQueryTravelledHighRiskCountryButton)
						if(lIsDoneQueryTravelledHighRiskCountry){
							lQueryTravelledHighRiskCountry=lQueryTravelledHighRiskCountryItem
							lQueryTravelledHighRiskCountry=IGNUemaHelper.concatMessageLeftRightByPipe(lQueryTravelledHighRiskCountry,IGNUemaHelper.getChildTextByWebElement(this.driver,lElementQueryTravelledHighRiskCountryButton))
						}
						if(lIsQueryTravelledHighRiskCountry){
							String lTagQueryTravelledHighRiskCountryButtonClose=''
							String lLocatorQueryTravelledHighRiskCountryButtonClose='#thankyou-modal button'
							if(IGNUemaHelper.checkElementPresentByLocator(this.driver,lLocatorQueryTravelledHighRiskCountryButtonClose,15)){
								WebElement lElementQueryTravelledHighRiskCountryButtonClose=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorQueryTravelledHighRiskCountryButtonClose)
								IGNUemaHelper.webJsScrollToElement(this.driver,lElementQueryTravelledHighRiskCountryButtonClose)
								IGNUemaHelper.webJsClickWebElementFinalWithScroll(this.driver,lElementQueryTravelledHighRiskCountryButtonClose)
							}
						}
						IGNUemaHelper.delayThreadSecond(1)
					}
				...
				lElementQueryDiedFromCancerButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueEqual(this.driver,lTagQueryDiedFromCancerButtonKey,lTagQueryDiedFromCancerButtonValue)
				if(!lElementQueryDiedFromCancerButton){
					IGNUemaHelper.delayThreadSecond(2)
					lElementQueryDiedFromCancerButton=IGNUemaHelper.getWebElementFromDataSeleniumKeyValueEqual(this.driver,lTagQueryDiedFromCancerButtonKey,lTagQueryDiedFromCancerButtonValue)
				}
				if(lElementQueryDiedFromCancerButton){
					if(!lIsDoneQueryDiedFromCancer){
						lIsDoneQueryDiedFromCancer=IGNUemaHelper.clickByWebElementWithScroll(this.driver,lElementQueryDiedFromCancerButton)
						if(lIsDoneQueryDiedFromCancer){
							lQueryDiedFromCancer=lQueryDiedFromCancerItem
							lQueryDiedFromCancer=IGNUemaHelper.concatMessageLeftRightByPipe(lQueryDiedFromCancer,IGNUemaHelper.getChildTextByWebElement(this.driver,lElementQueryDiedFromCancerButton))
						}
						if(lIsQueryDiedFromCancer){
							String lTagQueryDiedFromCancerButtonClose=''
							String lLocatorQueryDiedFromCancerButtonClose='#thankyou-modal button'
							if(IGNUemaHelper.checkElementPresentByLocator(this.driver,lLocatorQueryDiedFromCancerButtonClose,15)){
								WebElement lElementQueryDiedFromCancerButtonClose=IGNUemaHelper.getWebElementFromCssLocator(this.driver,lLocatorQueryDiedFromCancerButtonClose)
								IGNUemaHelper.webJsScrollToElement(this.driver,lElementQueryDiedFromCancerButtonClose)
								IGNUemaHelper.webJsClickWebElementFinalWithScroll(this.driver,lElementQueryDiedFromCancerButtonClose)
							}
						}
						IGNUemaHelper.delayThreadSecond(1)
					}
			...
			if(!lElementQueryTravelledHighRiskCountryButton){
				...
				lIsDoneQueryAll=lIsDoneQueryAll&&lIsDoneQueryTravelledHighRiskCountry
			}
			if(!lElementQueryHealthConditionButton){
				lQueryHealthCondition='No Option'
			}else{
			...
			if(!lElementQueryDiedFromCancerButton){
				...
				lIsDoneQueryAll=lIsDoneQueryAll&&lIsDoneQueryDiedFromCancer
			}
			if(!lElementQueryOtherQuestion01Button){
				lQueryOtherQuestion01='No Option'
			}else{
	...
	public Map inputInsuredEdit(String strInsuredEdit,String strInsuredGenderAndMaritalStatus,String strInsuredBirthDateMain){
		...
		if(lInsuredEdit.length()<=0){
			lInsuredEdit=THACancerQuotationDetail1Type.DEFAULT_INSURED_EDIT
		}
		...
		if(lInsuredGenderAndMaritalStatus.length()<=0){
			lInsuredGenderAndMaritalStatus=THACancerQuotationDetail1Type.DEFAULT_INSURED_GENDER_AND_MARITAL_STATUS
		}
		String lInsuredBirthDateMain=strInsuredBirthDateMain.trim()
		if(lInsuredBirthDateMain.length()<=0){
			lInsuredBirthDateMain=THACancerQuotationDetail1Type.DEFAULT_INSURED_BIRTH_DATE_MAIN
		}
		...
		try{
			...
			if(!lGenderAndMaritalStatusItem){
				lGenderAndMaritalStatusItem=lInsuredGenderAndMaritalStatusList.get(THACancerQuotationDetail1Type.DEFAULT_INSURED_GENDER_AND_MARITAL_STATUS)
			}
			if(lIsInsuredEdit){
	...
	public Map inputNationality(String strNationalityThai,String strNationalityThaiId,String strNationalityPassportId,String strNationalityPassportCountry){
		...
		if(lNationalityThai.length()<=0){
			lNationalityThai=THACancerQuotationDetail1Type.DEFAULT_NATIONALITY_THAI
		}
		String lNationalityThaiId=strNationalityThaiId.trim()
		if(lNationalityThaiId.length()<=0){
			lNationalityThaiId=THACancerQuotationDetail1Type.DEFAULT_NATIONALITY_THAI_ID
		}
		String lNationalityPassportId=strNationalityPassportId.trim()
		if(lNationalityPassportId.length()<=0){
			lNationalityPassportId=THACancerQuotationDetail1Type.DEFAULT_NATIONALITY_PASSPORT_ID
		}
		String lNationalityPassportCountry=strNationalityPassportCountry.trim()
		if(lNationalityPassportCountry.length()<=0){
			lNationalityPassportCountry=THACancerQuotationDetail1Type.DEFAULT_NATIONALITY_PASSPORT_COUNTRY
		}
		...
		try{
			...
			if(!lNationalityThaiItem){
				lNationalityThaiItem=lNationalityThaiList.get(THACancerQuotationDetail1Type.DEFAULT_NATIONALITY_THAI.toUpperCase())
			}
			lNationalityThai=''
	...
	public Map inputHolderFirstName(String strHolderFirstName){
		...
		if(lHolderFirstName.length()<=0){
			lHolderFirstName=THACancerQuotationDetail1Type.DEFAULT_HOLDER_FIRST_NAME
		}
		try{
			Boolean lResult=false
	...
	public Map inputHolderLastName(String strHolderLastName){
		...
		if(lHolderLastName.length()<=0){
			lHolderLastName=THACancerQuotationDetail1Type.DEFAULT_HOLDER_LAST_NAME
		}
		try{
			Boolean lResult=false
	...
	public Map inputPolicyStartDate(String strPolicyStartDate,String strPolicyStartOffsetDay){
		...
		if(lPolicyStartDate.length()<=0){
			lPolicyStartDate=THACancerQuotationDetail1Type.DEFAULT_POLICY_START_DATE
		}
		...
		if(lPolicyStartOffsetDay.length()<=0){
			lPolicyStartOffsetDay=THACancerQuotationDetail1Type.DEFAULT_POLICY_START_OFFSET_DAY
		}
	...
	public Map inputAddressPostalCode(String strAddressPostalCode){
		...
		if(lAddressPostalCode.length()<=0){
			lAddressPostalCode=THACancerQuotationDetail1Type.DEFAULT_ADDRESS_POSTAL_CODE
		}
		try{
			Boolean lResult=false
	...
	public Map inputAddressProvince(String strAddressProvince){
		...
		if(lAddressProvince.length()<=0){
			lAddressProvince=THACancerQuotationDetail1Type.DEFAULT_ADDRESS_PROVINCE
		}
		try{
			Boolean lResult=false
	...
	public Map inputAddressDistrict(String strAddressDistrict){
		...
		if(lAddressDistrict.length()<=0){
			lAddressDistrict=THACancerQuotationDetail1Type.DEFAULT_ADDRESS_DISTRICT
		}
		try{
			Boolean lResult=false
	...
	public Map inputAddressSubdistrict(String strAddressSubdistrict){
		...
		if(lAddressSubdistrict.length()<=0){
			lAddressSubdistrict=THACancerQuotationDetail1Type.DEFAULT_ADDRESS_SUBDISTRICT
		}
		try{
			Boolean lResult=false
	...
	public Map inputAddressRoad(String strAddressRoad){
		...
		if(lAddressRoad.length()<=0){
			lAddressRoad=THACancerQuotationDetail1Type.DEFAULT_ADDRESS_ROAD
		}
		try{
			Boolean lResult=false
	...
	public Map inputAddressBuildingName(String strAddressBuildingName){
		...
		if(lAddressBuildingName.length()<=0){
			lAddressBuildingName=THACancerQuotationDetail1Type.DEFAULT_ADDRESS_BUILDING_NAME
		}
		try{
			Boolean lResult=false
	...
	public Map inputAddressBuildingNumber(String strAddressBuildingNumber){
		...
		if(lAddressBuildingNumber.length()<=0){
			lAddressBuildingNumber=THACancerQuotationDetail1Type.DEFAULT_ADDRESS_BUILDING_NUMBER
		}
		try{
			Boolean lResult=false
	...
	public Map inputLegalHeir(String strLegalHeir){
		...
		if(lLegalHeir.length()<=0){
			lLegalHeir=THACancerQuotationDetail1Type.DEFAULT_LEGAL_HEIR
		}
		try{
			Boolean lResult=false
	...
	public Map inputBeneficiaryAdd(String strBeneficiary1Add,String strBeneficiary1FirstName,String strBeneficiary1LastName,String strBeneficiary1Relationship,String strBeneficiary1Percentage,String strBeneficiary2Add,String strBeneficiary2FirstName,String strBeneficiary2LastName,String strBeneficiary2Relationship,String strBeneficiary2Percentage,String strBeneficiary3Add,String strBeneficiary3FirstName,String strBeneficiary3LastName,String strBeneficiary3Relationship,String strBeneficiary3Percentage){
		...
		try{
			...
			if(!lBeneficiary1RelationshipItem){
				lBeneficiary1RelationshipItem=lBeneficiaryRelationshipList.get(THACancerQuotationDetail1Type.DEFAULT_BENEFICIARY1_RELATIONSHIP)
			}
			...
			if(!lBeneficiary1PercentageItem){
				lBeneficiary1PercentageItem=lBeneficiaryPercentageList.get(THACancerQuotationDetail1Type.DEFAULT_BENEFICIARY1_PERCENTAGE)
			}
			...
			if(!lBeneficiary2RelationshipItem){
				lBeneficiary2RelationshipItem=lBeneficiaryRelationshipList.get(THACancerQuotationDetail1Type.DEFAULT_BENEFICIARY2_RELATIONSHIP)
			}
			...
			if(!lBeneficiary2PercentageItem){
				lBeneficiary2PercentageItem=lBeneficiaryPercentageList.get(THACancerQuotationDetail1Type.DEFAULT_BENEFICIARY2_PERCENTAGE)
			}
			...
			if(!lBeneficiary3RelationshipItem){
				lBeneficiary3RelationshipItem=lBeneficiaryRelationshipList.get(THACancerQuotationDetail1Type.DEFAULT_BENEFICIARY3_RELATIONSHIP)
			}
			...
			if(!lBeneficiary3PercentageItem){
				lBeneficiary3PercentageItem=lBeneficiaryPercentageList.get(THACancerQuotationDetail1Type.DEFAULT_BENEFICIARY3_PERCENTAGE)
			}
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THACancerQuotationDetail1Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
	...
	public Map inputActualResult(Boolean isPositiveCase,String strHolderPhoneNo,Boolean isSkipOTP){
		...
		try{
			...
			this.waitUntilOpportunityNumberUpdated()
			lOpportunityNumber=THACancerCoreType.CURRENT_QUOTATION_HEALTH_OPPORTUNITY_NUMBER.trim()
