...
public class THACancerQuotationInputType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteCancer/Cancer_Quotation_01_Input.Input'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteCancer/Cancer_Quotation_01_Input.Output'
	...
	public static final String DEFAULT_CMS_BASE_URL_FORM_MINI='https://www.uat-roojai.com/cancer'
	...
	public static final String DEFAULT_BASE_URL='https://insure.uat-roojai.com/quote/#/?productType=health'
	...
	public Map Input=[:]
	public Map Output=[:]
	public THACancerQuotationInputType(){
		super()
		this.initInput()
		this.initOutput()
	}
