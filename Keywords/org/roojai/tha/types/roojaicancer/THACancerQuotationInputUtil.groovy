...
public class THACancerQuotationInputUtil{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THACancerQuotationInputUtil(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Map inputVersion(String strBaseUrl,String strVersion){
		...
		if(lBaseUrl.length()<=0){
			lBaseUrl=THACancerQuotationInputType.DEFAULT_BASE_URL
		}
		String lDefaultVersion=THACancerQuotationInputType.DEFAULT_VERSION
	...
	public Boolean inputInputFromCmsMain(Map caseInput,Map caseOutput){
		...
		try{
			...
			Boolean lIsCmsMainProductCancer=false
			...
			if(lElementCmsMainProductButtontList){
				for(WebElement lElementCmsMainProductButtontItem in lElementCmsMainProductButtontList){
					...
					lIsCmsMainProductCancer=IGNUemaHelper.checkStringContainString(lCmsMainProductButtontHrefText,'productType=cancer')
					if(lIsCmsMainProductCancer){
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THACancerQuotationInputType.DEFAULT_POSITIVE_CASE
		}
		try{
			Boolean lResult=false
	...
	public Map inputCmsLanguage(String strCmsLanguage){
		...
		if(lCmsLanguage.length()<=0){
			lCmsLanguage=THACancerQuotationInputType.DEFAULT_CMS_LANGUAGE
		}
		...
		try{
			...
			if(!lCmsLanguageItem){
				lCmsLanguageItem=lCmsLanguageList.get(THACancerQuotationInputType.DEFAULT_CMS_LANGUAGE)
			}
			lCmsLanguage=''
	...
	public Map inputLanguageA(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THACancerQuotationInputType.DEFAULT_LANGUAGE
		}
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THACancerQuotationInputType.DEFAULT_LANGUAGE)
			}
	...
	public Map inputCmsGenderAndMaritalStatus(String strCmsGenderAndMaritalStatus){
		...
		if(lCmsGenderAndMaritalStatus.length()<=0){
			lCmsGenderAndMaritalStatus=THACancerQuotationInputType.DEFAULT_CMS_GENDER_AND_MARITAL_STATUS
		}
		...
		try{
			...
			if(!lCmsGenderAndMaritalStatusItem){
				lCmsGenderAndMaritalStatusItem=lCmsGenderAndMaritalStatusList.get(THACancerQuotationInputType.DEFAULT_CMS_GENDER_AND_MARITAL_STATUS)
			}
	...
	public Map inputGenderAndMaritalStatusA(String strGenderAndMaritalStatus){
		...
		if(lGenderAndMaritalStatus.length()<=0){
			lGenderAndMaritalStatus=THACancerQuotationInputType.DEFAULT_GENDER_AND_MARITAL_STATUS
		}
		...
		try{
			...
			if(!lGenderAndMaritalStatusItem){
				lGenderAndMaritalStatusItem=lGenderAndMaritalStatusList.get(THACancerQuotationInputType.DEFAULT_GENDER_AND_MARITAL_STATUS)
			}
			lGenderAndMaritalStatus=''
	...
	public Map inputCmsBirthDateMain(String strCmsBirthDateMain){
		...
		if(lCmsBirthDateMain.length()<=0){
			lCmsBirthDateMain=THACancerQuotationInputType.DEFAULT_CMS_BIRTH_DATE_MAIN
		}
		try{
			Boolean lResult=false
	...
	public Map inputBirthDateMainA(String strBirthDateMain){
		...
		if(lBirthDateMain.length()<=0){
			lBirthDateMain=THACancerQuotationInputType.DEFAULT_BIRTH_DATE_MAIN
		}
		try{
			Boolean lResult=false
			lreturn.put('BirthDateMain','')
	...
	public Map inputCmsHeight(String strCmsHeight){
		...
		if(lCmsHeight.length()<=0){
			lCmsHeight=THACancerQuotationInputType.DEFAULT_CMS_HEIGHT
		}
		try{
			Boolean lResult=false
	...
	public Map inputHeightA(String strHeight){
		...
		if(lHeight.length()<=0){
			lHeight=THACancerQuotationInputType.DEFAULT_HEIGHT
		}
		try{
			Boolean lResult=false
			lreturn.put('Height','')
	...
	public Map inputCmsWeight(String strCmsWeight){
		...
		if(lCmsWeight.length()<=0){
			lCmsWeight=THACancerQuotationInputType.DEFAULT_CMS_WEIGHT
		}
		try{
			Boolean lResult=false
	...
	public Map inputWeightA(String strWeight){
		...
		if(lWeight.length()<=0){
			lWeight=THACancerQuotationInputType.DEFAULT_WEIGHT
		}
		try{
			Boolean lResult=false
			lreturn.put('Weight','')
	...
	public Map inputCmsInsuredOccupation(String strCmsInsuredOccupation){
		...
		if(lCmsInsuredOccupation.length()<=0){
			lCmsInsuredOccupation=THACancerQuotationInputType.DEFAULT_CMS_INSURED_OCCUPATION
		}
		try{
			Boolean lResult=false
	...
	public Map inputInsuredOccupationA(String strInsuredOccupation){
		...
		if(lInsuredOccupation.length()<=0){
			lInsuredOccupation=THACancerQuotationInputType.DEFAULT_INSURED_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('InsuredOccupation','')
	...
	public Map inputCmsInsuredSalary(String strCmsInsuredSalary){
		...
		if(lCmsInsuredSalary.length()<=0){
			lCmsInsuredSalary=THACancerQuotationInputType.DEFAULT_CMS_INSURED_SALARY
		}
		...
		try{
			...
			if(!lCmsInsuredSalaryItem){
				lCmsInsuredSalaryItem=lCmsInsuredSalaryList.get(THACancerQuotationInputType.DEFAULT_CMS_INSURED_SALARY)
			}
			lCmsInsuredSalary=''
	...
	public Map inputInsuredSalaryA(String strInsuredSalary){
		...
		if(lInsuredSalary.length()<=0){
			lInsuredSalary=THACancerQuotationInputType.DEFAULT_INSURED_SALARY
		}
		...
		try{
			...
			if(!lInsuredSalaryItem){
				lInsuredSalaryItem=lInsuredSalaryList.get(THACancerQuotationInputType.DEFAULT_INSURED_SALARY)
			}
			lInsuredSalary=''
			String lTagSliderInput='slider-income-input'
			String lLocatorSliderInput=IGNUemaHelper.getTagDataSeleniumKey(lTagSliderInput)
	...
	public Map inputCmsSmokingHabbit(String strCmsSmokingHabbit){
		...
		if(lCmsSmokingHabbit.length()<=0){
			lCmsSmokingHabbit=THACancerQuotationInputType.DEFAULT_CMS_SMOKING_HABBIT
		}
		...
		try{
			...
			if(!lCmsSmokingHabbitItem){
				lCmsSmokingHabbitItem=lCmsSmokingHabbitList.get(THACancerQuotationInputType.DEFAULT_CMS_SMOKING_HABBIT.toUpperCase())
			}
			lCmsSmokingHabbit=''
	...
	public Map inputSmokingHabbitA(String strSmokingHabbit){
		...
		if(lSmokingHabbit.length()<=0){
			lSmokingHabbit=THACancerQuotationInputType.DEFAULT_SMOKING_HABBIT
		}
		...
		try{
			...
			if(!lSmokingHabbitItem){
				lSmokingHabbitItem=lSmokingHabbitList.get(THACancerQuotationInputType.DEFAULT_SMOKING_HABBIT.toUpperCase())
			}
			lSmokingHabbit=''
	...
	public Map inputCmsKeepDetailA(String strCmsKeepDetail,String strCmsLanguage,String strCmsGenderAndMaritalStatus,String strCmsBirthDateMain,String strCmsHeight,String strCmsWeight,String strCmsInsuredOccupation,String strCmsInsuredSalary,String strCmsSmokingHabbit){
		...
		if(lCmsKeepDetail.length()<=0){
			lCmsKeepDetail=THACancerQuotationInputType.DEFAULT_CMS_KEEP_DETAIL
		}
	...
	public Map inputQueryQuestion(String strQueryTravelledHighRiskCountry,String strQueryHealthCondition,String strQueryInsuredDeniedCoverage,String strQueryDiedFromCancer,String strQueryOtherQuestion01,String strQueryOtherQuestion02,String strQueryOtherQuestion03,String strQueryOtherQuestion04,String strQueryOtherQuestion05,String strQueryOtherQuestion06,String strQueryOtherQuestion07,String strQueryOtherQuestion08,String strQueryOtherQuestion09,String strQueryOtherQuestion10){
		...
		try{
			...
			if(IGNUemaHelper.CURRENT_AB_TESTING_ENABLE){
				switch(IGNUemaHelper.CURRENT_AB_TESTING_VERSION){
					case 'A':
						lreturn=this.inputQueryQuestionA(strQueryTravelledHighRiskCountry,strQueryHealthCondition,strQueryInsuredDeniedCoverage,strQueryDiedFromCancer,strQueryOtherQuestion01,strQueryOtherQuestion02,strQueryOtherQuestion03,strQueryOtherQuestion04,strQueryOtherQuestion05,strQueryOtherQuestion06,strQueryOtherQuestion07,strQueryOtherQuestion08,strQueryOtherQuestion09,strQueryOtherQuestion10)
						break
					case 'B':
						lreturn=this.inputQueryQuestionB(strQueryTravelledHighRiskCountry,strQueryHealthCondition,strQueryInsuredDeniedCoverage,strQueryDiedFromCancer,strQueryOtherQuestion01,strQueryOtherQuestion02,strQueryOtherQuestion03,strQueryOtherQuestion04,strQueryOtherQuestion05,strQueryOtherQuestion06,strQueryOtherQuestion07,strQueryOtherQuestion08,strQueryOtherQuestion09,strQueryOtherQuestion10)
						break
					default:
						return lreturn
						break
	...
	public Map inputQueryQuestionA(String strQueryTravelledHighRiskCountry,String strQueryHealthCondition,String strQueryInsuredDeniedCoverage,String strQueryDiedFromCancer,String strQueryOtherQuestion01,String strQueryOtherQuestion02,String strQueryOtherQuestion03,String strQueryOtherQuestion04,String strQueryOtherQuestion05,String strQueryOtherQuestion06,String strQueryOtherQuestion07,String strQueryOtherQuestion08,String strQueryOtherQuestion09,String strQueryOtherQuestion10){
		Map lreturn=[:]
		...
		try{
			...
			if(!lQueryTravelledHighRiskCountryItem){
				lQueryTravelledHighRiskCountryItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_TRAVELLED_HIGH_RISK_COUNTRY.toUpperCase())
			}
			lQueryTravelledHighRiskCountry=''
			...
			if(!lQueryHealthConditionItem){
				lQueryHealthConditionItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HEALTH_CONDITION.toUpperCase())
			}
			lQueryHealthCondition=''
			...
			if(!lQueryInsuredDeniedCoverageItem){
				lQueryInsuredDeniedCoverageItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_INSURED_DENIED_COVERAGE.toUpperCase())
			}
			lQueryInsuredDeniedCoverage=''
			...
			if(!lQueryDiedFromCancerItem){
				lQueryDiedFromCancerItem=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_DIED_FROM_CANCER.toUpperCase())
			}
			lQueryDiedFromCancer=''
			...
			if(!lQueryOtherQuestion01Item){
				lQueryOtherQuestion01Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_01.toUpperCase())
			}
			lQueryOtherQuestion01=''
			...
			if(!lQueryOtherQuestion02Item){
				lQueryOtherQuestion02Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_02.toUpperCase())
			}
			lQueryOtherQuestion02=''
			...
			if(!lQueryOtherQuestion03Item){
				lQueryOtherQuestion03Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_03.toUpperCase())
			}
			lQueryOtherQuestion03=''
			...
			if(!lQueryOtherQuestion04Item){
				lQueryOtherQuestion04Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_04.toUpperCase())
			}
			lQueryOtherQuestion04=''
			...
			if(!lQueryOtherQuestion05Item){
				lQueryOtherQuestion05Item=lQueryQuestionListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_OTHER_QUESTION_05.toUpperCase())
			}
			lQueryOtherQuestion05=''
	...
	public Map inputQueryQuestionB(String strQueryTravelledHighRiskCountry,String strQueryHealthCondition,String strQueryInsuredDeniedCoverage,String strQueryDiedFromCancer,String strQueryOtherQuestion01,String strQueryOtherQuestion02,String strQueryOtherQuestion03,String strQueryOtherQuestion04,String strQueryOtherQuestion05,String strQueryOtherQuestion06,String strQueryOtherQuestion07,String strQueryOtherQuestion08,String strQueryOtherQuestion09,String strQueryOtherQuestion10){
		Map lreturn=[:]
		String lQueryTravelledHighRiskCountry=strQueryTravelledHighRiskCountry.toUpperCase().trim()
		if(lQueryTravelledHighRiskCountry.length()<=0){
			lQueryTravelledHighRiskCountry=THACancerQuotationInputType.DEFAULT_QUERY_TRAVELLED_HIGH_RISK_COUNTRY
	...
	public Map inputQueryHospitalIncomeBenefitToDoA(String strQueryHospitalIncomeBenefitToDo,String strQueryHospitalIncomeBenefitQuestion01,String strQueryHospitalIncomeBenefitQuestion02,String strQueryHospitalIncomeBenefitQuestion03,String strQueryHospitalIncomeBenefitQuestion04,String strQueryHospitalIncomeBenefitQuestion05,String strQueryHospitalIncomeBenefitQuestion06,String strQueryHospitalIncomeBenefitQuestion07,String strQueryHospitalIncomeBenefitQuestion08,String strQueryHospitalIncomeBenefitQuestion09,String strQueryHospitalIncomeBenefitQuestion10){
		...
		if(lQueryHospitalIncomeBenefitToDo.length()<=0){
			lQueryHospitalIncomeBenefitToDo=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_TO_DO
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion01.length()<=0){
			lQueryHospitalIncomeBenefitQuestion01=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_01
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion02.length()<=0){
			lQueryHospitalIncomeBenefitQuestion02=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_02
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion03.length()<=0){
			lQueryHospitalIncomeBenefitQuestion03=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_03
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion04.length()<=0){
			lQueryHospitalIncomeBenefitQuestion04=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_04
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion05.length()<=0){
			lQueryHospitalIncomeBenefitQuestion05=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_05
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion06.length()<=0){
			lQueryHospitalIncomeBenefitQuestion06=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_06
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion07.length()<=0){
			lQueryHospitalIncomeBenefitQuestion07=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_07
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion08.length()<=0){
			lQueryHospitalIncomeBenefitQuestion08=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_08
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion09.length()<=0){
			lQueryHospitalIncomeBenefitQuestion09=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_09
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion10.length()<=0){
			lQueryHospitalIncomeBenefitQuestion10=THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_10
		}
		...
		try{
			...
			if(!lQueryHospitalIncomeBenefitToDoItem){
				lQueryHospitalIncomeBenefitToDoItem=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_01.toUpperCase())
			}
			lQueryHospitalIncomeBenefitToDo=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion01Item){
				lQueryHospitalIncomeBenefitQuestion01Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_01.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion01=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion02Item){
				lQueryHospitalIncomeBenefitQuestion02Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_02.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion02=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion03Item){
				lQueryHospitalIncomeBenefitQuestion03Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_03.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion03=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion04Item){
				lQueryHospitalIncomeBenefitQuestion04Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_04.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion04=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion05Item){
				lQueryHospitalIncomeBenefitQuestion05Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_05.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion05=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion06Item){
				lQueryHospitalIncomeBenefitQuestion06Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_06.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion06=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion07Item){
				lQueryHospitalIncomeBenefitQuestion07Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_07.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion07=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion08Item){
				lQueryHospitalIncomeBenefitQuestion08Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_08.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion08=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion09Item){
				lQueryHospitalIncomeBenefitQuestion09Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_09.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion09=''
			...
			if(!lQueryHospitalIncomeBenefitQuestion10Item){
				lQueryHospitalIncomeBenefitQuestion10Item=lQueryHospitalIncomeBenefitToDoListAnswerTypeAnswerType1.get(THACancerQuotationInputType.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_10.toUpperCase())
			}
			lQueryHospitalIncomeBenefitQuestion10=''
