...
public class THARoojaiCovidQuotationVerifyType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/RoojaiCovid/RoojaiCovid_00_Verify.Input'
	public static final String INPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_RoojaiCovid.xlsx'
	public static final String INPUT_EXCEL_SHEET_NAME='RoojaiCovid_Verify'
	public static final Integer INPUT_EXCEL_COL_BEGIN=2
	public static final Integer INPUT_EXCEL_ROW_BEGIN=1
	public static final Integer INPUT_EXCEL_ROW_END=3
	public static final Integer INPUT_DATA_COL_BEGIN=3
	public static final Integer INPUT_DATA_ROW_BEGIN=1
	public static final Integer INPUT_DATA_ROW_END=4
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/RoojaiCovid/RoojaiCovid_00_Verify.Output'
	public static final String OUTPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_RoojaiCovid.xlsx'
	public static final String OUTPUT_EXCEL_SHEET_NAME='RoojaiCovid_Verify'
	public static final Integer OUTPUT_EXCEL_COL_BEGIN=2
	public static final Integer OUTPUT_EXCEL_ROW_BEGIN=1
	public static final Integer OUTPUT_EXCEL_ROW_END=3
	public static final Integer OUTPUT_DATA_COL_BEGIN=3
	public static final Integer OUTPUT_DATA_ROW_BEGIN=1
	public static final Integer OUTPUT_DATA_ROW_END=4
	//Constant
	public static final String DEFAULT_ROOJAI_COVID_INPUT=''
	public static final String DEFAULT_ROOJAI_COVID_DETAIL=''
	public static final String DEFAULT_ROOJAI_COVID_PAYMENT=''
	public static final String DEFAULT_ACTUAL_RESULT=''
	public Map Input=[:]
	public Map Output=[:]
	public THARoojaiCovidQuotationVerifyType(){
		super()
		this.initInput()
		this.initOutput()
	}
	...
	public void initInput(){
		this.Input.clear()
		this.Input.put('RoojaiCovidInput',this.DEFAULT_ROOJAI_COVID_INPUT)
		this.Input.put('RoojaiCovidDetail',this.DEFAULT_ROOJAI_COVID_DETAIL)
		this.Input.put('RoojaiCovidPayment',this.DEFAULT_ROOJAI_COVID_PAYMENT)
		this.Input.put('ActualResult',this.DEFAULT_ACTUAL_RESULT)
	}
	public void initOutput(){
		this.Output.clear()
		this.Output.put('RoojaiCovidInput','')
		this.Output.put('RoojaiCovidDetail','')
		this.Output.put('RoojaiCovidPayment','')
	...
	public static Boolean readInputFromDataFile(Integer caseNumber,Map caseInput){
		...
		try{
			...
			caseInput.put('RoojaiCovidInput',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseInput.put('RoojaiCovidDetail',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseInput.put('RoojaiCovidPayment',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
	...
	public static Boolean readOutputFromDataFile(Integer caseNumber,Map caseOutput){
		...
		try{
			...
			caseOutput.put('RoojaiCovidInput',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseOutput.put('RoojaiCovidDetail',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			caseOutput.put('RoojaiCovidPayment',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
