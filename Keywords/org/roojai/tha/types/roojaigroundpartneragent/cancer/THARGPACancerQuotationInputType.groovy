...
public class THARGPACancerQuotationInputType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/RoojaiGroundPartnerAgentCancer/RGPACancer_Quotation_01_Input.Input'
	public static final String INPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_RGPACancer_Quotation_Website.xlsx'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/RoojaiGroundPartnerAgentCancer/RGPACancer_Quotation_01_Input.Output'
	public static final String OUTPUT_EXCEL_FILE_NAME='Data Files/Release_UAT/Roojai/THA/Excel_RGPACancer_Quotation_Website.xlsx'
	...
	public static final String DEFAULT_QUERY_TRAVELLED_HIGH_RISK_COUNTRY='2'
	...
	public static final String DEFAULT_QUERY_DIED_FROM_CANCER='2'
	...
	public Map Input=[:]
	public Map Output=[:]
	public THARGPACancerQuotationInputType(){
		super()
		this.initInput()
		this.initOutput()
	}
	...
	public void initInput(){
		...
		this.Input.put('QueryTravelledHighRiskCountry',this.DEFAULT_QUERY_TRAVELLED_HIGH_RISK_COUNTRY)
		...
		this.Input.put('QueryDiedFromCancer',this.DEFAULT_QUERY_DIED_FROM_CANCER)
	...
	public void initOutput(){
		...
		this.Output.put('QueryTravelledHighRiskCountry','')
		this.Output.put('QueryHealthCondition','')
		this.Output.put('QueryInsuredDeniedCoverage','')
		this.Output.put('QueryDiedFromCancer','')
	...
	public static Boolean readInputFromDataFile(Integer caseNumber,Map caseInput){
		...
		try{
			...
			dataRowIndex+=1
			caseInput.put('QueryTravelledHighRiskCountry',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			...
			dataRowIndex+=1
			caseInput.put('QueryDiedFromCancer',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
	...
	public static Boolean readOutputFromDataFile(Integer caseNumber,Map caseOutput){
		...
		try{
			...
			dataRowIndex+=1
			caseOutput.put('QueryTravelledHighRiskCountry',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
			...
			dataRowIndex+=1
			caseOutput.put('QueryDiedFromCancer',lTestData.getValue(dataColIndex,dataRowIndex).trim())
			dataRowIndex+=1
