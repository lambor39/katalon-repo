...
public class THARGPACriticalIllnessQuotationDetail1Util{
	private WebDriver driver=null
	private WebDriver selenium=null
	private THACriticalIllnessQuotationDetail1Util lTHACriticalIllnessQuotationDetail1Util=null
	public THARGPACriticalIllnessQuotationDetail1Util(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	private THACriticalIllnessQuotationDetail1Util getlTHACriticalIllnessQuotationDetail1Util(){
		return this.lTHACriticalIllnessQuotationDetail1Util
	}
	private void setlTHACriticalIllnessQuotationDetail1Util(THACriticalIllnessQuotationDetail1Util newlTHACriticalIllnessQuotationDetail1Util){
		//Do Nothing
		//this.lTHACriticalIllnessQuotationDetail1Util=newlTHACriticalIllnessQuotationDetail1Util
	}
	public Boolean inputDetail1(Map caseInput,Map caseOutput){
		...
		try{
			...
			this.lTHACriticalIllnessQuotationDetail1Util=new THACriticalIllnessQuotationDetail1Util(this.driver,this.selenium)
			//Check ABTesting
			...
			if(!lIsHolderCallMeNowToDo){
				...
				Map lMapActualResult=this.inputActualResult(lIsPositiveCase,lHolderPhoneNo,THARGPACriticalIllnessCoreType.CURRENT_POLICY_DETAIL_1_SKIP_OTP)
				if(!lMapActualResult.Result){
					lActualResult=''
					lOpportunityNumber=''
				}else{
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_POSITIVE_CASE
		}
		try{
	...
	public Map inputLanguage(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_LANGUAGE
		}
		try{
			Boolean lResult=false
			lreturn.put('Language','')
			lreturn.put('Result',lResult)
			Map lMapLanguage=this.lTHACriticalIllnessQuotationDetail1Util.inputLanguage(lLanguage)
			if(!lMapLanguage.Result){
				lLanguage=''
			}else{
				lLanguage=lMapLanguage.Language
	...
	public Map inputSubmitCallMeBack(String strSubmitCallMeBack,String strCallMeBackEmail,String strCallMeBackMobile){
		...
		if(lSubmitCallMeBack.length()<=0){
			lSubmitCallMeBack=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_SUBMIT_CALL_ME_BACK
		}
		String lCallMeBackEmail=strCallMeBackEmail.trim()
		if(lCallMeBackEmail.length()<=0){
			lCallMeBackEmail=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_CALL_ME_BACK_EMAIL
		}
		String lCallMeBackMobile=strCallMeBackMobile.trim()
		if(lCallMeBackMobile.length()<=0){
			lCallMeBackMobile=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_CALL_ME_BACK_MOBILE
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapSubmitCallMeBack=this.lTHACriticalIllnessQuotationDetail1Util.inputSubmitCallMeBack(lSubmitCallMeBack,lCallMeBackEmail,lCallMeBackMobile)
			if(!lMapSubmitCallMeBack.Result){
				lSubmitCallMeBack=''
				lCallMeBackEmail=''
				lCallMeBackMobile=''
	...
	public Map inputHolderEmail(String strHolderEmail,String strHolderNewsletter){
		...
		if(lHolderEmail.length()<=0){
			lHolderEmail=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_HOLDER_EMAIL
		}
		String lHolderNewsletter=strHolderNewsletter.trim()
		if(lHolderNewsletter.length()<=0){
			lHolderNewsletter=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_HOLDER_NEWSLETTER
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapHolderEmail=this.lTHACriticalIllnessQuotationDetail1Util.inputHolderEmail(lHolderEmail,lHolderNewsletter)
			if(!lMapHolderEmail.Result){
				lHolderEmail=''
				lHolderNewsletter=''
			}else{
	...
	public Map inputHolderPhoneNo(String strHolderPhoneNo){
		...
		if(lHolderPhoneNo.length()<=0){
			lHolderPhoneNo=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_HOLDER_PHONE_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderPhoneNo','')
			lreturn.put('Result',lResult)
			Map lMapHolderPhoneNo=this.lTHACriticalIllnessQuotationDetail1Util.inputHolderPhoneNo(lHolderPhoneNo)
			if(!lMapHolderPhoneNo.Result){
				lHolderPhoneNo=''
			}else{
				lHolderPhoneNo=lMapHolderPhoneNo.HolderPhoneNo
	...
	public Map inputHolderCallMeNowToDo(String strHolderCallMeNowToDo){
		...
		if(lHolderCallMeNowToDo.length()<=0){
			lHolderCallMeNowToDo=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW_TO_DO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCallMeNowToDo','')
			lreturn.put('Result',lResult)
			Map lMapHolderCallMeNowToDo=this.lTHACriticalIllnessQuotationDetail1Util.inputHolderCallMeNowToDo(lHolderCallMeNowToDo)
			if(!lMapHolderCallMeNowToDo.Result){
				lHolderCallMeNowToDo=''
			}else{
				lHolderCallMeNowToDo=lMapHolderCallMeNowToDo.HolderCallMeNowToDo
	...
	public Map inputHolderCallMeNow(String strHolderCallMeNow){
		...
		if(lHolderCallMeNow.length()<=0){
			lHolderCallMeNow=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW.toUpperCase()
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCallMeNow','')
			lreturn.put('Result',lResult)
			Map lMapHolderCallMeNow=this.lTHACriticalIllnessQuotationDetail1Util.inputHolderCallMeNow(lHolderCallMeNow)
			if(!lMapHolderCallMeNow.Result){
				lHolderCallMeNow=''
			}else{
				lHolderCallMeNow=lMapHolderCallMeNow.HolderCallMeNow
	...
	public Map inputQueryQuestion(String strQueryHealthCondition,String strQueryInsuredDeniedCoverage,String strQueryDiedFromCriticalIllnesses,String strQueryIndustry,String strQueryOtherQuestion01,String strQueryOtherQuestion02,String strQueryOtherQuestion03,String strQueryOtherQuestion04,String strQueryOtherQuestion05,String strQueryOtherQuestion06,String strQueryOtherQuestion07,String strQueryOtherQuestion08,String strQueryOtherQuestion09,String strQueryOtherQuestion10,String strQueryHospitalIncomeBenefitQuestion01,String strQueryHospitalIncomeBenefitQuestion02,String strQueryHospitalIncomeBenefitQuestion03,String strQueryHospitalIncomeBenefitQuestion04,String strQueryHospitalIncomeBenefitQuestion05,String strQueryHospitalIncomeBenefitQuestion06,String strQueryHospitalIncomeBenefitQuestion07,String strQueryHospitalIncomeBenefitQuestion08,String strQueryHospitalIncomeBenefitQuestion09,String strQueryHospitalIncomeBenefitQuestion10){
		...
		if(lQueryHealthCondition.length()<=0){
			lQueryHealthCondition=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HEALTH_CONDITION
		}
		String lQueryInsuredDeniedCoverage=strQueryInsuredDeniedCoverage.toUpperCase().trim()
		if(lQueryInsuredDeniedCoverage.length()<=0){
			lQueryInsuredDeniedCoverage=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_INSURED_DENIED_COVERAGE
		}
		...
		if(lQueryDiedFromCriticalIllnesses.length()<=0){
			lQueryDiedFromCriticalIllnesses=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_DIED_FROM_CRITICAL_ILLNESSES
		}
		String lQueryIndustry=strQueryIndustry.toUpperCase().trim()
		if(lQueryIndustry.length()<=0){
			lQueryIndustry=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_INDUSTRY
		}
		String lQueryOtherQuestion01=strQueryOtherQuestion01.toUpperCase().trim()
		if(lQueryOtherQuestion01.length()<=0){
			lQueryOtherQuestion01=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_01
		}
		String lQueryOtherQuestion02=strQueryOtherQuestion02.toUpperCase().trim()
		if(lQueryOtherQuestion02.length()<=0){
			lQueryOtherQuestion02=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_02
		}
		String lQueryOtherQuestion03=strQueryOtherQuestion03.toUpperCase().trim()
		if(lQueryOtherQuestion03.length()<=0){
			lQueryOtherQuestion03=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_03
		}
		String lQueryOtherQuestion04=strQueryOtherQuestion04.toUpperCase().trim()
		if(lQueryOtherQuestion04.length()<=0){
			lQueryOtherQuestion04=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_04
		}
		String lQueryOtherQuestion05=strQueryOtherQuestion05.toUpperCase().trim()
		if(lQueryOtherQuestion05.length()<=0){
			lQueryOtherQuestion05=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_05
		}
		String lQueryOtherQuestion06=strQueryOtherQuestion06.toUpperCase().trim()
		if(lQueryOtherQuestion06.length()<=0){
			lQueryOtherQuestion06=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_06
		}
		String lQueryOtherQuestion07=strQueryOtherQuestion07.toUpperCase().trim()
		if(lQueryOtherQuestion07.length()<=0){
			lQueryOtherQuestion07=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_07
		}
		String lQueryOtherQuestion08=strQueryOtherQuestion08.toUpperCase().trim()
		if(lQueryOtherQuestion08.length()<=0){
			lQueryOtherQuestion08=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_08
		}
		String lQueryOtherQuestion09=strQueryOtherQuestion09.toUpperCase().trim()
		if(lQueryOtherQuestion09.length()<=0){
			lQueryOtherQuestion09=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_09
		}
		String lQueryOtherQuestion10=strQueryOtherQuestion10.toUpperCase().trim()
		if(lQueryOtherQuestion10.length()<=0){
			lQueryOtherQuestion10=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_OTHER_QUESTION_10
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion01.length()<=0){
			lQueryHospitalIncomeBenefitQuestion01=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_01
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion02.length()<=0){
			lQueryHospitalIncomeBenefitQuestion02=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_02
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion03.length()<=0){
			lQueryHospitalIncomeBenefitQuestion03=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_03
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion04.length()<=0){
			lQueryHospitalIncomeBenefitQuestion04=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_04
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion05.length()<=0){
			lQueryHospitalIncomeBenefitQuestion05=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_05
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion06.length()<=0){
			lQueryHospitalIncomeBenefitQuestion06=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_06
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion07.length()<=0){
			lQueryHospitalIncomeBenefitQuestion07=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_07
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion08.length()<=0){
			lQueryHospitalIncomeBenefitQuestion08=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_08
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion09.length()<=0){
			lQueryHospitalIncomeBenefitQuestion09=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_09
		}
		...
		if(lQueryHospitalIncomeBenefitQuestion10.length()<=0){
			lQueryHospitalIncomeBenefitQuestion10=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_QUERY_HOSPITAL_INCOME_BENEFIT_QUESTION_10
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapQueryQuestion=this.lTHACriticalIllnessQuotationDetail1Util.inputQueryQuestion(lQueryHealthCondition,lQueryInsuredDeniedCoverage,lQueryDiedFromCriticalIllnesses,lQueryIndustry,lQueryOtherQuestion01,lQueryOtherQuestion02,lQueryOtherQuestion03,lQueryOtherQuestion04,lQueryOtherQuestion05,lQueryOtherQuestion06,lQueryOtherQuestion07,lQueryOtherQuestion08,lQueryOtherQuestion09,lQueryOtherQuestion10,lQueryHospitalIncomeBenefitQuestion01,lQueryHospitalIncomeBenefitQuestion02,lQueryHospitalIncomeBenefitQuestion03,lQueryHospitalIncomeBenefitQuestion04,lQueryHospitalIncomeBenefitQuestion05,lQueryHospitalIncomeBenefitQuestion06,lQueryHospitalIncomeBenefitQuestion07,lQueryHospitalIncomeBenefitQuestion08,lQueryHospitalIncomeBenefitQuestion09,lQueryHospitalIncomeBenefitQuestion10)
			if(!lMapQueryQuestion.Result){
				lQueryHealthCondition=''
				lQueryInsuredDeniedCoverage=''
				lQueryDiedFromCriticalIllnesses=''
	...
	public Map inputInsuredEdit(String strInsuredEdit,String strInsuredGenderAndMaritalStatus,String strInsuredBirthDateMain){
		...
		if(lInsuredEdit.length()<=0){
			lInsuredEdit=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_INSURED_EDIT
		}
		...
		if(lInsuredGenderAndMaritalStatus.length()<=0){
			lInsuredGenderAndMaritalStatus=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_INSURED_GENDER_AND_MARITAL_STATUS
		}
		String lInsuredBirthDateMain=strInsuredBirthDateMain.trim()
		if(lInsuredBirthDateMain.length()<=0){
			lInsuredBirthDateMain=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_INSURED_BIRTH_DATE_MAIN
		}
		String lInsuredDetail=''
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapInsuredEdit=this.lTHACriticalIllnessQuotationDetail1Util.inputInsuredEdit(lInsuredEdit,lInsuredGenderAndMaritalStatus,lInsuredBirthDateMain)
			if(!lMapInsuredEdit.Result){
				lInsuredEdit=''
				lInsuredGenderAndMaritalStatus=''
				lInsuredBirthDateMain=''
	...
	public Map inputNationality(String strNationalityThai,String strNationalityThaiId,String strNationalityPassportId,String strNationalityPassportCountry){
		...
		if(lNationalityThai.length()<=0){
			lNationalityThai=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_NATIONALITY_THAI
		}
		String lNationalityThaiId=strNationalityThaiId.trim()
		if(lNationalityThaiId.length()<=0){
			lNationalityThaiId=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_NATIONALITY_THAI_ID
		}
		String lNationalityPassportId=strNationalityPassportId.trim()
		if(lNationalityPassportId.length()<=0){
			lNationalityPassportId=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_NATIONALITY_PASSPORT_ID
		}
		String lNationalityPassportCountry=strNationalityPassportCountry.trim()
		if(lNationalityPassportCountry.length()<=0){
			lNationalityPassportCountry=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_NATIONALITY_PASSPORT_COUNTRY
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapNationality=this.lTHACriticalIllnessQuotationDetail1Util.inputNationality(lNationalityThai,lNationalityThaiId,lNationalityPassportId,lNationalityPassportCountry)
	...
	public Map inputHolderFirstName(String strHolderFirstName){
		...
		if(lHolderFirstName.length()<=0){
			lHolderFirstName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_HOLDER_FIRST_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderFirstName','')
			lreturn.put('Result',lResult)
			Map lMapHolderFirstName=this.lTHACriticalIllnessQuotationDetail1Util.inputHolderFirstName(lHolderFirstName)
			if(!lMapHolderFirstName.Result){
				lHolderFirstName=''
			}else{
				lHolderFirstName=lMapHolderFirstName.HolderFirstName
	...
	public Map inputHolderLastName(String strHolderLastName){
		...
		if(lHolderLastName.length()<=0){
			lHolderLastName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_HOLDER_LAST_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderLastName','')
			lreturn.put('Result',lResult)
			Map lMapHolderLastName=this.lTHACriticalIllnessQuotationDetail1Util.inputHolderLastName(lHolderLastName)
			if(!lMapHolderLastName.Result){
				lHolderLastName=''
			}else{
				lHolderLastName=lMapHolderLastName.HolderLastName
	...
	public Map inputPolicyStartDate(String strPolicyStartDate,String strPolicyStartOffsetDay){
		...
		if(lPolicyStartDate.length()<=0){
			lPolicyStartDate=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_POLICY_START_DATE
		}
		String lPolicyStartOffsetDay=strPolicyStartOffsetDay.trim()
		if(lPolicyStartOffsetDay.length()<=0){
			lPolicyStartOffsetDay=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_POLICY_START_OFFSET_DAY
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapPolicyStartDate=this.lTHACriticalIllnessQuotationDetail1Util.inputPolicyStartDate(lPolicyStartDate,lPolicyStartOffsetDay)
			if(!lMapPolicyStartDate.Result){
				lPolicyStartDate=''
				lPolicyStartOffsetDay=''
			}else{
	...
	public Map inputAddressPostalCode(String strAddressPostalCode){
		...
		if(lAddressPostalCode.length()<=0){
			lAddressPostalCode=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_ADDRESS_POSTAL_CODE
		}
		try{
			Boolean lResult=false
			lreturn.put('AddressPostalCode','')
			lreturn.put('Result',lResult)
			Map lMapAddressPostalCode=this.lTHACriticalIllnessQuotationDetail1Util.inputAddressPostalCode(lAddressPostalCode)
			if(!lMapAddressPostalCode.Result){
				lAddressPostalCode=''
			}else{
				lAddressPostalCode=lMapAddressPostalCode.AddressPostalCode
	...
	public Map inputAddressProvince(String strAddressProvince){
		...
		if(lAddressProvince.length()<=0){
			lAddressProvince=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_ADDRESS_PROVINCE
		}
		try{
			Boolean lResult=false
			lreturn.put('AddressProvince','')
			lreturn.put('Result',lResult)
			Map lMapAddressProvince=this.lTHACriticalIllnessQuotationDetail1Util.inputAddressProvince(lAddressProvince)
			if(!lMapAddressProvince.Result){
				lAddressProvince=''
			}else{
				lAddressProvince=lMapAddressProvince.AddressProvince
	...
	public Map inputAddressDistrict(String strAddressDistrict){
		...
		if(lAddressDistrict.length()<=0){
			lAddressDistrict=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_ADDRESS_DISTRICT
		}
		try{
			Boolean lResult=false
			lreturn.put('AddressDistrict','')
			lreturn.put('Result',lResult)
			Map lMapAddressDistrict=this.lTHACriticalIllnessQuotationDetail1Util.inputAddressDistrict(lAddressDistrict)
			if(!lMapAddressDistrict.Result){
				lAddressDistrict=''
			}else{
				lAddressDistrict=lMapAddressDistrict.AddressDistrict
	...
	public Map inputAddressSubdistrict(String strAddressSubdistrict){
		...
		if(lAddressSubdistrict.length()<=0){
			lAddressSubdistrict=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_ADDRESS_SUBDISTRICT
		}
		try{
			Boolean lResult=false
			lreturn.put('AddressSubdistrict','')
			lreturn.put('Result',lResult)
			Map lMapAddressSubdistrict=this.lTHACriticalIllnessQuotationDetail1Util.inputAddressSubdistrict(lAddressSubdistrict)
			if(!lMapAddressSubdistrict.Result){
				lAddressSubdistrict=''
			}else{
				lAddressSubdistrict=lMapAddressSubdistrict.AddressSubdistrict
	...
	public Map inputAddressRoad(String strAddressRoad){
		...
		if(lAddressRoad.length()<=0){
			lAddressRoad=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_ADDRESS_ROAD
		}
		try{
			Boolean lResult=false
			lreturn.put('AddressRoad','')
			lreturn.put('Result',lResult)
			Map lMapAddressRoad=this.lTHACriticalIllnessQuotationDetail1Util.inputAddressRoad(lAddressRoad)
			if(!lMapAddressRoad.Result){
				lAddressRoad=''
			}else{
				lAddressRoad=lMapAddressRoad.AddressRoad
	...
	public Map inputAddressBuildingName(String strAddressBuildingName){
		...
		if(lAddressBuildingName.length()<=0){
			lAddressBuildingName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_ADDRESS_BUILDING_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('AddressBuildingName','')
			lreturn.put('Result',lResult)
			Map lMapAddressBuildingName=this.lTHACriticalIllnessQuotationDetail1Util.inputAddressBuildingName(lAddressBuildingName)
			if(!lMapAddressBuildingName.Result){
				lAddressBuildingName=''
			}else{
				lAddressBuildingName=lMapAddressBuildingName.AddressBuildingName
	...
	public Map inputAddressBuildingNumber(String strAddressBuildingNumber){
		...
		if(lAddressBuildingNumber.length()<=0){
			lAddressBuildingNumber=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_ADDRESS_BUILDING_NUMBER
		}
		try{
			Boolean lResult=false
			lreturn.put('AddressBuildingNumber','')
			lreturn.put('Result',lResult)
			Map lMapAddressBuildingNumber=this.lTHACriticalIllnessQuotationDetail1Util.inputAddressBuildingNumber(lAddressBuildingNumber)
			if(!lMapAddressBuildingNumber.Result){
				lAddressBuildingNumber=''
			}else{
				lAddressBuildingNumber=lMapAddressBuildingNumber.AddressBuildingNumber
	...
	public Map inputLegalHeir(String strLegalHeir){
		...
		if(lLegalHeir.length()<=0){
			lLegalHeir=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_LEGAL_HEIR
		}
		try{
			Boolean lResult=false
			lreturn.put('LegalHeir','')
			lreturn.put('Result',lResult)
			Map lMapLegalHeir=this.lTHACriticalIllnessQuotationDetail1Util.inputLegalHeir(lLegalHeir)
			if(!lMapLegalHeir.Result){
				lLegalHeir=''
			}else{
				lLegalHeir=lMapLegalHeir.LegalHeir
	...
	public Map inputBeneficiaryAdd(String strBeneficiary1Add,String strBeneficiary1FirstName,String strBeneficiary1LastName,String strBeneficiary1Relationship,String strBeneficiary1Percentage,String strBeneficiary2Add,String strBeneficiary2FirstName,String strBeneficiary2LastName,String strBeneficiary2Relationship,String strBeneficiary2Percentage,String strBeneficiary3Add,String strBeneficiary3FirstName,String strBeneficiary3LastName,String strBeneficiary3Relationship,String strBeneficiary3Percentage){
		...
		if(lBeneficiary1Add.length()<=0){
			lBeneficiary1Add=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY1_ADD
		}
		String lBeneficiary1FirstName=strBeneficiary1FirstName.trim()
		if(lBeneficiary1FirstName.length()<=0){
			lBeneficiary1FirstName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY1_FIRST_NAME
		}
		String lBeneficiary1LastName=strBeneficiary1LastName.trim()
		if(lBeneficiary1LastName.length()<=0){
			lBeneficiary1LastName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY1_LAST_NAME
		}
		String lBeneficiary1Relationship=strBeneficiary1Relationship.trim()
		if(lBeneficiary1Relationship.length()<=0){
			lBeneficiary1Relationship=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY1_RELATIONSHIP
		}
		String lBeneficiary1Percentage=strBeneficiary1Percentage.trim()
		if(lBeneficiary1Percentage.length()<=0){
			lBeneficiary1Percentage=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY1_PERCENTAGE
		}
		String lBeneficiary2Add=strBeneficiary2Add.trim()
		if(lBeneficiary2Add.length()<=0){
			lBeneficiary2Add=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY2_ADD
		}
		String lBeneficiary2FirstName=strBeneficiary2FirstName.trim()
		if(lBeneficiary2FirstName.length()<=0){
			lBeneficiary2FirstName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY2_FIRST_NAME
		}
		String lBeneficiary2LastName=strBeneficiary2LastName.trim()
		if(lBeneficiary2LastName.length()<=0){
			lBeneficiary2LastName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY2_LAST_NAME
		}
		String lBeneficiary2Relationship=strBeneficiary2Relationship.trim()
		if(lBeneficiary2Relationship.length()<=0){
			lBeneficiary2Relationship=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY2_RELATIONSHIP
		}
		String lBeneficiary2Percentage=strBeneficiary2Percentage.trim()
		if(lBeneficiary2Percentage.length()<=0){
			lBeneficiary2Percentage=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY2_PERCENTAGE
		}
		String lBeneficiary3Add=strBeneficiary3Add.trim()
		if(lBeneficiary3Add.length()<=0){
			lBeneficiary3Add=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY3_ADD
		}
		String lBeneficiary3FirstName=strBeneficiary3FirstName.trim()
		if(lBeneficiary3FirstName.length()<=0){
			lBeneficiary3FirstName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY3_FIRST_NAME
		}
		String lBeneficiary3LastName=strBeneficiary3LastName.trim()
		if(lBeneficiary3LastName.length()<=0){
			lBeneficiary3LastName=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY3_LAST_NAME
		}
		String lBeneficiary3Relationship=strBeneficiary3Relationship.trim()
		if(lBeneficiary3Relationship.length()<=0){
			lBeneficiary3Relationship=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY3_RELATIONSHIP
		}
		String lBeneficiary3Percentage=strBeneficiary3Percentage.trim()
		if(lBeneficiary3Percentage.length()<=0){
			lBeneficiary3Percentage=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_BENEFICIARY3_PERCENTAGE
		}
		String lAdditionBeneficiaryDetail=''
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapBeneficiaryAdd=this.lTHACriticalIllnessQuotationDetail1Util.inputBeneficiaryAdd(lBeneficiary1Add,lBeneficiary1FirstName,lBeneficiary1LastName,lBeneficiary1Relationship,lBeneficiary1Percentage,lBeneficiary2Add,lBeneficiary2FirstName,lBeneficiary2LastName,lBeneficiary2Relationship,lBeneficiary2Percentage,lBeneficiary3Add,lBeneficiary3FirstName,lBeneficiary3LastName,lBeneficiary3Relationship,lBeneficiary3Percentage)
			if(!lMapBeneficiaryAdd.Result){
				lBeneficiary1Add=''
				lBeneficiary1FirstName=''
				lBeneficiary1LastName=''
	...
	public Map inputPolicyInsurer(String strPolicyInsurer){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapPolicyInsurer=this.lTHACriticalIllnessQuotationDetail1Util.inputPolicyInsurer(lPolicyInsurer)
			if(!lMapPolicyInsurer.Result){
				lPolicyInsurer=''
			}else{
				lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THARGPACriticalIllnessQuotationDetail1Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
			lreturn.put('SalesforceProceedTodo','')
			lreturn.put('Result',lResult)
			Map lMapSalesforceProceedTodo=this.lTHACriticalIllnessQuotationDetail1Util.inputSalesforceProceedTodo(lSalesforceProceedTodo)
			if(!lMapSalesforceProceedTodo.Result){
				lSalesforceProceedTodo=''
			}else{
				lSalesforceProceedTodo=lMapSalesforceProceedTodo.SalesforceProceedTodo
	...
	public Map inputActualResult(Boolean isPositiveCase,String strHolderPhoneNo,Boolean isSkipOTP){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapActualResult=this.lTHACriticalIllnessQuotationDetail1Util.inputActualResult(isPositiveCase,strHolderPhoneNo,isSkipOTP)
			if(!lMapActualResult.Result){
				lActualResult=''
				lOpportunityNumber=''
			}else{
