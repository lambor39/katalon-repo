...
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationDetail2Util
public class THARGPALowMileageCarQuotationDetail2Util{
	private WebDriver driver=null
	private WebDriver selenium=null
	private def lLowMileageCarQuotationDetail2Util=null
	public THARGPALowMileageCarQuotationDetail2Util(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	private THALowMileageCarQuotationDetail2Util getlLowMileageCarQuotationDetail2Util(){
		return this.lLowMileageCarQuotationDetail2Util
	}
	private void setlLowMileageCarQuotationDetail2Util(THALowMileageCarQuotationDetail2Util newlLowMileageCarQuotationDetail2Util){
		//Do Nothing
		//this.lLowMileageCarQuotationDetail2Util=newlLowMileageCarQuotationDetail2Util
	}
	public Boolean inputDetail2(Map caseInput,Map caseOutput){
		...
		try{
			...
			this.lLowMileageCarQuotationDetail2Util=new THALowMileageCarQuotationDetail2Util(this.driver,this.selenium)
	...
	public String inputLanguage(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_LANGUAGE.toUpperCase()
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputLanguage(lLanguage)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputUnderFinancing(String strUnderFinancing){
		...
		if(lUnderFinancing.length()<=0){
			lUnderFinancing=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_UNDER_FINANCING
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputUnderFinancing(lUnderFinancing)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputFinancialOrganisation(String strFinancialOrganisation){
		...
		if(lFinancialOrganisation.length()<=0){
			lFinancialOrganisation=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_FINANCIAL_ORGANISATION
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputFinancialOrganisation(lFinancialOrganisation)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputWithRedPlate(String strWithRedPlate){
		...
		if(lWithRedPlate.length()<=0){
			lWithRedPlate=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_WITH_RED_PLATE
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputWithRedPlate(lWithRedPlate)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputChassisNumber(String strChassisNumber){
		...
		if(lChassisNumber.length()<=0){
			lChassisNumber=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_CHASSIS_NUMBER
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputChassisNumber(lChassisNumber)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPrevInsuranceCovered(String strPrevInsuranceCovered){
		...
		if(lPrevInsuranceCovered.length()<=0){
			lPrevInsuranceCovered=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COVERED
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPrevInsuranceCovered(lPrevInsuranceCovered)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPrevInsuranceCompany(String strPrevInsuranceCompany){
		...
		if(lPrevInsuranceCompany.length()<=0){
			lPrevInsuranceCompany=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COMPANY
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPrevInsuranceCompany(lPrevInsuranceCompany)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPrevInsuranceType(String strPrevInsuranceType){
		...
		if(lPrevInsuranceType.length()<=0){
			lPrevInsuranceType=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_PREV_INSURANCE_TYPE
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPrevInsuranceType(lPrevInsuranceType)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPolicyExpirationDayOffset(String strPolicyExpirationDayOffset){
		...
		if(lPolicyExpirationDayOffset.length()<=0){
			lPolicyExpirationDayOffset=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DAY_OFFSET
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPolicyExpirationDayOffset(lPolicyExpirationDayOffset)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPolicyExpirationDate(String strPolicyExpirationDate,Integer numPolicyExpirationDayOffset){
		...
		if(lPolicyExpirationDate.length()<=0){
			lPolicyExpirationDate=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DATE
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPolicyExpirationDate(lPolicyExpirationDate,numPolicyExpirationDayOffset)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPolicyStartDayOffset(String strPolicyStartDayOffset){
		...
		if(lPolicyStartDayOffset.length()<=0){
			lPolicyStartDayOffset=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_POLICY_START_DAY_OFFSET
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPolicyStartDayOffset(lPolicyStartDayOffset)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPolicyStartDate(String strPolicyStartDate,Integer numPolicyStartDayOffset){
		...
		if(lPolicyStartDate.length()<=0){
			lPolicyStartDate=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_POLICY_START_DATE
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPolicyStartDate(lPolicyStartDate,numPolicyStartDayOffset)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputSendToPostalCode(String strSendToPostalCode){
		...
		if(lSendToPostalCode.length()<=0){
			lSendToPostalCode=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SEND_TO_POSTAL_CODE
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputSendToPostalCode(lSendToPostalCode)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputSendToProvince(String strSendToProvince){
		...
		if(lSendToProvince.length()<=0){
			lSendToProvince=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SEND_TO_PROVINCE
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputSendToProvince(lSendToProvince)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputSendToDistrict(String strSendToDistrict){
		...
		if(lSendToDistrict.length()<=0){
			lSendToDistrict=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SEND_TO_DISTRICT
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputSendToDistrict(lSendToDistrict)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputSendToSubDistrict(String strSendToSubDistrict){
		...
		if(lSendToSubDistrict.length()<=0){
			lSendToSubDistrict=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SEND_TO_SUB_DISTRICT
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputSendToSubDistrict(lSendToSubDistrict)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputSendToRoad(String strSendToRoad){
		...
		if(lSendToRoad.length()<=0){
			lSendToRoad=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SEND_TO_ROAD
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputSendToRoad(lSendToRoad)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputSendToBuildingName(String strSendToBuildingName){
		...
		if(lSendToBuildingName.length()<=0){
			lSendToBuildingName=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NAME
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputSendToBuildingName(lSendToBuildingName)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputSendToBuildingNumber(String strSendToBuildingNumber){
		...
		if(lSendToBuildingNumber.length()<=0){
			lSendToBuildingNumber=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NUMBER
		}
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputSendToBuildingNumber(lSendToBuildingNumber)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPositiveCase(String strPositiveCase){
		...
		try{
			String lText=''
			if(lPositiveCase.length()<=0){
				lPositiveCase=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_POSITIVE_CASE
			}
			Boolean lIsPositiveCase=IGNUemaHelper.convertStringToBoolean(lPositiveCase)
	...
	public String inputActualResult(Boolean isPositiveCase){
		String lreturn=''
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputActualResult(isPositiveCase)
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputOpportunityNumber(){
		String lreturn=''
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputOpportunityNumber()
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPolicyAmtYearly(){
		String lreturn=''
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPolicyAmtYearly()
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public String inputPolicyAmtInstalment(){
		String lreturn=''
		try{
			lreturn=this.lTHALowMileageCarQuotationDetail2Util.inputPolicyAmtInstalment()
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
		}
	...
	public Map inputPolicyInsurer(String strPolicyInsurer){
		...
		try{
			...
			Map lMapPolicyInsurer=this.lTHALowMileageCarQuotationDetail2Util.inputPolicyInsurer(lPolicyInsurer)
			if(!lMapPolicyInsurer.Result){
				lPolicyInsurer=''
			}else{
				lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
			lreturn.put('SalesforceProceedTodo','')
			lreturn.put('Result',lResult)
			Map lMapSalesforceProceedTodo=this.lTHALowMileageCarQuotationDetail2Util.inputSalesforceProceedTodo(lSalesforceProceedTodo)
	...
	public Map inputAutomationDataBefore(){
		...
		try{
			Boolean lResult=false
			lreturn.put('Result',lResult)
			Map lMapAutomationDataBefore=this.lTHALowMileageCarQuotationDetail2Util.inputAutomationDataBefore()
	...
	public Map inputAutomationDataAfter(){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapAutomationDataAfter=this.lTHALowMileageCarQuotationDetail2Util.inputAutomationDataAfter()
			if(!lMapAutomationDataAfter.Result){
				lSalesforceRetrieveDataOpportunityNumber=''
				lSalesforceRetrieveDataPremiumYearly=''
				lSalesforceRetrieveDataPremiumDeposit=''
	...
	public Map inputSalesforceProceedVerifyBefore(Map caseOutput){
		...
		try{
			Boolean lResult=false
			lreturn.put('Result',lResult)
			Map lMapSalesforceProceedVerifyBefore=this.lTHALowMileageCarQuotationDetail2Util.inputSalesforceProceedVerifyBefore(caseOutput)
	...
	public Map inputSalesforceProceedVerifyAfter(Map caseOutput){
		...
		try{
			Boolean lResult=false
			lreturn.put('Result',lResult)
			Map lMapSalesforceProceedVerifyAfter=this.lTHALowMileageCarQuotationDetail2Util.inputSalesforceProceedVerifyAfter(caseOutput)
	...
	public Map inputSalesforceProceedRetrieveTodo(String strSalesforceProceedRetrieveTodo,String strAccountNameAnonymous){
		...
		if(lSalesforceProceedRetrieveTodo.length()<=0){
			lSalesforceProceedRetrieveTodo=THARGPALowMileageCarQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
			lreturn.put('SalesforceProceedRetrieveTodo','')
			lreturn.put('Result',lResult)
			Map lMapSalesforceProceedRetrieveTodo=this.lTHALowMileageCarQuotationDetail2Util.inputSalesforceProceedRetrieveTodo(lSalesforceProceedRetrieveTodo,strAccountNameAnonymous)
			if(!lMapSalesforceProceedRetrieveTodo.Result){
				lSalesforceProceedRetrieveTodo=''
			}else{
				lSalesforceProceedRetrieveTodo=lMapSalesforceProceedRetrieveTodo.SalesforceProceedRetrieveTodo
	...
	public Map inputSalesforceProceedRetrieveWebFromUrl(String strRetrievePageURL){
		...
		try{
			Boolean lResult=false
			lreturn.put('Result',lResult)
			Map lMapSalesforceProceedRetrieveWebFromUrl=this.lTHALowMileageCarQuotationDetail2Util.inputSalesforceProceedRetrieveWebFromUrl(lRetrievePageURL)
