...
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail2Util
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail2UtilOld
...
public class THARGPAMotorQuotationDetail2Util{
	private WebDriver driver=null
	private WebDriver selenium=null
	private def lTHAMotorBikeQuotationDetail2Util=null
	private def lTHAMotorCarQuotationDetail2Util=null
	public THARGPAMotorQuotationDetail2Util(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	private THAMotorBikeQuotationDetail2Util getlTHAMotorBikeQuotationDetail2Util(){
		return this.lTHAMotorBikeQuotationDetail2Util
	}
	private void setlTHAMotorBikeQuotationDetail2Util(THAMotorBikeQuotationDetail2Util newlTHAMotorBikeQuotationDetail2Util){
		//Do Nothing
		//this.lTHAMotorBikeQuotationDetail2Util=newlTHAMotorBikeQuotationDetail2Util
	}
	private THAMotorCarQuotationDetail2Util getlTHAMotorCarQuotationDetail2Util(){
		return this.lTHAMotorCarQuotationDetail2Util
	}
	private void setlTHAMotorCarQuotationDetail2Util(THAMotorCarQuotationDetail2Util newlTHAMotorCarQuotationDetail2Util){
		//Do Nothing
		//this.lTHAMotorCarQuotationDetail2Util=newlTHAMotorCarQuotationDetail2Util
	}
		...
		try{
			...
			if(THARGPAMotorCoreType.CURRENT_URL_UNDER_QUOTE_APPLICATION){
				if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
					this.lTHAMotorBikeQuotationDetail2Util=new THAMotorBikeQuotationDetail2Util(this.driver,this.selenium)
				}else{
					this.lTHAMotorCarQuotationDetail2Util=new THAMotorCarQuotationDetail2Util(this.driver,this.selenium)
				}
			}else{
				if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
					this.lTHAMotorBikeQuotationDetail2Util=new THAMotorBikeQuotationDetail2UtilOld(this.driver,this.selenium)
				}else{
					this.lTHAMotorCarQuotationDetail2Util=new THAMotorCarQuotationDetail2UtilOld(this.driver,this.selenium)
				}
			}
	...
	public Map inputLanguage(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THARGPAMotorQuotationDetail2Type.DEFAULT_LANGUAGE
		}
		try{
			...
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapLanguage=this.lTHAMotorBikeQuotationDetail2Util.inputLanguage(lLanguage)
				if(!lMapLanguage.Result){
					lLanguage=''
				}else{
					lLanguage=lMapLanguage.Language
				...
				Map lMapLanguage=this.lTHAMotorCarQuotationDetail2Util.inputLanguage(lLanguage)
				if(!lMapLanguage.Result){
					lLanguage=''
				}else{
					lLanguage=lMapLanguage.Language
	...
	public String inputUnderFinancing(String strUnderFinancing){
		...
		if(lUnderFinancing.length()<=0){
			lUnderFinancing=THARGPAMotorQuotationDetail2Type.DEFAULT_UNDER_FINANCING
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputUnderFinancing(lUnderFinancing)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputUnderFinancing(lUnderFinancing)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputFinancialOrganisation(String strFinancialOrganisation){
		...
		if(lFinancialOrganisation.length()<=0){
			lFinancialOrganisation=THARGPAMotorQuotationDetail2Type.DEFAULT_FINANCIAL_ORGANISATION
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputFinancialOrganisation(lFinancialOrganisation)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputFinancialOrganisation(lFinancialOrganisation)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputWithRedPlate(String strWithRedPlate){
		...
		if(lWithRedPlate.length()<=0){
			lWithRedPlate=THARGPAMotorQuotationDetail2Type.DEFAULT_WITH_RED_PLATE
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputWithRedPlate(lWithRedPlate)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputWithRedPlate(lWithRedPlate)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputChassisNumber(String strChassisNumber){
		...
		if(lChassisNumber.length()<=0){
			lChassisNumber=THARGPAMotorQuotationDetail2Type.DEFAULT_CHASSIS_NUMBER
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputChassisNumber(lChassisNumber)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputChassisNumber(lChassisNumber)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPrevInsuranceCovered(String strPrevInsuranceCovered){
		...
		if(lPrevInsuranceCovered.length()<=0){
			lPrevInsuranceCovered=THARGPAMotorQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COVERED
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPrevInsuranceCovered(lPrevInsuranceCovered)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPrevInsuranceCovered(lPrevInsuranceCovered)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPrevInsuranceCompany(String strPrevInsuranceCompany){
		...
		if(lPrevInsuranceCompany.length()<=0){
			lPrevInsuranceCompany=THARGPAMotorQuotationDetail2Type.DEFAULT_PREV_INSURANCE_COMPANY
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPrevInsuranceCompany(lPrevInsuranceCompany)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPrevInsuranceCompany(lPrevInsuranceCompany)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPrevInsuranceType(String strPrevInsuranceType){
		...
		if(lPrevInsuranceType.length()<=0){
			lPrevInsuranceType=THARGPAMotorQuotationDetail2Type.DEFAULT_PREV_INSURANCE_TYPE
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPrevInsuranceType(lPrevInsuranceType)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPrevInsuranceType(lPrevInsuranceType)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPolicyExpirationDayOffset(String strPolicyExpirationDayOffset){
		...
		if(lPolicyExpirationDayOffset.length()<=0){
			lPolicyExpirationDayOffset=THARGPAMotorQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DAY_OFFSET
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPolicyExpirationDayOffset(lPolicyExpirationDayOffset)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPolicyExpirationDayOffset(lPolicyExpirationDayOffset)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPolicyExpirationDate(String strPolicyExpirationDate,Integer numPolicyExpirationDayOffset){
		...
		if(lPolicyExpirationDate.length()<=0){
			lPolicyExpirationDate=THARGPAMotorQuotationDetail2Type.DEFAULT_POLICY_EXPIRATION_DATE
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPolicyExpirationDate(lPolicyExpirationDate,numPolicyExpirationDayOffset)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPolicyExpirationDate(lPolicyExpirationDate,numPolicyExpirationDayOffset)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPolicyStartDayOffset(String strPolicyStartDayOffset){
		...
		if(lPolicyStartDayOffset.length()<=0){
			lPolicyStartDayOffset=THARGPAMotorQuotationDetail2Type.DEFAULT_POLICY_START_DAY_OFFSET
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPolicyStartDayOffset(lPolicyStartDayOffset)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPolicyStartDayOffset(lPolicyStartDayOffset)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPolicyStartDate(String strPolicyStartDate,Integer numPolicyStartDayOffset){
		...
		if(lPolicyStartDate.length()<=0){
			lPolicyStartDate=THARGPAMotorQuotationDetail2Type.DEFAULT_POLICY_START_DATE
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPolicyStartDate(lPolicyStartDate,numPolicyStartDayOffset)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPolicyStartDate(lPolicyStartDate,numPolicyStartDayOffset)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputSendToPostalCode(String strSendToPostalCode){
		...
		if(lSendToPostalCode.length()<=0){
			lSendToPostalCode=THARGPAMotorQuotationDetail2Type.DEFAULT_SEND_TO_POSTAL_CODE
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputSendToPostalCode(lSendToPostalCode)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputSendToPostalCode(lSendToPostalCode)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputSendToProvince(String strSendToProvince){
		...
		if(lSendToProvince.length()<=0){
			lSendToProvince=THARGPAMotorQuotationDetail2Type.DEFAULT_SEND_TO_PROVINCE
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputSendToProvince(lSendToProvince)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputSendToProvince(lSendToProvince)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputSendToDistrict(String strSendToDistrict){
		...
		if(lSendToDistrict.length()<=0){
			lSendToDistrict=THARGPAMotorQuotationDetail2Type.DEFAULT_SEND_TO_DISTRICT
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputSendToDistrict(lSendToDistrict)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputSendToDistrict(lSendToDistrict)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputSendToSubDistrict(String strSendToSubDistrict){
		...
		if(lSendToSubDistrict.length()<=0){
			lSendToSubDistrict=THARGPAMotorQuotationDetail2Type.DEFAULT_SEND_TO_SUB_DISTRICT
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputSendToSubDistrict(lSendToSubDistrict)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputSendToSubDistrict(lSendToSubDistrict)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputSendToRoad(String strSendToRoad){
		...
		if(lSendToRoad.length()<=0){
			lSendToRoad=THARGPAMotorQuotationDetail2Type.DEFAULT_SEND_TO_ROAD
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputSendToRoad(lSendToRoad)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputSendToRoad(lSendToRoad)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputSendToBuildingName(String strSendToBuildingName){
		...
		if(lSendToBuildingName.length()<=0){
			lSendToBuildingName=THARGPAMotorQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NAME
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputSendToBuildingName(lSendToBuildingName)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputSendToBuildingName(lSendToBuildingName)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputSendToBuildingNumber(String strSendToBuildingNumber){
		...
		if(lSendToBuildingNumber.length()<=0){
			lSendToBuildingNumber=THARGPAMotorQuotationDetail2Type.DEFAULT_SEND_TO_BUILDING_NUMBER
		}
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputSendToBuildingNumber(lSendToBuildingNumber)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputSendToBuildingNumber(lSendToBuildingNumber)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPositiveCase(String strPositiveCase){
		...
		try{
			String lText=''
			if(lPositiveCase.length()<=0){
				lPositiveCase=THARGPAMotorQuotationDetail2Type.DEFAULT_POSITIVE_CASE
			}
			Boolean lIsPositiveCase=IGNUemaHelper.convertStringToBoolean(lPositiveCase)
	...
	public String inputActualResult(Boolean isPositiveCase){
		...
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputActualResult(isPositiveCase)
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputActualResult(isPositiveCase)
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputOpportunityNumber(){
		...
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputOpportunityNumber()
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputOpportunityNumber()
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPolicyAmtYearly(){
		...
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPolicyAmtYearly()
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPolicyAmtYearly()
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public String inputPolicyAmtInstalment(){
		...
		try{
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				lreturn=this.lTHAMotorBikeQuotationDetail2Util.inputPolicyAmtInstalment()
			}else{
				lreturn=this.lTHAMotorCarQuotationDetail2Util.inputPolicyAmtInstalment()
			}
		}catch(Exception e){
			e.printStackTrace()
			return lreturn
	...
	public Map inputPolicyInsurer(String strPolicyInsurer){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPolicyInsurer=this.lTHAMotorBikeQuotationDetail2Util.inputPolicyInsurer(lPolicyInsurer)
				if(!lMapPolicyInsurer.Result){
					lPolicyInsurer=''
				}else{
					lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
				...
				Map lMapPolicyInsurer=this.lTHAMotorCarQuotationDetail2Util.inputPolicyInsurer(lPolicyInsurer)
				if(!lMapPolicyInsurer.Result){
					lPolicyInsurer=''
				}else{
					lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THARGPAMotorQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedTodo=this.lTHAMotorBikeQuotationDetail2Util.inputSalesforceProceedTodo(lSalesforceProceedTodo)
				...
				Map lMapSalesforceProceedTodo=this.lTHAMotorCarQuotationDetail2Util.inputSalesforceProceedTodo(lSalesforceProceedTodo)
				if(!lMapSalesforceProceedTodo.Result){
					lSalesforceProceedTodo=''
				}else{
					lSalesforceProceedTodo=lMapSalesforceProceedTodo.SalesforceProceedTodo
	...
	public Map inputAutomationDataBefore(){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapAutomationDataBefore=this.lTHAMotorBikeQuotationDetail2Util.inputAutomationDataBefore()
				lResult=lMapAutomationDataBefore.Result
			}else{
				Map lMapAutomationDataBefore=this.lTHAMotorCarQuotationDetail2Util.inputAutomationDataBefore()
				lResult=lMapAutomationDataBefore.Result
			}
			if(lResult){
				lreturn.put('Result',lResult)
	...
	public Map inputAutomationDataAfter(){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapAutomationDataAfter=this.lTHAMotorBikeQuotationDetail2Util.inputAutomationDataAfter()
				if(!lMapAutomationDataAfter.Result){
					lSalesforceRetrieveDataOpportunityNumber=''
					lSalesforceRetrieveDataPremiumYearly=''
					lSalesforceRetrieveDataPremiumDeposit=''
				...
				Map lMapAutomationDataAfter=this.lTHAMotorCarQuotationDetail2Util.inputAutomationDataAfter()
				if(!lMapAutomationDataAfter.Result){
					lSalesforceRetrieveDataOpportunityNumber=''
					lSalesforceRetrieveDataPremiumYearly=''
					lSalesforceRetrieveDataPremiumDeposit=''
	...
	public Map inputSalesforceProceedVerifyBefore(Map caseOutput){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedVerifyBefore=this.lTHAMotorBikeQuotationDetail2Util.inputSalesforceProceedVerifyBefore(caseOutput)
				lResult=lMapSalesforceProceedVerifyBefore.Result
			}else{
				Map lMapSalesforceProceedVerifyBefore=this.lTHAMotorCarQuotationDetail2Util.inputSalesforceProceedVerifyBefore(caseOutput)
				lResult=lMapSalesforceProceedVerifyBefore.Result
			}
			if(lResult){
				lreturn.put('Result',lResult)
	...
	public Map inputSalesforceProceedVerifyAfter(Map caseOutput){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedVerifyAfter=this.lTHAMotorBikeQuotationDetail2Util.inputSalesforceProceedVerifyAfter(caseOutput)
				lResult=lMapSalesforceProceedVerifyAfter.Result
			}else{
				Map lMapSalesforceProceedVerifyAfter=this.lTHAMotorCarQuotationDetail2Util.inputSalesforceProceedVerifyAfter(caseOutput)
				lResult=lMapSalesforceProceedVerifyAfter.Result
			}
			if(lResult){
				lreturn.put('Result',lResult)
	...
	public Map inputSalesforceProceedRetrieveTodo(String strSalesforceProceedRetrieveTodo,String strAccountNameAnonymous){
		...
		if(lSalesforceProceedRetrieveTodo.length()<=0){
			lSalesforceProceedRetrieveTodo=THARGPAMotorQuotationDetail2Type.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedRetrieveTodo=this.lTHAMotorBikeQuotationDetail2Util.inputSalesforceProceedRetrieveTodo(lSalesforceProceedRetrieveTodo,strAccountNameAnonymous)
				if(!lMapSalesforceProceedRetrieveTodo.Result){
					lSalesforceProceedRetrieveTodo=''
				}else{
					lSalesforceProceedRetrieveTodo=lMapSalesforceProceedRetrieveTodo.SalesforceProceedRetrieveTodo
				...
				Map lMapSalesforceProceedRetrieveTodo=this.lTHAMotorCarQuotationDetail2Util.inputSalesforceProceedRetrieveTodo(lSalesforceProceedRetrieveTodo,strAccountNameAnonymous)
				if(!lMapSalesforceProceedRetrieveTodo.Result){
					lSalesforceProceedRetrieveTodo=''
				}else{
					lSalesforceProceedRetrieveTodo=lMapSalesforceProceedRetrieveTodo.SalesforceProceedRetrieveTodo
	...
	public Map inputSalesforceProceedRetrieveWebFromUrl(String strRetrievePageURL){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedRetrieveWebFromUrl=this.lTHAMotorBikeQuotationDetail2Util.inputSalesforceProceedRetrieveWebFromUrl(lRetrievePageURL)
				lResult=lMapSalesforceProceedRetrieveWebFromUrl.Result
			}else{
				Map lMapSalesforceProceedRetrieveWebFromUrl=this.lTHAMotorCarQuotationDetail2Util.inputSalesforceProceedRetrieveWebFromUrl(lRetrievePageURL)
				lResult=lMapSalesforceProceedRetrieveWebFromUrl.Result
			}
			if(lResult){
				lreturn.put('Result',lResult)
