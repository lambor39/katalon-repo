...
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationResultUtil
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationResultUtilOld
...
public class THARGPAMotorQuotationResultUtil{
	private WebDriver driver=null
	private WebDriver selenium=null
	private def lTHAMotorBikeQuotationResultUtil=null
	private def lTHAMotorCarQuotationResultUtil=null
	...
	public THARGPAMotorQuotationResultUtil(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	private THAMotorBikeQuotationResultUtil getlTHAMotorBikeQuotationResultUtil(){
		return this.lTHAMotorBikeQuotationResultUtil
	}
	private void setlTHAMotorBikeQuotationResultUtil(THAMotorBikeQuotationResultUtil newlTHAMotorBikeQuotationResultUtil){
		//Do Nothing
		//this.lTHAMotorBikeQuotationResultUtil=newlTHAMotorBikeQuotationResultUtil
	}
	private THAMotorCarQuotationResultUtil getlTHAMotorCarQuotationResultUtil(){
		return this.lTHAMotorCarQuotationResultUtil
	}
	private void setlTHAMotorCarQuotationResultUtil(THAMotorCarQuotationResultUtil newlTHAMotorCarQuotationResultUtil){
		//Do Nothing
		//this.lTHAMotorCarQuotationResultUtil=newlTHAMotorCarQuotationResultUtil
	}
		...
		try{
			...
			if(THARGPAMotorCoreType.CURRENT_URL_UNDER_QUOTE_APPLICATION){
				if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
					this.lTHAMotorBikeQuotationResultUtil=new THAMotorBikeQuotationResultUtil(this.driver,this.selenium)
				}else{
					this.lTHAMotorCarQuotationResultUtil=new THAMotorCarQuotationResultUtil(this.driver,this.selenium)
				}
			}else{
				if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
					this.lTHAMotorBikeQuotationResultUtil=new THAMotorBikeQuotationResultUtilOld(this.driver,this.selenium)
				}else{
					this.lTHAMotorCarQuotationResultUtil=new THAMotorCarQuotationResultUtilOld(this.driver,this.selenium)
				}
			}
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				...
				THAMotorBikeCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER=THARGPAMotorCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER
				...
				if(lIsActualResult){
					...
					if(lIsSalesforceProceedTodo){
						...
						THARGPAMotorCoreType.CURRENT_QUOTATION_RETRIEVAL_URL_PAGE_GENERAL=caseOutput.SalesforceVerifyDataOpportunityObjQuoteAccessUrlC
						THARGPAMotorCoreType.CURRENT_QUOTATION_RETRIEVAL_URL_PAGE_PAYMENT=caseOutput.SalesforceVerifyDataOpportunityObjPayOnlineUrlC
						THARGPAMotorCoreType.CURRENT_QUOTATION_RETRIEVAL_URL_PAGE_SOCIAL=caseOutput.SalesforceVerifyDataOpportunityObjCustomerRatingUrlC
						...
						if(lIsActualResult){
							...
							if(lIsSalesforceProceedRetrieveTodo){
								Map lMapSalesforceProceedRetrieveWebFromUrl=this.inputSalesforceProceedRetrieveWebFromUrl(THARGPAMotorCoreType.CURRENT_QUOTATION_RETRIEVAL_URL_PAGE_GENERAL)
				...
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PAGE_VALUE=lAutomationPageValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PAGE_TEXT=lAutomationPageText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_VERSION_VALUE=lAutomationVersionValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_VERSION_TEXT=lAutomationVersionText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_OPPORTUNITY_NUMBER_VALUE=lAutomationOpportunityNumberValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_OPPORTUNITY_NUMBER_TEXT=lAutomationOpportunityNumberText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_VEHICLE_DETAIL_VALUE=lAutomationVehicleDetailValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_VEHICLE_DETAIL_TEXT=lAutomationVehicleDetailText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_VALUE=lAutomationPremiumYearlyValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_YEARLY_TEXT=lAutomationPremiumYearlyText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_DEPOSIT_VALUE=lAutomationPremiumDepositValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_DEPOSIT_TEXT=lAutomationPremiumDepositText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_MONTHLY_VALUE=lAutomationPremiumMonthlyValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_MONTHLY_TEXT=lAutomationPremiumMonthlyText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_INSTALMENT_VALUE=lAutomationPremiumInstalmentValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_INSTALMENT_TEXT=lAutomationPremiumInstalmentText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NODEPOSIT_AMOUNT_VALUE=lAutomationPremiumNoDepositAmountValue=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NODEPOSIT_AMOUNT_TEXT=lAutomationPremiumNoDepositAmountText=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NODEPOSIT_TOTAL_VALUE=lAutomationPremiumNoDepositTotalValue=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_NODEPOSIT_TOTAL_TEXT=lAutomationPremiumNoDepositTotalText=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_AMOUNT_VALUE=lAutomationPremiumQuarterlyAmountValue=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_AMOUNT_TEXT=lAutomationPremiumQuarterlyAmountText=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_TOTAL_VALUE=lAutomationPremiumQuarterlyTotalValue=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PREMIUM_QUARTERLY_TOTAL_TEXT=lAutomationPremiumQuarterlyTotalText=''
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PLAN_TYPE_VALUE=lAutomationPlanTypeValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PLAN_TYPE_TEXT=lAutomationPlanTypeText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_SUM_INSURED_VALUE=lAutomationSumInsuredValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_SUM_INSURED_TEXT=lAutomationSumInsuredText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_WORKSHOP_VALUE=lAutomationWorkshopValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_WORKSHOP_TEXT=lAutomationWorkshopText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_EXCESS_PRICE_VALUE=lAutomationExcessPriceValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_EXCESS_PRICE_TEXT=lAutomationExcessPriceText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_DRIVER_PLAN_VALUE=lAutomationDriverPlanValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_DRIVER_PLAN_TEXT=lAutomationDriverPlanText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_TPBI_VALUE=lAutomationTpbiValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_TPBI_TEXT=lAutomationTpbiText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_TPPD_VALUE=lAutomationTppdValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_TPPD_TEXT=lAutomationTppdText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PA_AND_ME_VALUE=lAutomationPaAndMeValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PA_AND_ME_TEXT=lAutomationPaAndMeText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PA_ONLY_VALUE=lAutomationPaOnlyValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_PA_ONLY_TEXT=lAutomationPaOnlyText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ME_ONLY_VALUE=lAutomationMeOnlyValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ME_ONLY_TEXT=lAutomationMeOnlyText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_COMPULSORY_VALUE=lAutomationCompulsoryValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_COMPULSORY_TEXT=lAutomationCompulsoryText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_RSA_VALUE=lAutomationRsaValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_RSA_TEXT=lAutomationRsaText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_CAR_REPLACEMENT_SERVICE_VALUE=lAutomationCarReplacementServiceValue
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_CAR_REPLACEMENT_SERVICE_TEXT=lAutomationCarReplacementServiceText
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_01_VALUE=lAutomationAccessoryItem01Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_01_TEXT=lAutomationAccessoryItem01Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_02_VALUE=lAutomationAccessoryItem02Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_02_TEXT=lAutomationAccessoryItem02Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_03_VALUE=lAutomationAccessoryItem03Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_03_TEXT=lAutomationAccessoryItem03Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_04_VALUE=lAutomationAccessoryItem04Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_04_TEXT=lAutomationAccessoryItem04Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_05_VALUE=lAutomationAccessoryItem05Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_05_TEXT=lAutomationAccessoryItem05Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_06_VALUE=lAutomationAccessoryItem06Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_06_TEXT=lAutomationAccessoryItem06Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_07_VALUE=lAutomationAccessoryItem07Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_07_TEXT=lAutomationAccessoryItem07Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_08_VALUE=lAutomationAccessoryItem08Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_08_TEXT=lAutomationAccessoryItem08Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_09_VALUE=lAutomationAccessoryItem09Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_09_TEXT=lAutomationAccessoryItem09Text
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_10_VALUE=lAutomationAccessoryItem10Value
				THARGPAMotorCoreType.CURRENT_QUOTATION_AUTOMATION_ACCESSORY_ITEM_10_TEXT=lAutomationAccessoryItem10Text
				if(!lMapAutomationDataBefore.Result){
					return lreturn
				}
				Map lMapActualResult=this.inputActualResult(lIsPositiveCase,lQuoteBy)
				...
				caseOutput.PremiumQuarterlyTotal=lPremiumQuarterlyTotal
				THARGPAMotorCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER=lOpportunityNumber
				THAMotorCarCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER=THARGPAMotorCoreType.CURRENT_QUOTATION_VEHICLE_OPPORTUNITY_NUMBER
				Boolean lIsActualResult=IGNUemaHelper.convertStringToBoolean(lActualResult)
				if(lIsActualResult){
					Map lMapSalesforceProceedTodo=this.inputSalesforceProceedTodo(lSalesforceProceedTodo)
					if(!lMapSalesforceProceedTodo.Result){
					...
					if(lIsSalesforceProceedTodo){
						...
						caseOutput.ActualResult=lActualResult
						if(lIsActualResult){
							lIsChangedFromAnyToDealerWorkshop=caseOutput.SalesforceVerifyDataTransactionSyncedObjPolicyProductVersionC>=THARGPAMotorCoreType.CURRENT_QUOTATION_POLICY_PRODUCT_VERSION
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THARGPAMotorQuotationResultType.DEFAULT_POSITIVE_CASE
		}
		try{
	...
	public Map inputActualResult(Boolean isPositiveCase,String strQuoteBy){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(lQuoteBy.length()<=0){
				lQuoteBy=THARGPAMotorQuotationResultType.DEFAULT_QUOTE_BY.toUpperCase()
			}
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapActualResult=this.lTHAMotorBikeQuotationResultUtil.inputActualResult(isPositiveCase,lQuoteBy)
				if(!lMapActualResult.Result){
					lActualResult=''
					lOpportunityNumber=''
					lVersion=''
				...
				Map lMapActualResult=this.lTHAMotorCarQuotationResultUtil.inputActualResult(isPositiveCase,lQuoteBy)
				if(!lMapActualResult.Result){
					lActualResult=''
					lOpportunityNumber=''
					lVersion=''
	...
	public Map inputLanguage(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THARGPAMotorQuotationResultType.DEFAULT_LANGUAGE
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapLanguage=this.lTHAMotorBikeQuotationResultUtil.inputLanguage(lLanguage)
				if(!lMapLanguage.Result){
					lLanguage=''
				}else{
					lLanguage=lMapLanguage.Language
				...
				Map lMapLanguage=this.lTHAMotorCarQuotationResultUtil.inputLanguage(lLanguage)
				if(!lMapLanguage.Result){
					lLanguage=''
				}else{
					lLanguage=lMapLanguage.Language
	...
	public Map inputPrePackage(String strPrePackage){
		...
		if(lPrePackage.length()<=0){
			lPrePackage=THARGPAMotorQuotationResultType.DEFAULT_PRE_PACKAGE
		}
		String lPrePackagePremiumYearly=''
		String lPrePackagePremiumDeposit=''
		String lPrePackagePremiumMonthly=''
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPrePackage=this.lTHAMotorBikeQuotationResultUtil.inputPrePackage(lPrePackage)
				if(!lMapPrePackage.Result){
					lPrePackage=''
					lPrePackagePremiumYearly=''
					lPrePackagePremiumDeposit=''
				...
				Map lMapPrePackage=this.lTHAMotorCarQuotationResultUtil.inputPrePackage(lPrePackage)
				if(!lMapPrePackage.Result){
					lPrePackage=''
					lPrePackagePremiumYearly=''
					lPrePackagePremiumDeposit=''
	...
	public Map inputPostPrePackage(){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPostPrePackage=this.lTHAMotorBikeQuotationResultUtil.inputPostPrePackage()
				if(!lMapPostPrePackage.Result){
					lPostPrePackagePremiumYearly=''
					lPostPrePackagePremiumDeposit=''
					lPostPrePackagePremiumMonthly=''
				...
				Map lMapPostPrePackage=this.lTHAMotorCarQuotationResultUtil.inputPostPrePackage()
				if(!lMapPostPrePackage.Result){
					lPostPrePackagePremiumYearly=''
					lPostPrePackagePremiumDeposit=''
					lPostPrePackagePremiumMonthly=''
	...
	public Map inputPlanType(String strPlanType){
		...
		if(lPlanType.length()<=0){
			lPlanType=THARGPAMotorQuotationResultType.DEFAULT_PLAN_TYPE
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPlanType=this.lTHAMotorBikeQuotationResultUtil.inputPlanType(lPlanType)
				if(!lMapPlanType.Result){
					lPlanType=''
				}else{
					lPlanType=lMapPlanType.PlanType
				...
				Map lMapPlanType=this.lTHAMotorCarQuotationResultUtil.inputPlanType(lPlanType)
				if(!lMapPlanType.Result){
					lPlanType=''
				}else{
					lPlanType=lMapPlanType.PlanType
	...
	public Map inputPlanGarage(String strPlanGarage){
		...
		if(lPlanGarage.length()<=0){
			lPlanGarage=THARGPAMotorQuotationResultType.DEFAULT_PLAN_GARAGE
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPlanGarage=this.lTHAMotorBikeQuotationResultUtil.inputPlanGarage(lPlanGarage)
				if(!lMapPlanGarage.Result){
					lPlanGarage=''
				}else{
					lPlanGarage=lMapPlanGarage.PlanGarage
				...
				Map lMapPlanGarage=this.lTHAMotorCarQuotationResultUtil.inputPlanGarage(lPlanGarage)
				if(!lMapPlanGarage.Result){
					lPlanGarage=''
				}else{
					lPlanGarage=lMapPlanGarage.PlanGarage
	...
	public Map inputPlanExcess(String strPlanExcess){
		...
		if(lPlanExcess.length()<=0){
			lPlanExcess=THARGPAMotorQuotationResultType.DEFAULT_PLAN_EXCESS
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPlanExcess=this.lTHAMotorBikeQuotationResultUtil.inputPlanExcess(lPlanExcess)
				if(!lMapPlanExcess.Result){
					lPlanExcess=''
				}else{
					lPlanExcess=lMapPlanExcess.PlanExcess
				...
				Map lMapPlanExcess=this.lTHAMotorCarQuotationResultUtil.inputPlanExcess(lPlanExcess)
				if(!lMapPlanExcess.Result){
					lPlanExcess=''
				}else{
					lPlanExcess=lMapPlanExcess.PlanExcess
	...
	public Map inputPlanDriver(String strPlanDriver){
		...
		if(lPlanDriver.length()<=0){
			lPlanDriver=THARGPAMotorQuotationResultType.DEFAULT_PLAN_DRIVER
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPlanDriver=this.lTHAMotorBikeQuotationResultUtil.inputPlanDriver(lPlanDriver)
				if(!lMapPlanDriver.Result){
					lPlanDriver=''
				}else{
					lPlanDriver=lMapPlanDriver.PlanDriver
				...
				Map lMapPlanDriver=this.lTHAMotorCarQuotationResultUtil.inputPlanDriver(lPlanDriver)
				if(!lMapPlanDriver.Result){
					lPlanDriver=''
				}else{
					lPlanDriver=lMapPlanDriver.PlanDriver
	...
	public Map inputCompulsory(String strCompulsory){
		...
		if(lCompulsory.length()<=0){
			lCompulsory=THARGPAMotorQuotationResultType.DEFAULT_COMPULSORY
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapCompulsory=this.lTHAMotorBikeQuotationResultUtil.inputCompulsory(lCompulsory)
				if(!lMapCompulsory.Result){
					lCompulsory=''
				}else{
					lCompulsory=lMapCompulsory.Compulsory
				...
				Map lMapCompulsory=this.lTHAMotorCarQuotationResultUtil.inputCompulsory(lCompulsory)
				if(!lMapCompulsory.Result){
					lCompulsory=''
				}else{
					lCompulsory=lMapCompulsory.Compulsory
	...
	public Map inputWithRsa(String strWithRsa){
		...
		if(lWithRsa.length()<=0){
			lWithRsa=THARGPAMotorQuotationResultType.DEFAULT_WITH_RSA
		}
		try{
			Boolean lResult=false
			lreturn.put('WithRsa','')
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapWithRsa=this.lTHAMotorBikeQuotationResultUtil.inputWithRsa(lWithRsa)
				if(!lMapWithRsa.Result){
					lWithRsa=''
				}else{
					lWithRsa=lMapWithRsa.WithRsa
				...
				Map lMapWithRsa=this.lTHAMotorCarQuotationResultUtil.inputWithRsa(lWithRsa)
				if(!lMapWithRsa.Result){
					lWithRsa=''
				}else{
					lWithRsa=lMapWithRsa.WithRsa
	...
	public Map inputVoluntaryTPBI(String strVoluntaryTPBI){
		...
		if(lVoluntaryTPBI.length()<=0){
			lVoluntaryTPBI=THARGPAMotorQuotationResultType.DEFAULT_VOLUNTARY_TPBI
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapVoluntaryTPBI=this.lTHAMotorBikeQuotationResultUtil.inputVoluntaryTPBI(lVoluntaryTPBI)
				if(!lMapVoluntaryTPBI.Result){
					lVoluntaryTPBI=''
				}else{
					lVoluntaryTPBI=lMapVoluntaryTPBI.VoluntaryTPBI
				...
				Map lMapVoluntaryTPBI=this.lTHAMotorCarQuotationResultUtil.inputVoluntaryTPBI(lVoluntaryTPBI)
				if(!lMapVoluntaryTPBI.Result){
					lVoluntaryTPBI=''
				}else{
					lVoluntaryTPBI=lMapVoluntaryTPBI.VoluntaryTPBI
	...
	public Map inputPersonalAccidentPaAndMe(String strPersonalAccidentPaAndMe){
		...
		if(lPersonalAccidentPaAndMe.length()<=0){
			lPersonalAccidentPaAndMe=THARGPAMotorQuotationResultType.DEFAULT_PERSONAL_ACCIDENT_PA_AND_ME
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPersonalAccidentPaAndMe=this.lTHAMotorBikeQuotationResultUtil.inputPersonalAccidentPaAndMe(lPersonalAccidentPaAndMe)
				if(!lMapPersonalAccidentPaAndMe.Result){
					lPersonalAccidentPaAndMe=''
				}else{
					lPersonalAccidentPaAndMe=lMapPersonalAccidentPaAndMe.PersonalAccidentPaAndMe
				...
				Map lMapPersonalAccidentPaAndMe=this.lTHAMotorCarQuotationResultUtil.inputPersonalAccidentPaAndMe(lPersonalAccidentPaAndMe)
				if(!lMapPersonalAccidentPaAndMe.Result){
					lPersonalAccidentPaAndMe=''
				}else{
					lPersonalAccidentPaAndMe=lMapPersonalAccidentPaAndMe.PersonalAccidentPaAndMe
	...
	public Map inputPersonalAccidentPaOnly(String strPersonalAccidentPaOnly){
		...
		if(lPersonalAccidentPaOnly.length()<=0){
			lPersonalAccidentPaOnly=THARGPAMotorQuotationResultType.DEFAULT_PERSONAL_ACCIDENT_PA_ONLY
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPersonalAccidentPaOnly=this.lTHAMotorBikeQuotationResultUtil.inputPersonalAccidentPaOnly(lPersonalAccidentPaOnly)
				if(!lMapPersonalAccidentPaOnly.Result){
					lPersonalAccidentPaOnly=''
				}else{
					lPersonalAccidentPaOnly=lMapPersonalAccidentPaOnly.PersonalAccidentPaOnly
				...
				Map lMapPersonalAccidentPaOnly=this.lTHAMotorCarQuotationResultUtil.inputPersonalAccidentPaOnly(lPersonalAccidentPaOnly)
				if(!lMapPersonalAccidentPaOnly.Result){
					lPersonalAccidentPaOnly=''
				}else{
					lPersonalAccidentPaOnly=lMapPersonalAccidentPaOnly.PersonalAccidentPaOnly
	...
	public Map inputPersonalAccidentMeOnly(String strPersonalAccidentMeOnly){
		...
		if(lPersonalAccidentMeOnly.length()<=0){
			lPersonalAccidentMeOnly=THARGPAMotorQuotationResultType.DEFAULT_PERSONAL_ACCIDENT_ME_ONLY
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPersonalAccidentMeOnly=this.lTHAMotorBikeQuotationResultUtil.inputPersonalAccidentMeOnly(lPersonalAccidentMeOnly)
				if(!lMapPersonalAccidentMeOnly.Result){
					lPersonalAccidentMeOnly=''
				}else{
					lPersonalAccidentMeOnly=lMapPersonalAccidentMeOnly.PersonalAccidentMeOnly
				...
				Map lMapPersonalAccidentMeOnly=this.lTHAMotorCarQuotationResultUtil.inputPersonalAccidentMeOnly(lPersonalAccidentMeOnly)
				if(!lMapPersonalAccidentMeOnly.Result){
					lPersonalAccidentMeOnly=''
				}else{
					lPersonalAccidentMeOnly=lMapPersonalAccidentMeOnly.PersonalAccidentMeOnly
	...
	public Map inputCarRentalService(String strCarRentalService){
		...
		if(lCarRentalService.length()<=0){
			lCarRentalService=THARGPAMotorQuotationResultType.DEFAULT_CAR_RENTAL_SERVICE
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapCarRentalService=this.lTHAMotorBikeQuotationResultUtil.inputCarRentalService(lCarRentalService)
				if(!lMapCarRentalService.Result){
					lCarRentalService=''
				}else{
					lCarRentalService=lMapCarRentalService.CarRentalService
				...
				Map lMapCarRentalService=this.lTHAMotorCarQuotationResultUtil.inputCarRentalService(lCarRentalService)
				if(!lMapCarRentalService.Result){
					lCarRentalService=''
				}else{
					lCarRentalService=lMapCarRentalService.CarRentalService
	...
	public Map inputAccessoryAdd(String strAccessoryAdd,String strAccessoryCarryBoyAdd,String strAccessoryCarryBoyOption,String strAccessoryGasFuelingSystemAdd,String strAccessoryGasFuelingSystemOption,String strAccessoryBodyKitAdd,String strAccessoryBodyKitOption,String strAccessoryRimsTiresAdd,String strAccessoryRimsTiresOption,String strAccessorySolarFilmAdd,String strAccessorySolarFilmOption,String strAccessorySuspensionStabilizerSystemAdd,String strAccessorySuspensionStabilizerSystemOption,String strAccessoryInVehicleEntertainmentSystemAdd,String strAccessoryInVehicleEntertainmentSystemOption,String strAccessoryAirIntakeExhaustSystemAdd,String strAccessoryAirIntakeExhaustSystemOption,String strAccessoryCarCameraAdd,String strAccessoryCarCameraOption){
		...
		if(lAccessoryAdd.length()<=0){
			lAccessoryAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_ADD
		}
		String lAccessoryCarryBoyAdd=strAccessoryCarryBoyAdd.trim()
		if(lAccessoryCarryBoyAdd.length()<=0){
			lAccessoryCarryBoyAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_CARRY_BOY_ADD
		}
		String lAccessoryCarryBoyOption=strAccessoryCarryBoyOption.trim()
		if(lAccessoryCarryBoyOption.length()<=0){
			lAccessoryCarryBoyOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_CARRY_BOY_OPTION
		}
		String lAccessoryGasFuelingSystemAdd=strAccessoryGasFuelingSystemAdd.trim()
		if(lAccessoryGasFuelingSystemAdd.length()<=0){
			lAccessoryGasFuelingSystemAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_GAS_FUELING_SYSTEM_ADD
		}
		...
		if(lAccessoryGasFuelingSystemOption.length()<=0){
			lAccessoryGasFuelingSystemOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_GAS_FUELING_SYSTEM_OPTION
		}
		String lAccessoryBodyKitAdd=strAccessoryBodyKitAdd.trim()
		if(lAccessoryBodyKitAdd.length()<=0){
			lAccessoryBodyKitAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_BODY_KIT_ADD
		}
		String lAccessoryBodyKitOption=strAccessoryBodyKitOption.trim()
		if(lAccessoryBodyKitOption.length()<=0){
			lAccessoryBodyKitOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_BODY_KIT_OPTION
		}
		String lAccessoryRimsTiresAdd=strAccessoryRimsTiresAdd.trim()
		if(lAccessoryRimsTiresAdd.length()<=0){
			lAccessoryRimsTiresAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_RIMS_TIRES_ADD
		}
		String lAccessoryRimsTiresOption=strAccessoryRimsTiresOption.trim()
		if(lAccessoryRimsTiresOption.length()<=0){
			lAccessoryRimsTiresOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_RIMS_TIRES_OPTION
		}
		String lAccessorySolarFilmAdd=strAccessorySolarFilmAdd.trim()
		if(lAccessorySolarFilmAdd.length()<=0){
			lAccessorySolarFilmAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_SOLAR_FILM_ADD
		}
		String lAccessorySolarFilmOption=strAccessorySolarFilmOption.trim()
		if(lAccessorySolarFilmOption.length()<=0){
			lAccessorySolarFilmOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_SOLAR_FILM_OPTION
		}
		...
		if(lAccessorySuspensionStabilizerSystemAdd.length()<=0){
			lAccessorySuspensionStabilizerSystemAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_SUSPENSION_STABILIZER_SYSTEM_ADD
		}
		...
		if(lAccessorySuspensionStabilizerSystemOption.length()<=0){
			lAccessorySuspensionStabilizerSystemOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_SUSPENSION_STABILIZER_SYSTEM_OPTION
		}
		...
		if(lAccessoryInVehicleEntertainmentSystemAdd.length()<=0){
			lAccessoryInVehicleEntertainmentSystemAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_IN_VEHICLE_ENTERTAINMENT_SYSTEM_ADD
		}
		...
		if(lAccessoryInVehicleEntertainmentSystemOption.length()<=0){
			lAccessoryInVehicleEntertainmentSystemOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_IN_VEHICLE_ENTERTAINMENT_SYSTEM_OPTION
		}
		...
		if(lAccessoryAirIntakeExhaustSystemAdd.length()<=0){
			lAccessoryAirIntakeExhaustSystemAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_AIR_INTAKE_EXHAUST_SYSTEM_ADD
		}
		...
		if(lAccessoryAirIntakeExhaustSystemOption.length()<=0){
			lAccessoryAirIntakeExhaustSystemOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_AIR_INTAKE_EXHAUST_SYSTEM_OPTION
		}
		String lAccessoryCarCameraAdd=strAccessoryCarCameraAdd.trim()
		if(lAccessoryCarCameraAdd.length()<=0){
			lAccessoryCarCameraAdd=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_CAR_CAMERA_ADD
		}
		String lAccessoryCarCameraOption=strAccessoryCarCameraOption.trim()
		if(lAccessoryCarCameraOption.length()<=0){
			lAccessoryCarCameraOption=THARGPAMotorQuotationResultType.DEFAULT_ACCESSORY_CAR_CAMERA_OPTION
		}
		String lAccessoryAmount=''
		String lAccessoryDetail=''
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapAccessoryAdd=this.lTHAMotorBikeQuotationResultUtil.inputAccessoryAdd(lAccessoryAdd,lAccessoryCarryBoyAdd,lAccessoryCarryBoyOption,lAccessoryGasFuelingSystemAdd,lAccessoryGasFuelingSystemOption,lAccessoryBodyKitAdd,lAccessoryBodyKitOption,lAccessoryRimsTiresAdd,lAccessoryRimsTiresOption,lAccessorySolarFilmAdd,lAccessorySolarFilmOption,lAccessorySuspensionStabilizerSystemAdd,lAccessorySuspensionStabilizerSystemOption,lAccessoryInVehicleEntertainmentSystemAdd,lAccessoryInVehicleEntertainmentSystemOption,lAccessoryAirIntakeExhaustSystemAdd,lAccessoryAirIntakeExhaustSystemOption,lAccessoryCarCameraAdd,lAccessoryCarCameraOption)
				if(!lMapAccessoryAdd.Result){
					lAccessoryAdd=''
					lAccessoryCarryBoyAdd=''
					lAccessoryCarryBoyOption=''
				...
				Map lMapAccessoryAdd=this.lTHAMotorCarQuotationResultUtil.inputAccessoryAdd(lAccessoryAdd,lAccessoryCarryBoyAdd,lAccessoryCarryBoyOption,lAccessoryGasFuelingSystemAdd,lAccessoryGasFuelingSystemOption,lAccessoryBodyKitAdd,lAccessoryBodyKitOption,lAccessoryRimsTiresAdd,lAccessoryRimsTiresOption,lAccessorySolarFilmAdd,lAccessorySolarFilmOption,lAccessorySuspensionStabilizerSystemAdd,lAccessorySuspensionStabilizerSystemOption,lAccessoryInVehicleEntertainmentSystemAdd,lAccessoryInVehicleEntertainmentSystemOption,lAccessoryAirIntakeExhaustSystemAdd,lAccessoryAirIntakeExhaustSystemOption,lAccessoryCarCameraAdd,lAccessoryCarCameraOption)
				if(!lMapAccessoryAdd.Result){
					lAccessoryAdd=''
					lAccessoryCarryBoyAdd=''
					lAccessoryCarryBoyOption=''
	...
	public Map inputQuoteMe(String strQuoteBy,String strQuotePhoneNo,String strQuoteEmail,String strQuoteNewsletter,String strQuoteCallMeNow,String strQuotePDFDownloadToDo){
		...
		if(lQuoteBy.length()<=0){
			lQuoteBy=THARGPAMotorQuotationResultType.DEFAULT_QUOTE_BY
		}
		String lQuotePhoneNo=strQuotePhoneNo.trim()
		if(lQuotePhoneNo.length()<=0){
			lQuotePhoneNo=THARGPAMotorQuotationResultType.DEFAULT_QUOTE_PHONE_NO
		}
		String lQuoteEmail=strQuoteEmail.trim()
		if(lQuoteEmail.length()<=0){
			lQuoteEmail=THARGPAMotorQuotationResultType.DEFAULT_QUOTE_EMAIL
		}
		String lQuoteNewsletter=strQuoteNewsletter.trim()
		if(lQuoteNewsletter.length()<=0){
			lQuoteNewsletter=THARGPAMotorQuotationResultType.DEFAULT_QUOTE_NEWSLETTER
		}
		String lQuoteCallMeNow=strQuoteCallMeNow.trim()
		if(lQuoteCallMeNow.length()<=0){
			lQuoteCallMeNow=THARGPAMotorQuotationResultType.DEFAULT_QUOTE_CALL_ME_NOW
		}
		String lQuotePDFDownloadToDo=strQuotePDFDownloadToDo.trim()
		if(lQuotePDFDownloadToDo.length()<=0){
			lQuotePDFDownloadToDo=THARGPAMotorQuotationResultType.DEFAULT_QUOTE_PDF_DOWNLOAD_TO_DO
		}
		String lQuotePDFDownloadDetail=''
		String lQuotePDFDownloadResult=''
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapQuoteMe=this.lTHAMotorBikeQuotationResultUtil.inputQuoteMe(lQuoteBy,lQuotePhoneNo,lQuoteEmail,lQuoteNewsletter,lQuoteCallMeNow,lQuotePDFDownloadToDo)
				if(!lMapQuoteMe.Result){
					lQuoteBy=''
					lQuotePhoneNo=''
					lQuoteEmail=''
				...
				Map lMapQuoteMe=this.lTHAMotorCarQuotationResultUtil.inputQuoteMe(lQuoteBy,lQuotePhoneNo,lQuoteEmail,lQuoteNewsletter,lQuoteCallMeNow,lQuotePDFDownloadToDo)
				if(!lMapQuoteMe.Result){
					lQuoteBy=''
					lQuotePhoneNo=''
					lQuoteEmail=''
	...
	public Map inputPolicyInsurer(String strPolicyInsurer){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapPolicyInsurer=this.lTHAMotorBikeQuotationResultUtil.inputPolicyInsurer(lPolicyInsurer)
				if(!lMapPolicyInsurer.Result){
					lPolicyInsurer=''
				}else{
					lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
				...
				Map lMapPolicyInsurer=this.lTHAMotorCarQuotationResultUtil.inputPolicyInsurer(lPolicyInsurer)
				if(!lMapPolicyInsurer.Result){
					lPolicyInsurer=''
				}else{
					lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
	...
	public Map inputSalesforceProceedTodo(String strSalesforceProceedTodo){
		...
		if(lSalesforceProceedTodo.length()<=0){
			lSalesforceProceedTodo=THARGPAMotorQuotationResultType.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedTodo=this.lTHAMotorBikeQuotationResultUtil.inputSalesforceProceedTodo(lSalesforceProceedTodo)
				if(!lMapSalesforceProceedTodo.Result){
					lSalesforceProceedTodo=''
				}else{
					lSalesforceProceedTodo=lMapSalesforceProceedTodo.SalesforceProceedTodo
				...
				Map lMapSalesforceProceedTodo=this.lTHAMotorCarQuotationResultUtil.inputSalesforceProceedTodo(lSalesforceProceedTodo)
				if(!lMapSalesforceProceedTodo.Result){
					lSalesforceProceedTodo=''
				}else{
					lSalesforceProceedTodo=lMapSalesforceProceedTodo.SalesforceProceedTodo
	...
	public Map inputAutomationDataBefore(){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapAutomationDataBefore=this.lTHAMotorBikeQuotationResultUtil.inputAutomationDataBefore()
				if(!lMapAutomationDataBefore.Result){
					lAutomationPageValue=''
					lAutomationPageText=''
					lAutomationVersionValue=''
				...
				Map lMapAutomationDataBefore=this.lTHAMotorCarQuotationResultUtil.inputAutomationDataBefore()
				if(!lMapAutomationDataBefore.Result){
					lAutomationPageValue=''
					lAutomationPageText=''
					lAutomationVersionValue=''
	...
	public Map inputSalesforceProceedVerifyBefore(Map caseOutput){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedVerifyBefore=this.lTHAMotorBikeQuotationResultUtil.inputSalesforceProceedVerifyBefore(caseOutput)
				lResult=lMapSalesforceProceedVerifyBefore.Result
			}else{
				Map lMapSalesforceProceedVerifyBefore=this.lTHAMotorCarQuotationResultUtil.inputSalesforceProceedVerifyBefore(caseOutput)
				lResult=lMapSalesforceProceedVerifyBefore.Result
			}
			if(lResult){
				lreturn.put('Result',lResult)
	...
	public Map inputSalesforceProceedVerifyAfter(Map caseOutput,Boolean isPositiveCase,String strQuoteBy){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedVerifyAfter=this.lTHAMotorBikeQuotationResultUtil.inputSalesforceProceedVerifyAfter(caseOutput,isPositiveCase,strQuoteBy)
				lResult=lMapSalesforceProceedVerifyAfter.Result
			}else{
				Map lMapSalesforceProceedVerifyAfter=this.lTHAMotorCarQuotationResultUtil.inputSalesforceProceedVerifyAfter(caseOutput,isPositiveCase,strQuoteBy)
				lResult=lMapSalesforceProceedVerifyAfter.Result
			}
			if(lResult){
				lreturn.put('Result',lResult)
	...
	public Map inputSalesforceProceedRetrieveTodo(String strSalesforceProceedRetrieveTodo,String strAccountNameAnonymous){
		...
		if(lSalesforceProceedRetrieveTodo.length()<=0){
			lSalesforceProceedRetrieveTodo=THARGPAMotorQuotationResultType.DEFAULT_SALESFORCE_PROCEED_TODO
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedRetrieveTodo=this.lTHAMotorBikeQuotationResultUtil.inputSalesforceProceedRetrieveTodo(lSalesforceProceedRetrieveTodo,strAccountNameAnonymous)
				if(!lMapSalesforceProceedRetrieveTodo.Result){
					lSalesforceProceedRetrieveTodo=''
				}else{
					lSalesforceProceedRetrieveTodo=lMapSalesforceProceedRetrieveTodo.SalesforceProceedRetrieveTodo
				...
				Map lMapSalesforceProceedRetrieveTodo=this.lTHAMotorCarQuotationResultUtil.inputSalesforceProceedRetrieveTodo(lSalesforceProceedRetrieveTodo,strAccountNameAnonymous)
				if(!lMapSalesforceProceedRetrieveTodo.Result){
					lSalesforceProceedRetrieveTodo=''
				}else{
					lSalesforceProceedRetrieveTodo=lMapSalesforceProceedRetrieveTodo.SalesforceProceedRetrieveTodo
	...
	public Map inputSalesforceProceedRetrieveWebFromUrl(String strRetrievePageURL){
		...
		try{
			...
			lreturn.put('Result',lResult)
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				Map lMapSalesforceProceedRetrieveWebFromUrl=this.lTHAMotorBikeQuotationResultUtil.inputSalesforceProceedRetrieveWebFromUrl(lRetrievePageURL)
				lResult=lMapSalesforceProceedRetrieveWebFromUrl.Result
			}else{
				Map lMapSalesforceProceedRetrieveWebFromUrl=this.lTHAMotorCarQuotationResultUtil.inputSalesforceProceedRetrieveWebFromUrl(lRetrievePageURL)
				lResult=lMapSalesforceProceedRetrieveWebFromUrl.Result
			}
			if(lResult){
				lreturn.put('Result',lResult)
	...
	public Boolean inputExpectedKumkaCompareButton(Map targetMap){
		...
		if(!lExpectedKumkaCompareButtonItem){
			lExpectedKumkaCompareButtonItem=lExpectedKumkaCompareButtonList.get(THARGPAMotorQuotationResultType.DEFAULT_EXPECTED_KUMKA_COMPARE_BUTTON.toUpperCase())
		...
		if(!lKumkaCompareToDoItem){
			lKumkaCompareToDoItem=lKumkaCompareToDoList.get(THARGPAMotorQuotationResultType.DEFAULT_KUMKA_COMPARE_TO_DO.toUpperCase())
	...
	public Boolean inputKumkaCompareNow(String strLanguage,String strEmailToSave,String strCallMeBack,String strCallMeBackPhoneNo,Map targetMap){
		...
		if(lKumkaCompareToDo.length()<=0){
			lKumkaCompareToDo=THARGPAMotorQuotationResultType.DEFAULT_KUMKA_COMPARE_TO_DO
		}
		String lKumkaLoginPage=THARGPAMotorQuotationResultType.DEFAULT_KUMKA_LOGIN_URL
		String lLoginUser=THARGPAMotorQuotationResultType.DEFAULT_KUMKA_LOGIN_USER
		String lLoginPassword=THARGPAMotorQuotationResultType.DEFAULT_KUMKA_LOGIN_PASSWORD
		...
		try{
			...
			if(THARGPAMotorCoreType.CURRENT_PRODUCT_IS_MOTOR_BIKE){
				if(lElementButton){
					this.lTHAMotorBikeQuotationResultUtil.inputProceedRetrieveWebFromUrl(lKumkaLoginPage)
					this.lTHAMotorBikeQuotationResultUtil.inputLoginUserPassword(lLoginUser,lLoginPassword)
					...
					this.lTHAMotorBikeQuotationResultUtil.waitUntilKumkaPageLoaded()
					this.lTHAMotorBikeQuotationResultUtil.closeAskToSaveEmailForm()
					Map lMapKumkaOutboundCardResult=this.lTHAMotorBikeQuotationResultUtil.countKumkaOutboundCard()
					...
					if(lCurrentURLText.length()>0){
						THARGPAMotorCoreType.CURRENT_URL_UNDER_PAGE_RESULT_NEW_KUMKA=IGNUemaHelper.checkStringContainString(lCurrentURLText,'/CARDSNEW')
					}
					if(THARGPAMotorCoreType.CURRENT_URL_UNDER_PAGE_RESULT_NEW_KUMKA){
					...
					this.driver.close()
					this.driver.switchTo().window(lMainWindow)
					this.lTHAMotorBikeQuotationResultUtil.inputProceedRetrieveWebFromUrl(lKumkaDefaultSaveQuoteId)
					this.lTHAMotorBikeQuotationResultUtil.waitUntilKumkaPageLoaded()
					this.lTHAMotorBikeQuotationResultUtil.closeAskToSaveEmailForm()
					lMapKumkaOutboundCardResult.clear()
					lMapKumkaOutboundCardResult=this.lTHAMotorBikeQuotationResultUtil.countKumkaOutboundCard()
					if(!lMapKumkaOutboundCardResult.Result){
				...
				if(lElementButton){
					this.lTHAMotorCarQuotationResultUtil.inputProceedRetrieveWebFromUrl(lKumkaLoginPage)
					this.lTHAMotorCarQuotationResultUtil.inputLoginUserPassword(lLoginUser,lLoginPassword)
					lWindowHandle=this.driver.getWindowHandle()
					this.driver.close()
					this.driver.switchTo().window(lMainWindow)
					lKumkaDefaultCompareLink=IGNUemaHelper.getElementAttributeByWebElement(this.driver,lElementButton,'href')
					...
					this.lTHAMotorCarQuotationResultUtil.waitUntilKumkaPageLoaded()
					this.lTHAMotorCarQuotationResultUtil.closeAskToSaveEmailForm()
					Map lMapKumkaOutboundCardResult=this.lTHAMotorCarQuotationResultUtil.countKumkaOutboundCard()
					if(!lMapKumkaOutboundCardResult.Result){
						lKumkaOutboundCardCompareLinkNumber=''
					}else{
						lKumkaOutboundCardCompareLinkNumber=lMapKumkaOutboundCardResult.KumkaOutboundCardNumber
					...
					this.driver.close()
					this.driver.switchTo().window(lMainWindow)
					this.lTHAMotorCarQuotationResultUtil.inputProceedRetrieveWebFromUrl(lKumkaDefaultSaveQuoteId)
					this.lTHAMotorCarQuotationResultUtil.waitUntilKumkaPageLoaded()
					this.lTHAMotorCarQuotationResultUtil.closeAskToSaveEmailForm()
					lMapKumkaOutboundCardResult.clear()
					lMapKumkaOutboundCardResult=this.lTHAMotorCarQuotationResultUtil.countKumkaOutboundCard()
					if(!lMapKumkaOutboundCardResult.Result){
						lKumkaOutboundCardSaveQuoteIdNumber=''
					}else{
						lKumkaOutboundCardSaveQuoteIdNumber=lMapKumkaOutboundCardResult.KumkaOutboundCardNumber
