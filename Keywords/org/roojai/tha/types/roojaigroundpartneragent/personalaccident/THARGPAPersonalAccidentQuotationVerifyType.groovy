...
public class THARGPAPersonalAccidentQuotationVerifyType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/RoojaiGroundPartnerAgentPersonalAccident/RGPAPersonalAccident_Quotation_00_Verify.Input'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/RoojaiGroundPartnerAgentPersonalAccident/RGPAPersonalAccident_Quotation_00_Verify.Output'
	...
	public Map Input=[:]
	public Map Output=[:]
	public THARGPAPersonalAccidentQuotationVerifyType(){
		super()
		this.initInput()
		this.initOutput()
	}
