...
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationDetail1Util
public class THARGPAExtendedWarrantyQuotationDetail1Util{
	private WebDriver driver=null
	private WebDriver selenium=null
	private THAExtendedWarrantyQuotationDetail1Util lTHAExtendedWarrantyQuotationDetail1Util=null
	public THARGPAExtendedWarrantyQuotationDetail1Util(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	private THAExtendedWarrantyQuotationDetail1Util getlTHAExtendedWarrantyQuotationDetail1Util(){
		return this.lTHAExtendedWarrantyQuotationDetail1Util
	}
	private void setlTHAExtendedWarrantyQuotationDetail1Util(THAExtendedWarrantyQuotationDetail1Util newlTHAExtendedWarrantyQuotationDetail1Util){
		//Do Nothing
		//this.lTHAExtendedWarrantyQuotationDetail1Util=newlTHAExtendedWarrantyQuotationDetail1Util
	}
	public Boolean inputDetail1(Map caseInput,Map caseOutput){
		...
		try{
			...
			this.lTHAExtendedWarrantyQuotationDetail1Util=new THAExtendedWarrantyQuotationDetail1Util(this.driver,this.selenium)
			Map lMapDetail1Input=this.lTHAExtendedWarrantyQuotationDetail1Util.initDetail1Input()
	...
	public Map inputDetail1A(Map mapInput,Boolean isPositiveCase){
		Map lreturn=lTHAExtendedWarrantyQuotationDetail1Util.initDetail1Output()
		...
		try{
			...
			if(!lIsHolderCallMeNowToDo){
				...
				Map lMapActualResult=this.inputActualResult(isPositiveCase,lHolderPhoneNo,THARGPAExtendedWarrantyCoreType.CURRENT_POLICY_DETAIL_1_SKIP_OTP)
				if(!lMapActualResult.Result){
					lActualResult=''
				}else{
					lActualResult=lMapActualResult.ActualResult
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_POSITIVE_CASE
		}
		try{
	...
	public Map inputLanguage(String strLanguage){
		...
		if(lLanguage.length()<=0){
			lLanguage=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_LANGUAGE.toUpperCase()
		}
		try{
			Boolean lResult=false
			lreturn.put('Language','')
			lreturn.put('Result',lResult)
			Map lMapLanguage=this.lTHAExtendedWarrantyQuotationDetail1Util.inputLanguage(lLanguage)
			if(!lMapLanguage.Result){
				lLanguage=''
			}else{
				lLanguage=lMapLanguage.Language
	...
	public Map inputSubmitCallMeBack(String strSubmitCallMeBack,String strCallMeBackEmail,String strCallMeBackMobile){
		...
		if(lSubmitCallMeBack.length()<=0){
			lSubmitCallMeBack=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_SUBMIT_CALL_ME_BACK
		}
		String lCallMeBackEmail=strCallMeBackEmail.trim()
		if(lCallMeBackEmail.length()<=0){
			lCallMeBackEmail=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_CALL_ME_BACK_EMAIL
		}
		String lCallMeBackMobile=strCallMeBackMobile.trim()
		if(lCallMeBackMobile.length()<=0){
			lCallMeBackMobile=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_CALL_ME_BACK_MOBILE
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapSubmitCallMeBack=this.lTHAExtendedWarrantyQuotationDetail1Util.inputSubmitCallMeBack(lSubmitCallMeBack,lCallMeBackEmail,lCallMeBackMobile)
			if(!lMapSubmitCallMeBack.Result){
				lSubmitCallMeBack=''
				lCallMeBackEmail=''
				lCallMeBackMobile=''
	...
	public Map inputHolderIsMain(String strHolderIsMain){
		...
		if(lHolderIsMain.length()<=0){
			lHolderIsMain=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_IS_MAIN
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsMain','')
			lreturn.put('Result',lResult)
			Map lMapHolderIsMain=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderIsMain(lHolderIsMain)
			if(!lMapHolderIsMain.Result){
				lHolderIsMain=''
			}else{
				lHolderIsMain=lMapHolderIsMain.HolderIsMain
	...
	public Map inputHolderEmail(String strHolderEmail){
		...
		if(lHolderEmail.length()<=0){
			lHolderEmail=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_EMAIL
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderEmail','')
			lreturn.put('Result',lResult)
			Map lMapHolderEmail=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderEmail(lHolderEmail)
			if(!lMapHolderEmail.Result){
				lHolderEmail=''
			}else{
				lHolderEmail=lMapHolderEmail.HolderEmail
	...
	public Map inputHolderNewsletter(String strHolderNewsletter){
		...
		if(lHolderNewsletter.length()<=0){
			lHolderNewsletter=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_NEWSLETTER
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderNewsletter','')
			lreturn.put('Result',lResult)
			Map lMapHolderNewsletter=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderNewsletter(lHolderNewsletter)
			if(!lMapHolderNewsletter.Result){
				lHolderNewsletter=''
			}else{
				lHolderNewsletter=lMapHolderNewsletter.HolderNewsletter
	...
	public Map inputHolderPhoneNo(String strHolderPhoneNo){
		...
		if(lHolderPhoneNo.length()<=0){
			lHolderPhoneNo=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_PHONE_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderPhoneNo','')
			lreturn.put('Result',lResult)
			Map lMapHolderPhoneNo=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderPhoneNo(lHolderPhoneNo)
			if(!lMapHolderPhoneNo.Result){
				lHolderPhoneNo=''
			}else{
				lHolderPhoneNo=lMapHolderPhoneNo.HolderPhoneNo
	...
	public Map inputHolderCallMeNowToDo(String strHolderCallMeNowToDo){
		...
		if(lHolderCallMeNowToDo.length()<=0){
			lHolderCallMeNowToDo=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_CALL_ME_NOW_TO_DO
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCallMeNowToDo','')
			lreturn.put('Result',lResult)
			Map lMapHolderCallMeNowToDo=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderCallMeNowToDo(lHolderCallMeNowToDo)
			if(!lMapHolderCallMeNowToDo.Result){
				lHolderCallMeNowToDo=''
			}else{
				lHolderCallMeNowToDo=lMapHolderCallMeNowToDo.HolderCallMeNowToDo
	...
	public Map inputCallMeNow(String strCallMeNow){
		...
		if(lCallMeNow.length()<=0){
			lCallMeNow=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_CALL_ME_NOW
		}
		try{
			Boolean lResult=false
			lreturn.put('CallMeNow','')
			lreturn.put('Result',lResult)
			Map lMapCallMeNow=this.lTHAExtendedWarrantyQuotationDetail1Util.inputCallMeNow(lCallMeNow)
			if(!lMapCallMeNow.Result){
				lCallMeNow=''
			}else{
				lCallMeNow=lMapCallMeNow.CallMeNow
	...
	public Map inputCarForCommercial(String strCarForCommercial){
		...
		if(lCarForCommercial.length()<=0){
			lCarForCommercial=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_CAR_FOR_COMMERCIAL
		}
		try{
			Boolean lResult=false
			lreturn.put('CarForCommercial','')
			lreturn.put('Result',lResult)
			Map lMapCarForCommercial=this.lTHAExtendedWarrantyQuotationDetail1Util.inputCarForCommercial(lCarForCommercial)
			if(!lMapCarForCommercial.Result){
				lCarForCommercial=''
			}else{
				lCarForCommercial=lMapCarForCommercial.CarForCommercial
	...
	public Map inputHolderIsPerson(String strHolderIsPerson){
		...
		if(lHolderIsPerson.length()<=0){
			lHolderIsPerson=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_IS_PERSON
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsPerson','')
			lreturn.put('Result',lResult)
			Map lMapHolderIsPerson=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderIsPerson(lHolderIsPerson)
			if(!lMapHolderIsPerson.Result){
				lHolderIsPerson=''
			}else{
				lHolderIsPerson=lMapHolderIsPerson.HolderIsPerson
	...
	public Map inputHolderCompName(String strHolderCompName){
		...
		if(lHolderCompName.length()<=0){
			lHolderCompName=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_COMP_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCompName','')
			lreturn.put('Result',lResult)
			Map lMapHolderCompName=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderCompName(lHolderCompName)
			if(!lMapHolderCompName.Result){
				lHolderCompName=''
			}else{
				lHolderCompName=lMapHolderCompName.HolderCompName
	...
	public Map inputHolderCompId(String strHolderCompId){
		...
		if(lHolderCompId.length()<=0){
			lHolderCompId=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_COMP_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCompId','')
			lreturn.put('Result',lResult)
			Map lMapHolderCompId=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderCompId(lHolderCompId)
			if(!lMapHolderCompId.Result){
				lHolderCompId=''
			}else{
				lHolderCompId=lMapHolderCompId.HolderCompId
	...
	public Map inputCarPlateNumber(String strCarPlateNumber){
		...
		if(lCarPlateNumber.length()<=0){
			lCarPlateNumber=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_CAR_PLATE_NUMBER
		}
		try{
			Boolean lResult=false
			lreturn.put('CarPlateNumber','')
			lreturn.put('Result',lResult)
			Map lMapCarPlateNumber=this.lTHAExtendedWarrantyQuotationDetail1Util.inputCarPlateNumber(lCarPlateNumber)
			if(!lMapCarPlateNumber.Result){
				lCarPlateNumber=''
			}else{
				lCarPlateNumber=lMapCarPlateNumber.CarPlateNumber
	...
	public Map inputCarPlateProvince(String strCarPlateProvince){
		...
		if(lCarPlateProvince.length()<=0){
			lCarPlateProvince=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_CAR_PLATE_PROVINCE
		}
		try{
			Boolean lResult=false
			lreturn.put('CarPlateProvince','')
			lreturn.put('Result',lResult)
			Map lMapCarPlateProvince=this.lTHAExtendedWarrantyQuotationDetail1Util.inputCarPlateProvince(lCarPlateProvince)
			if(!lMapCarPlateProvince.Result){
				lCarPlateProvince=''
			}else{
				lCarPlateProvince=lMapCarPlateProvince.CarPlateProvince
	...
	public Map inputBlueBookWarantyExpiryDate(String strBlueBookWarantyExpiryDate,String strBlueBookWarantyExpiryOffsetDate){
		...
		if(lBlueBookWarantyExpiryDate.length()<=0){
			lBlueBookWarantyExpiryDate=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_BLUE_BOOK_WARANTY_EXPIRY_DATE
		}
		if(lBlueBookWarantyExpiryOffsetDate.length()<=0){
			lBlueBookWarantyExpiryOffsetDate=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_BLUE_BOOK_WARANTY_EXPIRY_OFFSET_DATE
		}
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapBlueBookWarantyExpiryDate=this.lTHAExtendedWarrantyQuotationDetail1Util.inputBlueBookWarantyExpiryDate(lBlueBookWarantyExpiryDate,lBlueBookWarantyExpiryOffsetDate)
			if(!lMapBlueBookWarantyExpiryDate.Result){
				lBlueBookWarantyExpiryDate=''
				lBlueBookWarantyExpiryOffsetDate=''
			}else{
			...
			lResult=lMapBlueBookWarantyExpiryDate.Result
			if(lResult){
	...
	public Map inputBlueBookWarantyOdometer(String strBlueBookWarantyOdometer){
		...
		if(lBlueBookWarantyOdometer.length()<=0){
			lBlueBookWarantyOdometer=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_BLUE_BOOK_WARANTY_ODOMETER
		}
		try{
			Boolean lResult=false
			lreturn.put('BlueBookWarantyOdometer','')
			lreturn.put('Result',lResult)
			Map lMapBlueBookWarantyOdometer=this.lTHAExtendedWarrantyQuotationDetail1Util.inputBlueBookWarantyOdometer(lBlueBookWarantyOdometer)
			if(!lMapBlueBookWarantyOdometer.Result){
				lBlueBookWarantyOdometer=''
			}else{
				lBlueBookWarantyOdometer=lMapBlueBookWarantyOdometer.BlueBookWarantyOdometer
	...
	public Map inputHolderStatus(String strHolderStatus){
		...
		if(lHolderStatus.length()<=0){
			lHolderStatus=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderStatus','')
			lreturn.put('Result',lResult)
			Map lMapHolderStatus=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderStatus(lHolderStatus)
			if(!lMapHolderStatus.Result){
				lHolderStatus=''
			}else{
				lHolderStatus=lMapHolderStatus.HolderStatus
	...
	public Map inputHolderDob(String strHolderDob){
		...
		if(lHolderDob.length()<=0){
			lHolderDob=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderDob','')
			lreturn.put('Result',lResult)
			Map lMapHolderDob=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderDob(lHolderDob)
			if(!lMapHolderDob.Result){
				lHolderDob=''
			}else{
				lHolderDob=lMapHolderDob.HolderDob
	...
	public Map inputHolderIsThai(String strHolderIsThai){
		...
		if(lHolderIsThai.length()<=0){
			lHolderIsThai=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderIsThai','')
			lreturn.put('Result',lResult)
			Map lMapHolderIsThai=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderIsThai(lHolderIsThai)
			if(!lMapHolderIsThai.Result){
				lHolderIsThai=''
			}else{
				lHolderIsThai=lMapHolderIsThai.HolderIsThai
	...
	public Map inputHolderThaiId(String strHolderThaiId){
		...
		if(lHolderThaiId.length()<=0){
			lHolderThaiId=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderThaiId','')
			lreturn.put('Result',lResult)
			Map lMapHolderThaiId=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderThaiId(lHolderThaiId)
			if(!lMapHolderThaiId.Result){
				lHolderThaiId=''
			}else{
				lHolderThaiId=lMapHolderThaiId.HolderThaiId
	...
	public Map inputHolderOccupation(String strHolderOccupation){
		...
		if(lHolderOccupation.length()<=0){
			lHolderOccupation=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderOccupation','')
			lreturn.put('Result',lResult)
			Map lMapHolderOccupation=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderOccupation(lHolderOccupation)
			if(!lMapHolderOccupation.Result){
				lHolderOccupation=''
			}else{
				lHolderOccupation=lMapHolderOccupation.HolderOccupation
	...
	public Map inputHolderPassport(String strHolderPassport){
		...
		if(lHolderPassport.length()<=0){
			lHolderPassport=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderPassport','')
			lreturn.put('Result',lResult)
			Map lMapHolderPassport=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderPassport(lHolderPassport)
			if(!lMapHolderPassport.Result){
				lHolderPassport=''
			}else{
				lHolderPassport=lMapHolderPassport.HolderPassport
	...
	public Map inputHolderCountry(String strHolderCountry){
		...
		if(lHolderCountry.length()<=0){
			lHolderCountry=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderCountry','')
			lreturn.put('Result',lResult)
			Map lMapHolderCountry=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderCountry(lHolderCountry)
			if(!lMapHolderCountry.Result){
				lHolderCountry=''
			}else{
				lHolderCountry=lMapHolderCountry.HolderCountry
	...
	public Map inputHolderName(String strHolderName){
		...
		if(lHolderName.length()<=0){
			lHolderName=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderName','')
			lreturn.put('Result',lResult)
			Map lMapHolderName=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderName(lHolderName)
			if(!lMapHolderName.Result){
				lHolderName=''
			}else{
				lHolderName=lMapHolderName.HolderName
	...
	public Map inputHolderSurname(String strHolderSurname){
		...
		if(lHolderSurname.length()<=0){
			lHolderSurname=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_HOLDER_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('HolderSurname','')
			lreturn.put('Result',lResult)
			Map lMapHolderSurname=this.lTHAExtendedWarrantyQuotationDetail1Util.inputHolderSurname(lHolderSurname)
			if(!lMapHolderSurname.Result){
				lHolderSurname=''
			}else{
				lHolderSurname=lMapHolderSurname.HolderSurname
	...
	public Map inputMainStatus(String strMainStatus){
		...
		if(lMainStatus.length()<=0){
			lMainStatus=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('MainStatus','')
			lreturn.put('Result',lResult)
			Map lMapMainStatus=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainStatus(lMainStatus)
			if(!lMapMainStatus.Result){
				lMainStatus=''
			}else{
				lMainStatus=lMapMainStatus.MainStatus
	...
	public Map inputMainDob(String strMainDob){
		...
		if(lMainDob.length()<=0){
			lMainDob=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('MainDob','')
			lreturn.put('Result',lResult)
			Map lMapMainDob=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainDob(lMainDob)
			if(!lMapMainDob.Result){
				lMainDob=''
			}else{
				lMainDob=lMapMainDob.MainDob
	...
	public Map inputMainIsThai(String strMainIsThai){
		...
		if(lMainIsThai.length()<=0){
			lMainIsThai=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('MainIsThai','')
			lreturn.put('Result',lResult)
			Map lMapMainIsThai=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainIsThai(lMainIsThai)
			if(!lMapMainIsThai.Result){
				lMainIsThai=''
			}else{
				lMainIsThai=lMapMainIsThai.MainIsThai
	...
	public Map inputMainThaiId(String strMainThaiId){
		...
		if(lMainThaiId.length()<=0){
			lMainThaiId=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('MainThaiId','')
			lreturn.put('Result',lResult)
			Map lMapMainThaiId=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainThaiId(lMainThaiId)
			if(!lMapMainThaiId.Result){
				lMainThaiId=''
			}else{
				lMainThaiId=lMapMainThaiId.MainThaiId
	...
	public Map inputMainOccupation(String strMainOccupation){
		...
		if(lMainOccupation.length()<=0){
			lMainOccupation=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('MainOccupation','')
			lreturn.put('Result',lResult)
			Map lMapMainOccupation=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainOccupation(lMainOccupation)
			if(!lMapMainOccupation.Result){
				lMainOccupation=''
			}else{
				lMainOccupation=lMapMainOccupation.MainOccupation
	...
	public Map inputMainPassport(String strMainPassport){
		...
		if(lMainPassport.length()<=0){
			lMainPassport=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('MainPassport','')
			lreturn.put('Result',lResult)
			Map lMapMainPassport=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainPassport(lMainPassport)
			if(!lMapMainPassport.Result){
				lMainPassport=''
			}else{
				lMainPassport=lMapMainPassport.MainPassport
	...
	public Map inputMainCountry(String strMainCountry){
		...
		if(lMainCountry.length()<=0){
			lMainCountry=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('MainCountry','')
			lreturn.put('Result',lResult)
			Map lMapMainCountry=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainCountry(lMainCountry)
			if(!lMapMainCountry.Result){
				lMainCountry=''
			}else{
				lMainCountry=lMapMainCountry.MainCountry
	...
	public Map inputMainName(String strMainName){
		...
		if(lMainName.length()<=0){
			lMainName=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('MainName','')
			lreturn.put('Result',lResult)
			Map lMapMainName=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainName(lMainName)
			if(!lMapMainName.Result){
				lMainName=''
			}else{
				lMainName=lMapMainName.MainName
	...
	public Map inputMainSurname(String strMainSurname){
		...
		if(lMainSurname.length()<=0){
			lMainSurname=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('MainSurname','')
			lreturn.put('Result',lResult)
			Map lMapMainSurname=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainSurname(lMainSurname)
			if(!lMapMainSurname.Result){
				lMainSurname=''
			}else{
				lMainSurname=lMapMainSurname.MainSurname
	...
	public Map inputMainEmail(String strMainEmail){
		...
		if(lMainEmail.length()<=0){
			lMainEmail=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_EMAIL
		}
		try{
			Boolean lResult=false
			lreturn.put('MainEmail','')
			lreturn.put('Result',lResult)
			Map lMapMainEmail=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainEmail(lMainEmail)
			if(!lMapMainEmail.Result){
				lMainEmail=''
			}else{
				lMainEmail=lMapMainEmail.MainEmail
	...
	public Map inputMainPhoneNo(String strMainPhoneNo){
		...
		if(lMainPhoneNo.length()<=0){
			lMainPhoneNo=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_MAIN_PHONE_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('MainPhoneNo','')
			lreturn.put('Result',lResult)
			Map lMapMainPhoneNo=this.lTHAExtendedWarrantyQuotationDetail1Util.inputMainPhoneNo(lMainPhoneNo)
			if(!lMapMainPhoneNo.Result){
				lMainPhoneNo=''
			}else{
				lMainPhoneNo=lMapMainPhoneNo.MainPhoneNo
	...
	public Map inputAdditionDrivers(String strAdditionDrivers){
		...
		if(lAdditionDrivers.length()<=0){
			lAdditionDrivers=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_ADDITION_DRIVERS
		}
		try{
			Boolean lResult=false
			lreturn.put('AdditionDrivers','')
			lreturn.put('Result',lResult)
			Map lMapAdditionDrivers=this.lTHAExtendedWarrantyQuotationDetail1Util.inputAdditionDrivers(lAdditionDrivers)
			if(!lMapAdditionDrivers.Result){
				lAdditionDrivers=''
			}else{
				lAdditionDrivers=lMapAdditionDrivers.AdditionDrivers
	...
	public Map inputDriversHaveLicense(String strDriversHaveLicense){
		...
		if(lDriversHaveLicense.length()<=0){
			lDriversHaveLicense=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVERS_HAVE_LICENSE
		}
		try{
			Boolean lResult=false
			lreturn.put('DriversHaveLicense','')
			lreturn.put('Result',lResult)
			Map lMapDriversHaveLicense=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriversHaveLicense(lDriversHaveLicense)
			if(!lMapDriversHaveLicense.Result){
				lDriversHaveLicense=''
			}else{
				lDriversHaveLicense=lMapDriversHaveLicense.DriversHaveLicense
	...
	public Map inputDriver1Status(String strDriver1Status){
		...
		if(lDriver1Status.length()<=0){
			lDriver1Status=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Status','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Status=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1Status(lDriver1Status)
			if(!lMapDriver1Status.Result){
				lDriver1Status=''
			}else{
				lDriver1Status=lMapDriver1Status.Driver1Status
	...
	public Map inputDriver1Dob(String strDriver1Dob){
		...
		if(lDriver1Dob.length()<=0){
			lDriver1Dob=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Dob','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Dob=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1Dob(lDriver1Dob)
			if(!lMapDriver1Dob.Result){
				lDriver1Dob=''
			}else{
				lDriver1Dob=lMapDriver1Dob.Driver1Dob
	...
	public Map inputDriver1IsThai(String strDriver1IsThai){
		...
		if(lDriver1IsThai.length()<=0){
			lDriver1IsThai=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1IsThai','')
			lreturn.put('Result',lResult)
			Map lMapDriver1IsThai=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1IsThai(lDriver1IsThai)
			if(!lMapDriver1IsThai.Result){
				lDriver1IsThai=''
			}else{
				lDriver1IsThai=lMapDriver1IsThai.Driver1IsThai
	...
	public Map inputDriver1ThaiId(String strDriver1ThaiId){
		...
		if(lDriver1ThaiId.length()<=0){
			lDriver1ThaiId=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1ThaiId','')
			lreturn.put('Result',lResult)
			Map lMapDriver1ThaiId=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1ThaiId(lDriver1ThaiId)
			if(!lMapDriver1ThaiId.Result){
				lDriver1ThaiId=''
			}else{
				lDriver1ThaiId=lMapDriver1ThaiId.Driver1ThaiId
	...
	public Map inputDriver1Passport(String strDriver1Passport){
		...
		if(lDriver1Passport.length()<=0){
			lDriver1Passport=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Passport','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Passport=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1Passport(lDriver1Passport)
			if(!lMapDriver1Passport.Result){
				lDriver1Passport=''
			}else{
				lDriver1Passport=lMapDriver1Passport.Driver1Passport
	...
	public Map inputDriver1Country(String strDriver1Country){
		...
		if(lDriver1Country.length()<=0){
			lDriver1Country=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Country','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Country=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1Country(lDriver1Country)
			if(!lMapDriver1Country.Result){
				lDriver1Country=''
			}else{
				lDriver1Country=lMapDriver1Country.Driver1Country
	...
	public Map inputDriver1Name(String strDriver1Name){
		...
		if(lDriver1Name.length()<=0){
			lDriver1Name=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Name','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Name=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1Name(lDriver1Name)
			if(!lMapDriver1Name.Result){
				lDriver1Name=''
			}else{
				lDriver1Name=lMapDriver1Name.Driver1Name
	...
	public Map inputDriver1Surname(String strDriver1Surname){
		...
		if(lDriver1Surname.length()<=0){
			lDriver1Surname=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Surname','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Surname=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1Surname(lDriver1Surname)
			if(!lMapDriver1Surname.Result){
				lDriver1Surname=''
			}else{
				lDriver1Surname=lMapDriver1Surname.Driver1Surname
	...
	public Map inputDriver1YearDriving(String strDriver1YearDriving){
		...
		if(lDriver1YearDriving.length()<=0){
			lDriver1YearDriving=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_YEAR_DRIVING
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1YearDriving','')
			lreturn.put('Result',lResult)
			Map lMapDriver1YearDriving=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1YearDriving(lDriver1YearDriving)
			if(!lMapDriver1YearDriving.Result){
				lDriver1YearDriving=''
			}else{
				lDriver1YearDriving=lMapDriver1YearDriving.Driver1YearDriving
	...
	public Map inputDriver1ClaimsNo(String strDriver1ClaimsNo){
		...
		if(lDriver1ClaimsNo.length()<=0){
			lDriver1ClaimsNo=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_CLAIMS_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1ClaimsNo','')
			lreturn.put('Result',lResult)
			Map lMapDriver1ClaimsNo=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1ClaimsNo(lDriver1ClaimsNo)
			if(!lMapDriver1ClaimsNo.Result){
				lDriver1ClaimsNo=''
			}else{
				lDriver1ClaimsNo=lMapDriver1ClaimsNo.Driver1ClaimsNo
	...
	public Map inputDriver1Occupation(String strDriver1Occupation){
		...
		if(lDriver1Occupation.length()<=0){
			lDriver1Occupation=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER1_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver1Occupation','')
			lreturn.put('Result',lResult)
			Map lMapDriver1Occupation=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver1Occupation(lDriver1Occupation)
			if(!lMapDriver1Occupation.Result){
				lDriver1Occupation=''
			}else{
				lDriver1Occupation=lMapDriver1Occupation.Driver1Occupation
	...
	public Map inputDriver2Status(String strDriver2Status){
		...
		if(lDriver2Status.length()<=0){
			lDriver2Status=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Status','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Status=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2Status(lDriver2Status)
			if(!lMapDriver2Status.Result){
				lDriver2Status=''
			}else{
				lDriver2Status=lMapDriver2Status.Driver2Status
	...
	public Map inputDriver2Dob(String strDriver2Dob){
		...
		if(lDriver2Dob.length()<=0){
			lDriver2Dob=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Dob','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Dob=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2Dob(lDriver2Dob)
			if(!lMapDriver2Dob.Result){
				lDriver2Dob=''
			}else{
				lDriver2Dob=lMapDriver2Dob.Driver2Dob
	...
	public Map inputDriver2IsThai(String strDriver2IsThai){
		...
		if(lDriver2IsThai.length()<=0){
			lDriver2IsThai=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2IsThai','')
			lreturn.put('Result',lResult)
			Map lMapDriver2IsThai=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2IsThai(lDriver2IsThai)
			if(!lMapDriver2IsThai.Result){
				lDriver2IsThai=''
			}else{
				lDriver2IsThai=lMapDriver2IsThai.Driver2IsThai
	...
	public Map inputDriver2ThaiId(String strDriver2ThaiId){
		...
		if(lDriver2ThaiId.length()<=0){
			lDriver2ThaiId=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2ThaiId','')
			lreturn.put('Result',lResult)
			Map lMapDriver2ThaiId=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2ThaiId(lDriver2ThaiId)
			if(!lMapDriver2ThaiId.Result){
				lDriver2ThaiId=''
			}else{
				lDriver2ThaiId=lMapDriver2ThaiId.Driver2ThaiId
	...
	public Map inputDriver2Passport(String strDriver2Passport){
		...
		if(lDriver2Passport.length()<=0){
			lDriver2Passport=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Passport','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Passport=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2Passport(lDriver2Passport)
			if(!lMapDriver2Passport.Result){
				lDriver2Passport=''
			}else{
				lDriver2Passport=lMapDriver2Passport.Driver2Passport
	...
	public Map inputDriver2Country(String strDriver2Country){
		...
		if(lDriver2Country.length()<=0){
			lDriver2Country=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Country','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Country=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2Country(lDriver2Country)
			if(!lMapDriver2Country.Result){
				lDriver2Country=''
			}else{
				lDriver2Country=lMapDriver2Country.Driver2Country
	...
	public Map inputDriver2Name(String strDriver2Name){
		...
		if(lDriver2Name.length()<=0){
			lDriver2Name=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Name','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Name=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2Name(lDriver2Name)
			if(!lMapDriver2Name.Result){
				lDriver2Name=''
			}else{
				lDriver2Name=lMapDriver2Name.Driver2Name
	...
	public Map inputDriver2Surname(String strDriver2Surname){
		...
		if(lDriver2Surname.length()<=0){
			lDriver2Surname=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Surname','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Surname=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2Surname(lDriver2Surname)
			if(!lMapDriver2Surname.Result){
				lDriver2Surname=''
			}else{
				lDriver2Surname=lMapDriver2Surname.Driver2Surname
	...
	public Map inputDriver2YearDriving(String strDriver2YearDriving){
		...
		if(lDriver2YearDriving.length()<=0){
			lDriver2YearDriving=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_YEAR_DRIVING
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2YearDriving','')
			lreturn.put('Result',lResult)
			Map lMapDriver2YearDriving=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2YearDriving(lDriver2YearDriving)
			if(!lMapDriver2YearDriving.Result){
				lDriver2YearDriving=''
			}else{
				lDriver2YearDriving=lMapDriver2YearDriving.Driver2YearDriving
	...
	public Map inputDriver2ClaimsNo(String strDriver2ClaimsNo){
		...
		if(lDriver2ClaimsNo.length()<=0){
			lDriver2ClaimsNo=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_CLAIMS_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2ClaimsNo','')
			lreturn.put('Result',lResult)
			Map lMapDriver2ClaimsNo=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2ClaimsNo(lDriver2ClaimsNo)
			if(!lMapDriver2ClaimsNo.Result){
				lDriver2ClaimsNo=''
			}else{
				lDriver2ClaimsNo=lMapDriver2ClaimsNo.Driver2ClaimsNo
	...
	public Map inputDriver2Occupation(String strDriver2Occupation){
		...
		if(lDriver2Occupation.length()<=0){
			lDriver2Occupation=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER2_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver2Occupation','')
			lreturn.put('Result',lResult)
			Map lMapDriver2Occupation=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver2Occupation(lDriver2Occupation)
			if(!lMapDriver2Occupation.Result){
				lDriver2Occupation=''
			}else{
				lDriver2Occupation=lMapDriver2Occupation.Driver2Occupation
	...
	public Map inputDriver3Status(String strDriver3Status){
		...
		if(lDriver3Status.length()<=0){
			lDriver3Status=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Status','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Status=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3Status(lDriver3Status)
			if(!lMapDriver3Status.Result){
				lDriver3Status=''
			}else{
				lDriver3Status=lMapDriver3Status.Driver3Status
	...
	public Map inputDriver3Dob(String strDriver3Dob){
		...
		if(lDriver3Dob.length()<=0){
			lDriver3Dob=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_DOB
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Dob','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Dob=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3Dob(lDriver3Dob)
			if(!lMapDriver3Dob.Result){
				lDriver3Dob=''
			}else{
				lDriver3Dob=lMapDriver3Dob.Driver3Dob
	...
	public Map inputDriver3IsThai(String strDriver3IsThai){
		...
		if(lDriver3IsThai.length()<=0){
			lDriver3IsThai=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_IS_THAI
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3IsThai','')
			lreturn.put('Result',lResult)
			Map lMapDriver3IsThai=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3IsThai(lDriver3IsThai)
			if(!lMapDriver3IsThai.Result){
				lDriver3IsThai=''
			}else{
				lDriver3IsThai=lMapDriver3IsThai.Driver3IsThai
	...
	public Map inputDriver3ThaiId(String strDriver3ThaiId){
		...
		if(lDriver3ThaiId.length()<=0){
			lDriver3ThaiId=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_THAI_ID
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3ThaiId','')
			lreturn.put('Result',lResult)
			Map lMapDriver3ThaiId=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3ThaiId(lDriver3ThaiId)
			if(!lMapDriver3ThaiId.Result){
				lDriver3ThaiId=''
			}else{
				lDriver3ThaiId=lMapDriver3ThaiId.Driver3ThaiId
	...
	public Map inputDriver3Passport(String strDriver3Passport){
		...
		if(lDriver3Passport.length()<=0){
			lDriver3Passport=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_PASSPORT
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Passport','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Passport=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3Passport(lDriver3Passport)
			if(!lMapDriver3Passport.Result){
				lDriver3Passport=''
			}else{
				lDriver3Passport=lMapDriver3Passport.Driver3Passport
	...
	public Map inputDriver3Country(String strDriver3Country){
		...
		if(lDriver3Country.length()<=0){
			lDriver3Country=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_COUNTRY
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Country','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Country=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3Country(lDriver3Country)
			if(!lMapDriver3Country.Result){
				lDriver3Country=''
			}else{
				lDriver3Country=lMapDriver3Country.Driver3Country
	...
	public Map inputDriver3Name(String strDriver3Name){
		...
		if(lDriver3Name.length()<=0){
			lDriver3Name=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_NAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Name','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Name=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3Name(lDriver3Name)
			if(!lMapDriver3Name.Result){
				lDriver3Name=''
			}else{
				lDriver3Name=lMapDriver3Name.Driver3Name
	...
	public Map inputDriver3Surname(String strDriver3Surname){
		...
		if(lDriver3Surname.length()<=0){
			lDriver3Surname=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_SURNAME
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Surname','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Surname=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3Surname(lDriver3Surname)
			if(!lMapDriver3Surname.Result){
				lDriver3Surname=''
			}else{
				lDriver3Surname=lMapDriver3Surname.Driver3Surname
	...
	public Map inputDriver3YearDriving(String strDriver3YearDriving){
		...
		if(lDriver3YearDriving.length()<=0){
			lDriver3YearDriving=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_YEAR_DRIVING
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3YearDriving','')
			lreturn.put('Result',lResult)
			Map lMapDriver3YearDriving=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3YearDriving(lDriver3YearDriving)
			if(!lMapDriver3YearDriving.Result){
				lDriver3YearDriving=''
			}else{
				lDriver3YearDriving=lMapDriver3YearDriving.Driver3YearDriving
	...
	public Map inputDriver3ClaimsNo(String strDriver3ClaimsNo){
		...
		if(lDriver3ClaimsNo.length()<=0){
			lDriver3ClaimsNo=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_CLAIMS_NO
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3ClaimsNo','')
			lreturn.put('Result',lResult)
			Map lMapDriver3ClaimsNo=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3ClaimsNo(lDriver3ClaimsNo)
			if(!lMapDriver3ClaimsNo.Result){
				lDriver3ClaimsNo=''
			}else{
				lDriver3ClaimsNo=lMapDriver3ClaimsNo.Driver3ClaimsNo
	...
	public Map inputDriver3Occupation(String strDriver3Occupation){
		...
		if(lDriver3Occupation.length()<=0){
			lDriver3Occupation=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_DRIVER3_OCCUPATION
		}
		try{
			Boolean lResult=false
			lreturn.put('Driver3Occupation','')
			lreturn.put('Result',lResult)
			Map lMapDriver3Occupation=this.lTHAExtendedWarrantyQuotationDetail1Util.inputDriver3Occupation(lDriver3Occupation)
			if(!lMapDriver3Occupation.Result){
				lDriver3Occupation=''
			}else{
				lDriver3Occupation=lMapDriver3Occupation.Driver3Occupation
	...
	public Map inputPolicyStartDate(String strPolicyStartDate,String strPolicyStartDayOffset){
		...
		if(lPolicyStartDate.length()<=0){
			lPolicyStartDate=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_POLICY_START_DATE
		}
		String lPolicyStartDayOffset=strPolicyStartDayOffset.trim()
		if(lPolicyStartDayOffset.length()<=0){
			lPolicyStartDayOffset=THARGPAExtendedWarrantyQuotationDetail1Type.DEFAULT_POLICY_START_DAY_OFFSET
		}
		try{
			Boolean lResult=false
			...
			lreturn.put('Result',lResult)
			Map lMapPolicyStartDate=this.lTHAExtendedWarrantyQuotationDetail1Util.inputPolicyStartDate(lPolicyStartDate,lPolicyStartDayOffset)
			if(!lMapPolicyStartDate.Result){
				lPolicyStartDate=''
				lPolicyStartDayOffset=''
			}else{
	...
	public Map inputPolicyInsurer(String strPolicyInsurer){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapPolicyInsurer=this.lTHAExtendedWarrantyQuotationDetail1Util.inputPolicyInsurer(lPolicyInsurer)
			if(!lMapPolicyInsurer.Result){
				lPolicyInsurer=''
			}else{
				lPolicyInsurer=lMapPolicyInsurer.PolicyInsurer
	...
	public Map inputActualResult(Boolean isPositiveCase,String strHolderPhoneNo,Boolean isSkipOTP){
		...
		try{
			...
			lreturn.put('Result',lResult)
			Map lMapActualResult=this.lTHAExtendedWarrantyQuotationDetail1Util.inputActualResult(isPositiveCase,lHolderPhoneNo,isSkipOTP)
			if(!lMapActualResult.Result){
				lActualResult=''
			}else{
				lActualResult=lMapActualResult.ActualResult
