...
public class THALowMileageCarQuotationInputUtil{
	private WebDriver driver=null
	private WebDriver selenium=null
	public THALowMileageCarQuotationInputUtil(WebDriver newDriver,WebDriver newSelenium){
		super()
	...
	public Map inputVersionReferrer(String strBaseUrl,String strVersion,String strReferrer){
		...
		if(lBaseUrl.length()<=0){
			lBaseUrl=THALowMileageCarQuotationInputType.DEFAULT_BASE_URL
		}
		String lDefaultVersion=THALowMileageCarQuotationInputType.DEFAULT_VERSION
	...
	public Map inputCmsLanguage(String strCmsLanguage){
		...
		if(lCmsLanguage.length()<=0){
			lCmsLanguage=THALowMileageCarQuotationInputType.DEFAULT_CMS_LANGUAGE.toUpperCase()
		}
		...
		try{
			...
			if(!lCmsLanguageItem){
				lCmsLanguageItem=lCmsLanguageList.get(THALowMileageCarQuotationInputType.DEFAULT_CMS_LANGUAGE.toUpperCase())
			}
			lCmsLanguage=''
	...
	public Map inputCmsAffiliateLanguage(String strCmsAffiliateLanguage){
		Map lreturn=[:]
		String lCmsAffiliateLanguage=strCmsAffiliateLanguage.toUpperCase().trim()
		if(lCmsAffiliateLanguage.length()<=0){
			lCmsAffiliateLanguage=THALowMileageCarQuotationInputType.DEFAULT_CMS_AFFILIATE_LANGUAGE.toUpperCase()
		}
		Map lCmsAffiliateLanguageList=['EN':'en','TH':'th']
		try{
			Boolean lResult=false
			...
			if(!lCmsAffiliateLanguageItem){
				lCmsAffiliateLanguageItem=lCmsAffiliateLanguageList.get(THALowMileageCarQuotationInputType.DEFAULT_CMS_AFFILIATE_LANGUAGE.toUpperCase())
			}
			...
			if(lElementCmsAffiliateLanguageSelectedImage){
				...
				if(lToChangeCmsAffiliateLanguage){
					String lLocatorCmsAffiliateLanguageChangeButton='#navbar-action ul li ul li a'
				...
				lIsCmsAffiliateLanguageCurrentThai=lCmsAffiliateLanguageSelectedImageSource.toLowerCase().contains(lStrCmsAffiliateLanguageImageSourceThai)
				if(lIsCmsAffiliateLanguageCurrentThai){
					lCmsAffiliateLanguage='TH'
				}else{
					lCmsAffiliateLanguage='EN'
				}
			}
			...
			if(lElementCmsAffiliateProductButtontList){
				for(WebElement lElementCmsAffiliateProductButtontItem in lElementCmsAffiliateProductButtontList){
					...
					Boolean lIsCmsAffiliateProductLowMileageCar=false
					lIsCmsAffiliateProductLowMileageCar=IGNUemaHelper.checkStringContainString(lCmsAffiliateProductButtontHrefText,'productType=LowMileageCar')
					if(!lIsCmsAffiliateProductLowMileageCar){
	...
	public String inputLanguageA(String strLanguage){
		...
		try{
			...
			if(!lLanguageItem){
				lLanguageItem=lLanguageList.get(THALowMileageCarQuotationInputType.DEFAULT_LANGUAGE.toUpperCase())
			}
	...
	public Map inputPositiveCase(String strPositiveCase){
		...
		if(lPositiveCase.length()<=0){
			lPositiveCase=THALowMileageCarQuotationInputType.DEFAULT_POSITIVE_CASE
		}
		try{
			Boolean lResult=false
	...
	public Map inputCmsCarMake(String strCmsCarMake){
		...
		if(lCmsCarMake.length()<=0){
			lCmsCarMake=THALowMileageCarQuotationInputType.DEFAULT_CMS_CAR_MAKE
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarMakeA(String strCarMake){
		...
		if(lCarMake.length()<=0){
			lCarMake=THALowMileageCarQuotationInputType.DEFAULT_CAR_MAKE
		}
		try{
			Boolean lResult=false
			lreturn.put('CarMake','')
	...
	public Map inputCmsCarModel(String strCmsCarModel){
		...
		if(lCmsCarModel.length()<=0){
			lCmsCarModel=THALowMileageCarQuotationInputType.DEFAULT_CMS_CAR_MODEL
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarModelA(String strCarModel){
		...
		if(lCarModel.length()<=0){
			lCarModel=THALowMileageCarQuotationInputType.DEFAULT_CAR_MODEL
		}
		try{
			Boolean lResult=false
			lreturn.put('CarModel','')
	...
	public Map inputCmsCarYear(String strCmsCarYear){
		...
		if(lCmsCarYear.length()<=0){
			lCmsCarYear=THALowMileageCarQuotationInputType.DEFAULT_CMS_CAR_YEAR
		}
		try{
			Boolean lResult=false
	...
	public Map inputCarYearA(String strCarYear){
		...
		if(lCarYear.length()<=0){
			lCarYear=THALowMileageCarQuotationInputType.DEFAULT_CAR_YEAR
		}
		try{
			Boolean lResult=false
			lreturn.put('CarYear','')
	...
	public Map inputCmsCarSubmodel(String strCmsCarSubmodel){
		...
		if(lCmsCarSubmodel.length()<=0){
			lCmsCarSubmodel=THALowMileageCarQuotationInputType.DEFAULT_CMS_CAR_SUBMODEL
		}
		try{
			Boolean lResult=false
	...
	public Map inputSubmodelA(String strSubmodel){
		...
		if(lSubmodel.length()<=0){
			lSubmodel=THALowMileageCarQuotationInputType.DEFAULT_SUBMODEL
		}
		try{
			Boolean lResult=false
			lreturn.put('Submodel','')
	...
	public Map inputCmsKeepDetailA(String strCmsKeepDetail,String strCmsLanguage,String strCmsCarMake,String strCmsCarModel,String strCmsCarYear,String strCmsCarSubmodel){
		...
		if(lCmsKeepDetail.length()<=0){
			lCmsKeepDetail=THALowMileageCarQuotationInputType.DEFAULT_CMS_KEEP_DETAIL
		}
		String lCmsLanguage=strCmsLanguage.toUpperCase().trim()
		String lCmsCarMake=strCmsCarMake.trim()
		String lCmsCarModel=strCmsCarModel.trim()
	...
	public Map inputGenderMainMaritalStatusA(String strGenderMain,String strMaritalStatus){
		...
		if(lGenderMain.length()<=0){
			lGenderMain=THALowMileageCarQuotationInputType.DEFAULT_GENDER_MAIN
		}
		String lMaritalStatus=strMaritalStatus.trim()
		if(lMaritalStatus.length()<=0){
			lMaritalStatus=THALowMileageCarQuotationInputType.DEFAULT_MARITAL_STATUS
		}
		try{
			Boolean lResult=false
			lreturn.put('GenderMain','')
	...
	public Map inputBirthDateMainA(String strBirthDateMain){
		...
		if(lBirthDateMain.length()<=0){
			lBirthDateMain=THALowMileageCarQuotationInputType.DEFAULT_BIRTH_DATE_MAIN
		}
		try{
			Boolean lResult=false
			lreturn.put('BirthDateMain','')
	...
	public Map inputYearDrivingA(String strYearDriving){
		...
		if(lYearDriving.length()<=0){
			lYearDriving=THALowMileageCarQuotationInputType.DEFAULT_YEAR_DRIVING
		}
	...
	public Map inputClaimsNoA(String strClaimsNo){
		...
		if(lClaimsNo.length()<=0){
			lClaimsNo=THALowMileageCarQuotationInputType.DEFAULT_CLAIMS_NO
		}
	...
	public Map inputVehicleUsageA(String strVehicleUsage){
		...
		try{
			...
			if(!lVehicleUsageItem){
				lVehicleUsageItem=lVehicleUsageList.get(THALowMileageCarQuotationInputType.DEFAULT_VEHICLE_USAGE.toUpperCase())
			}
	...
	public Map inputVehicleUsageForCommercialA(String strVehicleUsageForCommercial){
		...
		try{
			...
			if(!lVehicleUsageForCommercialItem){
				lVehicleUsageForCommercialItem=lVehicleUsageForCommercialList.get(THALowMileageCarQuotationInputType.DEFAULT_VEHICLE_USAGE_FOR_COMMERCIAL)
			}
			String lTagButtonKey='carUsage'
	...
	public Map inputVehicleUsageDriveToWorkA(String strVehicleUsageDriveToWork){
		...
		try{
			...
			if(!lVehicleUsageDriveToWorkItem){
				lVehicleUsageDriveToWorkItem=lVehicleUsageDriveToWorkList.get(THALowMileageCarQuotationInputType.DEFAULT_VEHICLE_USAGE_DRIVE_TO_WORK)
			}
	...
	public Map inputVehicleUsageDriveToWorkOftenA(String strVehicleUsageDriveToWorkOften){
		...
		try{
			...
			if(!lVehicleUsageDriveToWorkOftenItem){
				lVehicleUsageDriveToWorkOftenItem=lVehicleUsageDriveToWorkOftenList.get(THALowMileageCarQuotationInputType.DEFAULT_VEHICLE_USAGE_DRIVE_TO_WORK_OFTEN)
			}
			lVehicleUsageDriveToWorkOften=''
	...
	public Map inputTaxiOrVehicleForHireA(String strTaxiOrVehicleForHire){
		...
		if(lTaxiOrVehicleForHire.length()<=0){
			lTaxiOrVehicleForHire=THALowMileageCarQuotationInputType.DEFAULT_TAXI_OR_VEHICLE_FOR_HIRE
		}
		try{
			Boolean lResult=false
			lreturn.put('TaxiOrVehicleForHire','')
	...
	public Map inputRentalVehicleA(String strRentalVehicle){
		...
		if(lRentalVehicle.length()<=0){
			lRentalVehicle=THALowMileageCarQuotationInputType.DEFAULT_RENTAL_VEHICLE
		}
		try{
			Boolean lResult=false
			lreturn.put('RentalVehicle','')
	...
	public Map inputGoodsTransportVehicleA(String strGoodsTransportVehicle){
		...
		if(lGoodsTransportVehicle.length()<=0){
			lGoodsTransportVehicle=THALowMileageCarQuotationInputType.DEFAULT_GOODS_TRANSPORT_VEHICLE
		}
		try{
			Boolean lResult=false
			lreturn.put('GoodsTransportVehicle','')
	...
	public Map inputLogisticsOrCourierCompanyA(String strLogisticsOrCourierCompany){
		...
		if(lLogisticsOrCourierCompany.length()<=0){
			lLogisticsOrCourierCompany=THALowMileageCarQuotationInputType.DEFAULT_LOGISTICS_OR_COURIER_COMPANY
		}
		try{
			Boolean lResult=false
			lreturn.put('LogisticsOrCourierCompany','')
	...
	public Map inputGoodsTransportRouteA(String strGoodsTransportRoute){
		...
		try{
			...
			if(!lGoodsTransportRouteItem){
				lGoodsTransportRouteItem=lGoodsTransportRouteList.get(THALowMileageCarQuotationInputType.DEFAULT_GOODS_TRANSPORT_ROUTE.toUpperCase())
			}
	...
	public Map inputPostalCodeA(String strPostalCode){
		...
		if(lPostalCode.length()<=0){
			lPostalCode=THALowMileageCarQuotationInputType.DEFAULT_POSTAL_CODE
		}
		try{
			Boolean lResult=false
			lreturn.put('PostalCode','')
	...
	public Map inputDeclaredNcbA(String strDeclaredNcb){
		...
		if(lDeclaredNcb.length()<=0){
			lDeclaredNcb=THALowMileageCarQuotationInputType.DEFAULT_DECLARED_NCB
		}
	...
	public Map inputUnderFinancingA(String strUnderFinancing){
		...
		if(lUnderFinancing.length()<=0){
			lUnderFinancing=THALowMileageCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase()
		}
		...
		try{
			...
			if(!lUnderFinancingItem){
				lUnderFinancingItem=lUnderFinancingList.get(THALowMileageCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase())
			}
			lUnderFinancing=''
	...
	public Map inputCarCameraA(String strCarCamera){
		...
		if(lCarCamera.length()<=0){
			lCarCamera=THALowMileageCarQuotationInputType.DEFAULT_CAR_CAMERA
		}
		try{
			Boolean lResult=false
			lreturn.put('CarCamera','')
	...
	public Map inputTentativeA(String strTentative){
		...
		if(lTentative.length()<=0){
			lTentative=THALowMileageCarQuotationInputType.DEFAULT_TENTATIVE
		}
		try{
			Boolean lResult=false
			lreturn.put('Tentative','')
	...
	public Map inputAlcoholFreeA(String strAlcoholFree){
		...
		if(lAlcoholFree.length()<=0){
			lAlcoholFree=THALowMileageCarQuotationInputType.DEFAULT_ALCOHOL_FREE.toUpperCase()
		}
		...
		try{
			...
			if(!lAlcoholFreeItem){
				lAlcoholFreeItem=lAlcoholFreeList.get(THALowMileageCarQuotationInputType.DEFAULT_UNDER_FINANCING.toUpperCase())
			}
			lAlcoholFree=''
