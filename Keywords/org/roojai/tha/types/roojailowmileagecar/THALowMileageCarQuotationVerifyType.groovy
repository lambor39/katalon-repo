...
public class THALowMileageCarQuotationVerifyType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteLowMileageCar/LowMileageCar_Quotation_00_Verify.Input'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteLowMileageCar/LowMileageCar_Quotation_00_Verify.Output'
	...
	public Map Input=[:]
	public Map Output=[:]
	public THALowMileageCarQuotationVerifyType(){
		super()
		this.initInput()
		this.initOutput()
	}
	...
	public void initOutput(){
		this.Output.clear()
		this.Output.put('LowMileageCar01Input','')
