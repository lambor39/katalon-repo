...
public class THAExtendedWarrantyQuotationPaymentType{
	public static final String INPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteExtendedWarranty/ExtendedWarranty_Quotation_04_Payment.Input'
	...
	public static final String OUTPUT_DATA_FILE_NAME='Data Files/Release_UAT/Roojai/THA/QuotationWebsiteExtendedWarranty/ExtendedWarranty_Quotation_04_Payment.Output'
	...
	public Map Input=[:]
	public Map Output=[:]
	public THAExtendedWarrantyQuotationPaymentType(){
		super()
		this.initInput()
		this.initOutput()
	}
