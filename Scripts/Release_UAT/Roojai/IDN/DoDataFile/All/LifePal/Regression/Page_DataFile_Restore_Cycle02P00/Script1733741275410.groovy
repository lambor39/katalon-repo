...
IGNTestDataCountry lEnumIGNTestDataCountry=IGNTestDataCountry.Indonesia
IGNTestDataCompany lEnumIGNTestDataCompany=IGNTestDataCompany.LifePal
IGNTestDataExcelStoreType lEnumIGNTestDataExcelStoreType=IGNTestDataExcelStoreType.MultipleProductMultipleUser
String lStrProductName='Regression'
String lStrCycleUserName='Cycle02P00'
