...
TestData dataInput=TestDataFactory.findTestData(THAKumkaCancerVerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THAKumkaCancerVerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THAKumkaCancerVerifyFactory caseFactory=new THAKumkaCancerVerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THAKumkaCancerVerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THAKumkaCancerVerifyUtil caseUtil=null
Boolean runNext=false
/*Input
 caseInput.KumkaCancerInput
 caseInput.KumkaCancerResult
 caseInput.ActualResult
 */
/*Output
 caseOutput.KumkaCancerInput
 caseOutput.KumkaCancerResult
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	if(GlobalVariable.BrowserInit){
		...
		selenium=driver
		caseUtil=new THAKumkaCancerVerifyUtil(driver,selenium)
