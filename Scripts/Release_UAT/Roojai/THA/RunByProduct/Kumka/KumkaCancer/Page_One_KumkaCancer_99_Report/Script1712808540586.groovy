...
import org.roojai.tha.types.kumka.cancer.THAKumkaCancerResult_OutputFactory
import org.roojai.tha.types.kumka.cancer.THAKumkaCancerResult_OutputType
import org.roojai.tha.types.kumka.cancer.THAKumkaCancerResult_OutputUtil
import org.roojai.tha.types.kumka.cancer.THAKumkaCancerVerifyFactory
import org.roojai.tha.types.kumka.cancer.THAKumkaCancerVerifyType
import org.roojai.tha.types.kumka.cancer.THAKumkaCancerVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAKumkaCancerVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAKumkaCancerVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAKumkaCancerVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAKumkaCancerVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Mr.Kumka (Cancer Insurance)'
...
attachFiles[0]=THAKumkaCancerVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
