...
import org.roojai.tha.types.kumka.insurecar.THAKumkaInsureCarResult_OutputFactory
import org.roojai.tha.types.kumka.insurecar.THAKumkaInsureCarResult_OutputType
import org.roojai.tha.types.kumka.insurecar.THAKumkaInsureCarResult_OutputUtilDesignA
import org.roojai.tha.types.kumka.insurecar.THAKumkaInsureCarResult_OutputUtilDesignB
import org.roojai.tha.types.kumka.insurecar.THAKumkaInsureCarVerifyFactory
import org.roojai.tha.types.kumka.insurecar.THAKumkaInsureCarVerifyType
import org.roojai.tha.types.kumka.insurecar.THAKumkaInsureCarVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAKumkaInsureCarVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAKumkaInsureCarVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAKumkaInsureCarVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAKumkaInsureCarVerifyType.OUTPUT_DATA_ROW_END).trim()
...
if(lIsOnlyMe){
	...
	mailTo=THAGlobalConst.DEFAULT_EMAIL_TO_PRODUCT_KUMKA
}
String lstrDatetime=IGNUemaHelper.convertLocalDateTimeToString('yyyy/MM/dd HH:mm')
String lstrProductName='Mr.Kumka (Car Insurance)'
...
attachFiles[0]=THAKumkaInsureCarVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
