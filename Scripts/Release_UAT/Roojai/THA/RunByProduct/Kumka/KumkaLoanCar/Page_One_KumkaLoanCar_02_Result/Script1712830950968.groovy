...
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarResultFactory
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarResultType
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarResultUtil
...
TestData dataInput=TestDataFactory.findTestData(THAKumkaLoanCarResultType.INPUT_DATA_FILE_NAME)
TestData dataOutput=TestDataFactory.findTestData(THAKumkaLoanCarResultType.OUTPUT_DATA_FILE_NAME)
THAKumkaLoanCarResultFactory caseFactory=new THAKumkaLoanCarResultFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THAKumkaLoanCarResultType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THAKumkaLoanCarResultUtil caseUtil=null
...
/*Input
 ...
 caseInput.FillLoansRequestAmount
 caseInput.PositiveCaseLoansRequestAmount
 caseInput.LoansRequestAmount
 caseInput.FillNumberOfInstalment
 caseInput.PositiveCaseNumberOfInstalment
 caseInput.NumberOfInstalment
 caseInput.FillTransferRights
 caseInput.TransferRights
 caseInput.FillSortingBy
 caseInput.SortingBy
 caseInput.OutboundSave
 caseInput.OutboundPrefixName
 caseInput.OutboundFullName
...
/*Output
 ...
 caseOutput.FillLoansRequestAmount
 caseOutput.PositiveCaseLoansRequestAmount
 caseOutput.LoansRequestAmount
 caseOutput.FillNumberOfInstalment
 caseOutput.PositiveCaseNumberOfInstalment
 caseOutput.NumberOfInstalment
 caseOutput.FillTransferRights
 caseOutput.TransferRights
 caseOutput.FillSortingBy
 caseOutput.SortingBy
 caseOutput.OutboundSave
 caseOutput.OutboundPrefixName
 caseOutput.OutboundFullName
 ...
 caseOutput.DefaultCarBrandModel
 caseOutput.DefaultCarSubModel
 caseOutput.DefaultLoansRequestAmountMin
 caseOutput.DefaultLoansRequestAmountMax
 caseOutput.DefaultNumberOfInstalment
 caseOutput.DefaultTransferRights
 caseOutput.DefaultSortingBy
 caseOutput.FilteredNumberOfCards
 caseOutput.FilteredCarBrandModel
 caseOutput.FilteredCarSubModel
 caseOutput.FilteredLoansRequestAmountMin
 caseOutput.FilteredLoansRequestAmountMax
 caseOutput.FilteredNumberOfInstalment
 caseOutput.FilteredTransferRights
 caseOutput.FilteredSortingBy
 caseOutput.OutboundDisplayPlanId
 caseOutput.OutboundBankName
 caseOutput.OutboundPlanName
 caseOutput.OutboundPlanLoanType
 caseOutput.OutboundGuarantorRequired
 caseOutput.OutboundCarInspectionRequired
 caseOutput.OutboundCarInsuranceRequired
 caseOutput.OutboundPromotionText
 caseOutput.OutboundLoanAmount
 caseOutput.OutboundMaxLoanAmount
 caseOutput.OutboundLoanTerm
 caseOutput.OutboundMonthlyInstalment
 caseOutput.OutboundRatePerMonth
 caseOutput.OutboundTotalInterest
 caseOutput.OutboundTotalVat
 caseOutput.OutboundTotalPayment
 caseOutput.OutboundTotalFee
 caseOutput.OutboundApprovalDateMessage
 caseOutput.OutboundSelectedLoanAmount
 caseOutput.OutboundSelectedMaxLoanAmount
 caseOutput.OutboundSelectedLoanTerm
 caseOutput.OutboundSelectedMonthlyInstalment
 caseOutput.OutboundSelectedRatePerMonth
 caseOutput.OutboundDetailGurantorRequired
 caseOutput.OutboundDetailGurantorRequired
 caseOutput.OutboundDetailCarInspectionRequired
 caseOutput.OutboundSelectedStampDutyFeePercent
 caseOutput.OutboundSelectedStampDutyFee
 caseOutput.OutboundSelectedCarInspectionFee
 caseOutput.OutboundSelectedAdministrationFee
 caseOutput.OutboundSelectedContractTransferFee
 caseOutput.OutboundSelectedTotalVat
 caseOutput.OutboundSelectedTotalFee
 caseOutput.OutboundDetailQualificaiton
 caseOutput.OutboundQualificationRequired
 caseOutput.OutboundDetailDocumentRequire
 caseOutput.OutboundDocumentRequired
 caseOutput.OutboundDetailPromotionText
 */
if(GlobalVariable.PrevStatus){
	...
	if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
		...
		if(GlobalVariable.BrowserInit){
			...
			selenium=driver
			caseUtil=new THAKumkaLoanCarResultUtil(driver,selenium)
			String lLocatorToCheck1='#app #cards'
