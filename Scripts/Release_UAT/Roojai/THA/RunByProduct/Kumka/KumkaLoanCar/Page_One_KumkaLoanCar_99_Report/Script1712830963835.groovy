...
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarResult_OutputFactory
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarResult_OutputType
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarResult_OutputUtil
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarVerifyFactory
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarVerifyType
import org.roojai.tha.types.kumka.loancar.THAKumkaLoanCarVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAKumkaLoanCarVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAKumkaLoanCarVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAKumkaLoanCarVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAKumkaLoanCarVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Mr.Kumka (Car Loan)'
...
attachFiles[0]=THAKumkaLoanCarVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
