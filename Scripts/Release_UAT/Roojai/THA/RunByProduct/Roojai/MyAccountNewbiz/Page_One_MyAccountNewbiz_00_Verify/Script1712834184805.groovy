...
TestData dataInput=TestDataFactory.findTestData(THAMyAccountNewbizVerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THAMyAccountNewbizVerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THAMyAccountNewbizVerifyFactory caseFactory=new THAMyAccountNewbizVerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THAMyAccountNewbizVerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THAMyAccountNewbizVerifyUtil caseUtil=null
Boolean runNext=false
/*Input
 caseInput.MyAccountNewbiz01Input
 caseInput.MyAccountNewbiz02Main
 caseInput.ActualResult
 */
/*Output
 caseOutput.MyAccountNewbiz01Input
 caseOutput.MyAccountNewbiz02Main
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	if(GlobalVariable.BrowserInit){
		...
		selenium=driver
		caseUtil=new THAMyAccountNewbizVerifyUtil(driver,selenium)
