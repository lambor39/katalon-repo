...
import org.roojai.tha.types.myaccount.newbiz.THAMyAccountNewbizVerifyFactory
import org.roojai.tha.types.myaccount.newbiz.THAMyAccountNewbizVerifyType
import org.roojai.tha.types.myaccount.newbiz.THAMyAccountNewbizVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAMyAccountNewbizVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAMyAccountNewbizVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAMyAccountNewbizVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAMyAccountNewbizVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='MyAccount NewBiz'
...
attachFiles[0]=THAMyAccountNewbizVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
