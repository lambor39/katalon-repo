...
import org.roojai.tha.types.myaccount.renewal.THAMyAccountRenewalVerifyFactory
import org.roojai.tha.types.myaccount.renewal.THAMyAccountRenewalVerifyType
import org.roojai.tha.types.myaccount.renewal.THAMyAccountRenewalVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAMyAccountRenewalVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAMyAccountRenewalVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAMyAccountRenewalVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAMyAccountRenewalVerifyType.OUTPUT_DATA_ROW_END).trim()
...
if(lIsOnlyMe){
	...
	mailTo=THAGlobalConst.DEFAULT_EMAIL_TO_PRODUCT_IT
}
String lstrDatetime=IGNUemaHelper.convertLocalDateTimeToString('yyyy/MM/dd HH:mm')
String lstrProductName='MyAccount Renewal'
...
attachFiles[0]=THAMyAccountRenewalVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
