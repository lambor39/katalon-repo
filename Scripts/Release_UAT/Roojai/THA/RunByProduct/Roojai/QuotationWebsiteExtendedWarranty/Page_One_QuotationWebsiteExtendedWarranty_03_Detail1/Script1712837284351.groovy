...
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationDetail1Factory
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationDetail1Type
...
TestData dataInput=TestDataFactory.findTestData(THAExtendedWarrantyQuotationDetail1Type.INPUT_DATA_FILE_NAME)
TestData dataOutput=TestDataFactory.findTestData(THAExtendedWarrantyQuotationDetail1Type.OUTPUT_DATA_FILE_NAME)
THAExtendedWarrantyQuotationDetail1Factory caseFactory=new THAExtendedWarrantyQuotationDetail1Factory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THAExtendedWarrantyQuotationDetail1Type caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THAExtendedWarrantyQuotationDetail1Util caseUtil=null
...
if(GlobalVariable.PrevStatus){
	...
	if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
		...
		if(GlobalVariable.BrowserInit){
			...
			selenium=driver
			caseUtil=new THAExtendedWarrantyQuotationDetail1Util(driver,selenium)
