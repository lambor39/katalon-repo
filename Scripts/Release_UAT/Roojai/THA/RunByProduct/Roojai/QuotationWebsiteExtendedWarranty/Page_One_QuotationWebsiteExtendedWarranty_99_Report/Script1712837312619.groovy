...
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationInputFactory
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationInputType
...
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationVerifyFactory
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationVerifyType
import org.roojai.tha.types.roojaiquote.extendedwarranty.THAExtendedWarrantyQuotationVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAExtendedWarrantyQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAExtendedWarrantyQuotationVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAExtendedWarrantyQuotationVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAExtendedWarrantyQuotationVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Quotation website (Extended Warranty)'
...
attachFiles[0]=THAExtendedWarrantyQuotationVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
