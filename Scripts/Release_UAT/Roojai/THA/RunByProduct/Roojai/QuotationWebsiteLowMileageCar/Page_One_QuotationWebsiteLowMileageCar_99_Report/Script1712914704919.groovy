...
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationResultFactory
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationResultType
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationResultUtil
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationDetail1Factory
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationDetail1Type
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationDetail1Util
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationPaymentFactory
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationPaymentType
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationPaymentUtil
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationDetail2Factory
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationDetail2Type
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationDetail2Util
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationSocialFactory
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationSocialType
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationSocialUtil
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationVerifyFactory
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationVerifyType
import org.roojai.tha.types.roojailowmileagecar.THALowMileageCarQuotationVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THALowMileageCarQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THALowMileageCarQuotationVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THALowMileageCarQuotationVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THALowMileageCarQuotationVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Quotation website (Low Mileage Car)'
...
attachFiles[0]=THALowMileageCarQuotationVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
