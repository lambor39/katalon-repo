...
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationInputFactory
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationInputType
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationInputUtil
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationResultFactory
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationResultType
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationResultUtil
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail1Factory
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail1Type
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail1Util
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationPaymentFactory
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationPaymentType
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationPaymentUtil
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail2Factory
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail2Type
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationDetail2Util
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationSocialFactory
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationSocialType
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationSocialUtil
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationVerifyFactory
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationVerifyType
import org.roojai.tha.types.motorbike.THAMotorBikeQuotationVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAMotorBikeQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAMotorBikeQuotationVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAMotorBikeQuotationVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAMotorBikeQuotationVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Quotation website (MotorBike)'
...
attachFiles[0]=THAMotorBikeQuotationVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
