...
import org.roojai.tha.types.motorcar.THAMotorCarQuotationInputFactory
import org.roojai.tha.types.motorcar.THAMotorCarQuotationInputType
import org.roojai.tha.types.motorcar.THAMotorCarQuotationInputUtil
import org.roojai.tha.types.motorcar.THAMotorCarQuotationResultFactory
...
import org.roojai.tha.types.motorcar.THAMotorCarQuotationDetail1Factory
...
import org.roojai.tha.types.motorcar.THAMotorCarQuotationDetail2Factory
...
import org.roojai.tha.types.motorcar.THAMotorCarQuotationSocialFactory
...
import org.roojai.tha.types.motorcar.THAMotorCarQuotationVerifyFactory
import org.roojai.tha.types.motorcar.THAMotorCarQuotationVerifyType
import org.roojai.tha.types.motorcar.THAMotorCarQuotationVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAMotorCarQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAMotorCarQuotationVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAMotorCarQuotationVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAMotorCarQuotationVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Quotation website (MotorCar)'
...
attachFiles[0]=THAMotorCarQuotationVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
