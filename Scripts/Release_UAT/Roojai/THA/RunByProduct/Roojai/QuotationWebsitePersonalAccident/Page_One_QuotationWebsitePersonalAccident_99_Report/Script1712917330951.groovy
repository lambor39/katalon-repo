...
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationResultFactory
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationResultType
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationResultUtil
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationDetail1Factory
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationDetail1Type
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationDetail1Util
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationPaymentFactory
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationPaymentType
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationPaymentUtil
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationVerifyFactory
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationVerifyType
import org.roojai.tha.types.roojaipersonalaccident.THAPersonalAccidentQuotationVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THAPersonalAccidentQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THAPersonalAccidentQuotationVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THAPersonalAccidentQuotationVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THAPersonalAccidentQuotationVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Quotation website (Personal Accident)'
...
attachFiles[0]=THAPersonalAccidentQuotationVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
