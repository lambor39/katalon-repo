...
TestData dataInput=TestDataFactory.findTestData(THARoojaiAPI2VerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THARoojaiAPI2VerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THARoojaiAPI2VerifyFactory caseFactory=new THARoojaiAPI2VerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARoojaiAPI2VerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
THARoojaiAPI2VerifyUtil caseUtil=null
Boolean runNext=false
/*Input
 caseInput.RoojaiAPI2GetPlanList
 caseInput.ActualResult
 */
/*Output
 caseOutput.RoojaiAPI2GetPlanList
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	caseUtil=new THARoojaiAPI2VerifyUtil()
