...
import org.roojai.tha.types.roojaiapi2.THARoojaiAPI2GetPlanListFactory
import org.roojai.tha.types.roojaiapi2.THARoojaiAPI2GetPlanListType
import org.roojai.tha.types.roojaiapi2.THARoojaiAPI2GetPlanListUtil
import org.roojai.tha.types.roojaiapi2.THARoojaiAPI2VerifyFactory
import org.roojai.tha.types.roojaiapi2.THARoojaiAPI2VerifyType
import org.roojai.tha.types.roojaiapi2.THARoojaiAPI2VerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THARoojaiAPI2VerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THARoojaiAPI2VerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THARoojaiAPI2VerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THARoojaiAPI2VerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Roojai (RoojaiAPI2)'
...
attachFiles[0]=THARoojaiAPI2VerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
