...
import org.roojai.tha.types.roojaicovid.THARoojaiCovidQuotationDetailFactory
import org.roojai.tha.types.roojaicovid.THARoojaiCovidQuotationDetailType
import org.roojai.tha.types.roojaicovid.THARoojaiCovidQuotationDetailUtil
...
TestData dataInput=TestDataFactory.findTestData(THARoojaiCovidQuotationDetailType.INPUT_DATA_FILE_NAME)
TestData dataOutput=TestDataFactory.findTestData(THARoojaiCovidQuotationDetailType.OUTPUT_DATA_FILE_NAME)
THARoojaiCovidQuotationDetailFactory caseFactory=new THARoojaiCovidQuotationDetailFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARoojaiCovidQuotationDetailType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THARoojaiCovidQuotationDetailUtil caseUtil=null
...
/*Input
 ...
 caseInput.Language
 caseInput.HolderBasicInfoPositiveCase
 caseInput.HolderGenderStatus
 caseInput.HolderName
 caseInput.HolderSurname
 caseInput.HolderDob
 caseInput.HolderIsThai
 caseInput.HolderIdPositiveCase
 caseInput.HolderThaiId
 caseInput.HolderPassport
 caseInput.HolderEmailPositiveCase
 caseInput.HolderEmail
 caseInput.HolderMobilePositiveCase
 caseInput.HolderMobile
 caseInput.AddressPostalCode
 caseInput.AddressProvince
 caseInput.AddressDistrict
 caseInput.AddressSubDistrict
 caseInput.AddressHouseNoPositiveCase
 caseInput.AddressHouseNo
 caseInput.AddressBuilding
 caseInput.AddressRoad
 caseInput.AddressMooPositiveCase
 caseInput.AddressMoo
 caseInput.BeneficiaryLegal
 caseInput.BeneficiaryOtherPositiveCase
 caseInput.BeneficiaryOtherRelation
 caseInput.BeneficiaryOtherName
 caseInput.BeneficiaryOtherSurname
 caseInput.ConfirmInfo
 caseInput.ConfirmDisclosure
...
/*Output
 ...
 caseOutput.Language
 caseOutput.HolderBasicInfoPositiveCase
 caseOutput.HolderGenderStatus
 caseOutput.HolderName
 caseOutput.HolderSurname
 caseOutput.HolderDob
 caseOutput.HolderIsThai
 caseOutput.HolderIdPositiveCase
 caseOutput.HolderThaiId
 caseOutput.HolderPassport
 caseOutput.HolderEmailPositiveCase
 caseOutput.HolderEmail
 caseOutput.HolderMobilePositiveCase
 caseOutput.HolderMobile
 caseOutput.AddressPostalCode
 caseOutput.AddressProvince
 caseOutput.AddressDistrict
 caseOutput.AddressSubDistrict
 caseOutput.AddressHouseNoPositiveCase
 caseOutput.AddressHouseNo
 caseOutput.AddressBuilding
 caseOutput.AddressRoad
 caseOutput.AddressMooPositiveCase
 caseOutput.AddressMoo
 caseOutput.BeneficiaryLegal
 caseOutput.BeneficiaryOtherPositiveCase
 caseOutput.BeneficiaryOtherRelation
 caseOutput.BeneficiaryOtherName
 caseOutput.BeneficiaryOtherSurname
 caseOutput.ConfirmInfo
 caseOutput.ConfirmDisclosure
...
if(GlobalVariable.PrevStatus){
	...
	if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
		...
		if(GlobalVariable.BrowserInit){
			...
			selenium=driver
			caseUtil=new THARoojaiCovidQuotationDetailUtil(driver,selenium)
			IGNUemaHelper.delayThreadSecond(0)
			String lLocatorToCheck1='summary-price'
			String lLocatorToCheck2='#summary-price'
			...
			if(!runNext){
				...
				runNext=caseUtil.inputDetail(caseInput,caseOutput)
