...
import org.roojai.tha.types.roojaicovid.THARoojaiCovidQuotationVerifyFactory
import org.roojai.tha.types.roojaicovid.THARoojaiCovidQuotationVerifyType
import org.roojai.tha.types.roojaicovid.THARoojaiCovidQuotationVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THARoojaiCovidQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THARoojaiCovidQuotationVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THARoojaiCovidQuotationVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THARoojaiCovidQuotationVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Quotation website (Roojai Covid)'
...
attachFiles[0]=THARoojaiCovidQuotationVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
