...
TestData dataInput=TestDataFactory.findTestData(THARGPACriticalIllnessQuotationVerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THARGPACriticalIllnessQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THARGPACriticalIllnessQuotationVerifyFactory caseFactory=new THARGPACriticalIllnessQuotationVerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARGPACriticalIllnessQuotationVerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THARGPACriticalIllnessQuotationVerifyUtil caseUtil=null
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	if(GlobalVariable.BrowserInit){
		...
		selenium=driver
		caseUtil=new THARGPACriticalIllnessQuotationVerifyUtil(driver,selenium)
