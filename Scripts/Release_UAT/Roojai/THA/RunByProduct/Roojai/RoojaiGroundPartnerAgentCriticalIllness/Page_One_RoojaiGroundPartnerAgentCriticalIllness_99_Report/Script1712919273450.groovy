...
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationResultFactory
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationResultType
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationResultUtil
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationDetail1Factory
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationDetail1Type
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationDetail1Util
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationPaymentFactory
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationPaymentType
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationPaymentUtil
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationVerifyFactory
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationVerifyType
import org.roojai.tha.types.roojaigroundpartneragent.criticalillness.THARGPACriticalIllnessQuotationVerifyUtil
...
Integer lFailed=0
Integer lErrors=0
TestData dataOutput=TestDataFactory.findTestData(THARGPACriticalIllnessQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
Integer dataColNum=dataOutput.getColumnNumbers()
String lText1=''
String lText2=''
for(lIndex=THARGPACriticalIllnessQuotationVerifyType.OUTPUT_DATA_COL_BEGIN;lIndex<=dataColNum;lIndex++){
	lText1=''
	lText2=''
	lText1=dataOutput.getValue(lIndex,THARGPACriticalIllnessQuotationVerifyType.OUTPUT_DATA_ROW_BEGIN).trim()
	lText2=dataOutput.getValue(lIndex,THARGPACriticalIllnessQuotationVerifyType.OUTPUT_DATA_ROW_END).trim()
...
String lstrProductName='Quotation website (Roojai Ground Partner Agent Critical Illness)'
...
attachFiles[0]=THARGPACriticalIllnessQuotationVerifyType.OUTPUT_EXCEL_FILE_NAME
if(lTotal>0){
