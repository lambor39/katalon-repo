...
TestData dataInput=TestDataFactory.findTestData(THARGPAElectricMotorCarQuotationVerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THARGPAElectricMotorCarQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THARGPAElectricMotorCarQuotationVerifyFactory caseFactory=new THARGPAElectricMotorCarQuotationVerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARGPAElectricMotorCarQuotationVerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THARGPAElectricMotorCarQuotationVerifyUtil caseUtil=null
Boolean runNext=false
/*Input
 caseInput.ElectricMotorCar01Input
 caseInput.ElectricMotorCar02Result
 caseInput.ElectricMotorCar03Detail1
 caseInput.ElectricMotorCar04Payment
 caseInput.ElectricMotorCar05Detail2
 caseInput.ElectricMotorCar06Social
 caseInput.ActualResult
 */
/*Output
 caseOutput.ElectricMotorCar01Input
 caseOutput.ElectricMotorCar02Result
 caseOutput.ElectricMotorCar03Detail1
 caseOutput.ElectricMotorCar04Payment
 caseOutput.ElectricMotorCar05Detail2
 caseOutput.ElectricMotorCar06Social
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	if(GlobalVariable.BrowserInit){
		...
		selenium=driver
		caseUtil=new THARGPAElectricMotorCarQuotationVerifyUtil(driver,selenium)
