...
TestData dataInput=TestDataFactory.findTestData(THARGPAExtendedWarrantyQuotationVerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THARGPAExtendedWarrantyQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THARGPAExtendedWarrantyQuotationVerifyFactory caseFactory=new THARGPAExtendedWarrantyQuotationVerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARGPAExtendedWarrantyQuotationVerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THARGPAExtendedWarrantyQuotationVerifyUtil caseUtil=null
Boolean runNext=false
/*Input
 caseInput.ExtendedWarranty01Input
 caseInput.ExtendedWarranty02Result
 caseInput.ExtendedWarranty03Detail1
 caseInput.ExtendedWarranty04Payment
 caseInput.ExtendedWarranty05Detail2
 caseInput.ExtendedWarranty06Social
 caseInput.ActualResult
 */
/*Output
 caseOutput.ExtendedWarranty01Input
 caseOutput.ExtendedWarranty02Result
 caseOutput.ExtendedWarranty03Detail1
 caseOutput.ExtendedWarranty04Payment
 caseOutput.ExtendedWarranty05Detail2
 caseOutput.ExtendedWarranty06Social
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	if(GlobalVariable.BrowserInit){
		...
		selenium=driver
		caseUtil=new THARGPAExtendedWarrantyQuotationVerifyUtil(driver,selenium)
