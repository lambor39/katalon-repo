...
import org.roojai.tha.types.roojaigroundpartneragent.roojaiquote.extendedwarranty.THARGPAExtendedWarrantyQuotationResultFactory
import org.roojai.tha.types.roojaigroundpartneragent.roojaiquote.extendedwarranty.THARGPAExtendedWarrantyQuotationResultType
import org.roojai.tha.types.roojaigroundpartneragent.roojaiquote.extendedwarranty.THARGPAExtendedWarrantyQuotationResultUtil
...
TestData dataInput=TestDataFactory.findTestData(THARGPAExtendedWarrantyQuotationResultType.INPUT_DATA_FILE_NAME)
TestData dataOutput=TestDataFactory.findTestData(THARGPAExtendedWarrantyQuotationResultType.OUTPUT_DATA_FILE_NAME)
THARGPAExtendedWarrantyQuotationResultFactory caseFactory=new THARGPAExtendedWarrantyQuotationResultFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARGPAExtendedWarrantyQuotationResultType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THARGPAExtendedWarrantyQuotationResultUtil caseUtil=null
...
/*Input
 ...
 caseInput.Version
 caseInput.Language
 caseInput.PrePackage
 caseInput.PlanPackage
 caseInput.QuoteBy
 caseInput.QuotePhoneNo
 caseInput.QuoteEmail
 caseInput.QuoteNewsletter
 caseInput.QuoteCallMeNow
 caseInput.QuotePDFDownloadToDo
...
/*Output
 ...
 caseOutput.Version
 caseOutput.Language
 caseOutput.PrePackage
 caseOutput.PlanPackage
 caseOutput.QuoteBy
 caseOutput.QuotePhoneNo
 caseOutput.QuoteEmail
 caseOutput.QuoteNewsletter
 caseOutput.QuoteCallMeNow
 caseOutput.QuotePDFDownloadToDo
 caseOutput.PositiveCase
 caseOutput.ActualResult
 caseOutput.ResultMessage
 caseOutput.OpportunityNumber
 caseOutput.PrePackagePremiumYearly
 caseOutput.PrePackagePremiumDeposit
 caseOutput.PrePackagePremiumMonthly
 caseOutput.PrePackagePremiumInstalment
 caseOutput.PrePackagePremiumNoDepositAmount
 caseOutput.PrePackagePremiumNoDepositTotal
 caseOutput.PrePackagePremiumQuarterlyAmount
 caseOutput.PrePackagePremiumQuarterlyTotal
 caseOutput.PostPrePackagePremiumYearly
 caseOutput.PostPrePackagePremiumDeposit
 caseOutput.PostPrePackagePremiumMonthly
 caseOutput.PostPrePackagePremiumInstalment
 caseOutput.PostPrePackagePremiumNoDepositAmount
 caseOutput.PostPrePackagePremiumNoDepositTotal
 caseOutput.PostPrePackagePremiumQuarterlyAmount
 caseOutput.PostPrePackagePremiumQuarterlyTotal
 caseOutput.PremiumYearly
 caseOutput.PremiumDeposit
 caseOutput.PremiumMonthly
 caseOutput.PremiumInstalment
 caseOutput.PremiumNoDepositAmount
 caseOutput.PremiumNoDepositTotal
 caseOutput.PremiumQuarterlyAmount
 caseOutput.PremiumQuarterlyTotal
 caseOutput.PolicyInsurer
 caseOutput.QuotePDFDownloadDetail
 caseOutput.QuotePDFDownloadResult
 */
if(GlobalVariable.PrevStatus){
	...
	if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
		...
		if(GlobalVariable.BrowserInit){
			...
			Boolean ready1=IGNUemaHelper.checkElementPresentByElementId(driver,'extendedWarranty-packages',10)
			Boolean ready2=IGNUemaHelper.checkElementPresentByLocator(driver,'#extendedWarranty-packages',10)
			...
			if(!runNext){
				...
				caseFactory.SaveOutput()
				caseUtil=new THARGPAExtendedWarrantyQuotationResultUtil(driver,selenium)
				//Check ABTesting
				...
				runNext=caseUtil.inputResult(caseInput,caseOutput)
				...
				if(caseOutput.QuoteBy.toString().equalsIgnoreCase('NONE')){
