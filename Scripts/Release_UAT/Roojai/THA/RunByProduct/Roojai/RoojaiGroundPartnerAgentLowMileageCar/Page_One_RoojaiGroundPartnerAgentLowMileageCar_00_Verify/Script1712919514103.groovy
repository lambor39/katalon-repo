...
TestData dataInput=TestDataFactory.findTestData(THARGPALowMileageCarQuotationVerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THARGPALowMileageCarQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THARGPALowMileageCarQuotationVerifyFactory caseFactory=new THARGPALowMileageCarQuotationVerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARGPALowMileageCarQuotationVerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THARGPALowMileageCarQuotationVerifyUtil caseUtil=null
Boolean runNext=false
/*Input
 caseInput.LowMileageCar01Input
 caseInput.LowMileageCar02Result
 caseInput.LowMileageCar03Detail1
 caseInput.LowMileageCar04Payment
 caseInput.LowMileageCar05Detail2
 caseInput.LowMileageCar06Social
 caseInput.ActualResult
 */
/*Output
 caseOutput.LowMileageCar01Input
 caseOutput.LowMileageCar02Result
 caseOutput.LowMileageCar03Detail1
 caseOutput.LowMileageCar04Payment
 caseOutput.LowMileageCar05Detail2
 caseOutput.LowMileageCar06Social
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	if(GlobalVariable.BrowserInit){
		...
		selenium=driver
		caseUtil=new THARGPALowMileageCarQuotationVerifyUtil(driver,selenium)
