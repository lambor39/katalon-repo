...
IGNTestManager lIGNTestManager=IGNTestManagerHelperTHA.getIGNTestManagerInstance()
...
if(lIGNTestManager.getIsIGNTestManagerReady()){
	IGNUemaHelper.printLog('ConductSingle.CaseNumber='+GlobalVariable.CaseNumber)
	Boolean lConductTestExecutionOK=lIGNTestManager.conductTestExecutionSingle(GlobalVariable.CaseNumber)
	lIsActualResult=lConductTestExecutionOK
	IGNTestExecutorTypeItem lIGNTestExecutorTypeItem=lIGNTestManager.getIGNTestConductor().getIGNTestExecutorFactory().getIGNTestExecutorTypeItemStoreByCaseNumber(GlobalVariable.CaseNumber)
	if(!IGNUemaHelper.checkObjectNullOfObject(lIGNTestExecutorTypeItem)){
		String lStrTestCaseDataCurrentStore=''
		lStrTestCaseDataCurrentStore=IGNUemaHelper.concatMessageLeftRightByPipe(lStrTestCaseDataCurrentStore,'ActualResult:'+IGNUemaHelper.convertBooleanToYesNoString(lIGNTestExecutorTypeItem.getIsTestCaseDataCurrentStoreTestCaseActualResult()))
		lStrTestCaseDataCurrentStore=IGNUemaHelper.concatMessageLeftRightByPipe(lStrTestCaseDataCurrentStore,'Message:'+lIGNTestExecutorTypeItem.getStrTestCaseDataCurrentStoreTestCaseResultMessage())
		lStrTestCaseDataCurrentStore=IGNUemaHelper.concatMessageLeftRightByPipe(lStrTestCaseDataCurrentStore,'Detail:'+lIGNTestExecutorTypeItem.getStrTestCaseDataCurrentStoreTestCaseStoryDetail())
		IGNUemaHelper.printLog('Result='+lStrTestCaseDataCurrentStore)
	}
	IGNUemaHelper.printLog('ConductTestExecutionOK='+IGNUemaHelper.convertBooleanToString(lConductTestExecutionOK))
	if(!IGNUemaHelper.checkObjectNullOrEmptyOfString(lIGNTestManager.getStrIGNTestConductorTestStoryDetailAfterSingle())){
		IGNUemaHelper.printLog('StoryDetailAfterSingle='+lIGNTestManager.getStrIGNTestConductorTestStoryDetailAfterSingle())
	}
