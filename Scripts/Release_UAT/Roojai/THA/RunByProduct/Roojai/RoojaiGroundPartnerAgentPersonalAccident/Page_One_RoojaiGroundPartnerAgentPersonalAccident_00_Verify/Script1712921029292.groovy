...
TestData dataInput=TestDataFactory.findTestData(THARGPAPersonalAccidentQuotationVerifyType.INPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
TestData dataOutput=TestDataFactory.findTestData(THARGPAPersonalAccidentQuotationVerifyType.OUTPUT_DATA_FILE_NAME)
IGNUemaHelper.delayThreadSecond(1)
THARGPAPersonalAccidentQuotationVerifyFactory caseFactory=new THARGPAPersonalAccidentQuotationVerifyFactory(dataInput)
caseFactory.CurrentCase=GlobalVariable.CaseNumber
THARGPAPersonalAccidentQuotationVerifyType caseData=caseFactory.CaseData()
Map caseInput=caseData.Input
Map caseOutput=caseData.Output
WebDriver driver=null
WebDriver selenium=null
THARGPAPersonalAccidentQuotationVerifyUtil caseUtil=null
Boolean runNext=false
/*Input
 caseInput.PersonalAccident01Input
 caseInput.PersonalAccident02Result
 caseInput.PersonalAccident03Detail1
 caseInput.PersonalAccident04Payment
 caseInput.ActualResult
 */
/*Output
 caseOutput.PersonalAccident01Input
 caseOutput.PersonalAccident02Result
 caseOutput.PersonalAccident03Detail1
 caseOutput.PersonalAccident04Payment
...
if(caseFactory.IsValid &&(caseFactory.CurrentCase>0)){
	...
	if(GlobalVariable.BrowserInit){
		...
		selenium=driver
		caseUtil=new THARGPAPersonalAccidentQuotationVerifyUtil(driver,selenium)
