...
try{
	...
	if(lIsRunNext){
		lIsOK=IGNSalesforceRestAPIHelper.setIGNSalesforceRestAPICountry(IGNTestDataCountry.Thailand)
		...
		lMapGetSalesforceDataByOpportunityNumberToMapCaseOutputNoPrefixV1=IGNSalesforceRestAPIHelper.mapGetSalesforceDataByOpportunityNumberToMapCaseOutputNoPrefixV1('1000-02401753',lMapCaseOutputNoPrefixV1)
		...
		lMapGetSalesforceDataByOpportunityNumberToMapCaseOutputWithPrefixA=IGNSalesforceRestAPIHelper.mapGetSalesforceDataByOpportunityNumberToMapCaseOutputWithPrefix('1000-02401753','',lMapCaseOutputWithPrefixA)
		...
		lMapGetSalesforceDataByOpportunityNumberToMapCaseOutputWithPrefixB=IGNSalesforceRestAPIHelper.mapGetSalesforceDataByOpportunityNumberToMapCaseOutputWithPrefix('1000-02401753','ZZZZ',lMapCaseOutputWithPrefixB)
		...
		String lStrSOQLText='SELECT Id, IsDeleted, MasterRecordId, Name, LastName, FirstName, Salutation, MiddleName, Suffix FROM Account where Id=\'001F6000015oT3mIAE\''
